CREATE PROCEDURE [dbo].[spUpdateUserPermissionLogs]
	...
	,@MassPayrollTicket VARCHAR(1) = 'N'
	,@Violations VARCHAR(4)='NNNN'
AS
...
declare @currMassPayrollTicket VARCHAR(1)='N'
DECLARE @currViolationsPermission VARCHAR(6) = 'NNNN' 
SELECT 
	...
	, @currMassPayrollTicket				= MassPayrollTicket
	, @currViolationsPermission				= ISNULL(ViolationPermission,'NNNN')
FROM tblUser u
WHERE u.ID = @UserID
...
END
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Customer',@currCustomerPermissions, @CustomerPermissions
-- Location
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Location', @currLocationrPermissions, @LocationrPermissions
-- Equipments
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Equipments', @currElevator, @Elevator
-- Receive Payment
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Receive Payment', @currApplyPermissions, @ApplyPermissions
-- Make Deposit
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Make Deposit', @currDepositPermissions, @DepositPermissions
-- Collections 
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Collections', @currCollectionsPermissions, @CollectionsPermissions, '4'
-- Credit Hold
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Credit Hold', @currCreditHold, @CreditHold, '4'
-- Credit Flag
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Credit Flag', @currCreditFlag, @CreditFlag, '4'
...
-- Write off
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Write off',@currwriteOff, @writeOff, '1'
...
END
-- Recurring Contracts
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Recurring Contracts', @currProcessRCPermission, @ProcessRCPermission
-- Safety Tests 
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Safety Tests', @currSafetyTestsPermission, @SafetyTestsPermission
-- Recurring Invoices @ProcessC
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Recurring Invoices',@currProcessC, @ProcessC, '134'
-- Recurring Tickets
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Recurring Tickets',@currProcessT, @ProcessT, '134'
-- Renew/Escalate
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Renew/Escalate', @currRCRenewEscalatePermission, @RCRenewEscalatePermission, '14'
...
END
-- Ticket
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Ticket',@currTicketPermission, @TicketPermission, '12346'
-- Completed Ticket 
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Completed Ticket',@currTicketResolvedPermission, @TicketResolvedPermission
...
-- MassPayrollTicket
IF(ISNULL(@MassPayrollTicket,'N') != ISNULL(@currMassPayrollTicket,'N'))
BEGIN 	
	Declare @logMassPayrollTicket varchar(1) = ISNULL(@MassPayrollTicket,'N')
	Declare @logCurrMassPayrollTicket varchar(1) = ISNULL(@currMassPayrollTicket,'N')
	EXEC log2_insert @CreatedBy,@Screen,@RefId,'Permissions - Mass Payroll Ticket',@logCurrMassPayrollTicket,@logMassPayrollTicket
END
 

-- Schedule Board @ScheduleBoardPermission
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Schedule Board', @currScheduleBoardPermission, @ScheduleBoardPermission, '4'
-- Route Builder @RouteBuilderPermission
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Route Builder', @currRouteBuilderPermission, @RouteBuilderPermission, '4'
...
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Timesheet Entry', @currMTimesheetPermission, @MTimesheetPermission, '4'
-- e-Timesheet (Payroll data) @ETimesheetPermission
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - e-Timesheet (Payroll data)', @currETimesheetPermission, @ETimesheetPermission, '4'
-- Map @MapRPermission
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Map', @currMapRPermission, @MapRPermission,'4'
...
END
-- Project
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Project', @currProjectPermissions, @ProjectPermissions
-- Project Template
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Project Template', @currProjecttempPermission, @ProjecttempPermission
-- BOM
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - BOM', @currBOMPermission, @BOMPermission
-- WIP
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - WIP', @currWIPPermission, @WIPPermission, '12346'
-- Milestones
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Billing', @currMilestonesPermission, @MilestonesPermission
-- Project status
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Project status - Close', @currJobClosePermission, @JobClosePermission, '1'
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Project status - Complete', @currJobCompletedPermission, @JobCompletedPermission, '1'
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Project status - Reopen', @currJobReopenPermission, @JobReopenPermission, '1'
-- ProjectList Finance
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - ProjectList Finance', @currProjectListPermission, @ProjectListPermission, '1'
-- Project Finance 
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Project Finance', @currFinancePermission, @FinancePermission, '1'
...
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Inventory Item List', @currInventoryItemPermissions, @InventoryItemPermissions
-- Inventory Adjustment
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Inventory Adjustment', @currInventoryAdjustmentPermissions, @InventoryAdjustmentPermissions
-- Inventory WareHouse
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Inventory WareHouse', @currInventoryWarehousePermissions, @InventoryWarehousePermissions
-- Inventory setup
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Inventory setup', @currInventorysetupPermissions, @InventorysetupPermissions
-- Inventory Finance
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Inventory Finance', @currInventoryFinancePermissions, @InventoryFinancePermissions
...
END
-- Leads 
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Leads', @currSalesPermission, @SalesPermission, '12346'
-- Opportunities
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Opportunities', @currProposalPermission, @ProposalPermission, '12346'
-- Estimate
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Estimate', @currEstimatePermission, @EstimatePermission, '12346'
-- Complete Task
...
END
-- Task FollowUp 
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Task FollowUp', @currFollowUpPermission, @FollowUpPermission, '1'
-- Tasks
...
END
-- Convert Estimate
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Convert Estimate', @currConvertEstimatePermission, @ConvertEstimatePermission, '1'
-- Sales Setup
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Sales Setup', @currConvertEstimatePermission, @ConvertEstimatePermission, '1'
...
END
-- Vendors
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Vendors',@currAPVendor, @APVendor
-- Bills
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Bills', @currAPBill, @APBill
-- Manage Checks
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Manage Checks', @currAPBillPay, @APBillPay
...
END
-- Chart of Accounts 
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Chart of Accounts', @currChartPermissions, @ChartPermissions
-- Journal Entry
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Journal Entry', @currJournalEntryPermissions, @JournalEntryPermissions
-- Bank Reconciliation
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Bank Reconciliation', @currBankReconciliationPermissions, @BankReconciliationPermissions
-- Financial Statement Module
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Financial Statement Module', @currFinanceState, @FinanceState, '6'
...
END
-- Invoices
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Invoices', @currInvoicePermission, @InvoicePermission
-- Billing Codes
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Billing Codes', @currBillingCodesPermission, @BillingCodesPermission
-- Online Payment
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Online Payment', @currPaymentHistoryPermission, @PaymentHistoryPermission, '4'
...
END
-- PO
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - PO', @currPOPermission,@POPermission
-- Receive PO
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Receive PO', @currRPOPermission, @RPOPermission
-- PO Notification
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - PO Notification', @currPONotification, @PONotification, '1'
...
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Employee Maintenance', @currEmployee, @Employee, '4'
-- Users 
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Users', @currAccessUser, @AccessUser, '1'
-- Enter expenses @Expenses
--Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Enter expenses', @Expenses, '1'
-- Email Dispatch 
IF(ISNULL(@DispatchCheck,'N') != ISNULL(@currDispatchCheck,'N'))
BEGIN 	
	Declare @logDispatchCheck varchar(10) = ISNULL(@DispatchCheck,'N')
	Declare @logCurrDispatchCheck varchar(10) = ISNULL(@currDispatchCheck,'N')
	EXEC log2_insert @CreatedBy,@Screen,@RefId,'Permissions - Email Dispatch',@logCurrDispatchCheck,@logDispatchCheck
END
-- Document/Contact 
-- Document
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Document',@currDocumentPermission, @DocumentPermission
-- Contact
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Contact', @currContactPermission, @ContactPermission
-- Violations  
Exec spUpdateCRUDPermissionLogs @CreatedBy, @RefId, 'Permissions - Violations', @currViolationsPermission, @Violations ,'13'
/* End Permissions */