CREATE PROC [dbo].[spGetRunPayroll]       
@startdate datetime,      
@enddate datetime,      
...
Set @s_Etimesheet=@Etimesheet      
 ...
 FROM #TempPayroll GROUP BY ID,Name,EN,Company,fDesc,MileageRate,pay,holiday,vacation,sicktime,reimb,bonus,paymethod,pmethod,userid,usertype,phour,salary,HourlyRate,Customtick1 ORDER BY Name
