CREATE PROC [dbo].[spGetContractbyID] 	 @ContractbyID INT
AS 
SELECT j.Loc, 
       j.Owner, 
       Custom20, 
       ...
       isnull(l.Terr2,0) Terr2 ,
	    j.fDate     OriginalContract ,
	    isnull(c.LastRenew,j.fDate)  LastRenew ,
	   c.BLenght ContractLength
FROM   Job j 
