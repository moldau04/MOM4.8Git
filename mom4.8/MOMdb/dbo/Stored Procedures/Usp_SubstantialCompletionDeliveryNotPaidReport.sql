 -- Usp_SubstantialCompletionDeliveryNotPaidReport                    
CREATE PROCEDURE [dbo].Usp_SubstantialCompletionDeliveryNotPaidReport                
AS                  
BEGIN         
 ...
 Where isnull(vw.[Unit substantially Complete],'')   != '' and  isnull(vw.[PAYMENT 3 - DELIVERY PYMT RCVD],'')  =''           
 order By j.ID desc         
