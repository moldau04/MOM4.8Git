<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="APAging360Report" CodeBehind="APAging360Report.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; AP Aging Report</div>
            ...
            <div class="row">
                    ...
                    <div class="srchpaneinnernegate">
                        <div class="srchpaneinner">
                            ...
                            <div class="srchinputwrap">
                                <asp:DropDownList ID="ddlInvoice" CssClass="browser-default brow-css" runat="server" Width="120" >
                                    <asp:ListItem Value="1">Outstanding </asp:ListItem>
                                    <asp:ListItem Value="2">Due </asp:ListItem>
                                    <asp:ListItem Value="3">As of date </asp:ListItem>
                                </asp:DropDownList>
                            </div>
                ...
                <div class="grid_container">
                    <div class="form-section-row m-b-0" >
                        <cc1:StiWebViewer ID="StiWebViewerAPAging" Height="800px" runat="server" ScrollbarsMode="true" ViewMode="Continuous" CacheMode="None" BackgroundColor="White"
                            OnGetReport="StiWebViewerAPAging_GetReport" OnGetReportData="StiWebViewerAPAging_GetReportData" RequestTimeout="9000000" Visible="false" />
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; AP Aging Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
