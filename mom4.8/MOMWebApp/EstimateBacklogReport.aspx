<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="EstimateBacklogReport" CodeBehind="EstimateBacklogReport.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row" style="height: 40px;">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-communication-contacts"></i>&nbsp; Estimate Backlog Report</div>
        ...
        <div class="container">
            <div class="row">
                <div class="srchpane">
                    <div class="srchpaneinnernegate">
                        <div class="srchpaneinner">
                            <div class="srchtitle mt-10" style="margin-top: 10px">
                                Status
                            </div>
                            <div class="srchinputwrap">
                                <telerik:RadComboBox RenderMode="Auto" Skin="Metro" ID="rcStatus" runat="server" EmptyMessage="--Select Status--" Filter="StartsWith"
                                    CheckBoxes="true" EnableCheckAllItemsCheckBox="true" Width="150" CssClass="">
                                </telerik:RadComboBox>
                            </div>

                            <div class="srchinputwrap">
                                <div class="rdpairing m-t-m-l20" style="margin-top: 10px; margin-left: 20px;">
                                    <asp:CheckBox ID="chkConvertToProject" Text="Estimates converted to project" runat="server" CssClass="css-checkbox" />
                                </div>
                            </div>
                ...
                <div class="grid_container">
                    <cc1:StiWebViewer ID="StiWebViewerEstimateBacklog" Height="800px" RequestTimeout="20000" CacheMode="None" runat="server" ViewMode="Continuous" ScrollbarsMode="true"
                        OnGetReport="StiWebViewerEstimateBacklog_GetReport" OnGetReportData="StiWebViewerEstimateBacklog_GetReportData" />
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Estimate Backlog Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
