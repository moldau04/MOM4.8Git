<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="ARAgingOver90Days" Codebehind="ARAgingOver90Days.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; AR Aging Over 90 Days Report</div>
                    ...
                    <div class="srchpaneinnernegate">
                        <div class="srchpaneinner">
                            ...
                            <div class="srchinputwrap">
                                <asp:DropDownList ID="ddlType" CssClass="browser-default brow-css" runat="server" Width="120" >
                            ...
                            <div class="srchinputwrap rdleftmgn">
                                <div class="rdpairing">
                                    <asp:CheckBox ID="chkHidePartial" Text="Hide Partial Payment" runat="server" CssClass="css-checkbox"/>
                                </div>
                            </div>
                            <div class="srchinputwrap rdleftmgn">
                                <div class="rdpairing">
                            ...
                            <div class="srchinputwrap rdleftmgn">
                               ...
                               <div class="srchinputwrap rdleftmgn">
                                <div class="rdpairing">                                 
                                    <asp:CheckBox ID="chkRetainageAmount" Text="Include Retainage" runat="server" CssClass="css-checkbox" />
                                </div>
                            </div>
                ...
                <div class="grid_container">
                    <div class="form-section-row">
                        <cc1:StiWebViewer ID="StiWebViewerARAging" Height="800px" runat="server" ScrollbarsMode="true" ViewMode="Continuous" CacheMode="None" BackgroundColor="White"
                            OnGetReport="StiWebViewerARAging_GetReport" OnGetReportData="StiWebViewerARAging_GetReportData" OnExportReport="StiWebViewerARAging_ExportReport" RequestTimeout="9000000" />
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; AR Aging Over 90 Days Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
...
<asp:Content ID="Content2" ContentPlaceHolderID="javascriptHolder" runat="Server">
    <script type="text/javascript">
