...
public partial class PrintTicketCustomer : System.Web.UI.Page
{
    ...
    private void FillCallHistory()
    {
        ...
        string reportPath = "Reports/Customer.rdlc";        
        ...
        param1.Add(new Microsoft.Reporting.WebForms.ReportParameter("To", Todate.ToString()));
    ...
    {
        Response.Redirect("addcustomer.aspx?uid="+Request.QueryString["uid"].ToString());
    }
