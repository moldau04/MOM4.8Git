<%@ Page Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="EstimateProfile" CodeBehind="EstimateProfile.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="mainWindow">
                        ...
                        <div class="container row-color-grey">
                            <div class="row" style="height: 40px;">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-communication-contacts"></i>&nbsp; Estimate Profile</div>
        ...
        <cc1:StiWebViewer ID="StiWebViewer_EstimateProfileReport" Height="800px" runat="server" ViewMode="Continuous" ScrollbarsMode="true" RequestTimeout="90000"
            OnGetReport="StiWebViewer_EstimateProfileReport_GetReport" OnGetReportData="StiWebViewer_EstimateProfileReport_GetReportData" />
    </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Estimate Profile
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
