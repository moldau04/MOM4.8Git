<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" CodeBehind="ProjectSummarybyProjectManagerReport.aspx.cs" Inherits="MOMWebApp.ProjectSummarybyProjectManagerReport" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Project Summary By Project Manager Report</div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
                                                <a id="mailReport" href="javascript:void(0);" onclick="showMailReport();return false;">Email</a>
                                            </div>
                                            <div class="btnlinks">
                                                <asp:LinkButton ID="lnkProjectSummarybyProjectManagerReport" runat="server" OnClick="lnkProjectSummarybyProjectManagerReport_Click">Export to Excel</asp:LinkButton>
                                            </div>
                                        </div>
            ...
            <div class="row">
                <div class="srchpane">
                    ...
                    <div class="srchinputwrap rdleftmgn">
                        <div class="rdpairing">
                            <asp:CheckBox ID="chkIncludeClose" Text="Include Closed" runat="server" CssClass="css-checkbox"/>
                        </div>
                    </div>
                ...
                <div class="grid_container">
                    <div class="form-section-row" style="margin-bottom: 0 !important;">
                        <cc1:StiWebViewer ID="StiWebViewerProject" Height="800px" RequestTimeout="200000" runat="server" CacheMode="None" ScrollbarsMode="true"
                            OnGetReport="StiWebViewerProject_GetReport" OnGetReportData="StiWebViewerProject_GetReportData" Visible="false"/>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Project Summary Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
