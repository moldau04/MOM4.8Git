<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Mom.master" Inherits="PrintJobActualBudget_NewGable" CodeBehind="PrintJobActualBudget_NewGable.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp;  Project Actual Vs Budget Report-Gable</div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp;  Project Actual Vs Budget Report-Gable
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
