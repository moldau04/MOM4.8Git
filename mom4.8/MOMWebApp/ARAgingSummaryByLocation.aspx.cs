...
public partial class ARAgingSummaryByLocation : System.Web.UI.Page
{
    #region Variables
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                GetSMTPUser();
                SetAddress();
                string FileName = "ARAgingSummaryByLocation.pdf";
    ...
    {
        var url = "ARAgingSummaryByLocation.aspx?sdate=" + txtSearchDate.Text + "&inclNotes=" + chkIncludeNotes.Checked + "&creditFlag=" + chkCreditFlag.Checked;
    ...
    private StiReport LoadReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/ARAgingSummaryByLocation.mrt");
            ...
            DataSet ds = objBL_Contracts.GetARAgingSummaryByLocation(objContract, creditFlag);
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "AR Aging Summary by Location Report";
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "ARAgingSummaryByLocation.pdf")
                        {
                ...
                mail.FileName = "ARAgingSummaryByLocation.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "ARAgingSummaryByLocation.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=ARAgingSummaryByLocation.pdf");
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached AR Aging Summary by Location Report.";
