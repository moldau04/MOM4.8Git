<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="TrialBalance" CodeBehind="TrialBalance.aspx.cs" %>
...
margin-left:-1px !important;
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            if (selectedVal == "1") {
                document.getElementById('<%=lbEndDate.ClientID%>').innerHTML = 'As Of';
                $('.label-start-date').hide();
                $('.input-start-date').hide();
                $('.select-date-radio').hide();
            }
            else {
                document.getElementById('<%=lbEndDate.ClientID%>').innerHTML = 'End Date';
                $('.label-start-date').show();
                $('.input-start-date').show();
                $('.select-date-radio').show();
            }
            ...
            $('#<%=ddlReport.ClientID%>').change(function () {
                ...
                document.getElementById('<%=txtStartDate.ClientID%>').value = mm + '/01/' + yyyy;;
                document.getElementById('<%=txtEndDate.ClientID%>').value = mm + '/' + dd + '/' + yyyy;
    ...
    <div id="mainWindow">
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-assessment"></i>&nbsp;Trial Balance</div>
                ...
                <div class="srchpane">
                    <div class="srchpaneinner">
                        ...
                        <div class="srchinputwrap">
                            <asp:DropDownList ID="ddlReport" runat="server" CssClass="browser-default selectsml selectst" TabIndex="1" Style="min-width: 200px !important;">
                                <asp:ListItem Value="1">Trial Balance - Standard</asp:ListItem>
                                <asp:ListItem Value="2">Trial Balance - Activity</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                    </div>
                    ...
                    <div class="srchpaneinnernegate">
                        <div class="srchinputwrap pd-negatenw">
                            <div class="srchtitle srchtitlecustomwidth label-start-date" style="padding-left: 15px;">
                                <asp:Label ID="lbStartDate" runat="server">Start Date</asp:Label>
                            </div>
                            <div class="srchinputwrap input-start-date">
                                <asp:TextBox ID="txtStartDate" runat="server" CssClass="form-control"
                                    MaxLength="50" Width="130px" autocomplete="off" Visible="true"></asp:TextBox>
                            ...
                            <div class="srchtitle srchtitlecustomwidth label-end-date" style="padding-left: 15px;">
                                <asp:Label ID="lbEndDate" runat="server">As Of</asp:Label>
                            </div>
                            <div class="srchinputwrap label-end-date">
                        ...
                        <div class="srchinputwrap select-date-radio">
        ...
        <div class="grid_container">
            <div class="form-section-row" style="margin-bottom: 0 !important;">
                <cc1:StiWebViewer ID="StiWebViewerTrialBalance" Height="800px" runat="server" ScrollbarsMode="true" ViewMode="Continuous" BackgroundColor="White" RequestTimeout="9000000"
                    OnGetReport="StiWebViewerTrialBalance_GetReport" OnGetReportData="StiWebViewerTrialBalance_GetReportData" Visible="false" />
            </div>
        </div>
    </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-assessment"></i>&nbsp;Trial Balance
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
