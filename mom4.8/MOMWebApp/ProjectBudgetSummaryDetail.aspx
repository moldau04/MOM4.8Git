<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MOMRadWindow.Master" CodeBehind="ProjectBudgetSummaryDetail.aspx.cs" Inherits="ProjectBudgetSummaryDetail" %>
            ...
            <div class="card" style="min-height: 70vh !important; border-radius: 6px; margin-top: -10px;">
                <div class="card-content">
                    <ul class="tabs tab-demo-active white" style="width: 100%;">
                        ...
                        <div> 
      <div class="page-title" id="Div2" runat="server" ><i class="mdi-content-inbox"></i>&nbsp; AR Invoices</div>
