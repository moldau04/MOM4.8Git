...
public partial class ProjectLaborCostReport : System.Web.UI.Page
{
    #region Variables
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                GetSMTPUser();
                SetAddress();
                string FileName = "ProjectLaborCostReport.pdf";
    ...
    protected void StiWebViewerProjectLaborCostReport_GetReport(object sender, StiReportDataEventArgs e)
    {
        e.Report = LoadReport();
    }

    protected void StiWebViewerProjectLaborCostReport_GetReportData(object sender, StiReportDataEventArgs e)
    {
    ...
    protected void lnkExcel_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("Content-Disposition", "attachment;filename=ProjectLaborCostReport.xls");
    ...
    {
        Response.Redirect("ProjectLaborCostReport.aspx");
    }
    ...
    private StiReport LoadReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/ProjectLaborCostReport.mrt");
            ...
            objPj._dt = (DataTable)Session["dtJobslaborcost"];
            if (!string.IsNullOrEmpty(Request["sd"]) && !string.IsNullOrEmpty(Request["ed"]))
            {
                objPj.StartDate = Convert.ToDateTime(HttpUtility.UrlDecode(Request.QueryString["sd"]));
                objPj.EndDate = Convert.ToDateTime(HttpUtility.UrlDecode(Request.QueryString["ed"]));
            }
            else
            {
                objPj.StartDate = DateTime.Now;
                objPj.EndDate = DateTime.Now;
            }

            DataSet ds = new DataSet();
            ds = objBL_Bills.GetProjectLaborCostReport(objPj);
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "Project Labor Cost Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Project Labor Cost Report attached.";
                }
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "ProjectLaborCostReport.pdf")
                        {
                ...
                mail.FileName = "ProjectLaborCostReport.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "ProjectLaborCostReport.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=ProjectLaborCostReport.pdf");
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached Project Labor Cost Report.";
    ...
    protected void btnSearch_Click1(object sender, EventArgs e)
    {
        ...
        var url = "ProjectLaborCostReport.aspx?sd=" + txtfromDate.Text + "&ed=" + txtToDate.Text;
