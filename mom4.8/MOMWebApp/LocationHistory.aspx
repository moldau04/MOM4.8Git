<%@ Page Language="C#" MasterPageFile="~/Mom.master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="LocationHistory.aspx.cs" Inherits="LocationHistory" %>
                ...
                <div id="breadcrumbs-wrapper">
                    <header>
                        <div class="col s12 m12 l12">
                            <div class="row">
                                <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Location History Report</div>
            ...
            <div class="row">
                ...
                <div class="grid_container">
                    <div class="form-section-row" style="margin-bottom: 0 !important;">
                        <cc1:StiWebViewer ID="StiWebViewerLocationHistory" Height="800px" RequestTimeout="20000" runat="server" ViewMode="Continuous" ScrollbarsMode="true" Visible="true" />
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Location History Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
