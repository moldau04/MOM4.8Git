<%@ Page Title="" Language="C#" MasterPageFile="~/MOMRadWindow.Master" AutoEventWireup="true" Inherits="HistoryTransaction" Codebehind="HistoryTransaction.aspx.cs" %>
                            ...
                            <telerik:RadGrid RenderMode="Auto" ID="RadGridARInvoice"
                               ...
                               <ClientSettings>
                                ...
                                <MasterTableView AutoGenerateColumns="false" AllowFilteringByColumn="false" ShowFooter="true" AllowPaging="true" ShowHeadersWhenNoRecords="true" NoMasterRecordsText="No records to display.">
                                    <Columns>
                                           <telerik:GridTemplateColumn HeaderText="Invoice/Check" HeaderStyle-Width="120px" SortExpression="Ref"  Reorderable="true">
                                            <ItemTemplate>         
