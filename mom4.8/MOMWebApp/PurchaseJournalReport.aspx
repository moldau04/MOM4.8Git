<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Mom.master" Inherits="PurchaseJournalReport" CodeBehind="PurchaseJournalReport.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Bill Weekly Report</div>
            ...
            <div class="row">
                <div class="srchpane">
                    ...
                    <div class="srchinputwrap">
                        <asp:TextBox ID="txtEndDate" runat="server" class="srchcstm datepicker_mom" TabIndex="4" MaxLength="50" Width="130px" autocomplete="off"></asp:TextBox>
                ...
                <div class="grid_container">
                    <div class="form-section-row m-b-0" >
                        <cc1:StiWebViewer ID="StiWebViewerPurchaseJournal" Height="800px" RequestTimeout="20000" runat="server" CacheMode="None" ViewMode="Continuous" ScrollbarsMode="true"
                            OnGetReport="StiWebViewerPurchaseJournal_GetReport" OnGetReportData="StiWebViewerPurchaseJournal_GetReportData" />
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Bill Weekly Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
