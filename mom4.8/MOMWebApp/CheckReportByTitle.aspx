<%@ Page Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" CodeBehind="CheckReportByTitle.aspx.cs" Inherits="CheckReportByTitle" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Check Report By Title</div>
                ...
                <div class="srchpane">
                    ...
                    <div class="grid_container">
                        <div class="form-section-row" style="margin-bottom: 0 !important;">
                            <cc1:StiWebViewer ID="StiWebViewerCheckReportByTitle" Height="800px" RequestTimeout="20000" runat="server" CacheMode="None" Visible="false" ViewMode="Continuous" ScrollbarsMode="true"
                                OnGetReport="StiWebViewerCheckReportByTitle_GetReport" OnGetReportData="StiWebViewerCheckReportByTitle_GetReportData" />
                        </div>
                    </div>
                </div>
            </div>
