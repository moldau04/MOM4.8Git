<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" ValidateRequest="false" EnableEventValidation="false" Inherits="AddTicket" CodeBehind="AddTicket.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <telerik:RadCodeBlock ID="codeBlock1" runat="server">
        ...
        <style type="text/css">
            ...
            .loc-css {
                color: rgb(5 19 44 / 62%) !important;
                font-weight: bold;
        ...
        <script type="text/javascript">
            ...
            function calculate_Time() {
                ...
                var PermissionTT = $("#<%=PermissionHiddenFieldTT.ClientID%>").val();


                if (txtOS != '' && txtER != '' && txtOS != '__:__ AM' && txtOS != '__:__ PM' && txtER != '__:__ AM' && txtER != '__:__ PM' && PermissionTT == '1') {
                    ...
                    $("#<%=HiddenFieldTT.ClientID%>").val('0.00');
            ...
            function notyConfirm(ticid, Navigation, WorkerName) {

                if (Navigation == 'job') {

                    if (window.opener && !window.opener.closed) {
                        if (window.opener.document.getElementById('ctl00_ContentPlaceHolder1_lnkjobticketSearch')) {
                            window.opener.document.getElementById('ctl00_ContentPlaceHolder1_lnkjobticketSearch').click();
                        }
                    }
                    window.close();
                }
                if (Navigation == 'none') {
                    ...
                    //var SelectedValue = $("#ctl00_ContentPlaceHolder1_ddlRoute1 option:selected").text();
            ...
            function CallNearestWorkerList(lat, lng) {
                debugger;
                var ddlDefRoute = document.getElementById('<%= ddlRoute.ClientID %>');
            ...
            function createrow(rowData, addr) {
                ...
                strrow += " <span class='worker-name'><b>" + rowData.dwork + " </b></span>";
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager_AddTicket" runat="server" OnAjaxRequest="RadAjaxManager_AddTicket_AjaxRequest">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="chkPayroll">
                <UpdatedControls>
            ...
            <telerik:AjaxSetting AjaxControlID="btnSelectLoc">
                <UpdatedControls>
                    ...
                    <telerik:AjaxUpdatedControl ControlID="RadAjaxPanelHeader" />
                    <telerik:AjaxUpdatedControl ControlID="LocBalance" />
                    <telerik:AjaxUpdatedControl ControlID="imgDollar" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <%-- --------------btnGetCode --------------%>
                                    ...
                                    <div class="buttonContainer">
                                        <div class="btnlinks">
                                            <asp:LinkButton ID="lnkSave" ToolTip="Save Ticket" runat="server" ValidationGroup="addticketVG" CausesValidation="true" OnClick="lnkSave_Click"
                                                OnClientClick="return SaveTicket(this);">Save</asp:LinkButton>
                                        </div>
                                    ...
                                    <div class="rght-content">
                                        <div class="editlabel">
                                            <telerik:RadAjaxPanel ID="RadAjaxPanelHeader" Visible="false" runat="server">
                                                <ul class="anchor-links inlin-css">
                        ...
                        <div class="row">
                            <div class="tblnks">
                                <ul class="anchor-links">
                                    <li class="w-90"><a class="add-btn-click">Show Stats</a> </li>
                    ...
                    <div id="addinfo" class="form-section-row adv-sarch">
                        ...
                        <telerik:RadAjaxPanel ID="RadAjaxPanelstats" runat="server">
                            ...
                            <div class="form-section1">
                                <div class="section-ttle" style="margin-bottom:5px;">
                                    Nearest Workers 
                                ...
                                <div class="nearest-wrap">
                                    <table id="NearWorkers" class="roundCorner">
                                    </table>
                                </div>
                            </div>
                            <div class="form-section3-blank">
                        ...
                        <div class="form-section1" style="width:43%">
                            <div class="section-ttle" style="margin-bottom: 4px;">
                                Recent Calls
                            ...
                            <div class="nearest-worker-wrapper">
                                <table class="table-header">
                                                     <tbody>   
                                                         <tr>
                                                            <td class="worker-name" style=" width: 11%; ">
                                                                Ticket No
                                                            </td>
                                                            <td class="other-item" style=" width: 13%; ">
                                                                Call Type
                                                            </td>
                                                            <td class="other-item" style=" width: 13%; ">
                                                                Assig.  to
                                                            </td>        
                                                             <td class="other-item" style=" width: 15%; ">
                                                                Cat.
                                                            </td> 
                                                             <td class="other-item" style=" width: 13%; ">
                                                               EQPT.
                                                            </td>
                                                            <td class="ticket-datetime" style=" width: 106%; ">
                                                                <span class="ticket-date">
                                                                    Date</span>
                                                                <span class="ticket-time" style="font-weight:bold!important; padding-left: 21px;padding-right: 33px;">Time</span>
                                                                <span class="ticket-status">Status</span>
                                                            </td>
                                                           </tr>
                                                         </tbody>
                                                    </table>
                                <div class="nearest-worker ps-container ps-active-y" style="margin-top: 0px !important;">
                                    <div class="ticket-wrap">
                                        <asp:ListView ID="lstRecentCalls" runat="server">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <ul class="collapsible collapsible-tckts" data-collapsible="expandable" style="padding:0px!important" >
                                                    
                                                    <li>

                                                        <table class="collapsible-header collapsible-ticket-head tckts" style="<%# ( Convert.ToString(Eval("elev")) == hdnUnitID.Value  && hdnUnitID.Value!=""  && hdnUnitID.Value!="0") ?  "background-color:#ceebf8": "background-color:white" %>; padding:0px 3px !important;">
                                                           <tbody>
                                                               <tr>

                                                                <td class="worker-name" style="width: 11%;"><b>
                                                                <asp:HyperLink runat="server" ID="lblId"
                                                                    NavigateUrl='<%# String.Format("addticket.aspx?id={0}&comp={1}", Eval("id"), Eval("comp")) %>'
                                                                    Text='<%# Eval("ID") %>' Target="_blank" >
                                                                </asp:HyperLink></b></td>
                                                            ...
                                                            <td class="ticket-datetime" style="float: right;width: 106%; ">
                                                                <span class="ticket-date">
                    ...
                    <ul class="collapsible popout collapsible-accordion form-accordion-head" data-collapsible="expandable">
                                        ...
                                        <div class="form-content-pd">
                                            ...
                                            <div class="form-section-row">
                                                <div class="form-section3">
                                                    ...
                                                    <div class="input-field col s5">
                                                        <div class="row">
                                                            ...
                                                            <label for="txtWO"><a href="#" onclick="OpenWOreport();" class="a-css">WO #</a></label>
                                                    ...
                                                    <div class="srchclr btnlinksicon rowbtn">
                                                        <asp:LinkButton ID="lblRelatedTickets" runat="server" ToolTip="Related Tickets"
                                                            CausesValidation="False" OnClientClick="lblRelatedTickets_Client();" OnClick="lblRelatedTickets_Click">  <i class="mdi-maps-local-attraction mb" ></i></asp:LinkButton>
                                                    </div>
                                                </div>
                                                <div class="form-section3-blank">
                                                    &nbsp;
                                                ...
                                                <div class="form-section3">
                                                    <div class="input-field col s9">
                                                        ...
                                                        <div class="srchclr btnlinksicon rowbtn">
                                                            ...
                                                            <asp:HyperLink ID="lnkProjectID" Visible="true" Target="_blank" runat="server"><i class="mdi-action-work ml" ></i> </asp:HyperLink>
                                                ...
                                                <div class="form-section3">
                                                    ...
                                                    <div class="input-field col s4">
                                                        ...
                                                        <div class="row">
                                                            <asp:TextBox ID="txtManualInvoice" runat="server" MaxLength="12"
                                                                TabIndex="4"></asp:TextBox>
                                                            <label for="txtManualInvoice" style="top: 61px!important">Manual Invoice</label>
                                                        </div>
                                                        <div class="row">
                                                            <asp:TextBox ID="txtopp" runat="server" MaxLength="12"
                                                                TabIndex="4" Enabled="False"></asp:TextBox>
                                                            <label for="txtopp" style="top: 115px!important">Opportunity #</label>

                                                        </div>
                                                    </div>


                                                    <div class="input-field col s2" style="width: 5%">
                                                        <div class="row">
                                                            &nbsp;
                                                    ...
                                                    <div class="input-field col s4" style="width: 25%">
                                                        <div class="row">
                                                            <asp:TextBox ID="txtnkbt" runat="server" MaxLength="12"
                                                                TabIndex="4" Enabled="False"></asp:TextBox>
                                                            <label for="txtnkbt">Billing Rate</label>
                                                        </div>
                                                        <div class="row">
                                                            <asp:TextBox ID="txtnknt" runat="server" MaxLength="12"
                                                                TabIndex="4" Enabled="False"></asp:TextBox>
                                                            <label for="txtnknt" style="top: 61px!important">1.7 Rate</label>
                                                        </div>
                                                        <div class="row">
                                                            <asp:TextBox ID="txtnktr" runat="server" MaxLength="12"
                                                                TabIndex="4" Enabled="False"></asp:TextBox>
                                                            <label for="txtnktr" style="top: 115px!important">Travel Rate</label>
                                                    ...
                                                    <div class="input-field col s4" style="width: 25%">
                                                        <div class="row">
                                                            <asp:TextBox ID="txtnkot" runat="server" MaxLength="12"
                                                                TabIndex="4" Enabled="False"></asp:TextBox>
                                                            <label for="txtnkot">OT Rate</label>
                                                        </div>
                                                        <div class="row">
                                                            <asp:TextBox ID="txtnkdt" runat="server" MaxLength="12"
                                                                TabIndex="4" Enabled="False"></asp:TextBox>
                                                            <label for="txtnkdt" style="top: 61px!important">DT Rate</label>
                                                        </div>
                                                        <div class="row">
                                                            <asp:TextBox ID="txtnkMileage" runat="server" MaxLength="12"
                                                                TabIndex="4" Enabled="False"></asp:TextBox>
                                                            <label for="txtnkMileage" style="top: 115px!important">Mileage</label>
                                                    ...
                                                    <div class="input-field col s2">
                                                        <div class="row">
                                                            <img src='images/money.png' style='cursor: pointer; height: 25px; margin: 1px 2px 0px 5px' id="imgDollar" runat="server" visible="false" />
                                                            <telerik:RadToolTip RenderMode="Auto" ID="LocBalance" runat="server" TargetControlID="imgDollar" Width="200px"
                                                                RelativeTo="Element" Position="MiddleLeft">
                                                            </telerik:RadToolTip>
                                                        </div>
                                                    ...
                                                    <div class="input-field col s2">
                                                        <div class="row">
                                                            ...
                                                            <a id="lnkInvoice" runat="server" target="_blank" title="Invoice" visible="False"
                                                                ...
                                                                <asp:Image ID="imgInv" runat="server" Style="height: 25px; margin: 1px 2px 0px 5px" ToolTip="Invoice" />
                                                            </a>
                                                ...
                                                <div class="form-section3">
                                                    ...
                                                    <div class="input-field col s12">
                                                        <div class="row">
                                                            ...
                                                            <asp:Label ID="lblAlertProspect" runat="server"
                                                                CssClass="roundCorner transparent shadow cus-css" Text="You have not selected the existing customer/lead. This will add new lead."></asp:Label>
                                                    ...
                                                    <div class="srchclr btnlinksicon rowbtn2021">
                                                        <asp:LinkButton ID="lnkConvert" runat="server" Visible="False" OnClick="lnkConvert_Click" CausesValidation="False" ToolTip="Convert Lead"><i class="mdi-communication-ring-volume ml" ></i></asp:LinkButton>
                                                    ...
                                                    <div class="input-field col s12">
                                                        <div class="row">
                                                            ...
                                                            <asp:TextBox ID="txtAcctno" TabIndex="7" runat="server" class="loc-css" ReadOnly="True" MaxLength="15"></asp:TextBox>
                                                    ...
                                                    <div class="input-field col s12 mt-10">
                                                        <div class="row">
                                                            <label class="drpdwn-label w-100p" style="top: 0px !important;">Equipment</label>
                                                            <div class="tag-div materialize-textarea textarea-border" id="eqtag">
                                                            </div>


                                                            <div id="DivEqup" class="popup_div pop-css ">
                                                                ...
                                                                <div class="btnlinks" class="clos-css" style="margin-bottom: 5px; float: right;">
                                                ...
                                                <div class="form-section3">
                                                    ...
                                                    <div class="nlne text-field col s12" id="divlocContractinfo" runat="server">
                                                        <div class="row txtrow">
                                                            ...
                                                            <label id="locContractinfo" runat="server" style="font-size: 0.9rem !important;"></label>
                                            ...
                                            <div class="form-section-row">
                                                ...
                                                <div class="form-section3">
                                                    ...
                                                    <div class="input-field col s12 m-t-20">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <asp:LinkButton OnClick="btnCodes_Click" CausesValidation="False" Style="float: right; padding: 0 0px 0 0px;" runat="server" ID="btnCodes">
                                                                <i class="mdi-content-add-box sup-css-font" ></i>
                                                            </asp:LinkButton>
                                                            ...
                                                            <asp:TextBox ID="txtReason" runat="server" Height="120"
                                                                TextMode="MultiLine" Style="padding: 0.4rem 0 !important" Class="materialize-textarea textarea-border"></asp:TextBox>
                        ...
                        <li>
                            ...
                            <div id="accrdcompleted" class="collapsible-header accrd accordian-text-custom">
                                ...
                                <asp:Label ID="lblaccrdcompleted" runat="server" ForeColor="Red" Visible="false">(You do not have completed ticket permissions!)</asp:Label>
                            </div>
                                ...
                                <div class="form-content-wrap">
                                    <telerik:RadAjaxPanel ID="RadAjaxPanelCompleted" runat="server">
                                        <div class="form-content-pd" id="DIVaccrdcompleted" runat="server">
                                            <div class="form-section-row">
                                                <div class="input-field s12 pd-css">


                                                    <div class="form-section3">
                                                        <div class="input-field col s4" style="width: 35%">
                                                            <div class="checkrow">
                                                    ...
                                                    <div class="form-section3">
                                                        ...
                                                        <div class="input-field col s3">
                                                            <div class="checkrow">
                                                                <asp:CheckBox ID="chkPayroll" OnCheckedChanged="chkPayroll_CheckedChanged" AutoPostBack="true" runat="server" class="css-checkbox" TabIndex="13" Text="Payroll" />
                                                            </div>
                                                        </div>
                                                        <div class="input-field col s3">
                                                            <div class="checkrow">
                                                ...
                                                <div class="form-section3">
                                                    ...
                                                    <div class="input-field col s12">
                                                        <div class="row">
                                                            <div id="signbg" class="sig-css">
                                                                <asp:Image ID="imgSign" class="img-css" runat="server" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <telerik:RadAjaxPanel ID="RadAjaxPanelTimestamps" runat="server">
                                                        ...
                                                        <div class="input-field col s4">
                                                            <div class="row">
                                                                ...
                                                                <asp:Label ID="lblenroute" runat="server" AssociatedControlID="txtEnrTime">
                                                                    <asp:LinkButton ID="btnEnroute" Visible="true" runat="server" CausesValidation="False" OnClick="btnEnroute_Click" class="etn-css"
                                                        ...
                                                        <div class="input-field col s4">
                                                            <div class="row">
                                                                ...
                                                                <label>
                                                                    <asp:LinkButton ID="btnComplete" Visible="true" runat="server" CausesValidation="False" OnClick="btnComplete_Click" class="etn-css"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <label for="txtJobCode">
                                                                <%--Issue...  document.getElementById('<%=btnGetCode.ClientID%>').click()--%>
                                                                    Project Type         <a id="aref" class="a-nav" onclick="" href="#">
                                                                        <i class="mdi-navigation-refresh nav-css"></i>
                                            ...
                                            <div class="form-section-row">
                                                <div class="form-section3">
                                                    ...
                                                    <div class="input-field col s12">
                                                        <div class="row">
                                                            <asp:TextBox ID="txtRecommendation" runat="server" class="materialize-textarea rece-css" Height="50px"
                                                ...
                                                <div class="form-section3">
                                                    ...
                                                    <div class="input-field col s5">
                                                        <div class="row">
                                                            ...
                                                            <label for="txtExpZone">Zone Pay</label>
                                                        </div>
                                                    </div>
                                                    <div class="input-field col s2">
                                                        <div class="row">
                                                ...
                                                <div class="form-section-row">
                                                    <div class="RadGrid RadGrid_Material FormGrid">
                                                        <telerik:RadGrid ID="RadGVPO"
                                                            ...
                                                            <MasterTableView AutoGenerateColumns="false" AllowFilteringByColumn="True" ShowFooter="True">
                                                                <Columns>
                                                                    <telerik:GridTemplateColumn DataField="PO" AutoPostBackOnFilter="false" AllowFiltering="false" SortExpression="PO"
                                                                        CurrentFilterFunction="Contains" UniqueName="PO" HeaderText="PO#" ShowFilterIcon="false" HeaderStyle-Width="100">
                                                                        <ItemTemplate>
                                                                            <a href="AddPO.aspx?id=<%# Eval("PO") %>" target="_blank"><%# Eval("PO") %> </a>
                                                                        </ItemTemplate>
                                                                    </telerik:GridTemplateColumn>
                                                                    ...
                                                                    <telerik:GridTemplateColumn DataField="Comment" AutoPostBackOnFilter="false" AllowFiltering="false" SortExpression="Comment"
                                                                        CurrentFilterFunction="Contains" UniqueName="Comment" HeaderText="Comment" ShowFilterIcon="false" HeaderStyle-Width="100">
                                                                        <ItemTemplate>
                                                                            <%# Eval("Comment") %>
                                                                        </ItemTemplate>
                                                                    </telerik:GridTemplateColumn>
                            ...
                            <asp:AsyncPostBackTrigger ControlID="btnAddNewLines" />
                                        ...
                                        <div class="row mgntp10">
                                            <asp:LinkButton ID="btnAddNewLines" runat="server" CausesValidation="false" OnClientClick="itemJSON();" Style="color: #000; font-size: 1.5em;" OnClick="btnAddNewLines_Click">
                                                    <i class="mdi-content-add-circle add-css" ></i>
                                            </asp:LinkButton>
                                        </div>
                                        <div class="cf"></div>
                                    </div>
    ...
    <div runat="server" id="pnlTranslate" style="display: none;">
        ...
        <div>
            ...
            <a id="lnkCloseTranslate" onclick="$('#<%=pnlTranslate.ClientID%>').hide();" class="pnt-css">X</a>
        </div>
        <asp:TextBox ID="txtTranslate" runat="server"
            TextMode="MultiLine"></asp:TextBox>
    </div>

    <div id="divTransIconReason" runat="server" class="divTrans-css" style="height: 55px; background-color: Gray; display: none">
        <div class="m-5" style="margin: 5px 5px 5px 5px">
            ...
            <asp:TabPanel ID="TabPanel1" runat="server" HeaderText="Ticket Info">
                ...
                <ContentTemplate>
                    ...
                    <div class="fc-input">
                        ...
                        <div id="divTransicon" class="divTrans-css2" runat="server" style="width: 30px; height: 55px; background-color: Gray; display: none">
                            <div class="m-5" style="margin: 5px 5px 5px 5px">
    ...
    <telerik:RadAjaxPanel runat="server" ID="RadAjaxPanelHiddenField">
        <asp:HiddenField runat="server" ID="hdnProjectwageID" />
        ...
        <asp:HiddenField runat="server" ID="PermissionHiddenFieldTT" Value="1" />
            ...
            function SelectRowsEq() {
                ...
                if (masterTable != null) {
                    for (var i = 0; i < masterTable.get_dataItems().length; i++) {
                        ...
                        var gridItemElementStatus = masterTable.get_dataItems()[i].findElement("lblStatus");
                        if (gridItemElementStatus.textContent == 'Active') {
                            ...
                            //noty({ text: 'Location is inactive!.', type: 'warning', layout: 'topCenter', closeOnSelfClick: false, timeout: false, theme: 'noty_theme_default', closable: true });
                        }
                    }
                }
            }
