...
public partial class MonthlyRecurringHoursReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                StiWebViewerMonthlyRecurring.Visible = true;
            }
            ...
            else
            {
                ...
                txtfromDate.Text = startDay.ToShortDateString();
            }
            ...
            {
                txtToDate.Text = endDay.ToShortDateString();
            }
            ...
            GetSMTPUser();
            SetAddress();
            string FileName = "MonthlyRecurringHoursReport.pdf";
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        var url = "MonthlyRecurringHoursReport.aspx?sd=" + txtfromDate.Text + "&ed=" + txtToDate.Text + "&routes=" + HttpUtility.UrlEncode(routes) + "&redirect=" + Request.QueryString["redirect"];

        Response.Redirect(url);
    }

    protected void StiWebViewerMonthlyRecurring_GetReport(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
    {
        e.Report = LoadMonthlyRecurringHoursReport();
    }

    protected void StiWebViewerMonthlyRecurring_GetReportData(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
    {

    }

    private StiReport LoadMonthlyRecurringHoursReport()
    {
        string reportPathStimul = string.Empty;

        if (ConfigurationManager.AppSettings["CustomerName"].ToString().Equals("Transel"))
        {
            reportPathStimul = Server.MapPath("StimulsoftReports/MonthlyRecurringHoursReport-TEI.mrt");
        }
        else
        {
            reportPathStimul = Server.MapPath("StimulsoftReports/MonthlyRecurringHoursReport.mrt");
        }
        ...
        {
            var now = DateTime.Now;
            objChart.StartDate = new DateTime(now.Year, now.Month, 1);
        }
        ...
        {
            objChart.EndDate = objChart.StartDate.AddMonths(1).AddDays(-1);
        }
        ...
        if (ConfigurationManager.AppSettings["CustomerName"].ToString().Equals("Transel"))
        {
            ds = bL_Report.GetMonthlyRecurringHoursTEI(objChart, routes);
        }
        else
        {
            ds = bL_Report.GetMonthlyRecurringHours(objChart, routes);
        }
        ...
        //Set parameter
        report["StartDate"] = objChart.StartDate;
        report["EndDate"] = objChart.EndDate;
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "Monthly Recurring Hours By Location Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Monthly Recurring Hours By Location Report attached.";
                }
                ...
                service.ExportTo(LoadMonthlyRecurringHoursReport(), stream, settings);
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "MonthlyRecurringHoursReport.pdf")
                        {
                ...
                mail.FileName = "MonthlyRecurringHoursReport.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "MonthlyRecurringHoursReport.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=MonthlyRecurringHoursReport.pdf");
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached Monthly Recurring Hours By Location Report.";
