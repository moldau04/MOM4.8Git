<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="BillsReport" CodeBehind="BillsReport.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Bills Report</div>
            ...
            <div class="row">
                <div class="srchpane">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <Triggers>
                            <asp:AsyncPostbackTrigger ControlId="ddlInvoice" EventName="SelectedIndexChanged" />
                        </Triggers>
                        <ContentTemplate>
                            <div class="srchtitle srchtitlecustomwidth ser-css2">
                                Search for invoices
                            ...
                            <div class="srchinputwrap">
                                <asp:DropDownList ID="ddlInvoice" runat="server" CssClass="browser-default" TabIndex="1" Width="130"
                                    OnSelectedIndexChanged="ddlInvoice_SelectedIndexChanged" AutoPostBack="true" class="brow-css" style="margin-top: 2px;">
                            ...
                            <div class="srchinputwrap">
                                <asp:TextBox ID="txtSearchDate" runat="server" CssClass="srchcstm datepicker_mom" autocomplete="off"
                ...
                <div class="grid_container">
                    <div class="form-section-row pmd-card">
                        <cc1:StiWebViewer ID="StiWebViewerBills" Height="800px" RequestTimeout="20000" runat="server" CacheMode="None" ViewMode="Continuous" ScrollbarsMode="true"
                            OnGetReport="StiWebViewerBills_GetReport" OnGetReportData="StiWebViewerBills_GetReportData" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="dvEmailOpen" style="display: none;">
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Bills Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
        ...
        <div class="container mailtitcketcontainer" runat="server" id="pnlCompose">
            <div class="row">
                <div class="srchpane-advanced pmd-card">
