<%@ Page Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="PreviewInvoice" CodeBehind="PreviewInvoice.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-communication-contacts"></i>&nbsp;<asp:Label CssClass="title_text" ID="lblHeader" runat="server">Preview Invoice</asp:Label></div>
                                                            ...
                                                            <MasterTableView AutoGenerateColumns="false" AllowFilteringByColumn="True">
                                                                <Columns>
                                                                    ...
                                                                    <%--<telerik:GridTemplateColumn HeaderStyle-Width="5"
                                                                        DataField="Type" SortExpression="Type" AutoPostBackOnFilter="false"
                            ...
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        ...
                                        <div class="btnclosewrap">
                                            <%--<asp:LinkButton runat="server" OnClick="lnkClose_Click" OnClientClick="return confirm('Do you want to discard the mail?');" ID="LinkButton1" ToolTip="Close">
