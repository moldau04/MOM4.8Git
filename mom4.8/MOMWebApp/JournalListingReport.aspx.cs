...
public partial class JournalListingReport : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        lbl_todt.Text = string.Empty;
            ...
            lbl_RangeType.Text = "Date :";
            lbl_frmdt.Text = Session["StartDate"].ToString();
            lbl_todt.Text = Session["EndDate"].ToString();
        ...
        try
        {
            ...
            if (pubReportId != 0)
            {
                ...
                if (dsGetRptDetails.Tables.Count > 0)
                {
                    ...
                    if (sortBy == "Internal Ref" || sortBy == "Desc" )
                    {
                        sortBy = "[" + sortBy + "]";
                    }
    ...
    private void GetCustReportFiltersValue()
    {
        ...
        objProp_User.ConnConfig = Session["config"].ToString();
        dsGetEstimateReportFiltersValue = objBL_ReportsData.GetJournalReportFiltersValue(objProp_User);
              

        //if (dsGetEstimateReportFiltersValue.Tables[0].Rows.Count > 0)
        //{
        //    drpDueDate.DataSource = dsGetEstimateReportFiltersValue.Tables[0];
        ...
        if (dsGetEstimateReportFiltersValue.Tables[3].Rows.Count > 0)
        {
            drpDesc.DataSource = dsGetEstimateReportFiltersValue.Tables[3];
        ...
        if (dsGetEstimateReportFiltersValue.Tables[0].Rows.Count > 0)
        {
            drpDate.DataSource = dsGetEstimateReportFiltersValue.Tables[0];
        ...
        {
            drpRef.DataSource = dsGetEstimateReportFiltersValue.Tables[1];
        ...
        {
            drpInternalRef.DataSource = dsGetEstimateReportFiltersValue.Tables[2];
            drpInternalRef.DataTextField = "Internal Ref";
            drpInternalRef.DataValueField = "Internal Ref";
            drpInternalRef.DataBind();
        }   
    }
                ...
                else
                {
                   ...
                   endDate = Session["EndDate"].ToString();
                    ...
                    if (startDate != string.Empty || endDate != string.Empty)
                    {
                        ...
                        DateTime dt1 = Convert.ToDateTime(Session["StartDate"]);
                        DateTime dt2 = Convert.ToDateTime(Session["EndDate"]);
    ...
    private void GetCustomerDetails()
    {
        try
        {
            ...
            dsGetCustDetails = objBL_ReportsData.GetJournalDetails(objProp_User);
            ...
            if (dsGetCustDetails.Tables.Count > 0)
            {
                ...
                dsGetCustDetails.Tables[0].TableName = "Journal";
    ...
    protected void btnClose_Click(object sender, EventArgs e)
    {
        try
        {
            Response.Redirect("JournalEntry.aspx", false);
        }
        catch
        {
            //
    ...
    private void BindGridReport(string[] checkedColumns, string[] selectedFiltersColumns, string[] selectedFiltersValues, string sortBy)
    {
        ...
        {
            query += " FROM vw_JournalEntryReportDetails v order by v." + sortBy + "";
        }
        else
        {
            ...
            if (selectedFiltersColumns != null)
            {
                ...
                {
                    if (selectedFiltersColumns[i] == "InternalRef")
                    {
                        selectedFiltersColumns[i] = "Internal Ref";
                    }
            ...
            query += " FROM vw_JournalEntryReportDetails v where " + filters + " order by v." + sortBy + "";
        }
    ...
    public static string GeJournalReportPreviewDetails(int reportId, string FilterColumn, string FilterValues, string ColumnWidth, string SortColumn, string DataSortBy)
    {
        try
        {
            JournalListingReport _a = new JournalListingReport();
            BL_ReportsData objBL_ReportsData = new BL_ReportsData();
            BusinessEntity.User objProp_User = new BusinessEntity.User();
            CustomerReport objCustReport = new CustomerReport();
            DataSet dsCompDetail = new DataSet();
            ...
            if (DataSortBy == "Internal Ref" || DataSortBy == "Desc")
            {
            ...
            if (selectedFiltersColumns == null)
            {
                query += " FROM vw_JournalEntryReportDetails v order by v." + DataSortBy + "";
            }
            else
            {
                string filters = string.Empty;
                ...
                filters = filters.Substring(0, filters.Length - 4);
                query += " FROM vw_JournalEntryReportDetails v where " + filters + " order by v." + DataSortBy + "";
            }
            #endregion
