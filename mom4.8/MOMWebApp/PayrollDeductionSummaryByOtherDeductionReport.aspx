<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Mom.master" Inherits="PayrollDeductionSummaryByOtherDeductionReport" CodeBehind="PayrollDeductionSummaryByOtherDeductionReport.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="mainWindow">
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Payroll-Deduction Summary By Other Deduction Report</div>
        ...
        <div class="container">
            <div class="srchpane">
                        <div class="srchtitle srchtitlecustomwidth p-l-34" >
                            Start Date
                        </div>
            ...
            <div class="grid_container">
                <div class="form-section-row m-b-0" style="margin-bottom: 0 !important;">
                    <cc1:StiWebViewer ID="StiWebViewerPayrollDeductionSummaryByOtherDeductionReport" Height="800px" RequestTimeout="20000" CacheMode="None" runat="server" ViewMode="Continuous" ScrollbarsMode="true"
                        OnGetReport="StiWebViewerPayrollDeductionSummaryByOtherDeductionReport_GetReport" OnGetReportData="StiWebViewerPayrollDeductionSummaryByOtherDeductionReport_GetReportData" />
                </div>
            </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Payroll-Deduction Summary By Other Deduction Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
