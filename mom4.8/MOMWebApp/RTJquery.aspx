<%@ Page Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" CodeBehind="RTJquery.aspx.cs" Inherits="MOMWebApp.RTJquery" %> 
            ...
            <div class="srchpane-advanced">
                <div class="srchpaneinner">
                    ...
                    <div class="srchinputwrap">
                        <asp:TextBox ID="txtStartDt" runat="server"  Style="width: 80px !important;" TabIndex="5" CssClass="srchcstm datepicker_mom txtStartDt" ValidationGroup="dateTime" onblur="validateDatetime();" placeholder="From"></asp:TextBox>
                    ...
                    <div class="srchinputwrap">
                        <asp:TextBox ID="txtEndDate" runat="server" Style="width: 80px !important;" CssClass="srchcstm datepicker_mom txtEndDate" onblur="validateDatetime();" placeholder="To"></asp:TextBox>
                    ...
                    <div class="srchinputwrap">
                        <asp:DropDownList ID="ddlRoute" runat="server" CssClass="browser-default selectst selectsml ddlRoute" Style="width: 250px !important;" TabIndex="5">
                        </asp:DropDownList>
                    </div>
                    <div class="srchtitle srchtitlecustomwidth" style="padding-left: 15px;">
                        Special Notes
                    ...
                    <div class="form-section-row">
                        ...
                        <div class="input-field col s12" style="margin-top: 30px;">
                            <div class="row">
                                ...
                                <asp:TextBox ID="notes" runat="server" CssClass="textarea-border materialize-textarea notes" TextMode="MultiLine"></asp:TextBox>
                        ...
                        <div class="RadGrid RadGrid_Material FormGrid">
                                ...
                                <telerik:RadGrid RenderMode="Auto" ID="gvOpenCalls" runat="server" AutoGenerateColumns="False" Width="100%" FilterType="CheckList"
                                    ...
                                    <MasterTableView AutoGenerateColumns="false" AllowFilteringByColumn="True" ShowFooter="True" DataKeyNames="job">
                                        <Columns>
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Assigned Tickets" AutoPostBackOnFilter="true" DataType="System.String" SortExpression="TicketID" DataField="TicketID" UniqueName="TicketID" HeaderStyle-Width="125px" ShowFilterIcon="false" CurrentFilterFunction="Contains">
                                                <ItemTemplate>
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Customer" UniqueName="customername" DataField="customername" SortExpression="customername"
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Acct #" UniqueName="locid" DataField="locid" SortExpression="locid" ShowFilterIcon="false" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                                <ItemTemplate>
                                              ...
                                              <telerik:GridTemplateColumn HeaderStyle-Width="80"     HeaderText="Credit Hold" AllowFiltering="false" SortExpression="credit" Visible="true" ShowFilterIcon="false">
                                          ...
                                          <img id="imgCreditH" runat="server" visible='<%# (Eval("credit").ToString() == "1")?true:false %>' title="Credit Hold" src="images/MSCreditHold.png" style="float: left; width: 16px; background-color: rgba(255, 0, 0, 0.34)">
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="LocationName" UniqueName="locname" DataField="locname" SortExpression="locname" ShowFilterIcon="false" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                                <ItemTemplate>
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Address" SortExpression="locname" DataField="Address" UniqueName="Address" ShowFilterIcon="false" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                                <ItemTemplate>
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Equipment" SortExpression="unit" AllowFiltering="false" AllowSorting="false" DataField="unit" UniqueName="unit" ShowFilterIcon="false" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblEquipment" runat="server" Text='<%# Bind("unit") %>'></asp:Label>
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>
                                            <%--Showing in case of "Per Equipment" unchecked--%>
                                            <telerik:GridTemplateColumn HeaderText="Equipment" SortExpression="TempEquipmentstr" AllowFiltering="false" AllowSorting="false" DataField="TempEquipmentstr" UniqueName="TempEquipmentstr" ShowFilterIcon="false" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                                <ItemTemplate>
                           ...
                           <script>
                               $(document).ready(function () { 
                                   ...
                                   var RecurringTicketpram []; 

                                   var RTDataSource = new kendo.data.DataSource(
                                       {
                                           transport: {
                                               read: {
                                                   url: "http://192.168.29.12/MOMWebAPI/api/RecurringTicketsAPI",
                                                   dataType: "json",
                                                   data: { RecurringTicketpram: RecurringTicketpram }
                                   ...
                                   $("#grid").kendoGrid({
                                       ...
                                       {
                                           field: "TempEquipmentstr",
                                           title: "TempEquipmentstr",
                                           width: 150,
