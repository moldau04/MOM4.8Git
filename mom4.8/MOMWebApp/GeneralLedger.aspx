<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Mom.master" Inherits="GeneralLedger" CodeBehind="GeneralLedger.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; General Ledger Report</div>
        ...
        <div class="container">
            <div class="row">
                <div class="srchpane">
                    ...
                    <div class="srchinputwrap">
                        <asp:DropDownList ID="ddlAccount" runat="server" Height="25" CssClass="browser-default" TabIndex="2" Width="250">
                        </asp:DropDownList>
                    </div>
                ...
                <div class="grid_container">
                    <div class="form-section-row m-b-0">
                        <cc1:StiWebViewer ID="StiWebViewerGeneralLedger" Height="800px" RequestTimeout="20000" runat="server" CacheMode="None" ViewMode="Continuous" ScrollbarsMode="true"
                            OnGetReport="StiWebViewerGeneralLedger_GetReport" OnGetReportData="StiWebViewerGeneralLedger_GetReportData" />
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; General Ledger Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
