...
public partial class LocationTransactionLedger : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                GetSMTPUser();
                SetAddress();
                string FileName = "LocationTransactionLedger.pdf";
    ...
    {
        Response.Redirect("addlocation.aspx?uid=" + Request.QueryString["loc"]);
    }
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        var url = "LocationTransactionLedger.aspx?loc=" + Request.QueryString["loc"] + "&sd=" + txtfromDate.Text + "&ed=" + txtToDate.Text;
    ...
    {
        e.Report = LoadLocationTransactionLedger();
    }
    ...
    private StiReport LoadLocationTransactionLedger()
    {
        string reportPathStimul = Server.MapPath("StimulsoftReports/LocationTransactionLedger.mrt");
        ...
        {
            locID = Convert.ToInt32(Request.QueryString["loc"]);
        }

        // Get Location detail
        objPropUser.LocID = locID;
        var dsLoc = objBL_User.getLocationByIDReport(objPropUser);

        report.RegData("LocDetails", dsLoc.Tables[0]);
        ...
        DataSet ds = objBL_Invoice.GetARRevenue(objProp_Contracts);
        if (ds != null)
        {
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "Location Transaction Ledger Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Location Transaction Ledger Report attached.";
                }
                ...
                service.ExportTo(LoadLocationTransactionLedger(), stream, settings);
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "LocationTransactionLedger.pdf")
                        {
                ...
                mail.FileName = "LocationTransactionLedger.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "LocationTransactionLedger.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=LocationTransactionLedger.pdf");
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached Location Transaction Ledger Report.";
