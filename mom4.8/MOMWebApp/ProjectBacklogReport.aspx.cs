...
public partial class ProjectBacklogReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            GetSMTPUser();
            SetAddress();
            string FileName = "ProjectBacklogReport.pdf";
    ...
    protected void lnkExcel_Click(object sender, EventArgs e)
    {
        ...
        report = LoadProjectSummaryReport();
        ...
        Response.AddHeader("Content-Disposition", $"attachment;filename=ProjectBacklogReport.xls");
    ...
    {
        e.Report = LoadProjectSummaryReport();
    }
    ...
    private StiReport LoadProjectSummaryReport()
    {
        string reportPathStimul = Server.MapPath("StimulsoftReports/Project/ProjectBacklogReport.mrt");
        ...
        if (ds != null)
        {
            var dView = ds.Tables[0].DefaultView;
            dView.RowFilter = "Status = 'Open'";
            DataTable dtFinal = dView.ToTable();

            report.RegData("dtJob", dtFinal);
        }
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "Project Backlog Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Project Backlog Report attached.";
                }
                ...
                System.IO.MemoryStream stream = new System.IO.MemoryStream();
                service.ExportTo(LoadProjectSummaryReport(), stream, settings);
                buffer1 = stream.ToArray();
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "ProjectBacklogReport.pdf")
                        {
                ...
                mail.FileName = "ProjectBacklogReport.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "ProjectBacklogReport.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=ProjectBacklogReport.pdf");
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached Project Backlog Report.";
