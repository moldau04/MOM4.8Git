...
public partial class CustomersReport : System.Web.UI.Page
{
    ...
    GetCustReportFiltersValueParam _GetCustReportFiltersValue = new GetCustReportFiltersValueParam();
    getCustomerDetailsTestParam _getCustomerDetailsTest = new getCustomerDetailsTestParam();
    ...
    private void GetReportDetailByRptId()
    {
        try
        {
            ...
            if (pubReportId != 0)
            {
                ...
                {
                    string APINAME = "ItemAdjustmentAPI/CustomersReport_GetReportDetailById";
    ...
    private void GetCustomerType()
    {
        try
        {
            ...
            if (IsAPIIntegrationEnable == "YES")
            {
                string APINAME = "ItemAdjustmentAPI/CustomersReport_GetCustomerType";
    ...
    private void GetCustReportFiltersValue()
    {
        ...
        _GetCustReportFiltersValue.DBName = Session["dbname"].ToString();
        _GetCustReportFiltersValue.ConnConfig = Session["config"].ToString();

        ListGetCustReportFiltersValue _lstCustomerfilter = new ListGetCustReportFiltersValue();
        ...
        if (IsAPIIntegrationEnable == "YES")
        {
            string APINAME = "ItemAdjustmentAPI/CustomersReport_GetCustReportFiltersValue";

            APIResponse _APIResponse = new MOMWebUtility().CallMOMWebAPI(APINAME, _GetCustReportFiltersValue, true);

            JavaScriptSerializer serializer = new JavaScriptSerializer();

            serializer.MaxJsonLength = Int32.MaxValue;

            _lstCustomerfilter = serializer.Deserialize<ListGetCustReportFiltersValue>(_APIResponse.ResponseData);

            dsGetCustReportFiltersValue1 = _lstCustomerfilter.lstTable.ToDataSet();
            dsGetCustReportFiltersValue2 = _lstCustomerfilter.lstTable1.ToDataSet();
            dsGetCustReportFiltersValue3 = _lstCustomerfilter.lstTable2.ToDataSet();
            dsGetCustReportFiltersValue4 = _lstCustomerfilter.lstTable3.ToDataSet();
            dsGetCustReportFiltersValue5 = _lstCustomerfilter.lstTable4.ToDataSet();
            dsGetCustReportFiltersValue6 = _lstCustomerfilter.lstTable5.ToDataSet();
        ...
        if (IsAPIIntegrationEnable == "YES")
        {
            if (dsGetCustReportFiltersValue1.Tables[0].Rows.Count > 0)
            {
                drpName.DataSource = dsGetCustReportFiltersValue1.Tables[0];
                drpName.DataTextField = "Name";
                drpName.DataValueField = "Name";
                drpName.DataBind();
            }

            if (dsGetCustReportFiltersValue2.Tables[0].Rows.Count > 0)
            {
                drpAddress.DataSource = dsGetCustReportFiltersValue2.Tables[0];
                drpAddress.DataTextField = "Address";
                drpAddress.DataValueField = "Address";
                drpAddress.DataBind();
            }

            if (dsGetCustReportFiltersValue3.Tables[0].Rows.Count > 0)
            {
                drpCity.DataSource = dsGetCustReportFiltersValue3.Tables[0];
                drpCity.DataTextField = "City";
                drpCity.DataValueField = "City";
                drpCity.DataBind();
            }

            if (dsGetCustReportFiltersValue4.Tables[0].Rows.Count > 0)
            {
                ddlState.DataSource = dsGetCustReportFiltersValue4.Tables[0];
                ddlState.DataTextField = "State";
                ddlState.DataValueField = "State";
                ddlState.DataBind();
            }

            if (dsGetCustReportFiltersValue5.Tables[0].Rows.Count > 0)
            {
                drpType.DataSource = dsGetCustReportFiltersValue5.Tables[0];
                drpType.DataTextField = "Type";
                drpType.DataValueField = "Type";
                drpType.DataBind();
            }

            if (dsGetCustReportFiltersValue6.Tables[0].Rows.Count > 0)
            {
                drpStatus.DataSource = dsGetCustReportFiltersValue6.Tables[0];
        ...
        else
        {
            ...
            {
                drpCountry.DataSource = dsGetCustReportFiltersValue.Tables[4];
            ...
            {
                drpZip.DataSource = dsGetCustReportFiltersValue.Tables[5];
            ...
            {
                drpFax.DataSource = dsGetCustReportFiltersValue.Tables[6];
                drpFax.DataTextField = "Fax";
                drpFax.DataValueField = "Fax";
                drpFax.DataBind();
            }

            if (dsGetCustReportFiltersValue.Tables[7].Rows.Count > 0)
            {
                drpContact.DataSource = dsGetCustReportFiltersValue.Tables[7];
                drpContact.DataTextField = "Contact";
                drpContact.DataValueField = "Contact";
                drpContact.DataBind();
            }
            ...
            {
                drpEmail.DataSource = dsGetCustReportFiltersValue.Tables[8];
                drpEmail.DataTextField = "Email";
                drpEmail.DataValueField = "Email";
                drpEmail.DataBind();
            }*/
            ...
            if (dsGetCustReportFiltersValue.Tables[4].Rows.Count > 0)
            {
                drpType.DataSource = dsGetCustReportFiltersValue.Tables[4];
                drpType.DataTextField = "Type";
                drpType.DataValueField = "Type";
                drpType.DataBind();
            }
            ...
            if (dsGetCustReportFiltersValue.Tables[5].Rows.Count > 0)
            {
                drpStatus.DataSource = dsGetCustReportFiltersValue.Tables[5];
                drpStatus.DataTextField = "Status";
                drpStatus.DataValueField = "Status";
                drpStatus.DataBind();
            }
            ...
            {
                drpPhone.DataSource = dsGetCustReportFiltersValue.Tables[12];
                drpPhone.DataTextField = "Status";
                drpPhone.DataValueField = "Status";
                drpPhone.DataBind();
            }

            if (dsGetCustReportFiltersValue.Tables[13].Rows.Count > 0)
            {
                drploc.DataSource = dsGetCustReportFiltersValue.Tables[13];
                drploc.DataTextField = "loc";
                drploc.DataValueField = "loc";
                drploc.DataBind();
            }

            if (dsGetCustReportFiltersValue.Tables[14].Rows.Count > 0)
            {
                drpequip.DataSource = dsGetCustReportFiltersValue.Tables[14];
                drpequip.DataTextField = "equip";
                drpequip.DataValueField = "equip";
                drpequip.DataBind();
            }

            if (dsGetCustReportFiltersValue.Tables[15].Rows.Count > 0)
            {
                drpOpenCall.DataSource = dsGetCustReportFiltersValue.Tables[15];
                drpOpenCall.DataTextField = "OpenCall";
                drpOpenCall.DataValueField = "OpenCall";
                drpOpenCall.DataBind();
            }

            if (dsGetCustReportFiltersValue.Tables[16].Rows.Count > 0)
            {
                drpWebsite.DataSource = dsGetCustReportFiltersValue.Tables[16];
                drpWebsite.DataTextField = "Website";
                drpWebsite.DataValueField = "Website";
                drpWebsite.DataBind();
            }

            if (dsGetCustReportFiltersValue.Tables[17].Rows.Count > 0)
            {
                drpCellular.DataSource = dsGetCustReportFiltersValue.Tables[16];
                drpCellular.DataTextField = "Cellular";
                drpCellular.DataValueField = "Cellular";
                drpCellular.DataBind();
            }*/
            //if (dsGetCustReportFiltersValue.Tables[3].Rows.Count > 0)
            //{
    ...
    private void GetCustomerName()
    {
        try
        {
            ...
            if (IsAPIIntegrationEnable == "YES")
            {
                string APINAME = "ItemAdjustmentAPI/CustomersReport_GetCustomerName";
    ...
    private void GetCustomerAddress()
    {
        try
        {
            ...
            if (IsAPIIntegrationEnable == "YES")
            {
                string APINAME = "ItemAdjustmentAPI/CustomersReport_GetCustomerAddress";
    ...
    private void GetCustomerCity()
    {
        try
        {
            ...
            if (IsAPIIntegrationEnable == "YES")
            {
                string APINAME = "ItemAdjustmentAPI/CustomersReport_GetCustomerCity";
    ...
    private void GetReportsName()
    {
        try
        {
            ...
            if (IsAPIIntegrationEnable == "YES")
            {
                string APINAME = "ItemAdjustmentAPI/CustomersReport_GetDynamicReports";
    ...
    private void GetReportColumnsByRepId()
    {
        try
        {
            ...
            if (pubReportId != 0)
            {
                ...
                if (IsAPIIntegrationEnable == "YES")
                {
                    string APINAME = "ItemAdjustmentAPI/CustomersReport_GetReportColByRepId";
                ...
                if (IsAPIIntegrationEnable == "YES")
                {
                    string APINAME = "ItemAdjustmentAPI/CustomersReport_GetReportFiltersByRepId";
    ...
    private void GetCustomerDetails()
    {
        try
        {
            ...
            _getCustomerDetailsTest.DBName = Session["dbname"].ToString();
            _getCustomerDetailsTest.ConnConfig = Session["config"].ToString();
            ...
            if (IsAPIIntegrationEnable == "YES")
            {
                string APINAME = "ItemAdjustmentAPI/CustomersReport_getCustomerDetailsTest";

                APIResponse _APIResponse = new MOMWebUtility().CallMOMWebAPI(APINAME, _getCustomerDetailsTest, true);
                ...
                _lstCustFilter = serializer.Deserialize<List<CustomerFilterViewModel>>(_APIResponse.ResponseData);
                dsGetCustDetails = CommonMethods.ToDataSet<CustomerFilterViewModel>(_lstCustFilter);
            }
            else
            {
            ...
            if (IsAPIIntegrationEnable == "YES")
            {
                string APINAME = "ItemAdjustmentAPI/CustomersReport_GetAccountSummaryListingDetail";
            ...
            if (dsGetCustDetails.Tables.Count > 0)
            {
                ...
                //dsGetCustDetails.Tables[2].TableName = "Equipment";



                //dsGetCustDetails.Tables[3].TableName = "Vendor";
                //dsGetCustDetails.Tables[4].TableName = "Bill";
    ...
    protected void btnSaveReport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            _insertCustomerReport.Module = "Customer";
            ...
            _updateCustomerReport.Module = "Customer";
            ...
            if (IsAPIIntegrationEnable == "YES")
            {
                string APINAME = "ItemAdjustmentAPI/CustomersReport_CheckExistingReport";
            ...
            if (hdnReportAction.Value == "Save")
            {
                ...
                if (IsAPIIntegrationEnable == "YES")
                {
                    string APINAME = "ItemAdjustmentAPI/CustomersReport_InsertCustomerReport";
            ...
            else
            {
                if (IsAPIIntegrationEnable == "YES")
                {
                    string APINAME = "ItemAdjustmentAPI/CustomersReport_IsStockReportExist";
                    ...
                    if (returnVal == true)
                    {
                        string APINAME1 = "ItemAdjustmentAPI/CustomersReport_UpdateCustomerReport";
    ...
    protected void btnDeleteReport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (IsAPIIntegrationEnable == "YES")
            {
                string APINAME = "ItemAdjustmentAPI/CustomersReport_DeleteCustomerReport";
    ...
    private void BindHeaderDetails()
    {
        try
        {
            ...
            if (IsAPIIntegrationEnable == "YES")
            {
                string APINAME = "ItemAdjustmentAPI/CustomersReport_GetHeaderFooterDetail";
    ...
    private void GetGridData(string query)
    {
        try
        {
            ...
            if (IsAPIIntegrationEnable == "YES")
            {
                string APINAME = "ItemAdjustmentAPI/CustomersReport_GetOwners";
    ...
    private void BindReportTable(DataSet dsGetCustDetails)
    {
        try
        {
            ...
            if (IsAPIIntegrationEnable == "YES")
            {
                string APINAME = "ItemAdjustmentAPI/CustomersReport_GetColumnWidthByReportId";
    ...
    private void SaveResizedAndReorderReport()
    {
        try
        {
            ...
            if (IsAPIIntegrationEnable == "YES")
            {
                string APINAME = "ItemAdjustmentAPI/CustomersReport_UpdateCustomerReportResizedWidth";
        ...
        try
        {
            ...
            if (dsCompDetail.Tables[0].Rows.Count > 0)
            {
                ...
                if (dsGetHeaderFooterDetail.Tables[0].Rows.Count > 0)
                {
                   ...
                   if (dsGetHeaderFooterDetail.Tables[0].Rows[0]["MainHeader"].ToString() == "True")
                   {
                       sbHeader.Append("<tr><td><table><tr><td rowspan='4' style='height:150px;vertical-align:center;text-align:center;'></td><td>&nbsp;</td></tr><tr><td style='height:20px;text-align:left;color:Black;font-size:18px;font-weight:bold;'>" + dsCompDetail.Tables[0].Rows[0]["Name"].ToString() + "</td></tr>");
