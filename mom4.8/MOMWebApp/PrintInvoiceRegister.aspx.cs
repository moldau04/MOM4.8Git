...
public partial class PrintInvoiceRegister : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                GetSMTPUser();
                SetAddress();
                string FileName = "InvoicesWeeklyReport.pdf";
    ...
    {
        var url = "PrintInvoiceRegister.aspx?sd=" + txtfromDate.Text  + "&ed=" + txtToDate.Text;
    ...
    private StiReport LoadReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/InvoicesWeeklyReport.mrt");
            ...
            DataSet ds = objBL_Contracts.GetInvoices(objPropContracts, null, null, null);
            if (ds != null && ds.Tables.Count > 0)
            {
                var dl = ds.Tables[0].Copy().DefaultView;
                dl.RowFilter = "WeekDate IS NOT NULL";
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "Invoices Weekly Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Invoices Weekly Report attached.";
                }
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "InvoicesWeeklyReport.pdf")
                        {
                ...
                mail.FileName = "InvoicesWeeklyReport.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "InvoicesWeeklyReport.pdf")
            {
                byte[] buffer1 = null;
