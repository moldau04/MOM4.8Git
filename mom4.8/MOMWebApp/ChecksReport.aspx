<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Mom.master" Inherits="ChecksReport" CodeBehind="ChecksReport.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script>
        //Handeling Report Error and print in log function.
        //By PS
        function PrintReportException(msg) {
            console.log(msg);
        }
    </script>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Checks Report</div>
            ...
            <div class="row">
                <div class="grid_container">
                    <div class="form-section-row" style="margin-bottom: 0 !important;">
                        <cc1:stiwebviewer id="StiWebViewerChecksReport" height="800px" requesttimeout="20000" runat="server" viewmode="Continuous" scrollbarsmode="true"
                            ongetreport="StiWebViewerChecksReport_GetReport" ongetreportdata="StiWebViewerChecksReport_GetReportData" visible="false" />
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Checks Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
