<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="LocationEquipmentListReport.aspx.cs" Inherits="LocationEquipmentListReport" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Location Equipment List Report</div>
                                        <div class="buttonContainer">
                                            ...
                                            <div class="btnlinks">
                                                <asp:LinkButton runat="server" OnClick="lnkExportExcel_Click" ID="lnkExportExcel">Export Excel</asp:LinkButton>
                                            </div>
                                        </div>
        ...
        <div class="container">
            <div class="grid_container">
                <div class="form-section-row" style="margin-bottom: 0 !important;">
                    <cc1:StiWebViewer ID="StiWebViewerLocationList" Height="800px" RequestTimeout="20000" CacheMode="None" runat="server" ViewMode="Continuous" ScrollbarsMode="true"
                        OnGetReport="StiWebViewerLocationList_GetReport" OnGetReportData="StiWebViewerLocationList_GetReportData" />
                </div>
            </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Location Equipment List Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
