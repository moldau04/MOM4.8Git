...
public partial class UserReport : System.Web.UI.Page
{
    ...
    protected void StiWebViewerUser_GetReport(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
    {
        e.Report = LoadUserReport();
    }

    protected void StiWebViewerUser_GetReportData(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
    {
    ...
    private StiReport LoadUserReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/UserReport.mrt");
            ...
            objRol.ConnConfig = Session["config"].ToString();
            bool incInactive = false;
            if (!string.IsNullOrEmpty(Request["incInactive"]))
            {
                incInactive = Convert.ToBoolean(Request.QueryString["incInactive"]);
            }

            DataSet ds = objBL_Report.GetUserReport(objRol, incInactive);
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the User Report attached.";
                }
                ...
                service.ExportTo(LoadUserReport(), stream, settings);
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "UserReport.pdf")
            {
                byte[] buffer1 = null;
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached User Report.";
