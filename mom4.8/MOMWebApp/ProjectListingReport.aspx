<%@ Page Language="C#" MasterPageFile="~/CustomerReportMaster.master"
     AutoEventWireup="true" Inherits="ProjectListingReport" Title="" EnableEventValidation="false" Codebehind="ProjectListingReport.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script src="js/ReportsJs/ProjectReport.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        function setFilterStyle() {
            $('#ctl00_ContentPlaceHolder1_lstFilter option').each(function (index, element) {
                if ( $(element).val() == "Customers" || $(element).val() == "Locations" || $(element).val() == "Equipments" || $(element).val() == "Vendor") {
            ...
            <div class="col-lg-12 col-md-12">
                <div class="pc-title">
                    <ul class="lnklist-header">
                        <li>
                            <asp:Label CssClass="title_text" ID="lblHeader" runat="server">Project Report Preview</asp:Label></li>
                        <%--<li><a href="<%=ResolveUrl("~/Home.aspx") %>" class="icon-closed" data-original-title="Close" title="Close" data-placement="bottom"></a></li>--%>
                        <li><a title="Close" class="icon-closed" onclick="window.close();"></a></li>
                    </ul>
                </div>
            </div>
                        ...
                        <select style="width: 200px" class="tech" name="tech" id="tech" onchange="showValue(this)">
                            ...
                            Report</a>
                                    ...
                                    <td style="padding-left: 37px;">
                                        <asp:Button ID="btnClose" runat="server" Text="Close" class="myButton" OnClientClick="javascript:window.close()" />
                                    </td>
                                </tr>
                            </table>
                        </div>
                                ...
                                <div id="dvMainHeader" style="float: left;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-left: 35px;" colspan="4">
                                                <table width="500px" style="height: 100px;">                                                    
                                                        ...
                                                        <tr> 
                                                         <td>
                                                           <asp:Label runat="server" ID="lbl_rptName" Font-Underline="true" Font-Bold="true" Font-Size="18px" ForeColor="Black"></asp:Label>
                                                        </td>                                                            
                                                    </tr>
                                                      <tr>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Label ID="lblTime" runat="server" Font-Bold="true" Font-Size="11px" ForeColor="Black"></asp:Label>
                                                    ...
                                                    <tr>
                                                              <td>
                                                            <asp:Label runat="server" ID="lbl_RangeType" ForeColor="Black" Font-Bold="true" Font-Size="13px"></asp:Label>
                                                                  <asp:Label runat="server" ID="lbl_frmdt" ForeColor="Black" Font-Bold="true" Font-Size="12px"></asp:Label>
                                                                   <asp:Label runat="server" ID="lbl_dash" ForeColor="Black" Text="-" Font-Bold="true" Font-Size="15px"></asp:Label>&nbsp;&nbsp;&nbsp;
                                                                  <asp:Label runat="server" ID="lbl_todt" ForeColor="Black" Font-Bold="true" Font-Size="12px"></asp:Label>
                                                        </td>                                                        
                                                                </tr>
                                                  <%--  <tr>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                         ...
                                         <tr>
                                                        <td>
                                                            <asp:Label runat="server" ID="lblCity" ForeColor="Black" Font-Size="14px"></asp:Label>
                                                            <asp:Label runat="server" ID="lblState" ForeColor="Black" Font-Size="14px"></asp:Label>
                                                            <asp:Label runat="server" ID="lblZip" ForeColor="Black" Font-Size="14px"></asp:Label>
                                                        </td>
                                            ...
                                            <fieldset style="border-color: #CDCDCD; width: 460px;">
                                                ...
                                                <div id="Div2" style="float: right; margin: 20px; width: 220px;">
                                                    ...
                                                    <table id="tblCity" style="display: none">
                                                     ...
                                                     <table id="tblProject" style="display: none">
                                                        <tr>
                                                            <td>Project#
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpProject" runat="server" AddJQueryReference="false" UseButtons="false"
                                                                    Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblDateCreated" style="display: none">
                                                        <tr>
                                                            <td>Date Created
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpDateCreated" runat="server" AddJQueryReference="false" UseButtons="false"
                                                                    Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblExpenses" style="display: none">
                                                        <tr>
                                                            <td colspan="4">Expenses
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>&nbsp;
                                                        ...
                                                        <tr>
                                                            <td colspan="4">
                                                                <asp:RadioButton ID="rdbExpAny" runat="server" GroupName="Expenses" Text="Any" CssClass="ListControl" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbExpEqual" runat="server" Width="40px" GroupName="Expenses" Text="="
                                                                    CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtExpEqual" runat="server" CssClass="form-control" Width="80px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbExpLessAndEqual" runat="server" Width="40px" GroupName="Expenses"
                                                                    Text="&lt;=" CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtExpLessAndEqual" runat="server" CssClass="form-control"
                                                                    Width="80px"></asp:TextBox>
                                                                <span style="padding-left: 10px;">and</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbExpGreaterAndEqual" runat="server" Width="40px" GroupName="Expenses"
                                                                    Text="&gt;=" CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtExpGreaterAndEqual" runat="server" CssClass="form-control"
                                                                    Width="80px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>

                                                    <table id="tblLaborExpense" style="display: none">
                                                        <tr>
                                                            <td colspan="4">Labor Expense
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>&nbsp;
                                                        ...
                                                        <tr>
                                                            <td colspan="4">
                                                                <asp:RadioButton ID="rdbLExpAny" runat="server" GroupName="LaborExpense" Text="Any" CssClass="ListControl" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbLExpEqual" runat="server" Width="40px" GroupName="LaborExpense" Text="="
                                                                    CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtLExpEqual" runat="server" CssClass="form-control" Width="80px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbLExpLessAndEqual" runat="server" Width="40px" GroupName="LaborExpense"
                                                                    Text="&lt;=" CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtLExpLessAndEqual" runat="server" CssClass="form-control"
                                                                    Width="80px"></asp:TextBox>
                                                                <span style="padding-left: 10px;">and</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbLExpGreaterAndEqual" runat="server" Width="40px" GroupName="LaborExpense"
                                                                    Text="&gt;=" CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtLExpGreaterAndEqual" runat="server" CssClass="form-control"
                                                                    Width="80px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                     ...
                                                     <table id="tblHours" style="display: none">
                                                        ...
                                                        <tr>
                                                            <td colspan="4">
                                                                <asp:RadioButton ID="rdbHExpAny" runat="server" GroupName="Hours" Text="Any" CssClass="ListControl" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbHExpEqual" runat="server" Width="40px" GroupName="Hours" Text="="
                                                                    CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtHExpEqual" runat="server" CssClass="form-control" Width="80px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbHExpLessAndEqual" runat="server" Width="40px" GroupName="Hours"
                                                                    Text="&lt;=" CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtHExpLessAndEqual" runat="server" CssClass="form-control"
                                                                    Width="80px"></asp:TextBox>
                                                                <span style="padding-left: 10px;">and</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbHExpGreaterAndEqual" runat="server" Width="40px" GroupName="Hours"
                                                                    Text="&gt;=" CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtHExpGreaterAndEqual" runat="server" CssClass="form-control"
                                                                    Width="80px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>

                                                     <table id="tblMaterialExpense" style="display: none">
                                                        <tr>
                                                            <td colspan="4">Material Expense
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>&nbsp;
                                                        ...
                                                        <tr>
                                                            <td colspan="4">
                                                                <asp:RadioButton ID="rdbMExpAny" runat="server" GroupName="MaterialExpense" Text="Any" CssClass="ListControl" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbMExpEqual" runat="server" Width="40px" GroupName="MaterialExpense" Text="="
                                                                    CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtMExpEqual" runat="server" CssClass="form-control" Width="80px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbMExpLessAndEqual" runat="server" Width="40px" GroupName="MaterialExpense"
                                                                    Text="&lt;=" CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtMExpLessAndEqual" runat="server" CssClass="form-control"
                                                                    Width="80px"></asp:TextBox>
                                                                <span style="padding-left: 10px;">and</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbMExpGreaterAndEqual" runat="server" Width="40px" GroupName="MaterialExpense"
                                                                    Text="&gt;=" CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtMExpGreaterAndEqual" runat="server" CssClass="form-control"
                                                                    Width="80px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>

                                                     <table id="tblTotalBilled" style="display: none">
                                                        <tr>
                                                            <td colspan="4">Total Billed
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>&nbsp;
                                                        ...
                                                        <tr>
                                                            <td colspan="4">
                                                                <asp:RadioButton ID="rdbBExpAny" runat="server" GroupName="TotalBilled" Text="Any" CssClass="ListControl" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbBExpEqual" runat="server" Width="40px" GroupName="TotalBilled" Text="="
                                                                    CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtBExpEqual" runat="server" CssClass="form-control" Width="80px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbBExpLessAndEqual" runat="server" Width="40px" GroupName="TotalBilled"
                                                                    Text="&lt;=" CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtBExpLessAndEqual" runat="server" CssClass="form-control"
                                                                    Width="80px"></asp:TextBox>
                                                                <span style="padding-left: 10px;">and</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbBExpGreaterAndEqual" runat="server" Width="40px" GroupName="TotalBilled"
                                                                    Text="&gt;=" CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtBExpGreaterAndEqual" runat="server" CssClass="form-control"
                                                                    Width="80px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>

                                                    <table id="tblTotalExpenses" style="display: none">
                                                        <tr>
                                                            <td colspan="4">TotalExpenses
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>&nbsp;
                                                        ...
                                                        <tr>
                                                            <td colspan="4">
                                                                <asp:RadioButton ID="rdbTExpAny" runat="server" GroupName="TotalExpenses" Text="Any" CssClass="ListControl" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbTExpEqual" runat="server" Width="40px" GroupName="TotalExpenses" Text="="
                                                                    CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtTExpEqual" runat="server" CssClass="form-control" Width="80px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbTExpLessAndEqual" runat="server" Width="40px" GroupName="TotalExpenses"
                                                                    Text="&lt;=" CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtTExpLessAndEqual" runat="server" CssClass="form-control"
                                                                    Width="80px"></asp:TextBox>
                                                                <span style="padding-left: 10px;">and</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbTExpGreaterAndEqual" runat="server" Width="40px" GroupName="TotalExpenses"
                                                                    Text="&gt;=" CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtTExpGreaterAndEqual" runat="server" CssClass="form-control"
                                                                    Width="80px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>

                                                    <table id="tblTotalOnOrder" style="display: none">
                                                        <tr>
                                                            <td colspan="4">Total On Order
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>&nbsp;
                                                        ...
                                                        <tr>
                                                            <td colspan="4">
                                                                <asp:RadioButton ID="rdbTOExpAny" runat="server" GroupName="TotalOnOrder" Text="Any" CssClass="ListControl" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbTOExpEqual" runat="server" Width="40px" GroupName="TotalOnOrder" Text="="
                                                                    CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtTOExpEqual" runat="server" CssClass="form-control" Width="80px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbTOExpLessAndEqual" runat="server" Width="40px" GroupName="TotalOnOrder"
                                                                    Text="&lt;=" CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtTOExpLessAndEqual" runat="server" CssClass="form-control"
                                                                    Width="80px"></asp:TextBox>
                                                                <span style="padding-left: 10px;">and</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbTOExpGreaterAndEqual" runat="server" Width="40px" GroupName="TotalOnOrder"
                                                                    Text="&gt;=" CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtTOExpGreaterAndEqual" runat="server" CssClass="form-control"
                                                                    Width="80px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    <table id="tblLocation" style="display: none">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpLocation" runat="server" AddJQueryReference="false"
                                                     ...
                                                     <%--<table id="tblHours" style="display: none">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpHours" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false" CssClass="form-control">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblDescription" style="display: none">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpDescription" runat="server" AddJQueryReference="false"
                                                    ...
                                                    <table id="tblAmountDue" style="display: none">
                                                        <tr>
                                                            <td>Amount Due
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpAmountDue" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                   ...
                                                   <%-- <table id="tblTotalOnOrder" style="display: none">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpTotalOnOrder" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <%--<table id="tblTotalBilled" style="display: none">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpTotalBilled" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblPreTaxAmount" style="display: none">
                                                        <tr>
                                                            <td>Pre Tax Amount
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpPreTaxAmount" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblSalesTax" style="display: none">
                                                        <tr>
                                                            <td>Sales Tax
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpSalesTax" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblTotal" style="display: none">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpTotal" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblPO" style="display: none">
                                                        <tr>
                                                            <td>PO
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpPO" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblCustomerName" style="display: none">
                                                        <tr>
                                                            <td>Customer Name
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpCustomerName" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblBatch" style="display: none">
                                                        <tr>
                                                            <td>Batch
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpBatch" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                       ...
                                                       <table id="tblDueDate" style="display: none">
                                                        <tr>
                                                            <td>DueDate
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpDueDate" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                       ...
                                                       <table id="tblManualInvoice" style="display: none">
                                                        <tr>
                                                            <td>Manual Invoice
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpManualInvoice" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblShipVia" style="display: none">
                                                        <tr>
                                                            <td>ShipVia
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpShipVia" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblQBVendorID" style="display: none">
                                                        <tr>
                                                            <td>QBVendorID
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpQBVendorID" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblRemit" style="display: none">
                                                        <tr>
                                                            <td>Remit
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpRemit" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
