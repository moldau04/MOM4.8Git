<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="ARAgingReportDep" CodeBehind="ARAgingReportDep.aspx.cs" %>
                                    ...
                                    <div class="row">
                                        <div class="col s12 m12 l12">
                                            <div class="row">
                                                ...
                                                <asp:Label CssClass="title_text" ID="lblHeader" runat="server">AR Aging by Department Report</asp:Label>
                                                </div>
            ...
            <div class="row">
                <div class="srchpane">
                    <asp:UpdatePanel ID="upSearch" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            ...
                            <div class="srchinputwrap">
                                <telerik:RadComboBox RenderMode="Auto" ID="rcDepartment" CssClass="browser-default" runat="server" Filter="StartsWith" CheckBoxes="true" EnableCheckAllItemsCheckBox="true"
                                    EmptyMessage=":: Select ::" Skin="Metro">
                                </telerik:RadComboBox>
                            </div>
                            <div class="srchinputwrap">
                                <asp:DropDownList ID="ddlType" runat="server" CssClass="browser-default selectst selectsml">
                                    <asp:ListItem Value="0">Report by</asp:ListItem>
                                    <asp:ListItem Value="1">Outstanding </asp:ListItem>
                                    <asp:ListItem Value="2">As of date </asp:ListItem>
                                </asp:DropDownList>
                            </div>
                            <div class="srchinputwrap">
                            ...
                            <div class="srchinputwrap srchclr btnlinksicon margin-t-l">
                                <asp:LinkButton ID="btnSearch" runat="server" CausesValidation="true" ToolTip="Refresh"
                                    OnClick="btnSearch_Click" ValidationGroup="search"><i class="mdi-action-search"></i></asp:LinkButton>
                            </div>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                    <asp:UpdateProgress ID="updateProgress" runat="server">
                        <ProgressTemplate>
                            <div class="loder-img" >
                                <asp:Image ID="imgUpdateProgress" runat="server" class="loder-img-css" ImageUrl="~/images/1loader_round.gif" AlternateText="Loading ..." ToolTip="Loading ..."  />
                            </div>
                ...
                <div class="grid_container">
                    <cc1:StiWebViewer ID="StiWebViewerARAging" Height="800px" runat="server" ScrollbarsMode="true" ViewMode="Continuous" CacheMode="None" BackgroundColor="White"
                        OnGetReport="StiWebViewerARAging_GetReport" OnGetReportData="StiWebViewerARAging_GetReportData" RequestTimeout="9000000" Visible="false" />
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="col s12 m12 l12">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; AR Aging by Department Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
                    ...
                    <contenttemplate>
                        <div class="form-section">
                            <div class="srchpaneinner srch-css">
                                ...
                                <div class="srchinputwrap srchclr btnlinksicon ser-css">
