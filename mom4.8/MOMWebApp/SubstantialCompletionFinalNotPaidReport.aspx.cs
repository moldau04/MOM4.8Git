...
namespace MOMWebApp
{
    public partial class SubstantialCompletionFinalNotPaidReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                GetSMTPUser();
                SetAddress();
                string FileName = "SubstantialCompletionFinalNotPaidReport.pdf";
        ...
        protected void StiWebViewerSubstantialCompletedReport_GetReport(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
        {
            ...
            reportPathStimul = Server.MapPath("StimulsoftReports/SubstantialCompletionFinalNotPaidReport.mrt");
        ...
        protected void StiWebViewerSubstantialCompletedReport_GetReportData(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
        {
            ...
            try
            {
                ...
                ds = bL_Report.GetSubstantialCompletionFinalNotPaidReport(Session["config"].ToString());
        ...
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/SubstantialCompletionFinalNotPaidReport.mrt");
        ...
        protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
        {
            if (txtTo.Text.Trim() != string.Empty)
            {
                try
                {
                    ...
                    mail.Title = "Substantial Completed Final Not Paid Report";
                    ...
                    {
                        mail.Text = "This is report email sent from Mobile Office Manager. Please find the Substantial Completed Final Not Paid Report attached.";
                    }
                    ...
                    if (ViewState["pathmailatt"] != null)
                    {
                        ...
                        {
                            if (strpath != "SubstantialCompletionFinalNotPaidReport.pdf")
                            {
                    ...
                    mail.FileName = "SubstantialCompletionFinalNotPaidReport.pdf";
        ...
        private void DownloadDocument(string filePath, string DownloadFileName)
        {
            ...
            {
                if (DownloadFileName == "SubstantialCompletionFinalNotPaidReport.pdf")
                {
                    byte[] buffer1 = null;
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=SubstantialCompletionFinalNotPaidReport.pdf");
        ...
        private void SetAddress()
        {
            ...
            string mailBody = "Please review the attached Substantial Completed Final Not Paid Report.";
