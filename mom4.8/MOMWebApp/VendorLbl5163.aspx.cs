...
public partial class VendorLbl5163 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                GetSMTPUser();
                SetAddress();
                string FileName = "VendorLabel5163.pdf";
    ...
    {
        Response.Redirect("VendorLbl5163.aspx?stype=" + ddlVendorSearch.SelectedValue + "&stext=" + txtVendorSearch.Text);
    }
    ...
    private StiReport LoadVendorLabelReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/VendorLabel5163.mrt");
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "Vendor Label 5163 Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Vendor Label 5163 Report attached.";
                }
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "VendorLabel5163.pdf")
                        {
                ...
                mail.FileName = "VendorLabel5163.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "VendorLabel5163.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=VendorLabel5163.pdf");
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached Vendor Label 5163 Report.";
