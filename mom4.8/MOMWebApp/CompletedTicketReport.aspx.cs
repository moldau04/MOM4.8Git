...
public partial class CompletedTicketReport : System.Web.UI.Page
{
    ...
    {
        e.Report = LoadCompletedTicketReport();
    }
    ...
    private StiReport LoadCompletedTicketReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/CompletedTicketReport.mrt");
            if (!string.IsNullOrEmpty(Request["signature"]) && Convert.ToBoolean(Request["signature"]))
            {
                reportPathStimul = Server.MapPath("StimulsoftReports/CompletedTicketSignatureReport.mrt");
            }
            ...
            DataSet ds = bL_Report.GetCompletedTicket(objPropMapData, filters);
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Completed Ticket Report attached.";
                }
                ...
                service.ExportTo(LoadCompletedTicketReport(), stream, settings);
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached Completed Ticket Report.";
