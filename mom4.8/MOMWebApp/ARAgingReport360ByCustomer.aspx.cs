...
public partial class ARAgingReport360ByCustomer : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                GetSMTPUser();
                SetAddress();
                string FileName = "ARAging360ByCustomReport.pdf";
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        var url = "ARAgingReport360ByCustomer.aspx?stype=" + ddlType.SelectedValue + "&sdate=" + txtSearchDate.Text + "&type=" + type + "&inclNotes=" + chkIncludeNotes.Checked + "&creditFlag=" + chkCreditFlag.Checked;
    ...
    private StiReport LoadReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/ARAging360ByCustomerReport.mrt");
            if (!string.IsNullOrEmpty(Request["type"]) && Request["type"] == "summary")
            {
                reportPathStimul = Server.MapPath("StimulsoftReports/ARAging360ByCustomerSummaryReport.mrt");
            }
            ...
            objContract.DepartmentTypes = string.Empty;
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "AR Aging by Custom Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the AR Aging by Custom Report attached.";
                }
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "ARAging360ByCustomReport.pdf")
                        {
                ...
                mail.FileName = "ARAging360ByCustomReport.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "ARAging360ByCustomReport.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=ARAging360ByCustomReport.pdf");
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached AR Aging by Custom Report.";
