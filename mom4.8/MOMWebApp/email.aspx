<%@ Page Title="" Language="C#" MasterPageFile="~/MOM.master" AutoEventWireup="true" Inherits="email" Codebehind="email.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="divbutton-container" runat="server" id="replyHeader">       
                <header>
                    <div class="container row-color-grey">
                        <div class="row">
                            <div class="col s12 m12 l12">
                                <div class="row">
                                    <div class="col s12 m12 l12">
                                        <div class="row">
                                            <div class="page-title">
                                                <i class="mdi-editor-insert-drive-file"></i>&nbsp;
                                                 <asp:Label CssClass="title_text" ID="Label2" runat="server">Send Email</asp:Label>
                                            </div>
                                            <div class="buttonContainer">
                                                <div class="btnlinks">
                                            ...
                                            <div class="buttonContainer">
                                                <div class="btnlinks">
                                                    <asp:LinkButton ID="lnkFwd" runat="server" OnClick="lnkFwd_Click">Forward</asp:LinkButton>
                                                </div>
                                            </div>
                                            
                                            <div class="btnclosewrap">
                                                <asp:LinkButton runat="server" OnClick="lnkClose_Click" OnClientClick="return confirm('Do you want to discard the mail?');" ID="LinkButton3" ToolTip="Close">
                                                    <i class="mdi-content-clear"></i>
                                                </asp:LinkButton>
                                            </div>
                                        </div>
    ...
    <div class="container mailtitcketcontainer" runat="server" id="pnlBody">
        <div class="row">
              ...
              <div class="srchpane-advanced" style="margin: 0 !important;">
                <div class="srchpaneinner">
                    ...
                    <div class="form-col">
                        ...
                        <div class="fc-input">
                        <asp:DataList ID="dlAttachments" runat="server" CellPadding="0" CellSpacing="5" RepeatColumns="5"
                                                RepeatDirection="Horizontal">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="imgbtnAttachment" runat="server" OnClick="imgbtnAttachment_Click"
                     ...
                     <div class="form-col">
                        <iframe id="ifbody" runat="server" class="roundCorner shadow" name="ifbody" style="border: none; width: 900px; height: 600px"></iframe>
                        </div>
    ...
    <div class="container mailtitcketcontainer" runat="server" id="pnlCompose" Visible="false">
        <div class="row">
            <div class="srchpane-advanced" style="margin: 0 !important;">
                <div class="srchpaneinner">
                    <div class="form-col">
                        ...
                        <div class="fc-input">
                            <asp:TextBox ID="txtEmailFrom" runat="server" CssClass="form-control"
                                    Placeholder="From" TabIndex="9" ToolTip="From" ReadOnly="True"></asp:TextBox>
                    ...
                    <div class="form-col">
                        ...
                        <div class="fc-input">
                            <asp:TextBox ID="txtEmailCc" runat="server" CssClass="form-control"
                                    ...
                                    <ItemTemplate>
                                        <li>
                                            <div class="list-title">
                                                <asp:LinkButton runat="server" ID="lnkFileNameDownload" CommandArgument='<%#Eval("ID")%>' OnClick="lnkFileNameDownload_Click">
                                                              <%# Eval("FileName").ToString().Replace(".docx",".pdf") %>
                                                </asp:LinkButton>
                                            </div>
                                            <div class="list-delete">
                                                <asp:LinkButton ID="lnkFileName" runat="server" CommandName="Delete" CausesValidation="false" CommandArgument='<%#Eval("ID")%>'>
                                                             <img src="images/delete_email.png" />
                                                </asp:LinkButton>
                                            </div>
                                        </li>
                                    </ItemTemplate>
