<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="SalesTaxReportSumarryByVendor.aspx.cs" Inherits="SalesTaxReportSumarryByVendor" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Sales Tax By Vendor Report</div>
            ...
            <div class="row">
                ...
                <div class="grid_container">
                    <div class="form-section-row m-b-0">
                        <cc1:StiWebViewer ID="StiWebViewerSalesTaxByVendor" Height="800px" RequestTimeout="20000" runat="server" ViewMode="Continuous" ScrollbarsMode="true"
                            OnGetReport="StiWebViewerSalesTaxByVendor_GetReport" OnGetReportData="StiWebViewerSalesTaxByVendor_GetReportData" Visible="false" />
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="form-section">
                                <div class="input-field col s12">
                                    <div class="row">
                                        ...
                                        <asp:TextBox ID="txtBody" runat="server" TextMode="MultiLine" CssClass="materialize-textarea" Text="This report is generated from Mobile Office Manager. Please find attached the Sales Tax By Vendor Report."></asp:TextBox>
                                    </div>
                                </div>
