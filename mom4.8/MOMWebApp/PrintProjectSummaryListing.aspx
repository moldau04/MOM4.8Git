<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="PrintProjectSummaryListing" CodeBehind="PrintProjectSummaryListing.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row" style="height: 40px;">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-communication-contacts"></i>&nbsp; Project Summary Listing Report</div>
            ...
            <div class="row">
                <div class="srchpane">
                    <div class="grid_container">
                        <cc1:StiWebViewer ID="StiWebViewerProjectSummary" Height="800px" RequestTimeout="20000" runat="server" ViewMode="Continuous" ScrollbarsMode="true"
                            OnGetReport="StiWebViewerProjectSummary_GetReport" OnGetReportData="StiWebViewerProjectSummary_GetReportData" Visible="true" />
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Project Summary Listing Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
