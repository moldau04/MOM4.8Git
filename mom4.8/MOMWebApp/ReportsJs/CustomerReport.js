...
function EmptyFilters() {
    ...
    $("#tblPrefferedWorker").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpPrefWorker input[type="checkbox"]').attr('checked', false);
    $("#tblDescription").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpDescription input[type="checkbox"]').attr('checked', false);
    $("#tblBillStart").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpBillStart input[type="checkbox"]').attr('checked', false);
    ...
    $('#ctl00_ContentPlaceHolder1_drpTicketStart input[type="checkbox"]').attr('checked', false);
    $("#tblBillAmount").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpBillAmount input[type="checkbox"]').attr('checked', false); 
    ...
    $('#ctl00_ContentPlaceHolder1_drpTicketTime input[type="checkbox"]').attr('checked', false);
    ...
    $('#ctl00_ContentPlaceHolder1_drpTicketFreq input[type="checkbox"]').attr('checked', false);
   //Rahil
    ...
    //Rahil
     if (filterName == "Customer") {
        ...
        if (filterValue != '') {
            var splitedNames = filterValue.split("|");
            for (i = 0; i <= splitedNames.length - 1; i++) {
                $('#ctl00_ContentPlaceHolder1_drpCustomer input[type=checkbox]').each(function () {
                    var lblValue = $(this).next('label').html();
                    splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                    if (lblValue.trim() == splitedNames[i].trim()) {
                        $(this).attr('checked', true);
     ...
     if (filterName == "PreferredWorker") {
         ...
         if (filterValue != '') {
             var splitedNames = filterValue.split("|");
             for (i = 0; i <= splitedNames.length - 1; i++) {
                 $('#ctl00_ContentPlaceHolder1_drpPrefWorker input[type=checkbox]').each(function () {
                     var lblValue = $(this).next('label').html();
                     splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                     if (lblValue.trim() == splitedNames[i].trim()) {
                         $(this).attr('checked', true);
     ...
     if (filterName == "Description") {
         ...
         if (filterValue != '') {
             var splitedNames = filterValue.split("|");
             for (i = 0; i <= splitedNames.length - 1; i++) {
                 $('#ctl00_ContentPlaceHolder1_drpDescription input[type=checkbox]').each(function () {
                     var lblValue = $(this).next('label').html();
                     splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                     if (lblValue.trim() == splitedNames[i].trim()) {
                         $(this).attr('checked', true);
     ...
     if (filterName == "BillStart") {
         ...
         if (filterValue != '') {
             var splitedNames = filterValue.split("|");
             for (i = 0; i <= splitedNames.length - 1; i++) {
                 $('#ctl00_ContentPlaceHolder1_drpBillStart input[type=checkbox]').each(function () {
                     var lblValue = $(this).next('label').html();
                     splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                     if (lblValue.trim() == splitedNames[i].trim()) {
                         $(this).attr('checked', true);
     ...
     if (filterName == "TicketStart") {
         ...
         if (filterValue != '') {
             var splitedNames = filterValue.split("|");
             for (i = 0; i <= splitedNames.length - 1; i++) {
                 $('#ctl00_ContentPlaceHolder1_drpTicketStart input[type=checkbox]').each(function () {
                     var lblValue = $(this).next('label').html();
                     splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                     if (lblValue.trim() == splitedNames[i].trim()) {
                         $(this).attr('checked', true);
     ...
     if (filterName == "BillAmount") {
         ...
         if (filterValue != '') {
             var splitedNames = filterValue.split("|");
             for (i = 0; i <= splitedNames.length - 1; i++) {
                 $('#ctl00_ContentPlaceHolder1_drpBillAmount input[type=checkbox]').each(function () {
                     var lblValue = $(this).next('label').html();
                     splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                     if (lblValue.trim() == splitedNames[i].trim()) {
                         $(this).attr('checked', true);
     ...
     if (filterName == "LocType") {
         ...
         if (filterValue != '') {
             var splitedNames = filterValue.split("|");
             for (i = 0; i <= splitedNames.length - 1; i++) {
                 $('#ctl00_ContentPlaceHolder1_drpLocationType input[type=checkbox]').each(function () {
                     var lblValue = $(this).next('label').html();
                     splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                     if (lblValue.trim() == splitedNames[i].trim()) {
                         $(this).attr('checked', true);
     ...
     if (filterName == "TicketTime") {
         ...
         if (filterValue != '') {
             var splitedNames = filterValue.split("|");
             for (i = 0; i <= splitedNames.length - 1; i++) {
                 $('#ctl00_ContentPlaceHolder1_drpTicketTime input[type=checkbox]').each(function () {
                     var lblValue = $(this).next('label').html();
                     splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                     if (lblValue.trim() == splitedNames[i].trim()) {
                         $(this).attr('checked', true);
     ...
     if (filterName == "Hours") {
         ...
         if (filterValue != '') {
             var splitedNames = filterValue.split("|");
             for (i = 0; i <= splitedNames.length - 1; i++) {
                 $('#ctl00_ContentPlaceHolder1_drpHours input[type=checkbox]').each(function () {
                     var lblValue = $(this).next('label').html();
                     splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                     if (lblValue.trim() == splitedNames[i].trim()) {
                         $(this).attr('checked', true);
     ...
     if (filterName == "TicketFreq") {
         ...
         if (filterValue != '') {
             var splitedNames = filterValue.split("|");
             for (i = 0; i <= splitedNames.length - 1; i++) {
                 $('#ctl00_ContentPlaceHolder1_drpTicketFreq input[type=checkbox]').each(function () {
                     var lblValue = $(this).next('label').html();
                     splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                     if (lblValue.trim() == splitedNames[i].trim()) {
                         $(this).attr('checked', true);
...
jQuery(document).ready(function () {
   ...
   /* $('#ctl00_ContentPlaceHolder1_drpCustomer input[type="checkbox"]').click(function () {
        var filterValue = '';
        $('#ctl00_ContentPlaceHolder1_drpCustomer input[type=checkbox]:checked + label').each(function () {
            //alert($(this).text());
            filterValue += "'" + $(this).text() + "'" + " | ";
        });
        filterValue = filterValue.substring(0, filterValue.trim().length - 1);
        ...
        if (filterValue != '') {
            if ($('#tblFilterChoices tr td').hasClass("customer")) {
                $(".customer").html(filterValue);
            }
            else {
                $('#tblFilterChoices tbody').append('<tr id="trCustomer"><td width="100px" style="height:25px;">Customer</td><td  class="name" width="220px"  style="height:25px;">' + filterValue + '</td></tr>');
            }
        }
        else {
            $("#trCustomer").remove();
