...
public partial class EquipmentCustomDetailReport : System.Web.UI.Page
{
    #region Variables
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                GetSMTPUser();
                SetAddress();
                string FileName = "EquipmetCustomDetailReport.pdf";
    ...
    protected void lnkExcel_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("Content-Disposition", "attachment;filename=EquipmetCustomDetailReport.xls");
    ...
    protected void StiWebViewerEquipmentCustomDetailReport_GetReport(object sender, StiReportDataEventArgs e)
    {
        e.Report = LoadReport();
    }

    protected void StiWebViewerEquipmentCustomDetailReport_GetReportData(object sender, StiReportDataEventArgs e)
    {
    ...
    {
        Response.Redirect("EquipmentCustomDetailReport.aspx");
    }
    ...
    private StiReport LoadReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/EquipmentCustomDetailReport.mrt");
            ...
            {
                objPropUser.EquipID = Convert.ToInt32(eqId);
            }
            ...
            {
                report.RegData("ReportListData", ds.Tables[2]);
            }
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "Equipmet Custom Detail Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Equipmet Custom Detail Report attached.";
                }
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "EquipmetCustomDetailReport.pdf")
                        {
                ...
                mail.FileName = "EquipmetCustomDetailReport.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "EquipmetCustomDetailReport.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=EquipmetCustomDetailReport.pdf");
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached Equipmet Custom Detail Report.";
    ...
    {
        var url = "EquipmentCustomDetailReport.aspx";
