<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="ProjectBacklogWithBudgetsReport" CodeBehind="ProjectBacklogWithBudgetsReport.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row" style="height: 40px;">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-communication-contacts"></i>&nbsp; Project Backlog with Budgets Report</div>
            ...
            <div class="row">
                <div class="srchpane">
                    <div class="grid_container">
                        <cc1:StiWebViewer ID="StiWebViewerProjectBacklog" Height="800px" RequestTimeout="20000" CacheMode="None" runat="server" ViewMode="Continuous" ScrollbarsMode="true"
                            OnGetReport="StiWebViewerProjectBacklog_GetReport" OnGetReportData="StiWebViewerProjectBacklog_GetReportData" />
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Project Backlog with Budgets Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
