<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CustomerReportMaster.master" Inherits="PESEquipInspection" Title="" EnableEventValidation="false" Codebehind="PESEquipInspection.aspx.cs" %>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="pc-title">
                    <ul class="lnklist-header">
                        <li>
                            <asp:Label CssClass="title_text" ID="lblHeader" runat="server">PES Equipment Inspection Preview</asp:Label></li>
