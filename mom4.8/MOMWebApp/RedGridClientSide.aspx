<%@ Page Title="Client Side RedGrid || MOM" Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" CodeBehind="RedGridClientSide.aspx.cs" Inherits="MOMWebApp.RedGridClientSide" %>
                                    ...
                                    <asp:Panel runat="server" ID="pnlGridButtons">
                                        <div class="buttonContainer">
                                            ...
                                            <ul id="drpMenu" class="nomgn hideMenu menuList">
                                                <li>
                                                    <div class="btnlinks">
                                                        <a id="btnCopy" runat="server" onclientclick='return CopyWageClick();' onserverclick="btnCopy_Click">Copy</a>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="btnlinks">
            ...
            <div class="form-section-row" style="margin-bottom: 0 !important;">
                ...
                <div class="RadGrid RadGrid_Material">
                    <telerik:RadAjaxPanel ID="RadAjaxPanel_Wage" runat="server" LoadingPanelID="RadAjaxLoadingPanel_Wage" ClientEvents-OnRequestStart="requestStart" ClientEvents-OnResponseEnd="responseEnd">
                        <telerik:RadGrid RenderMode="Lightweight" runat="server" ID="RadGrid_Wage" AllowFilteringByColumn="true" ShowFooter="True" FilterType="CheckList"
                            PagerStyle-AlwaysVisible="true" ShowStatusBar="true" AllowPaging="True" AllowSorting="true" Width="100%" AllowCustomPaging="True" PageSize="1000" AllowCustomSorting="true">
                            <CommandItemStyle />
