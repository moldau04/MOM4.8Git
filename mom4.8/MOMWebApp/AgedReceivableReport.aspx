<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="AgedReceivableReport" CodeBehind="AgedReceivableReport.aspx.cs" %>
                                    ...
                                    <div class="row">
                                        <div class="col s12 m12 l12">
                                            <div class="row">
                                                ...
                                                <asp:Label CssClass="title_text" ID="lblHeader" runat="server">Aged Receivable Report</asp:Label>
                                                </div>
                        ...
                        <div class="col s12 m12 l12">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp;  Aged Receivable Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
