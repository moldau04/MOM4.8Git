<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MOM.master" Inherits="PrintMaddenPO1" Codebehind="PrintCustomPO.aspx.cs" %>
            ...
            <div class="srchpane-advanced" style="margin: 0 !important;">
                <div class="srchpaneinner">
                    ...
                    <div class="form-col">
                        ...
                        <div class="fc-input">
                            <asp:TextBox ID="txtTo" CssClass="form-control" runat="server" Placeholder="To"
                                ...
                                <div class="input-field col s12">
                                    <div class="form-section-row">
                                        <div class="row">
                                            ...
                                            <div class="input-field col s11" style="margin-top: -10px;">
                                                <input name="inputCc" type="text" value="" id="inputCc" class="txtUserName form-control validate" />
                                            </div>
                                            <div class="input-field col s1" style="margin-top: 0px;">
                                                <div class="srchtitle  srchtitlecustomwidth btnlinks">
                                            ...
                                            <div class="input-field col s11" style="margin-top: -10px;">
                                                <input name="inputBcc" type="text" value="" id="inputBcc" class="txtUserName form-control validate" />
                                            </div>
                                        </div>
                                    </div>
