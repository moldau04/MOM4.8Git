...
public partial class MaintenanceEquipmentCountByDate : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            //    txtstartrDate.Text = HttpUtility.UrlDecode(Request.QueryString["startDate"]);
            //}
            //else
            //{
            //    txtstartrDate.Text = "";
            ...
            GetSMTPUser();
            SetAddress();
            string FileName = "MaintenanceUnitCountByDateReport.pdf";
    ...
    //Lnik Close Button Event
    protected void lnkClose_Click(object sender, EventArgs e)
    {
        Response.Redirect("RecContracts.aspx?fil=1");
    }

    //Link Load Report Button Event
    protected void lnkLoad_Click(object sender, EventArgs e)
    {
        StiWebViewerUnitCount.Visible = true;
        //var routes = GetRadComboBoxSelectedItems(rcRoute);

        //Response.Redirect("MaintenanceEquipmentCountByDate.aspx?startDate=" + txtstartrDate.Text);
    }

    //Stimulsoft Report Event
    ...
    //Load Report and data Function
    private StiReport LoadReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/MaintenanceEquipmentByDateReport.mrt");
            ...
            //DateTime? routes = null;
            //if (!string.IsNullOrEmpty(Request["startDate"]))
            //{
            //    routes = Convert.ToDateTime(Request["startDate"]);
            //}
            ...
            {
                objContract.SearchBy = Request.QueryString["stype"];
                objContract.SearchValue = Request.QueryString["stext"];
            }
            ...
            ds = bL_Report.GetMaintenanceUnitCountByDate(objContract, filters);
            //}
            ...
            if (ds != null && ds.Tables[0].Rows.Count > 0)
            {
                ...
                //    {
                //        var MonthlyBillFilter = dtDetail.AsEnumerable()
                //                 .Where(i => i.Field<string>("Salesperson").Contains(obj.FilterValue));
                //        if (MonthlyBillFilter.Any())
                //        {
                //            dtDetail = MonthlyBillFilter.CopyToDataTable();
                //        }
                //        else
                //        {
                //            dtDetail.Clear();
                ...
                //    {
                //        var FreqencyFilter = dtDetail.AsEnumerable()
                //                         .Where(i => i.Field<string>("Salesperson2").StartsWith(obj.FilterValue));

                //        if (FreqencyFilter.Any())
                //        {
                //            dtDetail = FreqencyFilter.CopyToDataTable();
                //        }
                //    }
                //    //if (obj.FilterColumn == "MonthlyHours")
                //    //{
                //    //    var MonthlyHoursFilter = dtDetail.AsEnumerable()
                //    //                     .Where(i => i.Field<decimal>("MonthlyHours") == Convert.ToDecimal(obj.FilterValue));

                //    //    if (MonthlyHoursFilter.Any())
                //    //    {
                //    //        dtDetail = MonthlyHoursFilter.CopyToDataTable();
                //    //    }
                //    //}
                //    //if (obj.FilterColumn == "TicketFreq")
                //    //{
                //    //    var TicketFreqFilter = dtDetail.AsEnumerable()
                //    //                     .Where(i => i.Field<string>("TicketFreq").StartsWith(obj.FilterValue));

                //    //    if (TicketFreqFilter.Any())
                //    //    {
                //    //        dtDetail = TicketFreqFilter.CopyToDataTable();
                //    //    }
                //    //}
                //    //if (obj.FilterColumn == "Worker")
                //    //{
                //    //    var WorkerFilter = dtDetail.AsEnumerable()
                //    //                     .Where(i => i.Field<string>("Worker").StartsWith(obj.FilterValue));

                //    //    if (WorkerFilter.Any())
                //    //    {
                //    //        dtDetail = WorkerFilter.CopyToDataTable();
                //    //    }
                //    //}
                //    //if (obj.FilterColumn == "Status")
                //    //{
                //    //    var StatusFilter = dtDetail.AsEnumerable()
                //    //                     .Where(i => i.Field<string>("Status").StartsWith(obj.FilterValue));

                //    //    if (StatusFilter.Any())
                //    //    {
                //    //        dtDetail = StatusFilter.CopyToDataTable();
                //    //    }
                //    //}
    ...
    //Fill Distribution List Function
