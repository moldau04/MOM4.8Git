<%@ Page Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="OpenTicketDetailsByMechanic" Codebehind="OpenTicketDetailsByMechanic.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Open Tickets Details By Mechanic Report</div>
        ...
        <div class="container">
            <div class="grid_container">
                <div class="form-section-row" style="margin-bottom: 0 !important;">
                    <cc1:StiWebViewer ID="StiWebViewerOpenTicketDetailsByMechanic" Height="800px" RequestTimeout="20000" CacheMode="None" runat="server" ViewMode="Continuous" ScrollbarsMode="true"
                        OnGetReport="StiWebViewerOpenTicketDetailsByMechanic_GetReport" OnGetReportData="StiWebViewerOpenTicketDetailsByMechanic_GetReportData" />
                </div>
            </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Open Tickets Details By Mechanic Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
