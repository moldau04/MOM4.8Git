<%@ Page Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" CodeBehind="MaintenanceCancelledReport.aspx.cs" Inherits="MaintenanceCancelledReport" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Maintenance Cancelled Report</div>
                ...
                <div class="srchpane">
                    ...
                    <div class="grid_container">
                        <div class="form-section-row" style="margin-bottom: 0 !important;">
                            <cc1:StiWebViewer ID="StiWebViewerMaintenanceCancelled" Height="800px" RequestTimeout="20000" runat="server" CacheMode="None" Visible="false" ViewMode="Continuous" ScrollbarsMode="true"
                                OnGetReport="StiWebViewerMaintenanceCancelled_GetReport" OnGetReportData="StiWebViewerMaintenanceCancelled_GetReportData" />
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp;  Maintenance Cancelled Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
