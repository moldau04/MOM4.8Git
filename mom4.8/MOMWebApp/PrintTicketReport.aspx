<%@ Page Title="" Language="C#" MasterPageFile="~/MOM.master" AutoEventWireup="true" Inherits="PrintTicketReport" CodeBehind="PrintTicketReport.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Ticket List Report</div>
            ...
            <div class="row">
                <div class="srchpane">
                    ...
                    <div class="srchinputwrap">
                        <asp:DropDownList Width="250px" ID="ddlReport" runat="server" CssClass="browser-default selectst" OnSelectedIndexChanged="ddlReport_SelectedIndexChanged" AutoPostBack="true">
                            ...
                            <asp:ListItem Value="2">Timesheet Report</asp:ListItem>
                            <asp:ListItem Value="16">Timesheet Certified Project Report</asp:ListItem>
                            <asp:ListItem Value="13">Timesheet Report by Department</asp:ListItem>
                            <asp:ListItem Value="14">Timesheet Report ( No TT )</asp:ListItem>
                            <asp:ListItem Value="15">Timesheet Report by Wage Category</asp:ListItem>
                            <asp:ListItem Value="17">Mod Timesheet Report</asp:ListItem>
                            ...
                            <asp:ListItem Value="20">Ticket Category History</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                    <div id="divlblCategory" class="srchtitle srchtitlecustomwidth" runat="server" visible="false">
                        Select Category
                    </div>
                    <div class="srchinputwrap" id="divdrpCategory" runat="server" visible="false">
                    ...
                    <div class="srchinputwrap srchclr btnlinksicon">
                        <asp:LinkButton ID="btnLoad" runat="server" CausesValidation="false" OnClick="btnLoad_Click">
                ...
                <div class="grid_container">
                    <div class="form-section-row" style="margin-bottom: 0 !important;">
                        <cc1:StiWebViewer ID="StiWebViewerTicket" Height="800px" RequestTimeout="20000" runat="server" CacheMode="None" ViewMode="Continuous" ScrollbarsMode="true"
                            OnGetReport="StiWebViewerTicket_GetReport" OnGetReportData="StiWebViewerTicket_GetReportData" Visible="true" />
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Ticket List Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
