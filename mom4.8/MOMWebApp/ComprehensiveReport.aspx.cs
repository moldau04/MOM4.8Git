...
public partial class ComprehensiveReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    StiWebViewerComprehensiveReport.Visible = true;
                }
                ...
                GetSMTPUser();
                SetAddress();
                string FileName = "ComprehensiveReport.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "ComprehensiveReport.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=ComprehensiveReport.pdf");
    ...
    private StiReport LoadReport() 
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/ComprehensiveReport.mrt");
            ...
            DataSet ds = objBL_Contracts.GetComprehensiveReport(objPropContracts, null, null, null);
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "Comprehensive Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Comprehensive Report attached.";
                }
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "ComprehensiveReport.pdf")
                        {
                ...
                mail.FileName = "ComprehensiveReport.pdf";
    ...
    {
        var url = "ComprehensiveReport.aspx?sd=" + txtfromDate.Text + "&ed=" + txtToDate.Text;
    ...
    protected void StiWebViewerComprehensiveReport_GetReport(object sender, StiReportDataEventArgs e)
    {
        e.Report = LoadReport();
    }

    //Report Data Set Event
    protected void StiWebViewerComprehensiveReport_GetReportData(object sender, StiReportDataEventArgs e)
    {
