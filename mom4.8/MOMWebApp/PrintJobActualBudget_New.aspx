<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Mom.master" Inherits="PrintJobActualBudget_New" CodeBehind="PrintJobActualBudget_New.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="mainWindow">
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp;  Project Actual Vs Budget Report</div>
        ...
        <div class="container">
<%--            <div class="srchpane">
                <div class="srchtitle srchtitlecustomwidth" style="padding-top: 15px;">
                    Search for Category where
                </div>
                <div class="srchinputwrap">
                    <telerik:RadComboBox EmptyMessage="Select Category" RenderMode="Auto" ID="ddlcategory" runat="server" CssClass="browser-default selectst dllCategory" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" OnDataBinding="RadComboBox1_DataBinding">
                    </telerik:RadComboBox>
                </div>
            ...
            <div class="grid_container">
                <div class="form-section-row m-b-0">
                    <cc1:StiWebViewer ID="StiWebViewerCustomerCategoryDetailReport" Height="800px" RequestTimeout="20000" CacheMode="None" runat="server" ViewMode="Continuous" ScrollbarsMode="true"
                        OnGetReport="StiWebViewerCustomerCategoryDetailReport_GetReport" />
                </div>
            </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp;  Project Actual Vs Budget Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
                ...
                <div class="srchpane-advanced margin" style="margin: 0 !important;">
                    <div class="srchpaneinner">
                        ...
                        <div class="form-col">
                            <div class="fc-label">
                                <label>
                                    <asp:HyperLink ID="lnkBCC" runat="server"  OnClick="return OpenEmailsSelectionWindow_BCC();" Text="Bcc"></asp:HyperLink>
                                </label>
                            </div>
                            <div class="fc-input">
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        <div class="page-title"><i class="mdi-calender"></i>&nbsp;Project Actual Vs Budget Report</div>
    <div class="btnclosewrap"><a href="Project.aspx"><i class="mdi-content-clear"></i></a></div>
    <iframe id="scheduleiframe" src="PrintJobActualBudget.aspx" width="100%" frameborder="0" scrolling="no" onload="resizeIframe(this)"></iframe>
</asp:Content>
