...
public partial class DrawingsSentNotRcvdBack : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (pubReportId != 0)
            {
                ...
                if (dsGetRptDetails.Tables.Count > 0)
                {
                    ...
                    if (sortBy == "Drawings Technical Sheet Submitted" || sortBy == "Project #" || sortBy == "Drawings Submitted To")
                    {
                        sortBy = "[" + sortBy + "]";
                    }
    ...
    private void GetCustReportFiltersValue()
    {
        ...
        objProp_User.ConnConfig = Session["config"].ToString();
        dsGetCustReportFiltersValue = objBL_ReportsData.GetDrawingsReportFiltersValue(objProp_User);
    ...
    private void GetCustomerDetails()
    {
        try
        {
            ...
            dsGetCustDetails = objBL_ReportsData.GetDrawingsDetails(objProp_User);
            ...
            if (dsGetCustDetails.Tables.Count > 0)
            {
                ...
                dsGetCustDetails.Tables[0].TableName = "Drawing";
    ...
    private void BindGridReport(string[] checkedColumns, string[] selectedFiltersColumns, string[] selectedFiltersValues, string sortBy)
    {
        ...
        {
            query += " FROM vw_DrawingsSentNotRcvdBackReport order by " + sortBy;
        }
        else
        {
            ...
            if (selectedFiltersColumns != null)
            {
                for (int i = 0; i <= selectedFiltersColumns.Count() - 1; i++)
                {
                    ...
                    if (selectedFiltersColumns[i] == "DrawingsTechnicalSheetSubmitted")
                    {
                        selectedFiltersColumns[i] = "Drawings Technical Sheet Submitted";
                    }

                    if (selectedFiltersColumns[i] == "DrawingsSubmitted To")
                    {
                        selectedFiltersColumns[i] = "Drawings Submitted To";
                    }
            ...
            query += " FROM vw_DrawingsSentNotRcvdBackReport where " + filters + " order by " + sortBy;
        }
    ...
    private void GenerateExcelFile()
    {
        try
        {
            ...
            objCustReport.DBName = Session["dbname"].ToString();
            objCustReport.ConnConfig = Session["config"].ToString();
            Session["rptID"] = pubReportId;
            objCustReport.ReportId = (int)Session["rptID"];
            DataSet dsGetHeaderFooterDetail = new DataSet();
            dsGetHeaderFooterDetail = objBL_ReportsData.GetHeaderFooterDetail(objCustReport);
    ...
    public static string GetDrawingPreviewDetails(int reportId, string FilterColumn, string FilterValues, string ColumnWidth, string SortColumn, string DataSortBy)
    {
        try
        {
            DrawingsSentNotRcvdBack _a = new DrawingsSentNotRcvdBack();
            BL_ReportsData objBL_ReportsData = new BL_ReportsData();
            BusinessEntity.User objProp_User = new BusinessEntity.User();
            CustomerReport objCustReport = new CustomerReport();
            DataSet dsCompDetail = new DataSet();
            ...
            if (DataSortBy == "Drawings Technical Sheet Submitted" || DataSortBy == "Project #" || DataSortBy == "Drawings Submitted To")
            {
            ...
            if (selectedFiltersColumns == null)
            {
                query += " FROM vw_DrawingsSentNotRcvdBackReport order by " + DataSortBy;
            }
            else
            {
                string filters = string.Empty;
                if (selectedFiltersColumns != null)
                {
                    for (int i = 0; i <= selectedFiltersColumns.Count() - 1; i++)
                    {
                        ...
                        if (selectedFiltersColumns[i] == "DrawingsSubmittedTo")
                        {
                            selectedFiltersColumns[i] = "Drawings Submitted To";
                        }
                ...
                filters = filters.Substring(0, filters.Length - 4);
                query += " FROM vw_DrawingsSentNotRcvdBackReport where " + filters + " order by " + DataSortBy;
            }
            #endregion
