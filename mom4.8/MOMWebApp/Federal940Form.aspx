<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Mom.master" Inherits="Federal940Form" CodeBehind="Federal940Form.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="mainWindow">
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Fedral 940 Form</div>
        ...
        <div class="container">
            <div class="srchpane">
                        <div class="srchtitle srchtitlecustomwidth p-l-34" style="padding-left: 34px;">
                            Start Date
                        </div>
                        ...
                        <div class="srchtitle srchtitlecustomwidth p-l-15" style="padding-left: 15px;">
                            End Date
                        </div>
                        <div class="srchinputwrap">
            ...
            <div class="grid_container">
                <div class="form-section-row  m-b-0">
                    <cc1:StiWebViewer ID="StiWebViewerFedral940Form" Height="800px" RequestTimeout="20000" CacheMode="None" runat="server" ViewMode="Continuous" ScrollbarsMode="true"
                        OnGetReport="StiWebViewerFedral940Form_GetReport" OnGetReportData="StiWebViewerFedral940Form_GetReportData" Visible="false" />
                </div>
            </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Fedral 940 Form
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
