<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CustomerReportMaster.master" Inherits="JournalListingReport"  Title="" EnableEventValidation="false" Codebehind="JournalListingReport.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script src="js/ReportsJs/JournalReport.js" type="text/javascript"></script>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="pc-title">
                    <ul class="lnklist-header">
                        <li>
                            <asp:Label CssClass="title_text" ID="lblHeader" runat="server">Journal Entry Report Preview</asp:Label></li>
                ...
                <div class="com-cont">
                    <div class="title_bar" style="height: 32px">
                        ...
                        <select style="width: 200px" class="tech" name="tech" id="tech" onchange="showValue(this)">
                            ...
                            Report &nbsp<i class="fa fa-file-text-o" aria-hidden="true"></i></a>
                                    </td>
                                    <td style="padding-left: 2px;">
                                        <%--<asp:Button runat="server" ID="btnSaveReport2" CssClass="myButton" class="fa fa-floppy-o" Text="Save Report"
                                            OnClientClick="btnSaveReport();" OnClick="btnSaveReport2_Click" />--%>
                                        <button runat="server" id="btnSaveReport2" class="myButton" title="Search" onserverclick="btnSaveReport2_Click" onclose="btnSaveReport();" >
                                             Save Report &nbsp<i class="fa fa-floppy-o"></i> 
                                        </button>
                                    </td>
                                    <td style="padding-left: 2px">
                                        <%--<asp:Button ID="btnDeleteReport" runat="server" CssClass="myButton" Text="Delete Report"
                                         ...
                                         <button runat="server" id="btnDeleteReport" class="myButton" title="Delete" onserverclick="btnDeleteReport_Click" onclick="if (!UserDeleteConfirmation()) return false;" >
                                             Delete Report &nbsp<i class="fa fa-trash" aria-hidden="true"></i>
                                        </button>
                                    </td>
                                    <td style="padding-left: 2px;">
                                        <a id="btnCustomizeReport" class="myButton js-open-modal" href="#" data-modal-id="popup">Customize Report &nbsp<i class="fa fa-cogs" aria-hidden="true"></i></a>
                                    </td>
                                    <td style="padding-left: 2px;">
                                        <%--<input id="btnPrint" type="button" value="Print" class="myButton"  />--%>
                                        <a id="btnPrint" class="myButton" href="#">Print &nbsp<i class="fa fa-print"></i> </a>
                                    </td>
                                    <td>
                                    ...
                                    <td style="padding-left: 37px;">
                                        ...
                                        <%--<button runat="server" id="btnClose" class="myButton" title="Close" onserverclick="javascript:window.close()" >
                                             Close &nbsp<i class="fa fa-times" aria-hidden="true"></i> 
                                        </button>--%>
                                    </td>
                                </tr>
                            </table>
                                        ...
                                        <div style="float: left;">
                                            <fieldset style="border-color: #CDCDCD; width: 460px;">
                                                ...
                                                <div id="Div2" style="float: right; margin: 20px; width: 220px;">
                                                    <table id="tblStates" style="display: none">
                                                        <tr>
                                                            <td>States
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <table id="tblState" style="display: none">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <asp:DropDownCheckBoxes ID="drpState" runat="server" AddJQueryReference="false" UseButtons="false"
                                                                    Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblCity" style="display: none">
                                                      ...
                                                      <table id="tblAddress" style="display: none">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <%-- <asp:TextBox ID="txtCity" runat="server" CssClass="register_input_bg" Width="150px"></asp:TextBox>--%>
                                                                <asp:DropDownCheckBoxes ID="drpAddress" CssClass="form-control" runat="server" AddJQueryReference="false" UseButtons="false"
                                                                    Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblTask" style="display: none">
                                                        <tr>
                                                            <td>Task#
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpTask" runat="server" AddJQueryReference="false" UseButtons="false"
                                                                    Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblSubject" style="display: none">
                                                        <tr>
                                                            <td>Subject
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <asp:DropDownCheckBoxes ID="drpSubject" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                    ...
                                                    <table id="tblStatus" style="display: none">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpStatus" runat="server" AddJQueryReference="false"
                                                     ...
                                                     <table id="tblDesc" style="display: none">
                                                        <tr>
                                                            <td>Desc
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpDesc" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false" CssClass="form-control">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblRef" style="display: none">
                                                        <tr>
                                                            <td>Ref
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpRef" runat="server" AddJQueryReference="false" UseButtons="false"
                                                                    Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblAssignedTo" style="display: none">
                                                        <tr>
                                                            <td>AssignedTo
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpAssignedTo" runat="server" AddJQueryReference="false"
                                                    ...
                                                    <table id="tblDate" style="display: none">
                                                        <tr>
                                                            <td>Date
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpDate" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblInternalRef" style="display: none">
                                                        <tr>
                                                            <td>Internal Ref
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpInternalRef" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblAcc" style="display: none">
                                                        <tr>
                                                            <td>Acct#
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpAcc" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblFID" style="display: none">
                                                        <tr>
                                                            <td>FID
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpFID" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblTerms" style="display: none">
                                                        <tr>
                                                            <td>Terms
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpTerms" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblDisc" style="display: none">
                                                        <tr>
                                                            <td>Disc
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpDisc" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblDays" style="display: none">
                                                        <tr>
                                                            <td>#Days
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpDays" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                   ...
                                                   <table id="tblOpps" style="display: none">
                                                        <tr>
                                                            <td>#Opps
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpOpps" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                       ...
                                                       <table id="tblDBank" style="display: none">
                                                        <tr>
                                                            <td>DBank
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpDBank" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                       ...
                                                       <table id="tblOnePer" style="display: none">
                                                        <tr>
                                                            <td>OnePer
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpOnePer" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblCustom1" style="display: none">
                                                        <tr>
                                                            <td>Custom1
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpCustom1" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblCustom2" style="display: none">
                                                        <tr>
                                                            <td>Custom2
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpCustom2" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblCustom3" style="display: none">
                                                        <tr>
                                                            <td>Custom3
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpCustom3" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblCustom4" style="display: none">
                                                        <tr>
                                                            <td>Custom4
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpCustom4" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblCustom5" style="display: none">
                                                        <tr>
                                                            <td>Custom5
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpCustom5" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblCustom6" style="display: none">
                                                        <tr>
                                                            <td>Custom6
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpCustom6" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblCustom7" style="display: none">
                                                        <tr>
                                                            <td>Custom7
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpCustom7" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblCustom8" style="display: none">
                                                        <tr>
                                                            <td>Custom8
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpCustom8" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblCustom9" style="display: none">
                                                        <tr>
                                                            <td>Custom9
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpCustom9" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblCustom10" style="display: none">
                                                        <tr>
                                                            <td>Custom10
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpCustom10" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblQuotedPrice" style="display: none">
                                                        <tr>
                                                            <td colspan="4">Quoted Price
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>&nbsp;
                                                        ...
                                                        <tr>
                                                            <td colspan="4">
                                                                <asp:RadioButton ID="rdbQPAny" runat="server" GroupName="QuotedPrice" Text="Any" CssClass="ListControl" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbQPEqual" runat="server" Width="40px" GroupName="QuotedPrice" Text="="
                                                                    CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtQPEqual" runat="server" CssClass="form-control" Width="80px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbQPLessAndEqual" runat="server" Width="40px" GroupName="QuotedPrice"
                                                                    Text="&lt;=" CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtQPLessAndEqual" runat="server" CssClass="form-control"
                                                                    Width="80px"></asp:TextBox>
                                                                <span style="padding-left: 10px;">and</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbQPGreaterAndEqual" runat="server" Width="40px" GroupName="QuotedPrice"
                                                                    Text="&gt;=" CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtQPGreaterAndEqual" runat="server" CssClass="form-control"
                                                                    Width="80px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>

                                                    <table id="tblEstimatePrice" style="display: none">
                                                        <tr>
                                                            <td colspan="4">Estimate Price
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>&nbsp;
                                                        ...
                                                        <tr>
                                                            <td colspan="4">
                                                                <asp:RadioButton ID="rdbEPAny" runat="server" GroupName="EstimatePrice" Text="Any" CssClass="ListControl" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbEPEqual" runat="server" Width="40px" GroupName="EstimatePrice" Text="="
                                                                    CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtEPEqual" runat="server" CssClass="form-control" Width="80px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbEPLessAndEqual" runat="server" Width="40px" GroupName="EstimatePrice"
                                                                    Text="&lt;=" CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtEPLessAndEqual" runat="server" CssClass="form-control"
                                                                    Width="80px"></asp:TextBox>
                                                                <span style="padding-left: 10px;">and</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbEPGreaterAndEqual" runat="server" Width="40px" GroupName="EstimatePrice"
                                                                    Text="&gt;=" CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtEPGreaterAndEqual" runat="server" CssClass="form-control"
                                                                    Width="80px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
