<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="TaskSummaryReport" CodeBehind="TaskSummaryReport.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Task Summary Report</div>
            ...
            <div class="row">
                <div class="grid_container">
                    <div class="form-section-row">
                        <cc1:StiWebViewer ID="StiWebViewerTaskSummary" Height="800px" runat="server" ScrollbarsMode="true" ViewMode="Continuous" CacheMode="None" BackgroundColor="White"
                            OnGetReport="StiWebViewerTaskSummary_GetReport" OnGetReportData="StiWebViewerTaskSummary_GetReportData" RequestTimeout="9000000" />
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Task Summary Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
