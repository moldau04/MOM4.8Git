...
public partial class TelerikMaster : System.Web.UI.MasterPage
{
    ...
    private void SetSelectedRecord()
    {
        for (int i = 0; i < gvCompany.Rows.Count; i++)
        {
            RadioButton rb = (RadioButton)gvCompany.Rows[i].Cells[1]
                                            .FindControl("rbDefaultCompany");
            if (rb != null)
            {
                HiddenField hf = (HiddenField)gvCompany.Rows[i]
                                    .Cells[1].FindControl("hdnDefaultCompanyID");
    ...
    private void GetDefaultCompanySelected()
    {
        for (int i = 0; i < gvCompany.Rows.Count; i++)
        {
            ...
            CheckBox chk = (CheckBox)gvCompany.Rows[i].Cells[0].FindControl("chkSelect");
            if (rb != null)
            {
                HiddenField hf = (HiddenField)gvCompany.Rows[i]
                                    .Cells[1].FindControl("hdnDefaultCompanyID");
