...
namespace MOMWebApp
{
    public partial class UnitInspectedTrimNotCompleteReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                GetSMTPUser();
                SetAddress();
                string FileName = "UnitInspectedTrimNotCompleteReport.pdf";
        ...
        protected void StiWebViewerUnitInspectedReport_GetReport(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
        {
            string reportPathStimul = string.Empty;
            reportPathStimul = Server.MapPath("StimulsoftReports/UnitInspectedTrimNotCompleteReport.mrt");
        ...
        protected void StiWebViewerUnitInspectedReport_GetReportData(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
        {
            var report = e.Report;
            try
            {                
                ...
                e.Report.RegData("CompanyDetails", dsC.Tables[0]);

                DataSet ds = new DataSet();
                ds = bL_Report.GetUnitInspectedTrimNotCompleteReport(Session["config"].ToString());

                if (ds != null && ds.Tables.Count > 0)
                {
                    e.Report.RegData("ReportData", ds.Tables[0]);
                }
            }
            catch (Exception ex)
            {
        ...
        private StiReport LoadUnitInspectedReport()
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/UnitInspectedTrimNotCompleteReport.mrt");
        ...
        protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
        {
            if (txtTo.Text.Trim() != string.Empty)
            {
                try
                {
                    ...
                    mail.Title = "Unit Inspected Trim Not Complete Report";
                    ...
                    {
                        mail.Text = "This is report email sent from Mobile Office Manager. Please find the Unit Inspected Trim Not Complete Report attached.";
                    }
                    ...
                    service.ExportTo(LoadUnitInspectedReport(), stream, settings);
                    ...
                    if (ViewState["pathmailatt"] != null)
                    {
                        ...
                        {
                            if (strpath != "UnitInspectedTrimNotCompleteReport.pdf")
                            {
                    ...
                    mail.FileName = "UnitInspectedTrimNotCompleteReport.pdf";
        ...
        private void DownloadDocument(string filePath, string DownloadFileName)
        {
            ...
            {
                if (DownloadFileName == "UnitInspectedTrimNotCompleteReport.pdf")
                {
                    byte[] buffer1 = null;
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=UnitInspectedTrimNotCompleteReport.pdf");
        ...
        private void SetAddress()
        {
            ...
            string mailBody = "Please review the attached Unit Inspected Trim Not Complete Report.";
