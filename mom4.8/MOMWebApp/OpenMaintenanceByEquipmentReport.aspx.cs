...
public partial class OpenMaintenanceByEquipmentReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                GetSMTPUser();
                SetAddress();
                string FileName = "OpenMaintenanceByEquipmentReport.pdf";
    ...
    protected void StiWebViewerOpenMaintenance_GetReport(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
    {
        e.Report = LoadReport();
    }

    protected void StiWebViewerOpenMaintenance_GetReportData(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
    {
    ...
    protected void lnkExcel_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("Content-Disposition", $"attachment;filename=OpenMaintenanceByEquipmentReport.xls");
    ...
    private StiReport LoadReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/OpenMaintenanceByEquipmentReport.mrt");
            ...
            var defaultCategory = objBL_User.getDefaultCategory(objPropUser);
            if (string.IsNullOrEmpty(defaultCategory))
            {
                defaultCategory = "Recurring";
            }

            objPropMapData.ConnConfig = connString;
            var ds = objBL_Report.GetOpenMaintenanceByEquipment(objPropMapData, defaultCategory);
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = $"Open Maintenance by Equipment Report";
                ...
                {
                    mail.Text = $"This is report email sent from Mobile Office Manager. Please find the Open Maintenance by Equipment Report attached.";
                }
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "OpenMaintenanceByEquipmentReport.pdf")
                        {
                ...
                mail.FileName = "OpenMaintenanceByEquipmentReport.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "OpenMaintenanceByEquipmentReport.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", $"attachment;filename=OpenMaintenanceByEquipmentReport.pdf");
    ...
    private void SetAddress()
    {
        ...
        string mailBody = $"Please review the attached Open Maintenance by Equipment Report.";
