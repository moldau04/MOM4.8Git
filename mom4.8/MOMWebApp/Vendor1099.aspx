<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Mom.master" Inherits="Vendor1099" CodeBehind="Vendor1099.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function setCurrency() {
            var text = "$" + parseFloat($("#<%=txt_dollar.ClientID%>").val().toString().replace(/[\$\(\),]/g, '')).toLocaleString("en-US", { minimumFractionDigits: 2 });
            $("#<%=txt_dollar.ClientID%>").val(text);
        }
    </script>
</asp:Content>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Federal 1099</div>
            ...
            <div class="row">
                <div class="srchpane">
                    <div class="srchpaneinnernegate">
                        <div class="srchpaneinner">
                            <label for="">Gross proceeds paid in excessive of or equal to:</label>
                            <asp:TextBox ID="txt_dollar" runat="server" CssClass="aligntext" Height="25px" Width="130px"
                                onchange="setCurrency();" onkeypress="return isNumberKey(event)" Text="0"></asp:TextBox>
                            <asp:TextBoxWatermarkExtender ID="txtWM_dollar" runat="server" WatermarkText="$0.00"
                                TargetControlID="txt_dollar">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    ...
                                    <div class="srchinputwrap">
                                        <asp:TextBox ID="txtStartDate" runat="server" CssClass="form-control" Height="30px"
                                    ...
                                    <div class="srchinputwrap">
                                        <asp:TextBox ID="txtEndDate" runat="server" CssClass="form-control" Height="30px"
                ...
                <div class="grid_container">
                    <div class="form-section-row">
                        <cc1:StiWebViewer ID="StiWebViewerFederal" Height="800px" runat="server" ScrollbarsMode="true" ViewMode="Continuous" CacheMode="None" BackgroundColor="White"
                            OnGetReport="StiWebViewerFederal_GetReport" OnGetReportData="StiWebViewerFederal_GetReportData" RequestTimeout="9000000" />
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Federal 1099
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
