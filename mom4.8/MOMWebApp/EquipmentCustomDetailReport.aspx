<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="EquipmentCustomDetailReport" CodeBehind="EquipmentCustomDetailReport.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Equipmet Custom Detail Report </div>
            ...
            <div class="row">
                <div class="grid_container">
                    <div class="form-section-row m-b-0">
                        <cc1:StiWebViewer ID="StiWebViewerEquipmentCustomDetailReport" Height="800px" runat="server" ScrollbarsMode="true" ViewMode="Continuous" CacheMode="None" BackgroundColor="White"
                            OnGetReport="StiWebViewerEquipmentCustomDetailReport_GetReport" OnGetReportData="StiWebViewerEquipmentCustomDetailReport_GetReportData" RequestTimeout="9000000" />
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Equipment Custom Detail Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
