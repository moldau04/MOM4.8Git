...
public partial class ARAgingReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                GetSMTPUser();
                SetAddress();
                string FileName = "ARAgingReport.pdf";
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        var url = "ARAgingReport.aspx?stype=" + ddlType.SelectedValue + "&sdate=" + txtSearchDate.Text + "&type=" + type + "&pHide=" + chkHidePartial.Checked + "&inclNotes=" + chkIncludeNotes.Checked + "&creditFlag=" + chkCreditFlag.Checked + "&showRetainage=" + chkRetainageAmount.Checked;
    ...
    protected void rdExpCollAll_CheckedChanged(object sender, EventArgs e)
    {
        ...
        var url = "ARAgingReport.aspx?stype=" + ddlType.SelectedValue + "&sdate=" + txtSearchDate.Text + "&type=" + type + "&pHide=" + chkHidePartial.Checked + "&inclNotes=" + chkIncludeNotes.Checked + "&creditFlag=" + "&showRetainage=" + chkRetainageAmount.Checked;
    ...
    private StiReport LoadReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/ARAgingReport.mrt");
            ...
            else
            {
                ...
                if (!string.IsNullOrEmpty(Request["type"]) && Request["type"] == "summary")
                {
                    reportPathStimul = Server.MapPath("StimulsoftReports/ARAgingSummaryReport.mrt");
                }
            }
            ...
            {
                ds = objBL_Contracts.GetARAgingByAsOfDate(objContract, creditFlag);
            }
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "AR Aging by Customer Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the AR Aging by Customer Report attached.";
                }
                ...
                mail.FileName = "ARAgingReport.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "ARAgingReport.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=ARAgingReport.pdf");
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached AR Aging by Customer Report.";
