...
public partial class PayrollDeductionSummaryByOtherDeductionReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                GetSMTPUser();
                SetAddress();
                string FileName = "PayrollDeductionSummaryByOtherDeductionReport.pdf";
    ...
    {
        var url = "PayrollDeductionSummaryByOtherDeductionReport.aspx?sd=" + txtfromDate.Text + "&ed=" + txtToDate.Text;
        Response.Redirect(url);
    }

    //Get Report With Data Event
    protected void StiWebViewerPayrollDeductionSummaryByOtherDeductionReport_GetReport(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
    {
    ...
    private StiReport LoadFederal940FormReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/PayrollDeductionSummaryByOtherDeductionReport.mrt");
            ...
            ds = objBL_Report.GetPayrollDeductionSummarybyOtherDeductionReport(objPropContracts);
    ...
    //Report Event
    protected void StiWebViewerPayrollDeductionSummaryByOtherDeductionReport_GetReportData(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
    {
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "Payroll-Deduction Summary By Other Deduction Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Payroll-Deduction Summary By Other Deduction Report attached.";
                }
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "PayrollDeductionSummaryByOtherDeductionReport.pdf")
                        {
                ...
                mail.FileName = "PayrollDeductionSummaryByOtherDeductionReport.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "PayrollDeductionSummaryByOtherDeductionReport.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=PayrollDeductionSummaryByOtherDeductionReport.pdf");
    ...
    private void SetAddress()
    {
        ...
        if (dsC.Tables[0].Rows.Count > 0)
        {
            ...
            string mailBody = "Please review the attached Payroll-Deduction Summary By Other Deduction Report.";
