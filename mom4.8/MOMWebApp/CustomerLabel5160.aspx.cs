...
public partial class CustomerLabel5160 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                GetSMTPUser();
                SetAddress();
                string FileName = "CustomerLabel5160.pdf";
    ...
    {
        Response.Redirect("CustomerLabel5160.aspx?stype=" + ddlCustomerSearch.SelectedValue + "&stext=" + txtCustomerSearch.Text);
    }
    ...
    private StiReport LoadCustomerLabelReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/CustomerLabel5160.mrt");
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "Customer Label 5160 Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Customer Label 5160 Report attached.";
                }
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "CustomerLabel5160.pdf")
                        {
                ...
                mail.FileName = "CustomerLabel5160.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "CustomerLabel5160.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=CustomerLabel5160.pdf");
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached Customer Label 5160 Report.";
