...
public partial class DepositSlipReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                GetSMTPUser();
                SetAddress();
                string FileName = "DepositSlip.pdf";
    ...
    {       
        Response.Redirect("AddDeposit.aspx?id=" + Request.QueryString["uid"]);
    }

    protected void StiWebViewerDepositSlip_GetReport(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
    {
        e.Report = LoadLReport();
    }

    protected void StiWebViewerDepositSlip_GetReportData(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
    {
    ...
    private StiReport LoadLReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/DepositSlipReport.mrt");
            ...
            objReceivePay.DepID = 0;
            if (Request.QueryString["uid"] != null)
            {
                objReceivePay.DepID = Convert.ToInt32(Request.QueryString["uid"]);
            }

            DataSet ds = objBL_Deposit.GetReceivedPaymentByDepSlip(objReceivePay);
            DataSet dtHead = (DataSet)Session["DepositHead"];

            report.RegData("CompanyDetails", companyInfo.Tables[0]);
            report.RegData("DepositSlipHead", dtHead.Tables[0]);
            report.RegData("DepositSlip", ds.Tables[0]);
            report.RegData("GLAccount", ds.Tables[1]);
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "Deposit Slip Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Deposit Slip Report attached.";
                }
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "DepositSlip.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=DepositSlip.pdf");
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached Deposit Slip Report.";
