...
public partial class TicketListPayrollHoursReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            GetSMTPUser();
            SetAddress();
            string FileName = "TicketListPayrollHoursReport.pdf";
    ...
    protected void lnkExportToExcel_Click(object sender, EventArgs e)
    {
        ...
        report = LoadTicketListPayrollHoursReport();
        ...
        Response.AddHeader("Content-Disposition", $"attachment;filename=TicketListPayrollHoursReport.xls");
    ...
    {
        e.Report = LoadTicketListPayrollHoursReport();
    }
    ...
    private StiReport LoadTicketListPayrollHoursReport()
    {
        string reportPathStimul = Server.MapPath("StimulsoftReports/TicketListPayrollHoursReport.mrt");
        ...
        var ds = bL_Report.GetTicketListPayrollHours(objPropMapData, filters);
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "Ticket List Payroll Hours Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Ticket List Payroll Hours Report attached.";
                }
                ...
                System.IO.MemoryStream stream = new System.IO.MemoryStream();
                service.ExportTo(LoadTicketListPayrollHoursReport(), stream, settings);
                buffer1 = stream.ToArray();
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "TicketListPayrollHoursReport.pdf")
                        {
                ...
                mail.FileName = "TicketListPayrollHoursReport.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "TicketListPayrollHoursReport.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=TicketListPayrollHoursReport.pdf");
    ...
    private void SetAddress()
    {
        ...
        if (dsC.Tables[0].Rows.Count > 0)
        {
            ...
            string mailBody = "Please review the attached Ticket List Payroll Hours Report.";
