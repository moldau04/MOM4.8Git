<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="ProjectListingByRouteWithBudgetedHours.aspx.cs" Inherits="ProjectListingByRouteWithBudgetedHours" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <style type="text/css">
        ...
        #ctl00_ContentPlaceHolder1_rcRoute,
        #ctl00_ContentPlaceHolder1_rcRoute .RadComboBoxDropDown.RadComboBoxDropDown_Metro {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <div id="breadcrumbs-wrapper">
                    <header>
                        <div class="col s12 m12 l12">
                            <div class="row">
                                <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Project Listing by Route with Budgeted Hours Report</div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="srchpane">
                    <div class="srchpaneinner">                      
                        ...
                        <div class="srchinputwrap">
                            <telerik:RadComboBox RenderMode="Auto" Skin="Metro" ID="rcRoute" runat="server" Filter="StartsWith" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" Width="300"
                        ...
                        <div class="srchinputwrap">
                            <telerik:RadComboBox RenderMode="Auto" Skin="Metro" ID="rcDepartment" runat="server" Filter="StartsWith" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" Width="200"
                                EmptyMessage="--Select Department--" CssClass="inGrid">
                            </telerik:RadComboBox>
                        </div>

                        <div class="btnlinksicon">
                            <asp:LinkButton ID="btnSearch" runat="server" OnClick="btnSearch_Click" CausesValidation="false" ToolTip="Load Report"><i class="fa fa-refresh"></i></asp:LinkButton>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid_container">
                <div class="form-section-row m-b-0">
                    <cc1:StiWebViewer ID="StiWebViewerProjectListingByRoute" Height="800px" RequestTimeout="20000" runat="server" ViewMode="Continuous" CacheMode="None" ScrollbarsMode="true"
                        OnGetReport="StiWebViewerProjectListingByRoute_GetReport" OnGetReportData="StiWebViewerProjectListingByRoute_GetReportData" Visible="false" />
                </div>
            </div>
    ...
    <div id="dvEmailOpen" style="display: none;">
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Project Listing by Route with Budgeted Hours Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
        ...
        <div class="container mailtitcketcontainer" runat="server" id="pnlCompose">
            <div class="row">
                <div class="srchpane-advanced margin">
                    <div class="srchpaneinner">
                        <div class="form-col">
                            <div class="fc-label">
                                <label>From</label>
