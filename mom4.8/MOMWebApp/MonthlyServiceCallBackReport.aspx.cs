...
public partial class MonthlyServiceCallBackReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                GetSMTPUser();
                SetAddress();
                string FileName = "CompletedServiceCallback.pdf";
    ...
    protected void StiWebViewerMonthlyServiceCallBack_GetReport(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
    {
        e.Report = LoadMonthlyServiceCallBackReport();
    }


    protected void StiWebViewerMonthlyServiceCallBack_GetReportData(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
    {
    ...
    private StiReport LoadMonthlyServiceCallBackReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/MonthlyServiceCallBackReport.mrt");
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "Completed Service Callback Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Completed Service Callback Report attached.";
                }
                ...
                service.ExportTo(LoadMonthlyServiceCallBackReport(), stream, settings);
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "CompletedServiceCallback.pdf")
                        {
                ...
                mail.FileName = "CompletedServiceCallback.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "CompletedServiceCallback.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=CompletedServiceCallback.pdf");
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached Completed Service Callback Report.";
