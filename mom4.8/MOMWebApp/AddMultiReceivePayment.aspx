<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" Inherits="AddMultiReceivePayment" MasterPageFile="~/Mom.master" CodeBehind="AddMultiReceivePayment.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <div class="container row-color-grey">
                        <div class="row">
                            <div class="col s12 m12 l12">
                                <div class="row">
                                    <div class="page-title"><i class="mdi-editor-attach-money"></i>&nbsp;<asp:Label ID="lblHeader" runat="server">Batch Receipt</asp:Label></div>
    ...
    <div class="container">
        <div class="row">
            <div class="srchpane" style="margin-top:0px">
                <div class="srchpaneinner">
                    <div class="srchtitle">
                        Date
                    </div>
                    <div class="srchinputwrap width-r" >
                        <div class="row">
                            <asp:TextBox ID="txtDate" CssClass="datepicker_mom re-width" runat="server" autocomplete="off" Style="height:1.5rem;margin:16px"></asp:TextBox>
                    ...
                    <div class="srchinputwrap create-d" >
        ...
        <div class="row">
            ...
            <div class="srchpane"  style="margin-top:0px">
                <div class="srchpaneinner">
                    ...
                    <div class="srchinputwrap width-r30">
                ...
                <div class="grid_container">
                    <div class="form-section-row mb" >
                        ...
                        <div class="RadGrid RadGrid_Material FormGrid mt-10">
                                    ...
                                    <MasterTableView AutoGenerateColumns="false" AllowFilteringByColumn="false" ShowFooter="True">
                                        <Columns>
                                            ...
                                            <telerik:GridTemplateColumn DataField="OwnerName" SortExpression="loc" AutoPostBackOnFilter="true"
                                                HeaderText="Customer" ShowFilterIcon="false" HeaderStyle-Width="220px" UniqueName="OwnerName">
                                                <ItemTemplate>
                                            ...
                                            <telerik:GridTemplateColumn DataField="loc" SortExpression="loc" AutoPostBackOnFilter="true"
                                                HeaderText="Loc ID" ShowFilterIcon="false"  HeaderStyle-Width="100px" UniqueName="LocID">
                                                <ItemTemplate>
                                            ...
                                            <telerik:GridTemplateColumn DataField="LocationName" SortExpression="loc" AutoPostBackOnFilter="true"
                                                HeaderText="Location" ShowFilterIcon="false"  HeaderStyle-Width="220px"  UniqueName="LocationName">
                                                <ItemTemplate>
                                             ...
                                             <telerik:GridTemplateColumn AllowFiltering="false"  ShowFilterIcon="false"  HeaderText="Check" SortExpression="CheckNumber"  HeaderStyle-Width="100px" UniqueName="CheckNumber">
                                                <ItemTemplate>
                                            ...
                                            <telerik:GridTemplateColumn DataField="Invoice" SortExpression="fDate" 
                                                HeaderText="Invoices" ShowFilterIcon="false"  HeaderStyle-Width="80px" UniqueName="Invoice">
                                                <ItemTemplate>
                                                 
                                                    <div id="ListInvoices"></div>
                                                    <asp:TextBox runat="server" ID="txtInvoice" Width="80" onkeyup="SetContextKey(this)"  onclick="SetContextKey(this)" onblur="UpdateAmount(this)"
                                                        Text='<%# Eval("Invoice")%>'></asp:TextBox>
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>

                                             <telerik:GridTemplateColumn DataField="Amount" AutoPostBackOnFilter="true"   SortExpression="Amount"
                                                HeaderText="Pretax Amount" ShowFilterIcon="false" HeaderStyle-HorizontalAlign="Right"  HeaderStyle-Width="100px" UniqueName="Amount">
                                                <ItemTemplate>
                                              ...
                                              <telerik:GridTemplateColumn DataField="STax" AutoPostBackOnFilter="true"  SortExpression="STax" 
                                                HeaderText="Sales Tax Amount" ShowFilterIcon="false" HeaderStyle-HorizontalAlign="Right"  HeaderStyle-Width="100px" UniqueName="STax">
                                                <ItemTemplate>
                                            ...
                                            <telerik:GridTemplateColumn DataField="Total" SortExpression="Total" AutoPostBackOnFilter="true"
                                                HeaderText="Total Amount" ShowFilterIcon="false" HeaderStyle-Width="100px" HeaderStyle-HorizontalAlign="Right"  UniqueName="Total">
                                                <ItemTemplate>
                                            ...
                                            <telerik:GridTemplateColumn DataField="AmountDue" FooterStyle-HorizontalAlign="Right" SortExpression="AmountDue" AutoPostBackOnFilter="true"
                                                HeaderText="Amount Due" ShowFilterIcon="false" HeaderStyle-HorizontalAlign="Right"  HeaderStyle-Width="100px"  UniqueName="AmountDue">
                                                <ItemTemplate>
                                            ...
                                            <telerik:GridTemplateColumn DataField="paymentAmt" SortExpression="paymentAmt" AutoPostBackOnFilter="true"
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:TextBox ID="txtPAmount" runat="server" MaxLength="15" Text='<%# DataBinder.Eval(Container.DataItem, "paymentAmt", "{0:c}") %>'
                                                        EnableViewState="false"  CssClass="textRightAlign" onkeypress="return isDecimalKey(this,event)" >
                                                    </asp:TextBox>
        ...
        function pageLoad(sender, args) {
            ...
            $("[id*=txtPAmount]").change(function () {   
              // debugger
                ...
                //UpdaeDueAmount(line,Ref,PayAmount,DueAmount)
                ...
                if (countItem == 0) {
                    ...
                    <%--if (find_duplicateInvoice() > 0) {
                        ...
                        if (ValidateLess() == true) {
                            ...
                            if (document.getElementById("Confirm_Value").value == 'Yes') {
