<%@ Page Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="EquipmentQRCodeAvery5163" Title="Equipment QR Code Avery 5163 - Mobile Office Manager" CodeBehind="EquipmentQRCodeAvery5163.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp;Equipment-QR Code Avery 5163 Report</div>
        ...
        <div class="container">
            <div class="srchpane">
                ...
                <div class="srchinputwrap">
                    <asp:DropDownList ID="ddlsortBy" runat="server" CssClass="browser-default"
                        Width="200px" OnSelectedIndexChanged="ddlsortBy_SelectedIndexChanged">
                        <asp:ListItem Value="EquipmentName">Equipment Name</asp:ListItem>
                        <asp:ListItem Value="loc">Route Name</asp:ListItem>
                        <asp:ListItem Value="loc">Location Name</asp:ListItem>
                        <asp:ListItem Value="EquipmentCategory">Equipment Category</asp:ListItem>
                        <asp:ListItem Value="EquipmentType">Equipment Type</asp:ListItem>
                        <asp:ListItem Value="UnitID">Equipment Classification</asp:ListItem>
                    </asp:DropDownList>
                </div>
            ...
            <div class="row">
                <div class="grid_container">
                    <div class="form-section-row" style="margin-bottom: 0 !important;">
                        <cc1:StiWebViewer ID="StiWebViewerQRCode" Height="800px" RequestTimeout="20000" CacheMode="None" runat="server" ViewMode="Continuous" ScrollbarsMode="true"
                            OnGetReport="StiWebViewerQrCodes_GetReport" OnGetReportData="StiWebViewerQrCodes_GetReportData" />
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Equipment-QR Code Avery 5163 Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
                        ...
                        <div class="form-section">
                            <div class="srchpaneinner" style="padding: 20px 20px 0px 20px;">
                                ...
                                <div class="srchinputwrap srchclr btnlinksicon" style="margin-left: -10px; margin-top: -2px;">
                                    <asp:LinkButton ID="lnkSearch" runat="server" CausesValidation="false" ToolTip="Search"><i class="mdi-action-search"></i></asp:LinkButton>
                                </div>
