<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Mom.master" Inherits="ReceivePaymentListReport" Codebehind="ReceivePaymentListReport.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; <asp:Label runat="server" ID="lblTitle">Receive Payment Report</asp:Label></div>
        ...
        <div class="container">
            <div class="grid_container">
                <div class="form-section-row" style="margin-bottom: 0 !important;">
                    <cc1:StiWebViewer ID="StiWebViewerReceivePayment" Height="800px" RequestTimeout="20000" CacheMode="None" runat="server" ViewMode="Continuous" ScrollbarsMode="true"
                        OnGetReport="StiWebViewerReceivePayment_GetReport" OnGetReportData="StiWebViewerReceivePayment_GetReportData" />
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; <asp:Label runat="server" ID="lblEmailTitle">Receive Payment Report</asp:Label>
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
