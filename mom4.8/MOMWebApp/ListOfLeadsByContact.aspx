<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="ListOfLeadsByContact" Codebehind="ListOfLeadsByContact.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Leads by Contact</div>
        ...
        <div class="container">
            <div class="grid_container">
                <div class="form-section-row m-b-0" >
                    <cc1:StiWebViewer ID="StiWebViewerListOfLead" Height="800px" RequestTimeout="20000" CacheMode="None" runat="server" ViewMode="Continuous" ScrollbarsMode="true" 
                        OnGetReport="StiWebViewerListOfLead_GetReport" OnGetReportData="StiWebViewerListOfLead_GetReportData"/>
                </div>
            </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Leads by Contact
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
