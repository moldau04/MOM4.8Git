...
public partial class MonthlyRecurringHoursCategoriesReport : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        var url = "MonthlyRecurringHoursCategoriesReport.aspx?sd=" + txtfromDate.Text + "&ed=" + txtToDate.Text + "&routes=" + HttpUtility.UrlEncode(routes) + "&redirect=" + Request.QueryString["redirect"];
    ...
    {
        string reportPathStimul = Server.MapPath("StimulsoftReports/MonthlyRecurringHoursWithCategoriesReport-TEI.mrt");
        ...
        DataSet ds = bL_Report.GetMonthlyRecurringHoursTEI(objChart, routes, false);
