...
public partial class ListOfLeadsByContact : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                GetSMTPUser();
                SetAddress();
                string FileName = "LeadsByContact.pdf";
    ...
    protected void StiWebViewerListOfLead_GetReport(object sender, StiReportDataEventArgs e)
    {
        e.Report = LoadReport();
    }
    ...
    private StiReport LoadReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/ListLeadsByContactReport.mrt");
            ...
            DataSet ds = objBL_Customer.getProspectByContact(objPropCustomer);
            if (ds != null && ds.Tables.Count > 0)
            {
                report.RegData("ListLeads", ds.Tables[0]);
            }
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "Leads by Contact Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Leads by Contact Report attached.";
                }
                ...
                mail.FileName = "LeadsByContact.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "LeadsByContact.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=LeadsByContact.pdf");
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached Leads by Contact Report.";
