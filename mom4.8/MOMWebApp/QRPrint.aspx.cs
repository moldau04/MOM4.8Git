...
public partial class QRPrint : System.Web.UI.Page
{
    #region Globally
    //Global Defined
    ...
    //    ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("Ticket_dtEquip", dtEquip));
    //    string reportPath = "reports/qrreport.rdlc";
    ...
    private StiReport QrCodeReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/QrCode.mrt");
    ...
    {
        //Response.Redirect("Equipments?f=c");
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "QRCode.pdf")
            {
                byte[] buffer1 = null;
