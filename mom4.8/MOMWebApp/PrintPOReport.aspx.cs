...
public partial class PrintPOReport : System.Web.UI.Page
{
    #region Variable
    ...
    protected void StiWebViewerPO_GetReport(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
    {
        e.Report = LoadPOReport();
    }

    protected void StiWebViewerPO_GetReportData(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
    {
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the PO Report attached.";
                }
                ...
                service.ExportTo(LoadPOReport(), stream, settings);
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "POReport.pdf")
            {
                byte[] buffer1 = null;
    ...
    private StiReport LoadPOReport()
    {
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached PO Report.";
    ...
    private void SetToAddress()
    {
        ...
        #region Set contact's email for To column
        if (string.IsNullOrEmpty(txtTo.Text) && ds.Tables[0].Rows[0]["EMail"] != null)
        {
            txtTo.Text = hdnEmail.Value = ds.Tables[0].Rows[0]["EMail"].ToString();
        }
        #endregion
    }
}