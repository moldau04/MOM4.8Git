<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Mom.master" Inherits="JournalEntryReport" Codebehind="JournalEntryReport.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; <asp:Label runat="server" ID="lblTitle">Journal Entry Report</asp:Label></div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; <asp:Label runat="server" ID="lblEmailTitle">Journal Entry Report</asp:Label>
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
