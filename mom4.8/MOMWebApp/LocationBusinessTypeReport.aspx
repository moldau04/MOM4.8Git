<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Mom.master" Inherits="LocationBusinessTypeReport" Codebehind="LocationBusinessTypeReport.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; <span runat="server" id="pageTitle">Location by Business Type Report</span></div>
        ...
        <div class="container">
            <div class="grid_container">
                <div class="form-section-row" style="margin-bottom: 0 !important;">
                    <cc1:StiWebViewer ID="StiWebViewerLocationBusiness" Height="800px" RequestTimeout="20000" CacheMode="None" runat="server" ViewMode="Continuous" ScrollbarsMode="true"
                        OnGetReport="StiWebViewerLocationBusiness_GetReport" OnGetReportData="StiWebViewerLocationBusiness_GetReportData" />
                </div>
            </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; <span runat="server" id="pageEmailTitle">Location by Business Type Report</span>
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
