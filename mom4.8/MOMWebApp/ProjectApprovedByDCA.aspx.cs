...
public partial class ProjectApprovedByDCA : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            GetSMTPUser();
            SetAddress();
            string FileName = "ProjectApprovedByDCAReport.pdf";
    ...
    {
        e.Report = LoadProjectApprovedByDCAReport();
    }
    ...
    private StiReport LoadProjectApprovedByDCAReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/ProjectApprovedByDCAReport.mrt");
            ...
            var ds = bL_Report.GetJobProjectApprovalDCA(objChart);
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "Project Approved By DCA Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Project Approved By DCA Report attached.";
                }
                ...
                service.ExportTo(LoadProjectApprovedByDCAReport(), stream, settings);
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "ProjectApprovedByDCAReport.pdf")
                        {
                ...
                mail.FileName = "ProjectApprovedByDCAReport.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "ProjectApprovedByDCAReport.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=ProjectApprovedByDCAReport.pdf");
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached Project Approved By DCA Report.";
