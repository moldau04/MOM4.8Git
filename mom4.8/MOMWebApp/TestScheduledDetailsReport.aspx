<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Mom.master" Inherits="TestScheduledDetailsReport" Codebehind="TestScheduledDetailsReport.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Test Scheduled Details Report</div>
                    ...
                    <div class="srchpaneinnernegate">
                        <div class="srchpaneinner">
                            ...
                            <div class="srchinputwrap">
                                <asp:TextBox ID="txtScheduledDate" runat="server" CssClass="form-control" Height="30px"
                                    MaxLength="50" Width="130px" autocomplete="off"></asp:TextBox>
                                <asp:CalendarExtender ID="txtScheduledDate_CalendarExtender" runat="server" Enabled="True"
                                    TargetControlID="txtScheduledDate">
                                </asp:CalendarExtender>
                                <asp:RequiredFieldValidator ID="rfvEndDt"
                                    runat="server" ControlToValidate="txtScheduledDate" Display="None" ErrorMessage="Scheduled date is Required" ValidationGroup="search"
                                    SetFocusOnError="True"></asp:RequiredFieldValidator>
                                <asp:ValidatorCalloutExtender ID="vceEndDt" runat="server" Enabled="True"
                                    PopupPosition="Right" TargetControlID="rfvEndDt" />
                                <asp:RegularExpressionValidator ID="rfvEndDt1" ControlToValidate="txtScheduledDate" ValidationGroup="search"
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Test by Location Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
