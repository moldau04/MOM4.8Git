<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="InventoryReport" CodeBehind="InventoryReport.aspx.cs" %>
    ...
    <div id="mainWindow">
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-assessment"></i>&nbsp;Inventory Report</div>
            ...
            <div class="row">
                <div class="srchpane">
                    <div class="srchpaneinnernegate">
                        ...
                        <div class="btnlinks">
                            <asp:LinkButton ID="lnkSearchOld" runat="server" OnClick="btnSearch_Click" Text="Load"></asp:LinkButton>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="grid_container">
            <div class="form-section-row" style="margin-bottom: 0 !important;">
                <cc1:StiWebViewer ID="StiWebViewerInventory" Height="800px" runat="server" ScrollbarsMode="true" CacheMode="None" ViewMode="Continuous" BackgroundColor="White" RequestTimeout="9000000"
                    OnGetReport="StiWebViewerInventory_GetReport" OnGetReportData="StiWebViewerInventory_GetReportData" Visible="false" />
            </div>
        </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-assessment"></i>&nbsp;Inventory Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
