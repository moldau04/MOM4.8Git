<%@ Page Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" CodeBehind="PayRollCheckReport.aspx.cs" Inherits="PayRollCheckReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="mainWindow">
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Check Report</div>
        ...
        <div class="container">
            <div class="row">
                <div class="srchpane" style="padding: 10px 0px!important">
                    <div class="srchpane" style="padding: 10px 0px!important">
                        <div class="srchtitle srchtitlecustomwidth p-l-15" >
                            Start Date
                        </div>
                        ...
                        <div class="srchinputwrap" style="display: none">
                        ...
                        <div class="srchtitle m-l-15">
                            Employee
                        </div>

                        <%--                        <div class="srchinputwrap">
                            <asp:DropDownList ID="ddlSearchFilter" runat="server" AutoPostBack="false" CssClass="browser-default selectsml selectst" onchange="SelectSearch()"
                                OnSelectedIndexChanged="ddlSearch_SelectedIndexChanged">
                                <asp:ListItem Value="">Select</asp:ListItem>
                                <asp:ListItem Value="e.ID">Employee</asp:ListItem>
                                <asp:ListItem Value="d.ID">Category</asp:ListItem>
                                <asp:ListItem Value="e.fWork">Supervisor</asp:ListItem>

                            </asp:DropDownList>
                        </div>--%>
                        <div class="srchinputwrap">
                            <asp:DropDownList ID="rbEmployee" runat="server" CssClass="browser-default selectst selectsml">
                        ...
                        <div class="srchinputwrap">
                            <telerik:RadComboBox ID="rbDepartment" runat="server" EnableCheckAllItemsCheckBox="true" CheckBoxes="true"
                                EmptyMessage="All" CssClass="browser-default col s12"
                                Sort="Ascending">
                            </telerik:RadComboBox>
                        </div>
                        <div class="srchtitle m-l-15">
                        ...
                        <div class="srchinputwrap">
                            <asp:DropDownList ID="rbSupervisor" runat="server" CssClass="browser-default selectst selectsml" style="width: 132px!important;">
                    ...
                    <div class="grid_container">
                        <div class="form-section-row pmd-card" style="margin-bottom: 0 !important;">
                            <cc1:StiWebViewer ID="StiWebViewerPayrollCheck" Height="800px" RequestTimeout="20000" runat="server" CacheMode="None" Visible="false" ViewMode="Continuous" ScrollbarsMode="true"
                                OnGetReport="StiWebViewerPayrollCheck_GetReport" OnGetReportData="StiWebViewerPayrollCheck_GetReportData" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="dvEmailOpen" style="display: none;">
                                    ...
                                    <div class="col s12 m12 l12">
                                        <div class="row">
                                            <div class="page-title">
                                                <i class="mdi-action-swap-vert-circle"></i>&nbsp; Invoices Weekly Report
                                            </div>
                                            <div class="buttonContainer">
                                                <div class="btnlinks">
            ...
            <div class="container mailtitcketcontainer" runat="server" id="pnlCompose">
                <div class="row">
                    <div class="srchpane-advanced margin" style="margin: 0 !important;">
                        <div class="srchpaneinner">
                            ...
                            <div class="form-col">
                                <div class="fc-label">
                                    <label>
                                        <asp:HyperLink ID="lnkTo" runat="server" class="hyr-css" 
                            ...
                            <div class="form-col">
                                <div class="fc-label">
                                    <label>
                                        <asp:HyperLink ID="lnkCC" runat="server" class="hyr-css"  OnClick="return OpenEmailsSelectionWindow_CC();" Text="Cc"></asp:HyperLink>
                                    </label>
                                </div>
                                <div class="fc-input">
                            ...
                            <div class="form-col">
                                <div class="fc-label">
                                    <label>
                                        <asp:HyperLink ID="lnkBCC" runat="server" class="hyr-css"  OnClick="return OpenEmailsSelectionWindow_BCC();" Text="Bcc"></asp:HyperLink>
                                    </label>
                                </div>
                                <div class="fc-input">
                ...
                <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" UpdateMode="Conditional">
                    <contenttemplate>
                        <div class="form-section">
                            <div class="srchpaneinner srch-css" >
                        ...
                        <div class="form-section-row">
                            <div class="form-section">
                                <div class="input-field col s12">
                                    <div class="form-section-row">
                                        <div class="row">
                                            <div class="input-field col s1 m-t-0" >
                                            ...
                                            <div class="input-field col s11 m-t-n10" >
...
<%--        function SelectSearch() {
            debugger;
            var ddlSearch = $('#<%=ddlSearchFilter.ClientID%>');
            var rbEmployee = $('#<%=rbEmployee.ClientID%>');
            var txtSearch = $('#<%=txtSearch.ClientID%>');
            var rbDepartment = $('#<%=rbDepartment.ClientID%>');
            var rbSupervisor = $('#<%=rbSupervisor.ClientID%>');

            txtSearch.css("display", "none");
            rbEmployee.css("display", "none");
            rbDepartment.css("display", "none");
            rbSupervisor.css("display", "none");
            txtSearch.val('');

            try {
                rbEmployee.get(0).selectedIndex = 0;
                rbDepartment.get(0).selectedIndex = 0;
                rbSupervisor.get(0).selectedIndex = 0;

            } catch (ex) {

            }

            if (ddlSearch.val() == "e.ID") {
                rbEmployee.css("display", "block");
            }
            else if (ddlSearch.val() == "d.ID") {

                rbDepartment.css("display", "block");
            }
            else if (ddlSearch.val() == "e.fWork") {

                rbSupervisor.css("display", "block");
            }
            else {
