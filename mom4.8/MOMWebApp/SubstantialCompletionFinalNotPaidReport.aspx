<%@ Page Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" CodeBehind="SubstantialCompletionFinalNotPaidReport.aspx.cs" Inherits="MOMWebApp.SubstantialCompletionFinalNotPaidReport" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Substantial Completed Final Not Paid Report</div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Substantial Completed Final Not Paid Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
