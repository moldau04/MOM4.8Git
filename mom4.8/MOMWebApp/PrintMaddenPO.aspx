<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/HomeMaster.master" Inherits="PrintMaddenPO" Codebehind="PrintMaddenPO.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="page-content">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="com-cont">
                    <asp:Button runat="server" ID="hiddenTargetControlForModalPopup" Text="Send Email" Width="70px"
                            ...
                            <ContentTemplate>
                                <asp:Panel runat="Server" ID="programmaticPopupDragHandle" Style="cursor: move; background-color: #DDDDDD;">
                                    <div class="model-popup-body">
                                        <asp:Label CssClass="title_text" ID="Label8" runat="server">Email Report</asp:Label>
                                ...
                                <div style="padding: 20px;">
                                    <table style="width: 100%; height:400px">
                                        <tr>
                                            <td>From</td>
                                            <td>
                                                <asp:TextBox ID="txtFrom" CssClass="form-control" runat="server" Width="400px" Enabled="false"></asp:TextBox>
