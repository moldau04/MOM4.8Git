...
public partial class ARAgingReportByTerritory : System.Web.UI.Page
{
    #region Variables
    ...
    protected void StiWebViewerARReport_GetReportData(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
    {
        ...
        try
        {
            ...
            var ds = objBLContracts.GetARAgingByTerritory(objContract, terrs, creditFlag);
    ...
    private void GetARAgingReport()
    {
        try
        {
            ...
            String url = "ARAgingReportByTerritory.aspx?page=invoices&EndDate=" + endDate.ToString("MM/dd/yyyy") + "&Territories=" + territories + "&type=" + type + "&inclNotes=" + chkIncludeNotes.Checked + "&creditFlag=" + chkCreditFlag.Checked;
    ...
    protected void StiWebViewerARReportSummary_GetReport(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
    {
        string reportPathStimul = string.Empty;
        reportPathStimul = Server.MapPath("StimulsoftReports/ARAgingReportByTerritorySummaryReport.mrt");
        StiReport report = new StiReport();
    ...
    protected void StiWebViewerARReportSummary_GetReportData(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
    {
        var report = e.Report;
        try
        {
            ...
            var ds = objBLContracts.GetARAgingByTerritory(objContract, terrs);
    ...
    protected void rdCollapseAll_CheckedChanged(object sender, EventArgs e)
    {
        GetARAgingReport();
    }
