...
public partial class LocationReport : System.Web.UI.Page
{
    ...
    GetLocationDetailsParam _GetLocationDetails = new GetLocationDetailsParam();
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            else
            {
                ...
                GetCustomerDetails();
                GetReportsName(); 
                this.drpReports_SelectedIndexChanged(null, null);               
            }
            //GetPreviewFields();
        }
        reportType = Request.QueryString["type"];
    ...
    private void GetUserEmail()
    {
        ...
        {
            string APINAME = "LocationsAPI/LocationReport_GetUserEmail";
    ...
    private void GetReportDetailByRptId()
    {
        try
        {
            ...
            if (pubReportId != 0)
            {
                ...
                if (IsAPIIntegrationEnable == "YES")
                {
                    string APINAME = "LocationsAPI/LocationReport_GetReportDetailById";
    ...
    {
        DataSet dsGetLocationReportFiltersValue = new DataSet();
        objProp_User.DBName = Session["dbname"].ToString();
        objProp_User.ConnConfig = Session["config"].ToString();
        dsGetLocationReportFiltersValue = objBL_ReportsData.GetLocationReportFiltersValue(objProp_User);

        if (dsGetLocationReportFiltersValue.Tables[0].Rows.Count > 0)
        {
            drpCustomer.DataSource = dsGetLocationReportFiltersValue.Tables[0];
            drpCustomer.DataTextField = "Customer";
            drpCustomer.DataValueField = "Customer";
            drpCustomer.DataBind();
        }
        if (dsGetLocationReportFiltersValue.Tables[1].Rows.Count > 0)
        {
            drpLocation.DataSource = dsGetLocationReportFiltersValue.Tables[1];
            drpLocation.DataTextField = "Location";
            drpLocation.DataValueField = "Location";
            drpLocation.DataBind();
        }

       /* if (dsGetLocationReportFiltersValue.Tables[2].Rows.Count > 0)
        {
            drpBillingAddress.DataSource = dsGetLocationReportFiltersValue.Tables[2];
            drpBillingAddress.DataTextField = "BillingAddress";
            drpBillingAddress.DataValueField = "BillingAddress";
            drpBillingAddress.DataBind();
        }*/

        if (dsGetLocationReportFiltersValue.Tables[2].Rows.Count > 0)
        {
            drpCity.DataSource = dsGetLocationReportFiltersValue.Tables[2];
            drpCity.DataTextField = "City";
            drpCity.DataValueField = "City";
            drpCity.DataBind();
        }

        if (dsGetLocationReportFiltersValue.Tables[3].Rows.Count > 0)
        {
            drpState.DataSource = dsGetLocationReportFiltersValue.Tables[3];
            drpState.DataTextField = "State";
            drpState.DataValueField = "State";
            drpState.DataBind();
        }

        if (dsGetLocationReportFiltersValue.Tables[4].Rows.Count > 0)
        {
            drpZip.DataSource = dsGetLocationReportFiltersValue.Tables[4];
            drpZip.DataTextField = "Zip";
            drpZip.DataValueField = "Zip";
            drpZip.DataBind();
        }

        if (dsGetLocationReportFiltersValue.Tables[5].Rows.Count > 0)
        {
            drpAddress.DataSource = dsGetLocationReportFiltersValue.Tables[5];
            drpAddress.DataTextField = "Address";
            drpAddress.DataValueField = "Address";
            drpAddress.DataBind();
        }

        /*if (dsGetLocationReportFiltersValue.Tables[6].Rows.Count > 0)
        {
            drpProspect.DataSource = dsGetLocationReportFiltersValue.Tables[6];
            drpProspect.DataTextField = "Prospect";
            drpProspect.DataValueField = "Prospect";
            drpProspect.DataBind();
        }*/

        if (dsGetLocationReportFiltersValue.Tables[6].Rows.Count > 0)
        {
            drpLocationSTax.DataSource = dsGetLocationReportFiltersValue.Tables[6];
            drpLocationSTax.DataTextField = "LocationSTax";
            drpLocationSTax.DataValueField = "LocationSTax";
            drpLocationSTax.DataBind();
        }

        if (dsGetLocationReportFiltersValue.Tables[7].Rows.Count > 0)
        {
            drpType.DataSource = dsGetLocationReportFiltersValue.Tables[7];
            drpType.DataTextField = "Type";
            drpType.DataValueField = "Type";
            drpType.DataBind();
        }

        if (dsGetLocationReportFiltersValue.Tables[8].Rows.Count > 0)
        {
            drpTaxDesc.DataSource = dsGetLocationReportFiltersValue.Tables[8];
            drpTaxDesc.DataTextField = "TaxDesc";
            drpTaxDesc.DataValueField = "TaxDesc";
            drpTaxDesc.DataBind();
        }

        if (dsGetLocationReportFiltersValue.Tables[9].Rows.Count > 0)
        {
            drpTaxName.DataSource = dsGetLocationReportFiltersValue.Tables[9];
            drpTaxName.DataTextField = "TaxName";
            drpTaxName.DataValueField = "TaxName";
            drpTaxName.DataBind();
        }

        //if (dsGetLocationReportFiltersValue.Tables[10].Rows.Count > 0)
        //{
        //    drpTaxRate.DataSource = dsGetLocationReportFiltersValue.Tables[10];
        //    drpTaxRate.DataTextField = "TaxRate";
        //    drpTaxRate.DataValueField = "TaxRate";
        //    drpTaxRate.DataBind();
        //}

        if (dsGetLocationReportFiltersValue.Tables[11].Rows.Count > 0)
        {
            drpSalesPerson.DataSource = dsGetLocationReportFiltersValue.Tables[11];
            drpSalesPerson.DataTextField = "SalesPerson";
            drpSalesPerson.DataValueField = "SalesPerson";
            drpSalesPerson.DataBind();
        }

        if (dsGetLocationReportFiltersValue.Tables[12].Rows.Count > 0)
        {
            drpDefaultWorker.DataSource = dsGetLocationReportFiltersValue.Tables[12];
            drpDefaultWorker.DataTextField = "DefaultWorker";
            drpDefaultWorker.DataValueField = "DefaultWorker";
            drpDefaultWorker.DataBind();
        }

        if (dsGetLocationReportFiltersValue.Tables[13].Rows.Count > 0)
        {
            drpAcc.DataSource = dsGetLocationReportFiltersValue.Tables[13];
            drpAcc.DataTextField = "Acct#";
            drpAcc.DataValueField = "Acct#";
            drpAcc.DataBind();
        }

        if (dsGetLocationReportFiltersValue.Tables[14].Rows.Count > 0)
        {
            drpPreferredWorker.DataSource = dsGetLocationReportFiltersValue.Tables[14];
            drpPreferredWorker.DataTextField = "PreferredWorker";
            drpPreferredWorker.DataValueField = "PreferredWorker";
    ...
    private void GetReportsName()
    {
        try
        {
            ...
            if (IsAPIIntegrationEnable == "YES")
            {
                string APINAME = "LocationsAPI/LocationReport_GetDynamicReports";
    ...
    private void GetReportColumnsByRepId()
    {
        try
        {
            ...
            if (pubReportId != 0)
            {
                ...
                if (IsAPIIntegrationEnable == "YES")
                {
                    string APINAME = "LocationsAPI/LocationReport_GetReportColByRepId";
                ...
                if (IsAPIIntegrationEnable == "YES")
                {
                    string APINAME = "LocationsAPI/LocationReport_GetReportFiltersByRepId";
    ...
    private void GetCustomerDetails()
    {
        try
        {
            ...
            _GetLocationDetails.DBName = Session["dbname"].ToString();
            _GetLocationDetails.ConnConfig = Session["config"].ToString();
            ...
            ListGetLocationDetails _lstGetLocationDetails = new ListGetLocationDetails();
            DataSet dsGetCustDetails1 = new DataSet();
            DataSet dsGetCustDetails2 = new DataSet();
            if (IsAPIIntegrationEnable == "YES")
            {
                string APINAME = "LocationsAPI/LocationReport_GetLocationDetails";

                APIResponse _APIResponse = new MOMWebUtility().CallMOMWebAPI(APINAME, _GetLocationDetails, true);

                JavaScriptSerializer serializer = new JavaScriptSerializer();

                serializer.MaxJsonLength = Int32.MaxValue;

                _lstGetLocationDetails = serializer.Deserialize<ListGetLocationDetails>(_APIResponse.ResponseData);

                dsGetCustDetails1 = _lstGetLocationDetails.lstTable1.ToDataSet();
                dsGetCustDetails2 = _lstGetLocationDetails.lstTable2.ToDataSet();
                ...
                dsGetCustDetails.Tables[0].Columns["Acct"].ColumnName = "Acct#";

            }
            else
            {
                dsGetCustDetails = objBL_ReportsData.GetLocationDetails(objProp_User);
            }

            List<UserViewModel> _lstUserViewModel = new List<UserViewModel>();
            if (IsAPIIntegrationEnable == "YES")
            {
                string APINAME = "LocationsAPI/LocationReport_GetAccountSummaryListingDetail";
            ...
            if (dsGetCustDetails.Tables.Count > 0)
            {
                ...
                dsGetCustDetails.Tables[0].TableName = "Location";

                dsGetCustDetails.Tables[1].TableName = "Sales Tax";
    ...
    protected void btnSaveReport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            _insertCustomerReport.Module = "Location";
            ...
            _updateCustomerReport.Module = "Location";
            ...
            if (IsAPIIntegrationEnable == "YES")
            {
                string APINAME = "LocationsAPI/LocationReport_CheckExistingReport";
            ...
            if (hdnReportAction.Value == "Save")
            {
                ...
                if (IsAPIIntegrationEnable == "YES")
                {
                    string APINAME = "LocationsAPI/LocationReport_InsertCustomerReport";
            ...
            else
            {
                if (IsAPIIntegrationEnable == "YES")
                {
                    string APINAME = "LocationsAPI/LocationReport_IsStockReportExist";
                    ...
                    if (returnVal == true)
                    {
                        string APINAME1 = "LocationsAPI/LocationReport_UpdateCustomerReport";
    ...
    protected void btnDeleteReport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (IsAPIIntegrationEnable == "YES")
            {
                string APINAME = "LocationsAPI/LocationReport_DeleteCustomerReport";
    ...
    protected void btnClose_Click(object sender, EventArgs e)
    {
        try
        {
            Response.Redirect("Locations.aspx", false);
        }
        catch
        {
            //
    ...
    private void BindGridReport(string[] checkedColumns, string[] selectedFiltersColumns, string[] selectedFiltersValues, string sortBy)
    {
        ...
        {
            query += " FROM vw_LocationReportDetails order by " + sortBy;
        }
        else
        {
            ...
            query += " FROM vw_LocationReportDetails where " + filters + " order by " + sortBy;
        }
    ...
    private void BindHeaderDetails()
    {
        try
        {
            ...
            if (IsAPIIntegrationEnable == "YES")
            {
                string APINAME = "LocationsAPI/LocationReport_GetHeaderFooterDetail";
    ...
    private void GetGridData(string query)
    {
        try
        {
            ...
            if (IsAPIIntegrationEnable == "YES")
            {
                string APINAME = "LocationsAPI/LocationReport_GetOwners";
    ...
    private void BindReportTable(DataSet dsGetCustDetails)
    {
        try
        {
            ...
            if (IsAPIIntegrationEnable == "YES")
            {
                string APINAME = "LocationsAPI/LocationReport_GetColumnWidthByReportId";
    ...
    private void SaveResizedAndReorderReport()
    {
        try
        {
            ...
            if (IsAPIIntegrationEnable == "YES")
            {
                string APINAME = "LocationsAPI/LocationReport_UpdateCustomerReportResizedWidth";
        ...
        if (dsGetCustomerDetails != null)
        {
            ...
            if (dsGetCustomerDetails.Tables.Count > 0)
            {
                if (dsGetCustomerDetails.Tables[0].Rows.Count > 0)
                {
                    ...
                    string script = String.Format("window.open('LocationReportPreview.aspx');");
    ...
    public static string GetPESLocationPreviewDetails(int reportId, string FilterColumn, string FilterValues, string ColumnWidth, string SortColumn, string DataSortBy)
    {
        try
        {
            LocationReport _a = new LocationReport();
            BL_ReportsData objBL_ReportsData = new BL_ReportsData();
            BusinessEntity.User objProp_User = new BusinessEntity.User();
            CustomerReport objCustReport = new CustomerReport();
            string IsAPIIntegrationEnable = System.Web.Configuration.WebConfigurationManager.AppSettings["IsAPIIntegrationEnable"].Trim();
            ...
            if (selectedFiltersColumns == null)
            {
                query += " FROM vw_LocationReportDetails order by " + DataSortBy;
            }
            else
            {
                string filters = string.Empty;
                ...
                filters = filters.Substring(0, filters.Length - 4);
                query += " FROM vw_LocationReportDetails where " + filters + " order by " + DataSortBy;
            }
            #endregion
