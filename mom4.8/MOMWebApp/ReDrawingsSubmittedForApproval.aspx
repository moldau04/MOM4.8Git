<%@ Page Language="C#" MasterPageFile="~/CustomerReportMaster.master" AutoEventWireup="true" Inherits="ReDrawingsSubmittedForApproval" Title="" EnableEventValidation="false" CodeBehind="ReDrawingsSubmittedForApproval.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script src="js/ReportsJs/ReDrawingsReport.js" type="text/javascript"></script>
    ...
    <style>
        ...
        .menu tr td a:link, div tr td a:visited {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="pc-title">
                    <ul class="lnklist-header">
                        <li>
                            <asp:Label CssClass="title_text" ID="lblHeader" runat="server">Re-Drawings Submitted for Approval</asp:Label></li>
                        <li><a href="<%=ResolveUrl("~/project.aspx") %>" class="icon-closed" data-original-title="Close" title="Close" data-placement="bottom"></a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="com-cont">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <div id="dvBtnEmail">
                                            <ul style="width: auto">
                                                <li class="green" style="position: relative; bottom: 2px;"><span class="">
                                                    <a id="btnEmail" class="myButton button-list" href="#">Email</a>
                                    ...
                                    <td>
                                        <div id="colorNav">
                                            <ul style="width: auto">
                                                <li class="green" style="position: relative; bottom: 2px;"><span class="">
                                                    <a id="btnEmail" class="myButton button-list" href="#">Export</a>
                    ...
                    <div style="margin-left: 5px; padding-top: 20px;" align="center">
                        <div id="dvGridReport" runat="server" style="display: block; overflow: auto;">
                            <br />
                            ...
                            <div style="width: 100%; padding-top: 20px;" align="left">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding-left: 10px;">
                                                                    <asp:ListBox ID="lstColumnSort" runat="server" SelectionMode="Multiple" Height="217px"
                                                                        Width="150px" CssClass="form-control"></asp:ListBox>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                    ...
                                    <td style="padding-left: 10px;">
                                        <div>
                                            <asp:TextBox TextMode="MultiLine" ID="txtBody" runat="server" Width="400px" Height="130px"
                                                Text="This is report email sent from Mobile Office Manager. Please find the Report attached."></asp:TextBox>
                                        </div>
                                    </td>
                                </tr>
                            </table>
    ...
    <div class="clearfix"></div>
    <div class="pnlLoading" style="z-index: 900000; display: none;" id="loading" align="center">
