...
public partial class ARAgingReport360ByLocationType : System.Web.UI.Page
{
    #region Variables
    ...
    GetARAging360ByAsOfDateParam _GetARAging360ByAsOfDate = new GetARAging360ByAsOfDateParam();
    #endregion
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    var loctype = HttpUtility.UrlDecode(Request.QueryString["ltype"].Trim());
                ...
                GetSMTPUser();
                SetAddress();
                string FileName = "ARAgingReport360ByLocationType.pdf";
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        var url = "ARAgingReport360ByLocationType.aspx?sdate=" + txtSearchDate.Text + "&type=" + type + "&ltype=" + HttpUtility.UrlEncode(ltype) + "&inclNotes=" + chkIncludeNotes.Checked + "&creditFlag=" + chkCreditFlag.Checked;
    ...
    private StiReport LoadReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/ARAging360LocationTypeReport.mrt");
            if (!string.IsNullOrEmpty(Request["type"]) && Request["type"] == "summary")
            {
                reportPathStimul = Server.MapPath("StimulsoftReports/ARAging360LocationTypeSummaryReport.mrt");
            }
            ...
            DataSet ds = objBL_Contracts.GetARAging360ByAsOfDate(objContract, creditFlag);
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "AR Aging 360 by Location Type Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the AR Aging 360 by Location Type Report attached.";
                }
                ...
                StiWebViewerARAging.Report = report;
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "ARAgingReport360ByLocationType.pdf")
                        {
                ...
                mail.FileName = "ARAgingReport360ByLocationType.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "ARAgingReport360ByLocationType.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=ARAgingReport360ByLocationType.pdf");
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached AR Aging 360 by Location Type Report.";
