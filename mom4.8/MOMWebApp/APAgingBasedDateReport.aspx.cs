...
public partial class APAgingBasedDateReport : System.Web.UI.Page
{
    #region Variables
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        var url = "APAgingBasedDateReport.aspx?stype=" + ddlInvoice.SelectedValue + "&sdate=" + txtSearchDate.Text + "&type=" + type + "&includeZero=" + includeZero;
    ...
    private StiReport LoadReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/APAgingBasedDateReport.mrt");

            if (!string.IsNullOrEmpty(Request["type"]) && Request["type"] == "summary")
            {
                reportPathStimul = Server.MapPath("StimulsoftReports/APAgingBasedDateSummaryReport.mrt");
            }
            ...
            else
            {
                ...
                ds = objBL_Bills.GetAPAgingByBasedDate(objPJ);
            }
