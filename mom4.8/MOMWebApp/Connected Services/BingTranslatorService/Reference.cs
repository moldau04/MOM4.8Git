...
namespace MOMWebApp.BingTranslatorService {
    ...
    public partial class GetTranslationsResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private MOMWebApp.BingTranslatorService.TranslationMatch[] TranslationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false)]
        public MOMWebApp.BingTranslatorService.TranslationMatch[] Translations {
            get {
    ...
    public interface LanguageService {
        ...
        MOMWebApp.BingTranslatorService.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, MOMWebApp.BingTranslatorService.TranslateOptions options);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslations", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsResponse")]
        System.Threading.Tasks.Task<MOMWebApp.BingTranslatorService.GetTranslationsResponse> GetTranslationsAsync(string appId, string text, string from, string to, int maxTranslations, MOMWebApp.BingTranslatorService.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        void AddTranslationArray(string appId, MOMWebApp.BingTranslatorService.Translation[] translations, string from, string to, MOMWebApp.BingTranslatorService.TranslateOptions options);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        System.Threading.Tasks.Task AddTranslationArrayAsync(string appId, MOMWebApp.BingTranslatorService.Translation[] translations, string from, string to, MOMWebApp.BingTranslatorService.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        MOMWebApp.BingTranslatorService.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, MOMWebApp.BingTranslatorService.TranslateOptions options);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        System.Threading.Tasks.Task<MOMWebApp.BingTranslatorService.GetTranslationsResponse[]> GetTranslationsArrayAsync(string appId, string[] texts, string from, string to, int maxTranslations, MOMWebApp.BingTranslatorService.TranslateOptions options);
        ...
        MOMWebApp.BingTranslatorService.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, MOMWebApp.BingTranslatorService.TranslateOptions options);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/TranslateArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/TranslateArrayResponse")]
        System.Threading.Tasks.Task<MOMWebApp.BingTranslatorService.TranslateArrayResponse[]> TranslateArrayAsync(string appId, string[] texts, string from, string to, MOMWebApp.BingTranslatorService.TranslateOptions options);
        ...
        MOMWebApp.BingTranslatorService.TranslateArray2Response[] TranslateArray2(string appId, string[] texts, string from, string to, MOMWebApp.BingTranslatorService.TranslateOptions options);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/TranslateArray2", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/TranslateArray2Response")]
        System.Threading.Tasks.Task<MOMWebApp.BingTranslatorService.TranslateArray2Response[]> TranslateArray2Async(string appId, string[] texts, string from, string to, MOMWebApp.BingTranslatorService.TranslateOptions options);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LanguageServiceChannel : MOMWebApp.BingTranslatorService.LanguageService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LanguageServiceClient : System.ServiceModel.ClientBase<MOMWebApp.BingTranslatorService.LanguageService>, MOMWebApp.BingTranslatorService.LanguageService {
        ...
        public MOMWebApp.BingTranslatorService.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, MOMWebApp.BingTranslatorService.TranslateOptions options) {
            return base.Channel.GetTranslations(appId, text, from, to, maxTranslations, options);
        }
        
        public System.Threading.Tasks.Task<MOMWebApp.BingTranslatorService.GetTranslationsResponse> GetTranslationsAsync(string appId, string text, string from, string to, int maxTranslations, MOMWebApp.BingTranslatorService.TranslateOptions options) {
        ...
        public void AddTranslationArray(string appId, MOMWebApp.BingTranslatorService.Translation[] translations, string from, string to, MOMWebApp.BingTranslatorService.TranslateOptions options) {
            base.Channel.AddTranslationArray(appId, translations, from, to, options);
        }
        
        public System.Threading.Tasks.Task AddTranslationArrayAsync(string appId, MOMWebApp.BingTranslatorService.Translation[] translations, string from, string to, MOMWebApp.BingTranslatorService.TranslateOptions options) {
            return base.Channel.AddTranslationArrayAsync(appId, translations, from, to, options);
        }
        
        public MOMWebApp.BingTranslatorService.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, MOMWebApp.BingTranslatorService.TranslateOptions options) {
            return base.Channel.GetTranslationsArray(appId, texts, from, to, maxTranslations, options);
        }
        
        public System.Threading.Tasks.Task<MOMWebApp.BingTranslatorService.GetTranslationsResponse[]> GetTranslationsArrayAsync(string appId, string[] texts, string from, string to, int maxTranslations, MOMWebApp.BingTranslatorService.TranslateOptions options) {
        ...
        public MOMWebApp.BingTranslatorService.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, MOMWebApp.BingTranslatorService.TranslateOptions options) {
            return base.Channel.TranslateArray(appId, texts, from, to, options);
        }
        
        public System.Threading.Tasks.Task<MOMWebApp.BingTranslatorService.TranslateArrayResponse[]> TranslateArrayAsync(string appId, string[] texts, string from, string to, MOMWebApp.BingTranslatorService.TranslateOptions options) {
            return base.Channel.TranslateArrayAsync(appId, texts, from, to, options);
        }
        
        public MOMWebApp.BingTranslatorService.TranslateArray2Response[] TranslateArray2(string appId, string[] texts, string from, string to, MOMWebApp.BingTranslatorService.TranslateOptions options) {
            return base.Channel.TranslateArray2(appId, texts, from, to, options);
        }
        
        public System.Threading.Tasks.Task<MOMWebApp.BingTranslatorService.TranslateArray2Response[]> TranslateArray2Async(string appId, string[] texts, string from, string to, MOMWebApp.BingTranslatorService.TranslateOptions options) {
