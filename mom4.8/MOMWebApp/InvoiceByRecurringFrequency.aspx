<%@ Page Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="InvoiceByRecurringFrequency" Codebehind="InvoiceByRecurringFrequency.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Invoice By Recurring Frequency Report</div>
        ...
        <div class="container">
            <div class="row">
                <div class="srchpane">
                    ...
                    <div class="srchtitle srchtitlecustomwidth ser-css2">
                       <asp:Label runat="server" ID="lbCompany">Company</asp:Label> 
                    </div>
                    <div class="srchinputwrap">
                        <asp:DropDownList ID="drpCompany" runat="server" CssClass="browser-default brow-css brow-css" Width="150" style="margin-top: 2px;" />
                    </div>
                ...
                <div class="grid_container">
                    <div class="form-section-row m-b-0">
                        <cc1:StiWebViewer ID="StiWebViewerInvoiceFrequencyReport" Height="800px" RequestTimeout="20000" runat="server" CacheMode="None" ViewMode="Continuous" ScrollbarsMode="true"
                            OnGetReport="StiWebViewerInvoiceFrequencyReport_GetReport" OnGetReportData="StiWebViewerInvoiceFrequencyReport_GetReportData" />
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Invoice By Recurring Frequency Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
                ...
                <div class="srchpane-advanced margin" >
                    <div class="srchpaneinner">
                        ...
                        <div class="form-col">
                            <div class="fc-label">
                                <label>
                                    <asp:HyperLink ID="lnkTo" runat="server" class="hyr-css" OnClick="OpenEmailsSelectionWindow_To();return true;" Text="To"></asp:HyperLink>
                                </label>
                            </div>
                            <div class="fc-input">
