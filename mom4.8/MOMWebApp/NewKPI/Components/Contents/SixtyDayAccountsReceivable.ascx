<%@ Control Language="C#" AutoEventWireup="true" Inherits="NewKPI_Components_Contents_SixtyDayAccountsReceivable" Codebehind="SixtyDayAccountsReceivable.ascx.cs" %>
...
<div class="kpi-card">
    <div class="card-content white white-text" style="min-height: 140px;">
        ...
        <div class="blue-text text-darken-2">
            ...
            <p class="card-stats-title">60+ Accounts Receivable</p>
            <h4 class="card-stats-number"><span ID="CountsSixtyPlus" runat="server"></span>
