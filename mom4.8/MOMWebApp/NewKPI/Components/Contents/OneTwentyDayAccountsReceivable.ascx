<%@ Control Language="C#" AutoEventWireup="true" Inherits="NewKPI_Components_Contents_OneTwentyDayAccountsReceivable" Codebehind="OneTwentyDayAccountsReceivable.ascx.cs" %>
...
<div class="kpi-card">
    <div class="card-content white white-text" style="min-height: 140px;">
        ...
        <div class="blue-text text-darken-2">
            ...
            <p class="card-stats-title">120+ Accounts Receivable</p>
            <h4 class="card-stats-number"><span ID="CountsOneTwentyPlus" runat="server"></span>
