<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/CustomerReportMaster.master" 
    Title="" EnableEventValidation="false" Inherits="LocationReport" Codebehind="LocationReport.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script src="js/ReportsJs/LocationReport.js" type="text/javascript"></script>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="pc-title">
                    <ul class="lnklist-header">
                        <li>
                            <asp:Label CssClass="title_text" ID="lblHeader" runat="server">Location Report Preview</asp:Label></li>
                                                ...
                                                <div id="Div2" style="float: right; margin: 20px; width: 220px;">
                                                   <%-- <table id="tblState" style="display: none">
                                                    ...
                                                    <table id="tblState" style="display: none">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <%-- <asp:TextBox ID="txtCity" runat="server" CssClass="register_input_bg" Width="150px"></asp:TextBox>--%>
                                                                <asp:DropDownCheckBoxes ID="drpState" CssClass="form-control" runat="server" AddJQueryReference="false" UseButtons="false"
                                                                    Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblZip" style="display: none">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <%-- <asp:TextBox ID="txtCity" runat="server" CssClass="register_input_bg" Width="150px"></asp:TextBox>--%>
                                                                <asp:DropDownCheckBoxes ID="drpZip" CssClass="form-control" runat="server" AddJQueryReference="false" UseButtons="false"
                                                                    Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                   ...
                                                   <%-- <table id="tblZip" style="display: none">
                                                    ...
                                                    <table id="tblAddress" style="display: none">
                                                     ...
                                                     <table id="tblTaxDesc" style="display: none">
                                                        <tr>
                                                            <td>TaxDesc
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <%-- <asp:TextBox ID="txtAddress" runat="server" CssClass="register_input_bg" Width="150px"></asp:TextBox>--%>
                                                                <asp:DropDownCheckBoxes ID="drpTaxDesc" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblTaxName" style="display: none">
                                                        <tr>
                                                            <td>TaxName
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <%-- <asp:TextBox ID="txtAddress" runat="server" CssClass="register_input_bg" Width="150px"></asp:TextBox>--%>
                                                                <asp:DropDownCheckBoxes ID="drpTaxName" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                   ...
                                                   <%-- <table id="tblTaxRate" style="display: none">
                                                        <tr>
                                                            <td>TaxRate
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>                                                               
                                                               <%-- <asp:DropDownCheckBoxes ID="drpTaxRate" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblSalesPerson" style="display: none">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <%-- <asp:TextBox ID="txtAddress" runat="server" CssClass="register_input_bg" Width="150px"></asp:TextBox>--%>
                                                                <asp:DropDownCheckBoxes ID="drpSalesPerson" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblDefaultWorker" style="display: none">
                                                        <tr>
                                                            <td>DefaultWorker
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <%-- <asp:TextBox ID="txtAddress" runat="server" CssClass="register_input_bg" Width="150px"></asp:TextBox>--%>
                                                                <asp:DropDownCheckBoxes ID="drpDefaultWorker" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <%-- <asp:TextBox ID="txtAddress" runat="server" CssClass="register_input_bg" Width="150px"></asp:TextBox>--%>
                                                                <asp:DropDownCheckBoxes ID="drpPreferredWorker" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblTaxRate" style="display: none">
                                                        ...
                                                        <tr>
                                                            <td colspan="4">
                                                                <asp:RadioButton ID="rdbTaxRateAny" runat="server" GroupName="TaxRate" Text="Any" CssClass="ListControl" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbTaxRateEqual" runat="server" Width="40px" GroupName="TaxRate" Text="="
                                                                    CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtTaxRateEqual" runat="server" CssClass="form-control" Width="80px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbTaxRateLessAndEqual" runat="server" Width="40px" GroupName="TaxRate"
                                                                    Text="&lt;=" CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtTaxRateLessAndEqual" runat="server" CssClass="form-control"
                                                                    Width="80px"></asp:TextBox>
                                                                <span style="padding-left: 10px;">and</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbTaxRateGreaterAndEqual" runat="server" Width="40px" GroupName="TaxRate"
                                                                    Text="&gt;=" CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtTaxRateGreaterAndEqual" runat="server" CssClass="form-control"
                                                                    Width="80px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    <table id="tblBillingAddress" style="display: none">
                                                        <tr>
                                                            <td>Billing Address
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpBillingAddress" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblProspect" style="display: none">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpProspect" runat="server" CssClass="form-control" AddJQueryReference="false" UseButtons="false"
                                                                    Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
