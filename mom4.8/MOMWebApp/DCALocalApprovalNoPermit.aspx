<%@ Page Language="C#" MasterPageFile="~/CustomerReportMaster.master" AutoEventWireup="true" Inherits="DCALocalApprovalNoPermit" Title="" EnableEventValidation="false" Codebehind="DCALocalApprovalNoPermit.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script src="js/ReportsJs/ApprovalReport.js" type="text/javascript"></script>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="pc-title">
                    <ul class="lnklist-header">
                        <li>
                            <asp:Label CssClass="title_text" ID="lblHeader" runat="server">DCA & Local Approval No Permit Report Preview</asp:Label></li>
                ...
                <div class="com-cont">
                    ...
                    <div style="margin-left: 5px; padding-top: 20px;" align="center">
                        <div id="dvGridReport" runat="server" style="display: none;">
                            <br />
                            <div id="dvHeader" align="left" style="width: 1200px">
