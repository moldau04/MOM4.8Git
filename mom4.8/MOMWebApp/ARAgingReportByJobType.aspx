<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="ARAgingReportByJobType" CodeBehind="ARAgingReportByJobType.aspx.cs" %>
                                    ...
                                    <div class="row">
                                        <div class="col s12 m12 l12">
                                            <div class="row">
                                                ...
                                                <asp:Label CssClass="title_text" ID="lblHeader" runat="server">AR Aging Report By Department</asp:Label>
                                                </div>
            ...
            <div class="row">
                ...
                <div class="grid_container">
                    <cc1:StiWebViewer ID="StiWebViewerARReport" Height="800px" runat="server" ScrollbarsMode="true" RequestTimeout="900000" Zoom="100" BackgroundColor="White"
                        OnGetReport="StiWebViewerARReport_GetReport" OnGetReportData="StiWebViewerARReport_GetReportData" ViewMode="Continuous" Visible="false" />
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="col s12 m12 l12">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; AR Aging Report By Department
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
