<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="ProjectVendorDemandByVendor" CodeBehind="ProjectVendorDemandByVendor.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <style type="text/css">
        ...
        #ctl00_ContentPlaceHolder1_rcVendor{
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Project Vendor Demand by Vendor Report</div>
            ...
            <div class="row">
                <div class="srchpane">
                    ...
                    <div class="srchinputwrap">
                        <telerik:RadComboBox RenderMode="Auto" ID="rcVendor" CssClass="browser-default" DropDownAutoWidth="Enabled" runat="server" Filter="StartsWith" CheckBoxes="true" EnableCheckAllItemsCheckBox="true"
                            EmptyMessage="-- Select --" Skin="Metro" Width="300">
                        </telerik:RadComboBox>
                    </div>
                    <div class="srchtitle srchtitlecustomwidth chkboxsrch">
                        Department
                    </div>
                    <div class="srchinputwrap" style="display: block">
                        <telerik:RadComboBox RenderMode="Auto" ID="rcDepartment" CssClass="browser-default" DropDownAutoWidth="Enabled" runat="server" Filter="StartsWith" CheckBoxes="true" EnableCheckAllItemsCheckBox="true"
                            EmptyMessage="-- Select --" Skin="Metro">
                        </telerik:RadComboBox>
                    </div>
                    <div class="srchinputwrap rdleftmgn">
                        <div class="rdpairing">
                            <asp:CheckBox ID="chkIncludeClose" Text="Include closed PO" runat="server" CssClass="css-checkbox"/>
                        </div>
                    </div>
                ...
                <div class="grid_container">
                    <div class="form-section-row m-b-0" >
                        <cc1:StiWebViewer ID="StiWebViewerProjectVendor" Height="800px" RequestTimeout="200000" runat="server" CacheMode="None" ViewMode="Continuous" ScrollbarsMode="true"
                            OnGetReport="StiWebViewerProjectVendor_GetReport" OnGetReportData="StiWebViewerProjectVendor_GetReportData" Visible="false"/>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Project Vendor Demand by Vendor Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
                ...
                <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" UpdateMode="Conditional">
                    <contenttemplate>
                        <div class="form-section">
                            <div class="srchpaneinner dropdown-css" >
                                <div class="srchtitle  srchtitlecustomwidth">
                                    Search
                                </div>
                                ...
                                <div class="srchinputwrap srchclr btnlinksicon sech-css-v" >
