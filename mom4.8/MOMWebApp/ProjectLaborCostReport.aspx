<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="ProjectLaborCostReport" CodeBehind="ProjectLaborCostReport.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Project Labor Cost Report </div>
                ...
                <div class="srchpane">
                    ...
                    <div class="srchinputwrap srchclr btnlinksicon">
                        <asp:LinkButton ID="btnSearch" runat="server" CausesValidation="false"
                            OnClick="btnSearch_Click1"><i class="mdi-notification-sync"></i></asp:LinkButton>
                    </div>
                </div>
                <div class="grid_container">
                    <div class="form-section-row m-b-0">
                        <cc1:StiWebViewer ID="StiWebViewerProjectLaborCostReport" Height="800px" runat="server" ScrollbarsMode="true" CacheMode="None" BackgroundColor="White"
                            OnGetReport="StiWebViewerProjectLaborCostReport_GetReport" OnGetReportData="StiWebViewerProjectLaborCostReport_GetReportData" RequestTimeout="9000000" />
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Project Labor Cost Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
                                ...
                                <div class="input-field col s12">
                                    <div class="form-section-row">
                                        <div class="row">
                                            ...
                                            <div class="input-field col s1 m-t-0" s>
                                                <div class="srchtitle  srchtitlecustomwidth btnlinks">
