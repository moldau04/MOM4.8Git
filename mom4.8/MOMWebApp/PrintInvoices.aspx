<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMaster.master" AutoEventWireup="true" Inherits="PrintInvoices" Codebehind="PrintInvoices.aspx.cs" %>
    ...
    <div class="page-content">
        ...
        <div class="page-cont-top">
            ...
            <div class="page-bar-right" style="padding:5px;">
              <%--  <asp:LinkButton ID="lnkMailAll" runat="server"
                    OnClick="lnkMailAll_Click">Mail All</asp:LinkButton>--%>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="pc-title">
                    <ul class="lnklist-header">
                      ...
                      <%--  <li><a id="lnkMailReport" onclick="showMailReport();" title="Email Report" class="icon-mail"></a></li>--%>
                    </ul>
                </div>
            </div>
