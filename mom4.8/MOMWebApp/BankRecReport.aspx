<%@ Page Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="BankRecReport" CodeBehind="BankRecReport.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Bank Rec Progress Report</div>
        ...
        <div class="container">
            ...
            <div class="grid_container">
                <div class="form-section-row pmd-card">
                    <cc1:StiWebViewer ID="StiWebViewerBankRecReport" Height="800px" RequestTimeout="20000" CacheMode="None" runat="server" ViewMode="Continuous" ScrollbarsMode="true"
                        OnGetReport="StiWebViewerBankRecReport_GetReport" />
                </div>
            </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Bank Rec Progress Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
