...
public partial class SalesTaxReportSumarryByVendor : System.Web.UI.Page
{
    ...
    {
        string reportPathStimul = Server.MapPath("StimulsoftReports/SalesTaxReportByVendor.mrt");
        if (string.IsNullOrEmpty(Request.QueryString["type"]))
        {
            reportPathStimul = Server.MapPath("StimulsoftReports/SalesTaxReportByVendor.mrt");
        }
        else
        {
            if (Request.QueryString["type"] == "0")
            {
                reportPathStimul = Server.MapPath("StimulsoftReports/SalesTaxReportSummaryByVendor.mrt");
            }
        }
    ...
    protected void StiWebViewerSalesTaxByVendor_GetReportData(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
    {
        ...
        try
        {
            ...
            DataSet ds = objBLInvoices.GetSalesTaxByVendor(objInvoices, isSumarry);
            if (ds != null)
            {
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "Sales Tax Report By Vendor";
                ...
                {
                    mail.Text = "This report is generated from Mobile Office Manager. Please find attached the Sales Tax Report By Vendor.";
                }
                ...
                if (poToPrint != null && poToPrint.Count > 0)
                {
                    ...
                    mail.FileName = "SalesTaxReportByVendor.pdf";
                }
    ...
    public void processSaleTaxReportByVendor()
    {
        try
        {
            ...
            String url = "SalesTaxReportSumarryByVendor.aspx?redirect=Invoices.aspx&type=" + type + "&fromDate=" + fromDate.ToString("MM/dd/yyyy") + "&toDate=" + endDate.ToString("MM/dd/yyyy");
