<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="ARAgingReport" Codebehind="ARAgingReport.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; AR Aging by Customer Report</div>
                ...
                <div class="grid_container">
                    <div class="form-section-row">
                        <cc1:StiWebViewer ID="StiWebViewerARAging" Height="800px" runat="server" ScrollbarsMode="true" ViewMode="Continuous" CacheMode="None" BackgroundColor="White"
                            OnGetReport="StiWebViewerARAging_GetReport" OnGetReportData="StiWebViewerARAging_GetReportData" RequestTimeout="9000000" />
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; AR Aging by Customer Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
                    ...
                    <contenttemplate>
                        <div class="form-section">
                            <div class="srchpaneinner srch-css" >
                                ...
                                <div class="btnlinks btnlinks-cs">
