<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/CustomerReportMaster.master" Inherits="EquipmentReport" Title="" EnableEventValidation="false" Codebehind="EquipmentReport.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script src="js/ReportsJs/EquipmentReport.js" type="text/javascript"></script>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="pc-title">
                    <ul class="lnklist-header">
                        <li>
                            <asp:Label CssClass="title_text" ID="lblHeader" runat="server">Equipment Preview</asp:Label></li>
                                            ...
                                            <fieldset style="border-color: #CDCDCD; width: 460px;">
                                                ...
                                                <div id="Div2" style="float: right; margin: 20px; width: 220px;">
                                                    ...
                                                    <table id="tblContact" style="display: none">
                                                     ...
                                                     <table id="tblLocation" style="display: none">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <asp:DropDownCheckBoxes ID="drpLocation" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                     ...
                                                     <table id="tblOwnerID" style="display: none">
                                                        <tr>
                                                            <td>OwnerID
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <%-- <asp:TextBox ID="txtAddress" runat="server" CssClass="register_input_bg" Width="150px"></asp:TextBox>--%>
                                                                <asp:DropDownCheckBoxes ID="drpOwnerID" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblOwnerName" style="display: none">
                                                        <tr>
                                                            <td>OwnerName
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <%-- <asp:TextBox ID="txtAddress" runat="server" CssClass="register_input_bg" Width="150px"></asp:TextBox>--%>
                                                                <asp:DropDownCheckBoxes ID="drpOwnerName" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblfive_year_Insp_Date" style="display: none">
                                                        <tr>
                                                            <td>Five Year Insp Date
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <%-- <asp:TextBox ID="txtAddress" runat="server" CssClass="register_input_bg" Width="150px"></asp:TextBox>--%>
                                                                <asp:DropDownCheckBoxes ID="drpfive_year_Insp_Date" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblUnique" style="display: none">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <%-- <asp:TextBox ID="txtAddress" runat="server" CssClass="register_input_bg" Width="150px"></asp:TextBox>--%>
                                                                <asp:DropDownCheckBoxes ID="drpUnique" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblannual_Insp_Date" style="display: none">
                                                        <tr>
                                                            <td>Annual Insp Date
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <%-- <asp:TextBox ID="txtAddress" runat="server" CssClass="register_input_bg" Width="150px"></asp:TextBox>--%>
                                                                <asp:DropDownCheckBoxes ID="drpannual_Insp_Date" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblcustomer" style="display: none">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <%-- <asp:TextBox ID="txtAddress" runat="server" CssClass="register_input_bg" Width="150px"></asp:TextBox>--%>
                                                                <asp:DropDownCheckBoxes ID="drpcustomer" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblInspector_Name" style="display: none">
                                                        <tr>
                                                            <td>Inspector Name
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <%-- <asp:TextBox ID="txtAddress" runat="server" CssClass="register_input_bg" Width="150px"></asp:TextBox>--%>
                                                                <asp:DropDownCheckBoxes ID="drpInspector_Name" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblShutdown" style="display: none">
                                                        <tr>
                                                            <td>Shutdown
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownList ID="drpShutdown" runat="server" CssClass="form-control" Width="150px">
                                                                    <asp:ListItem Value="All">All</asp:ListItem>
                                                    ...
                                                    <table id="tblEquipmentState" style="display: none">
                                                     ...
                                                     <table id="tblequipment" style="display: none">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpequipment" runat="server" CssClass="form-control" AddJQueryReference="false" UseButtons="false"
                                                                    Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
