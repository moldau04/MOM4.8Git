...
public partial class ContractListingByRoute : System.Web.UI.Page
{
    ...
    protected void StiWebViewerContractListingByRoute_GetReportData(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
    {
        ...
        try
        {
            ...
            report.Dictionary.Variables["ReportTitle"].Value = "CONTRACT LISTING BY ROUTE WITH CONTRACT HOURS STATIC AND DATE RANGE";
            ...
            var ds = bL_Report.GetContractListingByRoute(objChart, routes, false);
