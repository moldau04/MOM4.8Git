...
public partial class PrintInvoiceRegisterGL : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                GetSMTPUser();
                SetAddress();
                string FileName = "InvoiceRegisterGLReport.pdf";
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        var url = "PrintInvoiceRegisterGL.aspx?sd=" + txtfromDate.Text + "&ed=" + txtToDate.Text + "&type=" + type;
    ...
    private StiReport LoadReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/InvoiceRegisterGLReport.mrt");
            if (!string.IsNullOrEmpty(Request["type"]) && Request["type"] == "summary")
            {
                reportPathStimul = Server.MapPath("StimulsoftReports/InvoiceRegisterGLSummaryReport.mrt");
            }
            ...
            DataSet ds = objBL_Contract.GetARGLReg(objContract);
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "Invoice Register GL Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Invoice Register GL Report attached.";
                }
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "InvoiceRegisterGLReport.pdf")
                        {
                ...
                mail.FileName = "InvoiceRegisterGLReport.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "InvoiceRegisterGLReport.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=InvoiceRegisterGLReport.pdf");
