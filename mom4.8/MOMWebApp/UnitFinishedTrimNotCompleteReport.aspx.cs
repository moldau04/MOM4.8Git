...
namespace MOMWebApp
{
    public partial class UnitFinishedTrimNotCompleteReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                GetSMTPUser();
                SetAddress();
                string FileName = "UnitFinishedTrimNotCompleteReport.pdf";
        ...
        protected void StiWebViewerUnitFinishedReport_GetReport(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
        {
            string reportPathStimul = string.Empty;
            reportPathStimul = Server.MapPath("StimulsoftReports/UnitFinishedTrimNotCompleteReport.mrt");
        ...
        protected void StiWebViewerUnitFinishedReport_GetReportData(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
        {
            var report = e.Report;
            try
            {
                ...
                ds = bL_Report.GetUnitFinishedTrimNotCompleteReport(Session["config"].ToString());
        ...
        private StiReport LoadUnitFinishedReport()
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/UnitFinishedTrimNotCompleteReport.mrt");
        ...
        protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
        {
            if (txtTo.Text.Trim() != string.Empty)
            {
                try
                {
                    ...
                    mail.Title = "Unit Finished Trim Not Complete Report";
                    ...
                    {
                        mail.Text = "This is report email sent from Mobile Office Manager. Please find the Unit Finished Trim Not Complete Report attached.";
                    }
                    ...
                    service.ExportTo(LoadUnitFinishedReport(), stream, settings);
                    ...
                    if (ViewState["pathmailatt"] != null)
                    {
                        ...
                        {
                            if (strpath != "UnitFinishedTrimNotCompleteReport.pdf")
                            {
                    ...
                    mail.FileName = "UnitFinishedTrimNotCompleteReport.pdf";
        ...
        private void DownloadDocument(string filePath, string DownloadFileName)
        {
            ...
            {
                if (DownloadFileName == "UnitFinishedTrimNotCompleteReport.pdf")
                {
                    byte[] buffer1 = null;
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=UnitFinishedTrimNotCompleteReport.pdf");
        ...
        private void SetAddress()
        {
            ...
            string mailBody = "Please review the attached Unit Finished Trim Not Complete Report.";
