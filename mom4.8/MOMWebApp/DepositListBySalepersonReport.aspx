<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="DepositListBySalepersonReport" Codebehind="DepositListBySalepersonReport.aspx.cs" %>
                                    ...
                                    <div class="col s12 m12 l12">
                                        <div class="row">
                                            <div class="page-title">
                                                ...
                                                <asp:Label CssClass="title_text" ID="lblHeader" runat="server">Deposit List with Default Salesperson</asp:Label>
                                            </div>
          ...
          <div class="srchpane">
                <div class="srchtitle srchtitlecustomwidth" style="padding-left: 15px;">
                 ...
                 <div class="srchinputwrap">
                    <asp:TextBox ID="txtFromDate" runat="server" CssClass="srchcstm"
                    ...
                    <asp:RequiredFieldValidator ID="rfvFromDt"
                        runat="server" ControlToValidate="txtFromDate" Display="None" ErrorMessage="From date is Required" ValidationGroup="search"
                        SetFocusOnError="True"></asp:RequiredFieldValidator>
                    <asp:ValidatorCalloutExtender ID="vceFromDt" runat="server" Enabled="True"
                        PopupPosition="Right" TargetControlID="rfvFromDt" />
                    <asp:RegularExpressionValidator ID="rfvFromDt1" ControlToValidate="txtFromDate" ValidationGroup="search"
                    ...
                    <asp:ValidatorCalloutExtender ID="vceFromDt1" runat="server" Enabled="True" PopupPosition="Right"
              ...
              <div class="srchinputwrap" style="float:right">                    
                  <asp:CheckBox ID="chkInc" Text="Include zero amount" runat="server" OnCheckedChanged="chkInc_CheckedChanged" AutoPostBack="false" CssClass="css-checkbox"/>
                ...
                <div class="grid_container">
                    <cc1:StiWebViewer ID="StiWebViewerARReport" Height="800px" runat="server" ScrollbarsMode="true" RequestTimeout="900000" Zoom="100" BackgroundColor="White"
                        OnGetReport="StiWebViewerARReport_GetReport" OnGetReportData="StiWebViewerARReport_GetReportData" ViewMode="Continuous"  Visible="true" CacheMode="None" />
                        ...
                        <div class="col s12 m12 l12">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Deposit List with Default Salesperson
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
