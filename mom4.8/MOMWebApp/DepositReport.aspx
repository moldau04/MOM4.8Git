<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/HomeMaster.master" Inherits="DepositReport" Codebehind="DepositReport.aspx.cs" %>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="pc-title">
                    <ul class="lnklist-header">
                        <li>
                            <asp:Label CssClass="title_text" ID="lblHeader" runat="server">Deposit Report</asp:Label></li>
                    ...
                    <div class="table-scrollable" style="border: none">
                       ...
                       <div class="sc-form">
                        ...
                        <div class="col-lg-12 col-md-12">
                            ...
                            <rsweb:ReportViewer ID="rvDepositReport" runat="server" Width="1300px" Height="1500px"
                                BorderColor="Gray" BorderStyle="None" BorderWidth="1px"
                                AsyncRendering="false" ShowZoomControl="False" OnReportRefresh="rvDepositReport_ReportRefresh">
                            </rsweb:ReportViewer>
                            <div>
