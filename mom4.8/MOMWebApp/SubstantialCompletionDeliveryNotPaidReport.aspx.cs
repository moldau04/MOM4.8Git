...
namespace MOMWebApp
{
    public partial class SubstantialCompletionDeliveryNotPaidReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                GetSMTPUser();
                SetAddress();
                string FileName = "SubstantialCompletionDeliveryNotPaidReport.pdf";
        ...
        protected void StiWebViewerSubstantialCompletedReport_GetReport(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
        {
            string reportPathStimul = string.Empty;
            reportPathStimul = Server.MapPath("StimulsoftReports/SubstantialCompletionDeliveryNotPaidReport.mrt");
        ...
        protected void StiWebViewerSubstantialCompletedReport_GetReportData(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
        {
            var report = e.Report;
            try
            {
                // DataTable dtReportData = ds;
                ...
                ds = bL_Report.GetSubstantialCompletionDeliveryNotPaidReport(Session["config"].ToString());
        ...
        private StiReport LoadSubstantialCompletedReport()
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/SubstantialCompletionDeliveryNotPaidReport.mrt");
        ...
        protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
        {
            if (txtTo.Text.Trim() != string.Empty)
            {
                try
                {
                    ...
                    mail.Title = "Substantial Completed Delivery Not Paid Report";
                    ...
                    {
                        mail.Text = "This is report email sent from Mobile Office Manager. Please find the Substantial Completed Delivery Not Paid Report attached.";
                    }
                    ...
                    service.ExportTo(LoadSubstantialCompletedReport(), stream, settings);
                    ...
                    if (ViewState["pathmailatt"] != null)
                    {
                        ...
                        {
                            if (strpath != "SubstantialCompletionDeliveryNotPaidReport.pdf")
                            {
                    ...
                    mail.FileName = "SubstantialCompletionDeliveryNotPaidReport.pdf";
        ...
        private void DownloadDocument(string filePath, string DownloadFileName)
        {
            ...
            {
                if (DownloadFileName == "SubstantialCompletionDeliveryNotPaidReport.pdf")
                {
                    byte[] buffer1 = null;
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=SubstantialCompletionDeliveryNotPaidReport.pdf");
        ...
        private void SetAddress()
        {
            ...
            string mailBody = "Please review the attached Substantial Completed Delivery Not Paid Report.";
