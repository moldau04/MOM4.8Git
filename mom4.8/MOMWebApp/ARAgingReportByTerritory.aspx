<%@ Page Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" CodeBehind="ARAgingReportByTerritory.aspx.cs" Inherits="ARAgingReportByTerritory" %>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="grid_container">
                ...
                <cc1:StiWebViewer ID="StiWebViewerARReportSummary" Height="800px" runat="server" ScrollbarsMode="true" ViewMode="Continuous" BackgroundColor="White" RequestTimeout="900000"
                    OnGetReport="StiWebViewerARReportSummary_GetReport" OnGetReportData="StiWebViewerARReportSummary_GetReportData" Visible="false" />
            </div>
        </div>
    </div>
