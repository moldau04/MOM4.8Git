<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="TicketReport" CodeBehind="TicketReport.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row" style="height: 40px;">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-communication-contacts"></i>&nbsp; Ticket Report</div>
            ...
            <div class="row">
                <div class="srchpane">
                    <div class="srchinputwrap">
                        <asp:CheckBox ID="chkCoord" Text="Coordinates" runat="server" AutoPostBack="True" OnCheckedChanged="chkCoord_CheckedChanged" CssClass="css-checkbox"
                            ToolTip="Show address on site times." />
                    </div>   
                </div>
                <div class="srchpane">
                    <div class="grid_container">
                        <cc1:StiWebViewer ID="StiWebViewerTicket" Height="800px" RequestTimeout="20000" runat="server" ViewMode="Continuous" ScrollbarsMode="true" CacheMode="None"
                            OnGetReport="StiWebViewerTicket_GetReport" OnGetReportData="StiWebViewerTicket_GetReportData"/>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Ticket Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
