<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="OpenTicketsByMechanicReport" Codebehind="OpenTicketsByMechanicReport.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Open Tickets By Mechanic Report</div>
        ...
        <div class="container">
            <div class="grid_container">
                <div class="form-section-row" style="margin-bottom: 0 !important;">
                    <cc1:StiWebViewer ID="StiWebViewerOpenTicketsByMechanic" Height="800px" RequestTimeout="20000" CacheMode="None" runat="server" ViewMode="Continuous" ScrollbarsMode="true"
                        OnGetReport="StiWebViewerOpenTicketsByMechanic_GetReport" OnGetReportData="StiWebViewerOpenTicketsByMechanic_GetReportData" />
                </div>
            </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Open Tickets By Mechanic Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
