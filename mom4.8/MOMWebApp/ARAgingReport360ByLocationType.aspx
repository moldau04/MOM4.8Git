<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Mom.master" Inherits="ARAgingReport360ByLocationType" CodeBehind="ARAgingReport360ByLocationType.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp;AR Aging 360 by Location Type Report</div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="grid_container">
                    <cc1:StiWebViewer ID="StiWebViewerARAging" Height="800px" runat="server" ScrollbarsMode="true" RequestTimeout="900000" Zoom="100" BackgroundColor="White"
                        OnGetReport="StiWebViewerARAging_GetReport" OnGetReportData="StiWebViewerARAging_GetReportData" CacheMode="None" ViewMode="Continuous" Visible="false" />
                </div>
            </div>
        </div>
        <!-- edit-tab start -->
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; AR Aging 360 by Location Type Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
                ...
                <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" UpdateMode="Conditional">
                    <contenttemplate>
                        ...
                        <div class="form-section-row">
                            <div class="form-section">
                                <div class="input-field col s12">ARAgingReport360ByLocationType
                                    <div class="form-section-row">
                                        <div class="row">
