<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaintenanceEquipmentCountByDate.aspx.cs" MasterPageFile="~/Mom.master" Inherits="MaintenanceEquipmentCountByDate" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Maintenance Equipment Details Report</div>
...
<%--            <div class="row">
                ...
                <div class="srchpane">
                    <div class="srchpaneinner">
                        <div class="srchtitle" style="padding-left: 15px;">
                            ...
                            <telerik:RadComboBox RenderMode="Auto" Skin="Metro" ID="rcRoute" runat="server" Filter="StartsWith" CheckBoxes="true" EnableCheckAllItemsCheckBox="true"
                                EmptyMessage="--Select Route--" CssClass="inGrid" autocomplete="off">
                            </telerik:RadComboBox>
                        </div>
                        <div class="srchinputwrap">
                            <asp:TextBox ID="txtstartrDate" runat="server" TabIndex="1" class="srchcstm datepicker_mom" MaxLength="50" AutoPostBack="false"></asp:TextBox>
                        </div>

                        <div class="btnlinksicon">
                            <asp:LinkButton ID="lnkLoad" runat="server" OnClick="lnkLoad_Click" CausesValidation="false" ToolTip="Load Report"><i class="fa fa-refresh"></i></asp:LinkButton>
                        </div>
                    </div>
                </div>
            </div>--%>
            ...
            <div class="grid_container">
                <div class="form-section-row" style="margin-bottom: 0 !important;">
                    <cc1:StiWebViewer ID="StiWebViewerUnitCount" Height="800px" CacheMode="None" RequestTimeout="20000" runat="server" ViewMode="Continuous" ScrollbarsMode="true"
                        OnGetReport="StiWebViewerUnitCount_GetReport" OnGetReportData="StiWebViewerUnitCount_GetReportData" />
                </div>
            </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Maintenance Equipment Count Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
