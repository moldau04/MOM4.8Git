<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="OpenTicketReportbyRoutes" CodeBehind="OpenTicketReportbyRoutes.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Open Ticket by Routes Report </div>
        ...
        <div class="container">
            <div class="row">
                <div class="srchpane">
                    ...
                    <div class="srchinputwrap">
                        <telerik:RadComboBox EmptyMessage="Select Category" RenderMode="Auto" ID="ddlDefRoute" runat="server" CssClass="browser-default selectst dllCategory" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" OnDataBinding="ddlDefRoute_DataBinding">
                        </telerik:RadComboBox>
                    </div>
                ...
                <div class="grid_container">
                    <div class="form-section-row m-b-0">
                        <cc1:StiWebViewer ID="StiWebViewerOpenTicketbyRoutesReport" Height="800px" runat="server" ScrollbarsMode="true" CacheMode="None" BackgroundColor="White" ViewMode="Continuous"
                            OnGetReport="StiWebViewerOpenTicketbyRoutesReport_GetReport" OnGetReportData="StiWebViewerOpenTicketbyRoutesReport_GetReportData" RequestTimeout="9000000" />
                    </div>
                </div>
            </div>
        </div>
