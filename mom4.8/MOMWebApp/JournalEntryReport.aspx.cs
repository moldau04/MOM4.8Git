...
public partial class JournalEntryReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    lblTitle.Text = "Recurring Entry Report";
                    lblEmailTitle.Text = "Recurring Entry Report";
                }
                else
                {
                    lblTitle.Text = "Journal Entry Report";
                    lblEmailTitle.Text = "Journal Entry Report";
                }

                GetSMTPUser();
                SetAddress();
                string FileName = "JournalEntry.pdf";
    ...
    protected void lnkClose_Click(object sender, EventArgs e)
    {
        ...
        {
            urlString += "addjournalentry.aspx?id=" + Request.QueryString["id"];

            if (Request.QueryString["r"] != null)
            {
                urlString += "&r=" + Request.QueryString["r"];
            }
        }
        else
        {
            urlString += "journalentry?f=c";
        }
    ...
    private StiReport LoadLocationLabelReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/JournalEntryReport.mrt");
            ...
            SetForUpdate(Convert.ToInt32(Request.QueryString["id"]), isRecurring);
            DataTable dt = (DataTable)ViewState["Transactions"];
            DataTable dtHead = (DataTable)ViewState["TransHead"];

            report.RegData("CompanyDetails", companyInfo.Tables[0]);
            report.RegData("JournalEntryHead", dtHead);
            report.RegData("JournalEntry", dt);
            ...
            report.Dictionary.Variables["IsRecurring"].Value = isRecurring.ToString();
    ...
    private void SetForUpdate(int tRef, bool IsRecur = false)
    {
        try
        {
            ...
            DataSet dsGLA = _objBLJournal.GetDataByRef(_objJournal);
            ViewState["TransHead"] = dsGLA.Tables[0];
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "Journal Entry Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Journal Entry Report attached.";
                }
                ...
                mail.FileName = "JournalEntry.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "JournalEntry.pdf")
            {
                byte[] buffer1 = null;
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached Journal Entry Report.";
