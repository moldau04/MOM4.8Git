...
public partial class ARAgingReportByLocationCollection : System.Web.UI.Page
{
    #region Variables
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        var url = "ARAgingReportByLocationCollection.aspx?sdate=" + txtSearchDate.Text + "&type=" + type + "&inclNotes=" + chkIncludeNotes.Checked + "&creditFlag=" + chkCreditFlag.Checked;
