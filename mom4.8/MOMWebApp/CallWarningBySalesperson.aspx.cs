...
public partial class CallWarningBySalesperson : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            GetSMTPUser();
            SetAddress();
            string FileName = "CallWarningBySalespersonReport.pdf";
    ...
    {
        string reportPathStimul = Server.MapPath("StimulsoftReports/CallWarningBySalespersonReport.mrt");
        ...
        var ds = bL_Report.GetCompletedTicketWarning(objPropMapData, filters, false, string.Empty);
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "Call Warning by Salesperson Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Call Warning by Salesperson Report attached.";
                }
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "CallWarningBySalespersonReport.pdf")
                        {
                ...
                mail.FileName = "CallWarningBySalespersonReport.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "CallWarningBySalespersonReport.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=CallWarningBySalespersonReport.pdf");
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached Call Warning by Salesperson Report.";
