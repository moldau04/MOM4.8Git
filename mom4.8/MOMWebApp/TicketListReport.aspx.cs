...
public partial class TicketListReport : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            try
            {
                ...
                sqlquery = GetTickets(string.Empty);
    ...
    private void GetCustReportFiltersValue()
    {
        ...
        objProp_User.ConnConfig = Session["config"].ToString();
        string query = GetTickets(string.Empty);
        dsGetCustReportFiltersValue = objBL_ReportsData.GetTicketReportFiltersValue(query,objProp_User);

        if (dsGetCustReportFiltersValue.Tables[0].Rows.Count > 0)
        {
            //drpCustomername.DataSource = dsGetCustReportFiltersValue.Tables[0];
            drpAssignName.DataSource = dsGetCustReportFiltersValue.Tables[0].DefaultView.ToTable(true,"assignname");
            drpAssignName.DataTextField = "assignname";
            drpAssignName.DataValueField = "assignname";
            drpAssignName.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[0].Rows.Count > 0)
        {
            drpCharge.DataSource = dsGetCustReportFiltersValue.Tables[0].DefaultView.ToTable(true, "charge");
            drpCharge.DataTextField = "charge";
            drpCharge.DataValueField = "charge";
            drpCharge.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[0].Rows.Count > 0)
        {
            drpCustomername.DataSource = dsGetCustReportFiltersValue.Tables[0].DefaultView.ToTable(true, "customername");
        ...
        if (dsGetCustReportFiltersValue.Tables[0].Rows.Count > 0)
        {
            drpCharge.DataSource = dsGetCustReportFiltersValue.Tables[0].DefaultView.ToTable(true, "descres");
            drpDescres.DataTextField = "descres";
            drpDescres.DataValueField = "descres";
            drpDescres.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[0].Rows.Count > 0)
        {
            drpDT.DataSource = dsGetCustReportFiltersValue.Tables[0].DefaultView.ToTable(true, "DT");
            drpDT.DataTextField = "DT";
            drpDT.DataValueField = "DT";
            drpDT.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[0].Rows.Count > 0)
        {
            drpedate.DataSource = dsGetCustReportFiltersValue.Tables[0].DefaultView.ToTable(true, "edate");
            drpedate.DataTextField = "edate";
            drpedate.DataValueField = "edate";
            drpedate.DataBind();
        }

         if (dsGetCustReportFiltersValue.Tables[0].Rows.Count > 0)
        {
            drpexpenses.DataSource = dsGetCustReportFiltersValue.Tables[0].DefaultView.ToTable(true, "expenses");
            drpexpenses.DataTextField = "expenses";
            drpexpenses.DataValueField = "expenses";
            drpexpenses.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[0].Rows.Count > 0)
        {
            drpfDesc.DataSource = dsGetCustReportFiltersValue.Tables[0].DefaultView.ToTable(true, "fDesc");
            drpfDesc.DataTextField = "fDesc";
            drpfDesc.DataValueField = "fDesc";
            drpfDesc.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[0].Rows.Count > 0)
        {
            drpfulladdress.DataSource = dsGetCustReportFiltersValue.Tables[0].DefaultView.ToTable(true, "fulladdress");
            drpfulladdress.DataTextField = "fulladdress";
            drpfulladdress.DataValueField = "fulladdress";
            drpfulladdress.DataBind();
        }

       /* if (dsGetCustReportFiltersValue.Tables[0].Rows.Count > 0)
        {
            drpManuf.DataSource = dsGetCustReportFiltersValue.Tables[0];
            drpManuf.DataTextField = "ID";
            drpManuf.DataValueField = "ID";
            drpManuf.DataBind();
        }*/

        if (dsGetCustReportFiltersValue.Tables[0].Rows.Count > 0)
        {
            drplocname.DataSource = dsGetCustReportFiltersValue.Tables[0].DefaultView.ToTable(true, "locname");
            drplocname.DataTextField = "locname";
            drplocname.DataValueField = "locname";
            drplocname.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[0].Rows.Count > 0)
        {
            drpmanualinvoice.DataSource = dsGetCustReportFiltersValue.Tables[0].DefaultView.ToTable(true, "manualinvoice");
            drpmanualinvoice.DataTextField = "manualinvoice";
            drpmanualinvoice.DataValueField = "manualinvoice";
            drpmanualinvoice.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[0].Rows.Count > 0)
        {
            drpmileage.DataSource = dsGetCustReportFiltersValue.Tables[0].DefaultView.ToTable(true, "mileage");
            drpmileage.DataTextField = "mileage";
            drpmileage.DataValueField = "mileage";
            drpmileage.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[0].Rows.Count > 0)
        {
            drpNT.DataSource = dsGetCustReportFiltersValue.Tables[0].DefaultView.ToTable(true, "NT");
            drpNT.DataTextField = "NT";
            drpNT.DataValueField = "NT";
            drpNT.DataBind();
        }
        if (dsGetCustReportFiltersValue.Tables[0].Rows.Count > 0)
        {
            drpOT.DataSource = dsGetCustReportFiltersValue.Tables[0].DefaultView.ToTable(true, "OT");
            drpOT.DataTextField = "OT";
            drpOT.DataValueField = "OT";
            drpOT.DataBind();
        }
        if (dsGetCustReportFiltersValue.Tables[0].Rows.Count > 0)
        {
            drpphone.DataSource = dsGetCustReportFiltersValue.Tables[0].DefaultView.ToTable(true, "phone");
            drpphone.DataTextField = "phone";
            drpphone.DataValueField = "phone";
            drpphone.DataBind();
        }
        if (dsGetCustReportFiltersValue.Tables[0].Rows.Count > 0)
        {
            drpReg.DataSource = dsGetCustReportFiltersValue.Tables[0].DefaultView.ToTable(true, "Reg");
            drpReg.DataTextField = "Reg";
            drpReg.DataValueField = "Reg";
            drpReg.DataBind();
        }
        if (dsGetCustReportFiltersValue.Tables[0].Rows.Count > 0)
        {
            drpTimeComp.DataSource = dsGetCustReportFiltersValue.Tables[0].DefaultView.ToTable(true, "TimeComp");
            drpTimeComp.DataTextField = "TimeComp";
            drpTimeComp.DataValueField = "TimeComp";
            drpTimeComp.DataBind();
        }
        if (dsGetCustReportFiltersValue.Tables[0].Rows.Count > 0)
        {
            drpTimeRoute.DataSource = dsGetCustReportFiltersValue.Tables[0].DefaultView.ToTable(true, "TimeRoute");
            drpTimeRoute.DataTextField = "TimeRoute";
            drpTimeRoute.DataValueField = "TimeRoute";
            drpTimeRoute.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[0].Rows.Count > 0)
        {
            drpTimeSite.DataSource = dsGetCustReportFiltersValue.Tables[0].DefaultView.ToTable(true, "TimeSite");
            drpTimeSite.DataTextField = "TimeSite";
            drpTimeSite.DataValueField = "TimeSite";
            drpTimeSite.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[0].Rows.Count > 0)
        {
            drpTottime.DataSource = dsGetCustReportFiltersValue.Tables[0].DefaultView.ToTable(true, "Tottime");
            drpTottime.DataTextField = "Tottime";
            drpTottime.DataValueField = "Tottime";
            drpTottime.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[0].Rows.Count > 0)
        {
            drpTT.DataSource = dsGetCustReportFiltersValue.Tables[0].DefaultView.ToTable(true, "TT");
            drpTT.DataTextField = "TT";
            drpTT.DataValueField = "TT";
            drpTT.DataBind();
        }
    }
    ...
    private void GetCustomerDetails()
    {
        try
        {
            ...
            toDate = (string)Session["toDate"];
            sqlquery = GetTickets(string.Empty);           
            string[] SelectedColumns = { "id", "ManualInvoice", "CustomerName", "LocName", "FullAddress", "Phone", "assignname", "Charge", "fdesc", "descres", "edate", "timeroute", "timesite", "timecomp", "reg", "NT", "DT", "OT", "TT", "tottime", "Expenses", "Mileage" };
            ...
            dsGetDetails = objBL_ReportsData.getTicketDetails(objProp_User, sqlquery);
            DataTable dtdetails = new DataTable();
            dtdetails = dsGetDetails.Tables[0];
            dtdetails = dtdetails.DefaultView.ToTable(false, SelectedColumns);
            dsGetCustDetails.Tables.Add(dtdetails);
            ...
            if (dsGetCustDetails.Tables.Count > 0)
            {
                ...
                dsGetCustDetails.Tables[0].TableName = "TicketList";                
    ...
    protected void btnSaveReport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            objCustReport.Module = "TicketList";
    ...
    protected void btnClose_Click(object sender, EventArgs e)
    {
        try
        {
            Response.Redirect("TicketListView.aspx", false);
        }
        catch
        {
            //
    ...
    private void BindGridReport(string[] checkedColumns, string[] selectedFiltersColumns, string[] selectedFiltersValues, string sortBy)
    {
        ...
        //{
        //    query += " FROM vw_TicketListSignatureReport order by " + sortBy;
        //}
        if (selectedFiltersColumns == null)
        {
        ...
        else
        {
            ...
            //    query += " FROM vw_TicketListSignatureReport where " + filters + " order by " + sortBy;
            GsortBy = sortBy;
        }       

        GlobalArray = checkedColumns;
        fromDate = (string)Session["fromDate"];
        toDate = (string)Session["toDate"];
        string query = GetTickets(string.Empty);
        BindHeaderDetails();
    ...
    private void GetGridData(string query)
    {
        try
        {
            ...
            if (dsGetCustDetails.Tables[0].Rows.Count > 0)
            {
                ...
                dttable = dsGetCustDetails.Tables[0];
                dttable = dttable.DefaultView.ToTable(false, GlobalArray);

                if (filters!= string.Empty)
                {
                    DataRow[] drow = dttable.Select(filters, GsortBy);
                    dttable = drow.CopyToDataTable();
                }
                DataSet dst = new DataSet();
                dst.Tables.Add(dttable);
                BindReportTable(dst);
    ...
    public static string GetTicketPreviewDetails(int reportId, string FilterColumn, string FilterValues, string ColumnWidth, string SortColumn, string DataSortBy)
    {
        try
        {
            TicketListReport _a = new TicketListReport();
            BL_ReportsData objBL_ReportsData = new BL_ReportsData();
            BusinessEntity.User objProp_User = new BusinessEntity.User();
            CustomerReport objCustReport = new CustomerReport();
            DataSet dsCompDetail = new DataSet();
            ...
            //if (selectedFiltersColumns == null)
            //{
            //    query += " FROM vw_TicketListSignatureReport order by " + DataSortBy;
            //}
            if (selectedFiltersColumns == null)
            {
            ...
            else
            {
                ...
                filters = filters.Substring(0, filters.Length - 4);
                //query += " FROM vw_TicketListSignatureReport where " + filters + " order by " + DataSortBy;
                GsortBy = sortBy;
            }
            #endregion

           GlobalArray = checkedColumns;
           string fromDate = TicketListReport.fromDate;
           string toDate = TicketListReport.toDate;
            string query = _a.GetTickets(string.Empty);
            ...
            if (dsCustDetails.Tables[0].Rows.Count > 0)
            {
                ...
                dtt = dsCustDetails.Tables[0];
                dtt = dtt.DefaultView.ToTable(false, GlobalArray);

                if (filters != string.Empty)
                {
                    DataRow[] drow = dtt.Select(filters, GsortBy);
                    dtt = drow.CopyToDataTable();
                }

                dsGetCustDetails.Tables.Add(dtt);
    ...
    private string GetTickets(string OrderBy)
    {
        ...
        //Rahil
        query = objBL_MapData.getTicketListSignature(objMapData);      
    ...
    private void SetValues()
    {
       // objMapData.ConnConfig = Session["config"].ToString();
        ...
        {
            objMapData.StartDate = Convert.ToDateTime(fromDate);
        }
        else
        {
        ...
        {
            objMapData.EndDate = Convert.ToDateTime(toDate);
        }
        else
        {
