<%@ Page Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" CodeBehind="SubstantialCompletionDeliveryNotPaidReport.aspx.cs" Inherits="MOMWebApp.SubstantialCompletionDeliveryNotPaidReport" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Substantial Completed Delivery Not Paid Report</div>
            ...
            <div class="row">
                <div class="grid_container">
                    <div class="form-section-row" style="margin-bottom: 0 !important;">
                       <cc1:StiWebViewer ID="StiWebViewerSubstantialCompletedReport" Height="800px" runat="server" ScrollbarsMode="true" CacheMode="None" RequestTimeout="900000" Zoom="100" BackgroundColor="White"
                            OnGetReport="StiWebViewerSubstantialCompletedReport_GetReport" OnGetReportData="StiWebViewerSubstantialCompletedReport_GetReportData" ViewMode="Continuous" />
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Substantial Completed Delivery Not Paid Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
