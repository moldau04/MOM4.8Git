...
public partial class PayrollLiabilityReport : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    txtfromDate.Text = objBL_Contracts.GetPayrollLiabilityMinDate(objPropContracts).ToString("MM/dd/yyyy");
                    txtToDate.Text = DateTime.Now.ToString("MM/dd/yyyy");
                    var url = "PayrollLiabilityReport.aspx?sd=" + txtfromDate.Text + "&ed=" + txtToDate.Text;
                ...
                GetSMTPUser();
                SetAddress();
                string FileName = "PayrollLiabilityReport.pdf";
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "Payroll Liability Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Payroll Liability Report attached.";
                }
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "PayrollLiabilityReport.pdf")
                        {
                ...
                mail.FileName = "PayrollLiabilityReport.pdf";
    ...
    protected void StiWebViewerPayrollLiabilityReport_GetReport(object sender, StiReportDataEventArgs e)
    {
        e.Report = LoadReport();
    }

    //Report Data Set Event
    protected void StiWebViewerPayrollLiabilityReport_GetReportData(object sender, StiReportDataEventArgs e)
    {
    ...
    private void SetAddress()
    {
        ...
        if (dsC.Tables[0].Rows.Count > 0)
        {
            ...
            string mailBody = "Please review the Payroll Liability Report.";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "PayrollLiabilityReport.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=PayrollLiabilityReport.pdf");
    ...
    private StiReport LoadReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/PayrollLiabilityReport.mrt");
            ...
            DataSet ds = objBL_Contracts.GetPayrollLiabilityReport(objPropContracts, null, null, null);
