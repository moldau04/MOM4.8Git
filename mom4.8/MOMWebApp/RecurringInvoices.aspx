<%@ Page Title="Recurring Invoices || MOM" Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="RecurringInvoices" CodeBehind="RecurringInvoices.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                                ...
                                <div class="row">
                                    ...
                                    <div class="buttonContainer">
                                        ...
                                        <ul id="drpMenu" class="nomgn hideMenu menuList">
                                            <li>
                                                <div class="btnlinks btnDeleteContainer mb-4">
    ...
    <div class="container">
        <div class="row">
            <div class="alert alert-warning divAlert text-red" runat="server" id="divSuccess" >
           ...
           <div class="srchpane-advanced">
                <div class="srchpaneinner">
                    ...
                    <div class="srchinputwrap">
                        <asp:DropDownList ID="ddlMonths" runat="server" Width="125px" CssClass="browser-default selectst selectsml ddlMonths"    AutoPostBack="false"></asp:DropDownList>
                    </div>
                    <div class="srchtitle srchtitlecustomwidth pad-le-15">
                        Year
                    </div>
                    <div class="srchinputwrap">
                        <asp:DropDownList ID="ddlYears" runat="server" Width="125px " CssClass="browser-default selectst selectsml ddlYears"   AutoPostBack="false"></asp:DropDownList>
                    </div>
                    <div class="srchtitle srchtitlecustomwidth pad-le-15">
                        Special Notes &nbsp;
                    </div>
                    ...
                    <div class="srchinputwrap srchclr btnlinksicon ml-15">                    

                        <asp:LinkButton ID="LinkButton1" CssClass="submit" runat="server" CausesValidation="false"
                            OnClick="lnkSearch_Click"><i class="mdi-action-search ml" ></i></asp:LinkButton>
                    </div>
                    <div class="srchtitle srchtitlecustomwidth pad-le-15">
                        Customer
                    </div>
                    ...
                    <div class="srchinputwrap">
                        <asp:TextBox ID="txtCustomer" runat="server" autocomplete="off" CssClass="validate srchcstm" Width="266px"></asp:TextBox>
                    ...
                    <div class="form-section-row">
                        ...
                        <div class="form-section-row">
                                    ...
                                    <div class="row">
                                       ...
                                       <%-- <asp:DropDownList ID="ddlTerms" TabIndex="6" runat="server" CssClass="browser-default ddlTerms">
                                            ...
                                            <asp:ListItem Value="9">COD</asp:ListItem>
                                                                                        ...
                                                                                        <%--Terms Dropdown--%>
                                                                                        <asp:DropDownList ID="ddlTerms" runat="server" CssClass="browser-default ddlTerms" AutoPostBack="false"
                                                                                          >
                                                                                        </asp:DropDownList>
                                    </div>
                                </div>
                            ...
                            <div class="form-section3">
                                 <div class="input-field col s2">
                                    <div class="row">
                                        <label for="drpdwn-label" style="top: -12px;" >Taxable</label>
                        ...
                        <div class="input-field col s2" id="divCheckBox" runat="server" style="width: 26.666667%;">
                            <div class="checkrow">
                            ...
                            <div class="input-field col s5 form-section-row ml">
                            </div>
                        </div>

                        <div class="input-field col s2" id="div1" runat="server" style="width: 50%;"> 
                            <div class="checkrow"> 
                               <asp:CheckBox ID="chkIncludeContractRemarks" CssClass="filled-in" AutoPostBack="false" TabIndex="6" runat="server" />
                              <label for="drpdwn-label" runat="server">Include Contract Remarks</label>
                            </div> 
                            </div>
                        <div class="input-field col s12">
                            <div class="row">
                                <asp:TextBox ID="txtRemark" CssClass="textarea-border materialize-textarea txtRemark text-box-css " runat="server" TextMode="MultiLine" style="width:99%"></asp:TextBox>
                                ...
                                <telerik:RadGrid ID="rgRecurringInvoice" runat="server" AutoGenerateColumns="False" Width="100%"
                                    ...
                                    <MasterTableView AutoGenerateColumns="false" AllowFilteringByColumn="True" ShowFooter="True" CanRetrieveAllData="false">
                                        <Columns>
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Invoice#" DataField="InvoiceID" HeaderStyle-Width="100" UniqueName="InvoiceID" SortExpression="InvoiceID" Visible="true" AutoPostBackOnFilter="true" CurrentFilterFunction="EqualTo" ShowFilterIcon="false">
                                                <ItemTemplate>
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Location Name" HeaderStyle-Width="200" UniqueName="locname" DataField="locname" ShowFilterIcon="false" SortExpression="locname" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                                <ItemTemplate>
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Service Type" HeaderStyle-Width="100" SortExpression="servicetype" DataField="servicetype" ShowFilterIcon="false" UniqueName="servicetype" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSvcType" runat="server" Text='<%# Bind("servicetype") %>'></asp:Label>
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>

                                            <telerik:GridTemplateColumn HeaderText="Esc Type" HeaderStyle-Width="100" SortExpression="EscType" DataField="EscType" ShowFilterIcon="false" UniqueName="EscType" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblEscType" runat="server" Text='<%# Bind("EscType") %>'></asp:Label>
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>
                                           ...
                                           <telerik:GridTemplateColumn HeaderText="GST Tax" HeaderStyle-Width="100" SortExpression="GSTTax" FooterAggregateFormatString="{0:c}"  Aggregate="Sum" DataField="GST" UniqueName="GSTTax" ShowFilterIcon="false" AutoPostBackOnFilter="true" CurrentFilterFunction="EqualTo">
                                            <ItemTemplate>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="HST/PST Tax" HeaderStyle-Width="100" SortExpression="stax" FooterAggregateFormatString="{0:c}" Aggregate="Sum" DataField="stax" UniqueName="stax" ShowFilterIcon="false" AutoPostBackOnFilter="true" CurrentFilterFunction="EqualTo">
                                            <ItemTemplate>
                                        ...
                                        <telerik:GridTemplateColumn HeaderText="Invoice Total" HeaderStyle-Width="100" FooterAggregateFormatString="{0:c}" Aggregate="Sum" SortExpression="total" DataField="total" UniqueName="InvoiceTotal" ShowFilterIcon="false" AutoPostBackOnFilter="true" CurrentFilterFunction="EqualTo">
                                            <ItemTemplate>
                                                <asp:Label ID="InvInvoiceTotal" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "total", "{0:c}") %>'></asp:Label>
                                            </ItemTemplate>                                          
                                        </telerik:GridTemplateColumn>

                                                <telerik:GridTemplateColumn HeaderText="Special Notes" ShowFilterIcon="false" HeaderStyle-Width="200" DataField="SRemarks"  SortExpression="SRemarks" UniqueName="SpecialNotes" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSpecialNotes" runat="server" Text='<%# Bind("SRemarks") %>'></asp:Label>
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>
            ...
            <div>
                ...
                <div id="pnlRecurringInv" class="table-subcategory table-css" style="display:none;">
                    <div class="popup_Container">
                        <div class="popup_Body">
                            <div class="model-popup-body model-popup-body-print-invoce" >
                                <asp:Label CssClass="title_text" Style="float: left" ID="lblVoidCheck" runat="server">Print Invoice</asp:Label>

                                <div style="float: right;">
                                    <asp:LinkButton CssClass="save_button save-css" ID="lnkSave"  runat="server" OnClick="lnkSave_Click"
                                    ...
                                    <asp:LinkButton CssClass="save_button save-css" ID="lbtnClose" OnClientClick="cancel();"  runat="server" OnClick="lbtnClose_Click"
                        ...
                        <div>
                            <div class="col-lg-12 col-md-12 start-css">
                                <div class="com-cont">
                                        ...
                                        <div class="form-col">
                                            ...
                                            <div class="fc-input fc-css" >
                                                ...
                                                <div class="form-group">
                                                    <div style="float: left;margin-left: 0px!important;" class="checkrow" >
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#<%=txtRemark.ClientID%>").keyup(function (event) {
                debugger
                replaceQuickCodes(event, '<%=txtRemark.ClientID%>', $("#<%=hdnCon.ClientID%>").val());
            });
        });
    </script>
