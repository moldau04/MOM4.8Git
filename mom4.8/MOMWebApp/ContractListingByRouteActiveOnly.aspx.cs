...
public partial class ContractListingByRouteActiveOnly : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            rcRoute.DataSource = bL_Report.GetContractRoute(objChart);
            rcRoute.DataTextField = "Name";
            rcRoute.DataValueField = "ID";
            rcRoute.DataBind();
    ...
    {
        string reportPathStimul = Server.MapPath("StimulsoftReports/ContractListingByRouteReport.mrt");
    ...
    protected void StiWebViewerContractListingByRoute_GetReportData(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
    {
        ...
        try
        {
            ...
            report.Dictionary.Variables["ReportTitle"].Value = "CONTRACT LISTING BY ROUTE WITH CONTRACT HOURS STATIC AND DATE RANGE ACTIVE ONLY";
            ...
            var ds = bL_Report.GetContractListingByRoute(objChart, routes, true);
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Contract Listing by Route Active Only Report attached.";
                }
                ...
                if (poToPrint != null && poToPrint.Count > 0)
                {
                    ...
                    mail.FileName = "ContractListingByRouteActiveOnly.pdf";
                }
    ...
    private List<byte[]> PrintTemplate(StiWebViewer rvTemplate)
    {
        ...
        try
        {
            ...
            reportPathStimul = Server.MapPath("StimulsoftReports/ContractListingByRouteReport.mrt");
            StiReport report = new StiReport();
            report.Load(reportPathStimul);
            //report.Compile();
