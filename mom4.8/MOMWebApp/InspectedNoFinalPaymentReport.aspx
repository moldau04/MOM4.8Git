<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CustomerReportMaster.master" Inherits="InspectedNoFinalPaymentReport" Title="" EnableEventValidation="false" Codebehind="InspectedNoFinalPaymentReport.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script src="js/ReportsJs/InspectedPaymentReport.js" type="text/javascript"></script>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="pc-title">
                    <ul class="lnklist-header">
                        <li>
                            <asp:Label CssClass="title_text" ID="lblHeader" runat="server">Inspected No Final Payment Report Preview</asp:Label></li>
