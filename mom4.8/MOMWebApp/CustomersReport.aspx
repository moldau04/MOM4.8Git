<%@ Page Language="C#" MasterPageFile="~/CustomerReportMaster.master" AutoEventWireup="true" Inherits="CustomersReport" Title="" EnableEventValidation="false" Codebehind="CustomersReport.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12">
                <div class="com-cont">
                                ...
                                <tr>
                                        ...
                                        <%-- <div id="dvBtnEmail">
                                            <ul style="width: 66px">
                                                <li class="green" style="position: relative;"><span class="">
                                                    <img src="images/email_btn.png" height="23px" style=" ;" />
                                                    <div id="dvEmail" style="left: 90%">
                                    ...
                                    <td>
                                        <%-- <div id="colorNav">
                                            <ul style="width: 66px">
                                                <li class="green" style="position: relative;"><span class="">
                                                    <img src="images/export_btn.png" height="23px"   />
                                                    <div id="dynamic-div" style="left: 90%">
                                                        <ul id="dynamicUI" style="">
                                                        </ul>
                                                    </div>
                    ...
                    <div class="main-header-css"  align="center">
                        ...
                        <div id="dvGridReport" runat="server" style="display: none;">
                            ...
                            <br />--%>
                            <br />
                            <div id="dvHeader" class="p-l-40" align="left" >
                                <div id="dvMainHeader" style="float: left;">
                                    <table>
                                        <tr>
                                            ...
                                            <td class="p-l-36"  colspan="4">
                                                <table width="500px" class="h-100" >
                                                    <tr>
                                                        <td>
                    ...
                    <div id="popup" class="modal-box" style="top: -200px !important">
                        ...
                        <p>
                            ...
                            massa interdum risus ornare mollis.</p>--%>
                                        <fieldset class="color-colum" >
                                            <legend class="color-col-css formt-css"  ><b>COLUMNS:</b></legend>
                                            <div>
                                                <div style="float: left;">
                                                    <div id="dvColumn" class="div-css">
                                                        <label>
                                            ...
                                            <div id="dvSort" class="dvsort-css">
                                                <table>
                                                    <tr>
                                                        <td>Sort by
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td colspan="2" class="p-t-50">Put a check mark next to each column that
                                            <br />
                                    ...
                                    <div id="tab2" class="tab h-280">
                                        <div style="float: left;">
                                            <fieldset class="chose-css" >
                                                <legend class="formt-css"  ><b>CHOOSE FILTER:</b></legend>
                                                <div class="lst-fil-css">
                                                    <asp:ListBox ID="lstFilter" runat="server" CssClass="form-control" Height="217px" Width="150px" Font-Size="12px"></asp:ListBox>
                                                </div>
                                                <div id="Div2" class="tbl-css" >
                                        ...
                                        <div style="float: right;">
                                            <fieldset class="current-css">
                                                <legend class="formt-css"  ><b>CURRENT FILTER CHOICES</b></legend>
                                                <div class="for-main">
                                                    <div class="for-sub">
                                                        <table width="247px">
                                                            <thead>
                                                                <tr class="for-sub-row">
                                                                    <td width="100px" class="h-25" style="height: 25px;"> FILTER
                                                                    </td>
                                                                    <td width="220px" class="h-25" style="height: 25px"> SET TO
                                                                    </td>
                                                                </tr>
                                                            </thead>
                                                        </table>
                                        ...
                                        <div style="float: left;">
                                            <fieldset class="chose-css">
                                                ...
                                                <table class="w-400">
                                                    ...
                                                    <tr>
                                                        <td colspan="2" class="company-css">
                                                            <asp:CheckBox runat="server" ID="chkTimePrepared" Text="Time Prepared" CssClass="ListControl"
                                                                Checked="true" />
                                                        </td>
                                                    </tr>
                                                    <%-- <tr>
                                        <td colspan="2" class="pgination-css" style="width: 150px; padding-left: 25px; padding-top: 12px;">
                                    ...
                                    <tr>
                                        <td colspan="2" class="pgination-css" style="width: 150px; padding-left: 25px; padding-top: 12px;">
                                            ...
                                            <br />
                                            <fieldset class="chose-css">
                                                <legend class="formt-css"  ><b>SHOW FOOTER INFORMATION:</b></legend>
                                                <table class="w-400">
                                                    <tr>
                                                        <td class="pgination-css">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td  class="p-t-2" style="padding-top: 2px">
                                        ...
                                        <div style="float: right">
                                            <fieldset style="border-color: #CDCDCD; width: 230px; height: 277px;">
                                                <legend class="formt-css"  ><b>PAGE LAYOUT:</b></legend>
                                    ...
                                    <div id="tab4" class="tab" style="height: 150px;">
                                        <div style="float: left;">
                                            <fieldset style="border-color: #CDCDCD; width: 460px; height: 100px;">
                                                <legend class="formt-css"  ><b>PDF Page Size:</b></legend>
    ...
    <b style="font-size: 14px;">Bcc:</b> </td> <td  > <asp:TextBox
    ...
    <b style="font-size: 14px;">Attached File:</b> </td> <td  >
    ...
    <%--  <asp:UpdatePanel runat="server">
        ...
        <ContentTemplate>--%>
    <div class="clearfix"></div>
    <div class="pnlLoading pn-css" style="z-index: 900000; display: none;" id="loading"
        align="center">
        ...
        <div class="modal-dialog" style="width: 1200px !important">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="table-scrollable scro-css" >
