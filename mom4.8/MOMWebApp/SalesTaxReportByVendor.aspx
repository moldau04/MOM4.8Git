<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="SalesTaxReportByVendor.aspx.cs" Inherits="SalesTaxReportByVendor" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Sales Tax Collected By Vendor</div>
                            ...
                            <div class="form-section">
                                <div class="input-field col s12">
                                    <div class="row">
                                        ...
                                        <asp:TextBox ID="txtBody" runat="server" TextMode="MultiLine" CssClass="materialize-textarea" Text="This report is generated from Mobile Office Manager. Please find attached the Sales Tax Collected By Vendor Report"></asp:TextBox>
                                    </div>
                                </div>
