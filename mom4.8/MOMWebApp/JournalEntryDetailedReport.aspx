<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Mom.master" Inherits="JournalEntryDetailedReport" CodeBehind="JournalEntryDetailedReport.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Journal Entry Detailed Report</div>
        ...
        <div class="container">
            ...
            <div class="grid_container">
                <div class="form-section-row m-b-0" style="margin-bottom: 0 !important;">
                    <cc1:StiWebViewer ID="StiWebViewerJournalEntry" Height="800px" RequestTimeout="20000" CacheMode="None" runat="server" ViewMode="Continuous" ScrollbarsMode="true"
                        OnGetReport="StiWebViewerJournalEntry_GetReport" OnGetReportData="StiWebViewerJournalEntry_GetReportData" />
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Journal Entry Detailed Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
                ...
                <div class="srchpane-advanced margin" style="margin: 0 !important;">
                    <div class="srchpaneinner">
                        ...
                        <div class="form-col">
                            <div class="fc-label">
                                <label>
                                    <asp:HyperLink ID="lnkTo" runat="server" class="hyr-css" Style="cursor: pointer; text-decoration: underline; color: #105099;"
                        ...
                        <div class="form-col">
                            <div class="fc-label">
                                <label>
                                    <asp:HyperLink ID="lnkCC" runat="server" class="hyr-css" Style="cursor: pointer; text-decoration: underline; color: #105099;" OnClick="return OpenEmailsSelectionWindow_CC();" Text="Cc"></asp:HyperLink>
                                </label>
                            </div>
                            <div class="fc-input">
                        ...
                        <div class="form-col">
                            <div class="fc-label">
                                <label>
                                    <asp:HyperLink ID="lnkBCC" runat="server" class="hyr-css" Style="cursor: pointer; text-decoration: underline; color: #105099;" OnClick="return OpenEmailsSelectionWindow_BCC();" Text="Bcc"></asp:HyperLink>
                                </label>
                            </div>
                            <div class="fc-input">
                ...
                <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" UpdateMode="Conditional">
                    <contenttemplate>
                        <div class="form-section">
                            <div class="srchpaneinner srch-css" style="padding:20px 20px 0px 20px;">
                                ...
                                <div class="srchinputwrap srchclr btnlinksicon srch-m" style="margin-left: -10px; margin-top: -2px;">
                                ...
                                <div class="btnlinks sel-css" style="margin-left:5px;margin-top:10px;">
                        ...
                        <div class="form-section-row">
                            <div class="form-section">
                                <div class="input-field col s12">
                                    <div class="form-section-row">
                                        <div class="row">
                                            <div class="input-field col s1 m-t-0" style="margin-top: 0px;">
                                            ...
                                            <div class="input-field col s11 m-t-n10" style="margin-top: -10px;">
