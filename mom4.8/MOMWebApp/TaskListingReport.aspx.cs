...
public partial class TaskListingReport : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (pubReportId != 0)
            {
                ...
                if (dsGetRptDetails.Tables.Count > 0)
                {
                    ...
                    //if (sortBy == "Due Date" || sortBy == "Assign To")
                    //{
                    //    sortBy = "[" + sortBy + "]";
                    //}
                }
    ...
    private void GetCustReportFiltersValue()
    {
        ...
        objProp_User.ConnConfig = Session["config"].ToString();
        dsGetEstimateReportFiltersValue = objBL_ReportsData.GetTaskReportFiltersValue(objProp_User);

        if (dsGetEstimateReportFiltersValue.Tables[0].Rows.Count > 0)
        {
            drpTask.DataSource = dsGetEstimateReportFiltersValue.Tables[0];
            drpTask.DataTextField = "Task#";
            drpTask.DataValueField = "Task#";
            drpTask.DataBind();
        }

        if (dsGetEstimateReportFiltersValue.Tables[1].Rows.Count > 0)
        {
            drpName.DataSource = dsGetEstimateReportFiltersValue.Tables[1];
        ...
        {
            drpDueDate.DataSource = dsGetEstimateReportFiltersValue.Tables[2];
        ...
        {
            drpDays.DataSource = dsGetEstimateReportFiltersValue.Tables[3];
        ...
        {
            drpSubject.DataSource = dsGetEstimateReportFiltersValue.Tables[4];
        ...
        {
            drpDesc.DataSource = dsGetEstimateReportFiltersValue.Tables[5];
            drpDesc.DataTextField = "Desc";
            drpDesc.DataValueField = "Desc";
            drpDesc.DataBind();
        }      

        if (dsGetEstimateReportFiltersValue.Tables[6].Rows.Count > 0)
        {
            drpResolution.DataSource = dsGetEstimateReportFiltersValue.Tables[6];
            drpResolution.DataTextField = "Resolution";
            drpResolution.DataValueField = "Resolution";
            drpResolution.DataBind();
        }

        if (dsGetEstimateReportFiltersValue.Tables[7].Rows.Count > 0)
        {
            drpAssignedTo.DataSource = dsGetEstimateReportFiltersValue.Tables[7];
            drpAssignedTo.DataTextField = "Assigned To";
            drpAssignedTo.DataValueField = "Assigned To";
            drpAssignedTo.DataBind();
        }

        if (dsGetEstimateReportFiltersValue.Tables[8].Rows.Count > 0)
        {
            drpStatus.DataSource = dsGetEstimateReportFiltersValue.Tables[8];
    ...
    private void GetCustomerDetails()
    {
        try
        {
            ...
            dsGetCustDetails = objBL_ReportsData.GetTaskDetails(objProp_User);
            ...
            if (dsGetCustDetails.Tables.Count > 0)
            {
                ...
                dsGetCustDetails.Tables[0].TableName = "Task";
    ...
    private void BindGridReport(string[] checkedColumns, string[] selectedFiltersColumns, string[] selectedFiltersValues, string sortBy)
    {
        ...
        {
            query += " FROM vw_TaskReportDetails v order by v." + sortBy +"";
        }
        else
        {
            ...
            if (selectedFiltersColumns != null)
            {
                for (int i = 0; i <= selectedFiltersColumns.Count() - 1; i++)
                {
                    ...
                    if (selectedFiltersColumns[i] == "AssignedTo")
                    {
                        selectedFiltersColumns[i] = "Assigned To";
                    }
            ...
            query += " FROM vw_TaskReportDetails v where " + filters + " order by v." + sortBy +"";
        }
    ...
    public static string GetTaskPreviewDetails(int reportId, string FilterColumn, string FilterValues, string ColumnWidth, string SortColumn, string DataSortBy)
    {
        try
        {
            TaskListingReport _a = new TaskListingReport();
            BL_ReportsData objBL_ReportsData = new BL_ReportsData();
            BusinessEntity.User objProp_User = new BusinessEntity.User();
            CustomerReport objCustReport = new CustomerReport();
            DataSet dsCompDetail = new DataSet();
            ...
            if (DataSortBy == "Due Date" || DataSortBy == "Assign To" || DataSortBy == "Desc")
            {
            ...
            if (selectedFiltersColumns == null)
            {
                query += " FROM vw_TaskReportDetails v order by v." + DataSortBy + "";
            }
            else
            {
                string filters = string.Empty;
                if (selectedFiltersColumns != null)
                {
                    for (int i = 0; i <= selectedFiltersColumns.Count() - 1; i++)
                    {
                        ...
                        if (selectedFiltersColumns[i] == "AssignTo")
                        {
                            selectedFiltersColumns[i] = "Assign To";
                        }
                        if (selectedFiltersColumns[i].ToLower() != "balance" && selectedFiltersColumns[i].ToLower() != "loc" && selectedFiltersColumns[i].ToLower() != "equip" && selectedFiltersColumns[i].ToLower() != "opencall" && selectedFiltersColumns[i].ToLower() != "equipmentprice" && selectedFiltersColumns[i].ToLower() != "equipmentcounts")
                        {
                            if (!selectedFiltersValues[i].Contains("'") && !selectedFiltersValues[i].Contains("|"))
                ...
                filters = filters.Substring(0, filters.Length - 4);
                query += " FROM vw_TaskReportDetails v where " + filters + " order by v." + DataSortBy +"";
            }
            #endregion
