...
public partial class ARAgingReportByLocation : System.Web.UI.Page
{
    #region Variables
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                GetSMTPUser();
                SetAddress();
                string FileName = "LocationARAgingReport.pdf";
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        var url = "ARAgingReportByLocation.aspx?sdate=" + txtSearchDate.Text + "&type=" + type + "&pHide=" + chkHidePartial.Checked + "&inclNotes=" + chkIncludeNotes.Checked + "&creditFlag=" + chkCreditFlag.Checked + "&showRetainage=" + chkRetainageAmount.Checked;
    ...
    private StiReport LoadReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/ARAgingLocationReport.mrt");
            if (!string.IsNullOrEmpty(Request["showRetainage"]) && Request["showRetainage"] == "True")
            {
                reportPathStimul = Server.MapPath("StimulsoftReports/ARAgingLocationReport_Retainage.mrt");
                if (!string.IsNullOrEmpty(Request["type"]) && Request["type"] == "summary")
                {
                    reportPathStimul = Server.MapPath("StimulsoftReports/ARAgingLocationSummaryReport_Retainage.mrt");
                }
            }
            else
            {
                reportPathStimul = Server.MapPath("StimulsoftReports/ARAgingLocationReport.mrt");
                if (!string.IsNullOrEmpty(Request["type"]) && Request["type"] == "summary")
                {
                    reportPathStimul = Server.MapPath("StimulsoftReports/ARAgingLocationSummaryReport.mrt");
                }
            }
            ...
            DataSet ds = objBL_Contracts.GetARAgingByAsOfDate(objContract, creditFlag);
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "AR Aging by Location Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the AR Aging by Location Report attached.";
                }
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "LocationARAgingReport.pdf")
                        {
                ...
                mail.FileName = "LocationARAgingReport.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "LocationARAgingReport.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=LocationARAgingReport.pdf");
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached AR Aging by Location Report.";
