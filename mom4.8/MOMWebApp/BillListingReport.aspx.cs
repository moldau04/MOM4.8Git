...
public partial class BillListingReport : System.Web.UI.Page
{
    ...
    GetBillReportFiltersValueParam _getBillReportFiltersValue = new GetBillReportFiltersValueParam();
    GetBillDetailsParam _getBillDetails = new GetBillDetailsParam();
    ...
    CustomerReportParam _customerReport = new CustomerReportParam();
    ...
    private void GetReportDetailByRptId()
    {
        try
        {
            ...
            if (pubReportId != 0)
            {
                ...
                {
                    string APINAME = "BillAPI/BillsReport_GetReportDetailById";
                ...
                if (dsGetRptDetails.Tables.Count > 0)
                {
                    ...
                    if (sortBy == "Posting Date" || sortBy == "Invoice Date" || sortBy == "Vendor Name" || sortBy == "Use Tax")
                    {
                        sortBy = "[" + sortBy + "]";
                    }
    ...
    private void GetCustomerType()
    {
        try
        {
            ...
            if (_objAPIIntegration.IsAPIIntegrationForAPModule == true)
            {
                string APINAME = "BillAPI/BillsReport_GetCustomerType";
    ...
    {
        DataSet dsGetBillReportFiltersValue = new DataSet();
        objProp_User.DBName = Session["dbname"].ToString();
        objProp_User.ConnConfig = Session["config"].ToString();

        //API
        _getBillReportFiltersValue.DBName = Session["dbname"].ToString();
        _getBillReportFiltersValue.ConnConfig = Session["config"].ToString();

        DataSet dsGetBillReportFiltersValue1 = new DataSet();
        DataSet dsGetBillReportFiltersValue2 = new DataSet();
        DataSet dsGetBillReportFiltersValue3 = new DataSet();
        DataSet dsGetBillReportFiltersValue4 = new DataSet();
        DataSet dsGetBillReportFiltersValue5 = new DataSet();
        DataSet dsGetBillReportFiltersValue6 = new DataSet();
        DataSet dsGetBillReportFiltersValue7 = new DataSet();
        DataSet dsGetBillReportFiltersValue8 = new DataSet();
        ...
        if (_objAPIIntegration.IsAPIIntegrationForAPModule == true)
        {
            string APINAME = "BillAPI/BillsReport_GetBillReportFiltersValue";

            APIResponse _APIResponse = new MOMWebUtility().CallMOMWebAPI(APINAME, _getBillReportFiltersValue, true);
            JavaScriptSerializer serializer = new JavaScriptSerializer();

            serializer.MaxJsonLength = Int32.MaxValue;

            _lstBillReportDetails = serializer.Deserialize<ListGetBillReportFiltersValue>(_APIResponse.ResponseData);

            dsGetBillReportFiltersValue1 = _lstBillReportDetails.lstTable.ToDataSet();
            dsGetBillReportFiltersValue2 = _lstBillReportDetails.lstTable1.ToDataSet();
            dsGetBillReportFiltersValue3 = _lstBillReportDetails.lstTable2.ToDataSet();
            dsGetBillReportFiltersValue4 = _lstBillReportDetails.lstTable3.ToDataSet();
            dsGetBillReportFiltersValue5 = _lstBillReportDetails.lstTable4.ToDataSet();
            dsGetBillReportFiltersValue6 = _lstBillReportDetails.lstTable5.ToDataSet();
            dsGetBillReportFiltersValue7 = _lstBillReportDetails.lstTable6.ToDataSet();
            dsGetBillReportFiltersValue8 = _lstBillReportDetails.lstTable7.ToDataSet();

            dsGetBillReportFiltersValue1.Tables[0].Columns["InvoiceDate"].ColumnName = "Invoice Date";
            dsGetBillReportFiltersValue6.Tables[0].Columns["UseTax"].ColumnName = "Use Tax";
            dsGetBillReportFiltersValue7.Tables[0].Columns["VendorName"].ColumnName = "Vendor Name";
            dsGetBillReportFiltersValue8.Tables[0].Columns["PostingDate"].ColumnName = "Posting Date";

            
        }
        else
        {
            dsGetBillReportFiltersValue = objBL_ReportsData.GetBillReportFiltersValue(objProp_User);
        }

        //if (IsAPIIntegrationEnable == "YES")
        if (_objAPIIntegration.IsAPIIntegrationForAPModule == true)
        {
            if (dsGetBillReportFiltersValue1.Tables[0].Rows.Count > 0)
            {
                drpInvoiceDate.DataSource = dsGetBillReportFiltersValue1.Tables[0];
                drpInvoiceDate.DataTextField = "Invoice Date";
                drpInvoiceDate.DataValueField = "Invoice Date";
                drpInvoiceDate.DataBind();
            }

            if (dsGetBillReportFiltersValue2.Tables[0].Rows.Count > 0)
            {
                drpRef.DataSource = dsGetBillReportFiltersValue2.Tables[0];
                drpRef.DataTextField = "Ref";
                drpRef.DataValueField = "Ref";
                drpRef.DataBind();
            }

            if (dsGetBillReportFiltersValue3.Tables[0].Rows.Count > 0)
            {
                drpDescription.DataSource = dsGetBillReportFiltersValue3.Tables[0];
                drpDescription.DataTextField = "Description";
                drpDescription.DataValueField = "Description";
                drpDescription.DataBind();
            }
            if (dsGetBillReportFiltersValue4.Tables[0].Rows.Count > 0)
            {
                drpAmount.DataSource = dsGetBillReportFiltersValue4.Tables[0];
                drpAmount.DataTextField = "Amount";
                drpAmount.DataValueField = "Amount";
                drpAmount.DataBind();
            }

            if (dsGetBillReportFiltersValue5.Tables[0].Rows.Count > 0)
            {
                drpStatus.DataSource = dsGetBillReportFiltersValue5.Tables[0];
            ...
            if (dsGetBillReportFiltersValue6.Tables[0].Rows.Count > 0)
            {
                drpUseTax.DataSource = dsGetBillReportFiltersValue6.Tables[0];
                drpUseTax.DataTextField = "Use Tax";
                drpUseTax.DataValueField = "Use Tax";
                drpUseTax.DataBind();
            }

            if (dsGetBillReportFiltersValue7.Tables[0].Rows.Count > 0)
            {
                drpVendorName.DataSource = dsGetBillReportFiltersValue7.Tables[0];
                drpVendorName.DataTextField = "Vendor Name";
                drpVendorName.DataValueField = "Vendor Name";
                drpVendorName.DataBind();
            }

            if (dsGetBillReportFiltersValue8.Tables[0].Rows.Count > 0)
            {
                drpPostingDate.DataSource = dsGetBillReportFiltersValue8.Tables[0];
                drpPostingDate.DataTextField = "Posting Date";
                drpPostingDate.DataValueField = "Posting Date";
                drpPostingDate.DataBind();
            }
        }
        else
        {

            if (dsGetBillReportFiltersValue.Tables[0].Rows.Count > 0)
            {
                drpInvoiceDate.DataSource = dsGetBillReportFiltersValue.Tables[0];
                drpInvoiceDate.DataTextField = "Invoice Date";
                drpInvoiceDate.DataValueField = "Invoice Date";
                drpInvoiceDate.DataBind();
            }

            if (dsGetBillReportFiltersValue.Tables[1].Rows.Count > 0)
            {
                drpRef.DataSource = dsGetBillReportFiltersValue.Tables[1];
                drpRef.DataTextField = "Ref";
                drpRef.DataValueField = "Ref";
                drpRef.DataBind();
            }

            if (dsGetBillReportFiltersValue.Tables[2].Rows.Count > 0)
            {
                drpDescription.DataSource = dsGetBillReportFiltersValue.Tables[2];
                drpDescription.DataTextField = "Description";
                drpDescription.DataValueField = "Description";
                drpDescription.DataBind();
            }
            if (dsGetBillReportFiltersValue.Tables[3].Rows.Count > 0)
            {
                drpAmount.DataSource = dsGetBillReportFiltersValue.Tables[3];
                drpAmount.DataTextField = "Amount";
                drpAmount.DataValueField = "Amount";
                drpAmount.DataBind();
            }

            if (dsGetBillReportFiltersValue.Tables[4].Rows.Count > 0)
            {
                drpStatus.DataSource = dsGetBillReportFiltersValue.Tables[4];
                drpStatus.DataTextField = "Status";
                drpStatus.DataValueField = "Status";
                drpStatus.DataBind();
                drpStatus.Items.Insert(0, "All");
            ...
            if (dsGetBillReportFiltersValue.Tables[5].Rows.Count > 0)
            {
                drpUseTax.DataSource = dsGetBillReportFiltersValue.Tables[5];
                drpUseTax.DataTextField = "Use Tax";
                drpUseTax.DataValueField = "Use Tax";
                drpUseTax.DataBind();
            }

            if (dsGetBillReportFiltersValue.Tables[6].Rows.Count > 0)
            {
                drpVendorName.DataSource = dsGetBillReportFiltersValue.Tables[6];
                drpVendorName.DataTextField = "Vendor Name";
                drpVendorName.DataValueField = "Vendor Name";
                drpVendorName.DataBind();
            }

            if (dsGetBillReportFiltersValue.Tables[7].Rows.Count > 0)
            {
                drpPostingDate.DataSource = dsGetBillReportFiltersValue.Tables[7];
                drpPostingDate.DataTextField = "Posting Date";
                drpPostingDate.DataValueField = "Posting Date";
                drpPostingDate.DataBind();
            }
    ...
    private void GetCustomerName()
    {
        try
        {
            ...
            if (_objAPIIntegration.IsAPIIntegrationForAPModule == true)
            {
                string APINAME = "BillAPI/BillsReport_GetCustomerName";
    ...
    private void GetCustomerAddress()
    {
        try
        {
            ...
            if (_objAPIIntegration.IsAPIIntegrationForAPModule == true)
            {
                string APINAME = "BillAPI/BillsReport_GetCustomerAddress";
    ...
    private void GetCustomerCity()
    {
        try
        {
            ...
            if (_objAPIIntegration.IsAPIIntegrationForAPModule == true)
            {
                string APINAME = "BillAPI/BillsReport_GetCustomerCity";
    ...
    private void GetReportsName()
    {
        try
        {
            ...
            if (_objAPIIntegration.IsAPIIntegrationForAPModule == true)
            {
                string APINAME = "BillAPI/BillsReport_GetDynamicReports";
    ...
    private void GetReportColumnsByRepId()
    {
        try
        {
            ...
            if (pubReportId != 0)
            {
                ...
                if (_objAPIIntegration.IsAPIIntegrationForAPModule == true)
                {
                    string APINAME = "BillAPI/BillsReport_GetReportColByRepId";
                ...
                if (_objAPIIntegration.IsAPIIntegrationForAPModule == true)
                {
                    string APINAME = "BillAPI/BillsReport_GetReportFiltersByRepId";
    ...
    private void GetCustomerDetails()
    {
        try
        {
            ...
            //API
            _getBillDetails.DBName = Session["dbname"].ToString();
            _getBillDetails.ConnConfig = Session["config"].ToString();
            ...
            if (_objAPIIntegration.IsAPIIntegrationForAPModule == true)
            {
                string APINAME = "BillAPI/BillsReport_GetBillDetails";

                APIResponse _APIResponse = new MOMWebUtility().CallMOMWebAPI(APINAME, _getBillDetails, true);
                JavaScriptSerializer serializer = new JavaScriptSerializer();

                serializer.MaxJsonLength = Int32.MaxValue;

                _lstBillReportDetails = serializer.Deserialize<List<BillReportDetails>>(_APIResponse.ResponseData);
                dsGetCustDetails = CommonMethods.ToDataSet<BillReportDetails>(_lstBillReportDetails);
            }
            else
            {
                dsGetCustDetails = objBL_ReportsData.GetBillDetails(objProp_User);
            }
            ...
            if (_objAPIIntegration.IsAPIIntegrationForAPModule == true)
            {
                string APINAME = "BillAPI/BillsReport_GetAccountSummaryListingDetail";
            ...
            if (dsGetCustDetails.Tables.Count > 0)
            {
                ...
                dsGetCustDetails.Tables[0].TableName = "Bills";
    ...
    protected void btnSaveReport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            _insertCustomerReport.Module = "Bill";
            ...
            _updateCustomerReport.Module = "Bill";
            ...
            if (_objAPIIntegration.IsAPIIntegrationForAPModule == true)
            {
                string APINAME = "BillAPI/BillsReport_CheckExistingReport";
            ...
            if (hdnReportAction.Value == "Save")
            {
                ...
                if (_objAPIIntegration.IsAPIIntegrationForAPModule == true)
                {
                    string APINAME = "BillAPI/BillsReport_InsertCustomerReport";
            ...
            else
            {
                ...
                if (_objAPIIntegration.IsAPIIntegrationForAPModule == true)
                {
                    string APINAME = "BillAPI/BillsReport_IsStockReportExist";

                    //objCustReport.reportAction = hdnReportAction.Value;
                    ...
                    if (returnVal == true)
                    {
                        string APINAME1 = "BillAPI/AddBills_UpdateCustomerReport";
    ...
    protected void btnDeleteReport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (_objAPIIntegration.IsAPIIntegrationForAPModule == true)
            {
                string APINAME = "BillAPI/BillsReport_DeleteCustomerReport";
    ...
    {        
        ...
        {
            if (item == "Posting Date" || item == "Invoice Date" || item == "Vendor Name" || item == "Use Tax")
            {
                query += "[" + item + "],";
            }
            else
        ...
        {
            query += " FROM vw_BillReportDetails Where Convert(DateTime,[Posting Date]) Between '" + fromDate + "' And '" + toDate + "' order by " + sortBy;
        }
        else
        {
            ...
            if (selectedFiltersColumns != null)
            {
                ...
                {
                    if (selectedFiltersColumns[i] == "VendorName")
                    {
                        selectedFiltersColumns[i] = "Vendor Name";
                    }

                    if (selectedFiltersColumns[i] == "UseTax")
                    {
                        selectedFiltersColumns[i] = "Use Tax";
                    }
                    ...
                    if (selectedFiltersColumns[i] == "PostingDate")
                    {
                        selectedFiltersColumns[i] = "Posting Date";
                    }
            ...
            query += " FROM vw_BillReportDetails where " + filters + " And Convert(DateTime,[Posting Date]) Between '" + fromDate + "' And '" + toDate + "'order by " + sortBy;
        }
    ...
    private void BindHeaderDetails()
    {
        try
        {
            ...
            _getConnectionConfig.DBName = Session["dbname"].ToString();
            _getConnectionConfig.ConnConfig = Session["config"].ToString();

            _GetHeaderFooterDetail.ConnConfig = Session["config"].ToString();

            List<CustomerFilterViewModel> _lstCustomerReport = new List<CustomerFilterViewModel>();
            ...
            //if (_objAPIIntegration.IsAPIIntegrationForAPModule == true)
                //{
                //    string APINAME = "BillAPI/BillsReport_GetControlForReports";

                //    APIResponse _APIResponse = new MOMWebUtility().CallMOMWebAPI(APINAME, _getConnectionConfig, true);

                //    _lstCustomerReport = (new JavaScriptSerializer()).Deserialize<List<CustomerFilterViewModel>>(_APIResponse.ResponseData);
                //    dsCompDetail = CommonMethods.ToDataSet<CustomerFilterViewModel>(_lstCustomerReport);
                //}
                //else
                //{
            ...
            if (_objAPIIntegration.IsAPIIntegrationForAPModule == true)
            {
                string APINAME = "BillAPI/BillsReport_GetHeaderFooterDetail";
    ...
    private void GetGridData(string query)
    {
        try
        {
            ...
            if (_objAPIIntegration.IsAPIIntegrationForAPModule == true)
            {
                string APINAME = "BillAPI/BillsReport_GetOwners";
    ...
    private void BindReportTable(DataSet dsGetCustDetails)
    {
        try
        {
            ...
            if (_objAPIIntegration.IsAPIIntegrationForAPModule == true)
            {
                string APINAME = "BillAPI/BillsReport_GetColumnWidthByReportId";
            ...
            foreach (DataRow row in dsGetCustDetails.Tables[0].Rows)
            {
                ...
                foreach (DataColumn column in dsGetCustDetails.Tables[0].Columns)
                {
                    ...
                    {
                         decimal amount = Convert.ToDecimal(row[column.ColumnName]);
                         string amt = amount.ToString("#,##0.00");
                        html.Append(amt);
                    }
                    else if (column.ColumnName == "Use Tax")
                    {
                        decimal UseTax = Convert.ToDecimal(row[column.ColumnName]);
                        string utax = UseTax.ToString("#,##0.00");
                        html.Append(utax);
                    }
                    else
                    {
            ...
            for (int i = 0; i <= dsGetCustDetails.Tables[0].Columns.Count - 1; i++)
            {
                ...
                if (dsGetCustDetails.Tables[0].Columns[i].ToString() == "Use Tax")
                {
                    decimal UTax = Convert.ToDecimal(dsGetCustDetails.Tables[0].Compute("SUM([Use Tax])", string.Empty));
                    string ut = UTax.ToString("#,##0.00");
                    footer += "<td style='border:0;padding:20px 20px 3px 10px;color:black;font-weight:bold;'>" + "$" + ut + "</td>";
                    //footer += "<td style='border:0;padding:20px 20px 3px 10px;color:black;font-weight:bold;'>" + dsGetCustDetails.Tables[0].Compute("SUM(UseTax)", string.Empty).ToString() + "</td>";
                }
                else if (dsGetCustDetails.Tables[0].Columns[i].ToString() == "Amount")
                {
                    decimal amount =Convert.ToDecimal(dsGetCustDetails.Tables[0].Compute("SUM(Amount)", string.Empty));
                    string amt = amount.ToString("#,##0.00");
                    //footer += "<td style='border:0;padding:20px 20px 3px 10px;color:black;font-weight:bold;'>" + dsGetCustDetails.Tables[0].Compute("SUM(Amount)", string.Empty).ToString() + "</td>";
                    footer += "<td style='border:0;padding:20px 20px 3px 10px;color:black;font-weight:bold;'>" + "$" + amt + "</td>";
                }
                else
                {
            ...
            if (dsGetHeaderFooterDetail.Tables[0].Rows.Count > 0)
            {
                if (dsGetHeaderFooterDetail.Tables[0].Rows[0]["MainHeader"].ToString() == "True")
                {
                    ...
                    //if (_objAPIIntegration.IsAPIIntegrationForAPModule == true)
                        ...
                        //    _lstCustomerFilter = serializer.Deserialize<List<CustomerFilterViewModel>>(_APIResponse.ResponseData);
                        //    dsCompDetail = CommonMethods.ToDataSet<CustomerFilterViewModel>(_lstCustomerFilter);
                        //}
                        //else
                        //{
                        dsCompDetail = objBL_ReportsData.GetControlForReports(objProp_User);
    ...
    private void SaveResizedAndReorderReport()
    {
        try
        {
            ...
            if (_objAPIIntegration.IsAPIIntegrationForAPModule == true)
            {
                string APINAME = "BillAPI/BillsReport_UpdateCustomerReportResizedWidth";
    ...
    private void GenerateExcelFile()
    {
        try
        {
            ...
            //if (_objAPIIntegration.IsAPIIntegrationForAPModule == true)
                ...
                //    _lstCustomerReport = serializer.Deserialize<List<CustomerFilterViewModel>>(_APIResponse.ResponseData);
                //    dsCompDetail = CommonMethods.ToDataSet<CustomerFilterViewModel>(_lstCustomerReport);
                //}
                //else
                //{
    ...
    public static string GetBillPreviewDetails(int reportId, string FilterColumn, string FilterValues, string ColumnWidth, string SortColumn, string DataSortBy)
    {
        try
        {           
            BillListingReport _a = new BillListingReport();
            BL_ReportsData objBL_ReportsData = new BL_ReportsData();
            BusinessEntity.User objProp_User = new BusinessEntity.User();
            getConnectionConfigParam _getConnectionConfig = new getConnectionConfigParam();
            CustomerReport objCustReport = new CustomerReport();
            ...
            _getConnectionConfig.DBName = HttpContext.Current.Session["dbname"].ToString();
            _getConnectionConfig.ConnConfig = HttpContext.Current.Session["config"].ToString();
            ...
            _objAPIIntegration = (APIIntegrationModel)HttpContext.Current.Session["IsAPIIntegration"];
            ...
            if (DataSortBy == "Posting Date" || DataSortBy == "Invoice Date" || DataSortBy == "Vendor Name" || DataSortBy == "Use Tax")
            {
            ...
            if (selectedFiltersColumns == null)
            {
                query += " FROM vw_BillReportDetails Where Convert(DateTime,[Posting Date]) Between '" + fromDate + "' And '" + toDate + "' order by " + DataSortBy;
            }
            else
            {
                string filters = string.Empty;
                ...
                filters = filters.Substring(0, filters.Length - 4);
                query += " FROM vw_BillReportDetails where " + filters + " And Convert(DateTime,[Posting Date]) Between '" + fromDate + "' And '" + toDate + "' order by " + DataSortBy;
            }
            #endregion
