<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="ARAgingReportByLocType" CodeBehind="ARAgingReportByLocType.aspx.cs" %>
                                    ...
                                    <div class="row">
                                        <div class="col s12 m12 l12">
                                            <div class="row">
                                                ...
                                                <asp:Label CssClass="title_text" ID="lblHeader" runat="server">AR Aging by Location Type Report</asp:Label>
                                                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="srchpane">
                    ...
                    <div class="srchinputwrap srchclr btnlinksicon ser-css1">
                ...
                <div class="grid_container">
                    <cc1:StiWebViewer ID="StiWebViewerARReport" Height="800px" runat="server" ScrollbarsMode="true" RequestTimeout="900000" Zoom="100" BackgroundColor="White"
                        OnGetReport="StiWebViewerARReport_GetReport" OnGetReportData="StiWebViewerARReport_GetReportData" CacheMode="None" ViewMode="Continuous" Visible="false" />
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="col s12 m12 l12">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; AR Aging by Location Type Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
                        ...
                        <div class="form-section">
                            <div class="srchpaneinner srch-css">
                                ...
                                <div class="srchinputwrap srchclr btnlinksicon margin-t-l">
                                    <asp:LinkButton ID="lnkSearchEmail" runat="server" CausesValidation="false" ToolTip="Search" OnClick="lnkSearchEmail_Click"><i class="mdi-action-search"></i></asp:LinkButton>
                                </div>
