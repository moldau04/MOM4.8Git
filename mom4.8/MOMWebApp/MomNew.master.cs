...
public partial class MomNew : System.Web.UI.MasterPage
{
    ...
    private void Qblastsync()
    {
        ...
        if (Session["MSM"].ToString() != "TS")
        {
            if (Convert.ToInt32(Session["ISsupervisor"]) != 1)
            {
                ...
                //{
                //    List<QBLastSyncResParam> _QBLastSyncResParam = new List<QBLastSyncResParam>();
                //    General _objGeneral = new General();
                //    objGeneral.ConnConfig = Session["config"].ToString();                    
                //    string APINAME = "DashBoardAPI/DashBoard_GetQBlatSync";
                //    APIResponse _APIResponse = new MOMWebUtility().CallMOMWebAPI(APINAME, _objGeneral);
                //    _QBLastSyncResParam = (new JavaScriptSerializer()).Deserialize<List<QBLastSyncResParam>>(_APIResponse.ResponseData);
                //}
    ...
    private void LoadDashboardMenu()
    {
        ...
        //    GetDashboardParam _GetDashboard = new GetDashboardParam();
        //    _GetDashboard.ConnConfig = Session["config"].ToString();
        //    _GetDashboard.UserId = objPropUser.UserID;
        //    _GetDashboard.UserId = Convert.ToInt32(Session["userid"]);
        //    string APINAME = "DashBoardAPI/DashBoard_GetDashboardByUserID";
        //    APIResponse _APIResponse = new MOMWebUtility().CallMOMWebAPI(APINAME, _GetDashboard);
        //    _Dashboard = (new JavaScriptSerializer()).Deserialize<List<Dashboard>>(_APIResponse.ResponseData);
        //}
    ...
    private void GetGPSInfo()
    {
        ...
        //{
        //    List<Dashboard> _Dashboard = new List<Dashboard>();
        //    string APINAME = "DashBoardAPI/DashBoard_GetGPSInterval";
        //    APIResponse _APIResponse = new MOMWebUtility().CallMOMWebAPI(APINAME, objgeneral);
        //    _Dashboard = (new JavaScriptSerializer()).Deserialize<List<Dashboard>>(_APIResponse.ResponseData);
        //}
