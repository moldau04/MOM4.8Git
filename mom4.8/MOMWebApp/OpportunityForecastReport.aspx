<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="OpportunityForecastReport" Codebehind="OpportunityForecastReport.aspx.cs" %>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; <span runat="server" ID="pageTitle">Open Opportunities by Month</span>
                                        </div>
            ...
            <div class="row">
                ...
                <div class="grid_container">
                    <div class="form-section-row" style="margin-bottom: 0 !important;">
                        <cc1:StiWebViewer ID="StiWebViewerOpportunity" Height="800px" RequestTimeout="20000" runat="server" CacheMode="None" ViewMode="Continuous" ScrollbarsMode="true"
                            OnGetReport="StiWebViewerOpportunity_GetReport" OnGetReportData="StiWebViewerOpportunity_GetReportData" />
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col s12 m12 l12">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; <span runat="server" id="pageEmailTitle">Open Opportunities by Month</span>
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
