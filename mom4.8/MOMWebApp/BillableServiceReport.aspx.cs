...
public partial class BillableServiceReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                GetSMTPUser();
                SetAddress();
                string FileName ="BillableServiceReport.pdf";
    ...
    protected void StiWebViewerBillableServiceReport_GetReportData(object sender, StiReportDataEventArgs e)
    {

    }

    protected void StiWebViewerBillableServiceReport_GetReport(object sender, StiReportDataEventArgs e)
    {
        e.Report = LoadReport();
    }
    ...
    {
        //Response.Redirect("BillableServiceReport.aspx?fil=1");
    ...
    {
        var url = "BillableServiceReport.aspx?sd=" + txtfromDate.Text + "&ed=" + txtToDate.Text;
    ...
    private StiReport LoadReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/BillableServiceReport.mrt");
            ...
            DataSet ds = objBL_Contract.GetBillableServiceReport(objContract);
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "Billable Service Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Billable Service Report attached.";
                }
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "BillableServiceReport.pdf")
                        {
                ...
                mail.FileName = "BillableServiceReport.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "BillableServiceReport.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=BillableServiceReport.pdf");
