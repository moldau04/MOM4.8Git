...
public partial class PESEquipInspection : System.Web.UI.Page
{
    ...
    private void GetCustomerDetails()
    {
        try
        {
            ...
            if (dsGetCustDetails.Tables.Count > 0)
            {
                ...
                dsGetCustDetails.Tables[0].TableName = "PESInspection";
    ...
    private void BindGridReport(string[] checkedColumns, string[] selectedFiltersColumns, string[] selectedFiltersValues, string sortBy)
    {
        ...
        {
            query += " FROM vw_PESEquipInspection order by OwnerID,location," + sortBy;
        }
        else
        {
            ...
            query += " FROM vw_PESEquipInspection where " + filters + " order by " + sortBy;
        }
    ...
    public static string GetCustomerPreviewDetails(int reportId, string FilterColumn, string FilterValues, string ColumnWidth, string SortColumn, string DataSortBy)
    {
        try
        {
            PESEquipInspection _a = new PESEquipInspection();
            BL_ReportsData objBL_ReportsData = new BL_ReportsData();
            BusinessEntity.User objProp_User = new BusinessEntity.User();
            CustomerReport objCustReport = new CustomerReport();
            DataSet dsCompDetail = new DataSet();
