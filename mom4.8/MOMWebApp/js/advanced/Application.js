Ext.define('Gnt.examples.advanced.Application', {
    ...
    paths           : {
        'Gnt.locale'    : '../../packages/bryntum-gantt/src/Gnt/locale',
        'Sch.locale'    : '../../packages/bryntum-gantt/src/Sch/locale'
    },
        ...
        switch (true) {
            case lcRecord && !me.mainView && me.currentLocale != lc:
                ...
                Ext.Loader.loadScript({
                    ...
                    url     : 'https://www.bryntum.com/examples/extjs-6.7.0/build/classic/locale/locale-' + lc + '.js',
                    onLoad  : function() {
