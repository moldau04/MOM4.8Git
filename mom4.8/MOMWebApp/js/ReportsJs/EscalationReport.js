...
function EmptyFilters() {
    ...
    $("#tblEscType").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpEscType input[type="checkbox"]').attr('checked', false);

    $("#tblAction").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpAction input[type="checkbox"]').attr('checked', false);

    $("#tblEscCycle").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpEscCycle input[type="checkbox"]').attr('checked', false);

    $("#tblBillingFreqency").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpBillingFreqency input[type="checkbox"]').attr('checked', false);

    $("#tblEscFactor").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpEscFactor input[type="checkbox"]').attr('checked', false);

    $("#tblLastEsc").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpLastEsc input[type="checkbox"]').attr('checked', false);

    $("#tblStartEsc").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpStartEsc input[type="checkbox"]').attr('checked', false);

    $("#tblFinishEsc").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpFinishEsc input[type="checkbox"]').attr('checked', false);

    $("#tblNextDue").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpNextDue input[type="checkbox"]').attr('checked', false);

    $("#tblNewAmount").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpNewAmount input[type="checkbox"]').attr('checked', false);

    $("#tbldrpLength").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpLength input[type="checkbox"]').attr('checked', false);

    $("#tblExpirationDate").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpExpirationDate input[type="checkbox"]').attr('checked', false);

    $("#tblContract").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpContract input[type="checkbox"]').attr('checked', false);

    $("#tblRenewalNotes").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpRenewalNotes input[type="checkbox"]').attr('checked', false);
...
function setFiltersValue(filterName, filterValue) {
    ...
    if (filterName == "Location Id") {
        ...
        if (filterValue != '') {
            var splitedNames = filterValue.split("|");
            for (i = 0; i <= splitedNames.length - 1; i++) {
                $('#ctl00_ContentPlaceHolder1_drpLocationId input[type=checkbox]').each(function () {
                    var lblValue = $(this).next('label').html();
                    splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                    if (lblValue.trim() == splitedNames[i].trim()) {
                        $(this).attr('checked', true);
    ...
    if (filterName == "Service Type") {
        ...
        if (filterValue != '') {
            var splitedNames = filterValue.split("|");
            for (i = 0; i <= splitedNames.length - 1; i++) {
                $('#ctl00_ContentPlaceHolder1_drpServiceType input[type=checkbox]').each(function () {
                    var lblValue = $(this).next('label').html();
                    splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                    if (lblValue.trim() == splitedNames[i].trim()) {
                        $(this).attr('checked', true);
    ...
    if (filterName == "Billing Freqency") {

        $('#ctl00_ContentPlaceHolder1_drpBillingFreqency input[type="checkbox"]').attr('checked', false);
        if (filterValue != '') {
            var splitedNames = filterValue.split("|");
            for (i = 0; i <= splitedNames.length - 1; i++) {
                $('#ctl00_ContentPlaceHolder1_drpBillingFreqency input[type=checkbox]').each(function () {
                    var lblValue = $(this).next('label').html();
                    splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                    if (lblValue.trim() == splitedNames[i].trim()) {
                        $(this).attr('checked', true);
    ...
    if (filterName == "Esc Type") {

        $('#ctl00_ContentPlaceHolder1_drpEscType input[type="checkbox"]').attr('checked', false);
        if (filterValue != '') {
            var splitedNames = filterValue.split("|");
            for (i = 0; i <= splitedNames.length - 1; i++) {
                $('#ctl00_ContentPlaceHolder1_drpEscType input[type=checkbox]').each(function () {
                    var lblValue = $(this).next('label').html();
                    splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                    if (lblValue.trim() == splitedNames[i].trim()) {
                        $(this).attr('checked', true);
    ...
    if (filterName == "Esc Cycle") {

        $('#ctl00_ContentPlaceHolder1_drpEscCycle input[type="checkbox"]').attr('checked', false);
        if (filterValue != '') {
            var splitedNames = filterValue.split("|");
            for (i = 0; i <= splitedNames.length - 1; i++) {
                $('#ctl00_ContentPlaceHolder1_drpEscCycle input[type=checkbox]').each(function () {
                    var lblValue = $(this).next('label').html();
                    splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                    if (lblValue.trim() == splitedNames[i].trim()) {
                        $(this).attr('checked', true);
    ...
    if (filterName == "Esc Factor") {

        $('#ctl00_ContentPlaceHolder1_drpEscFactor input[type="checkbox"]').attr('checked', false);
        if (filterValue != '') {
            var splitedNames = filterValue.split("|");
            for (i = 0; i <= splitedNames.length - 1; i++) {
                $('#ctl00_ContentPlaceHolder1_drpEscFactor input[type=checkbox]').each(function () {
                    var lblValue = $(this).next('label').html();
                    splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                    if (lblValue.trim() == splitedNames[i].trim()) {
                        $(this).attr('checked', true);
    ...
    if (filterName == "Last Esc") {

        $('#ctl00_ContentPlaceHolder1_drpLastEsc input[type="checkbox"]').attr('checked', false);
        if (filterValue != '') {
            var splitedNames = filterValue.split("|");
            for (i = 0; i <= splitedNames.length - 1; i++) {
                $('#ctl00_ContentPlaceHolder1_drpLastEsc input[type=checkbox]').each(function () {
                    var lblValue = $(this).next('label').html();
                    splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                    if (lblValue.trim() == splitedNames[i].trim()) {
                        $(this).attr('checked', true);
    ...
    if (filterName == "Start Esc") {

        $('#ctl00_ContentPlaceHolder1_drpStartEsc input[type="checkbox"]').attr('checked', false);
        if (filterValue != '') {
            var splitedNames = filterValue.split("|");
            for (i = 0; i <= splitedNames.length - 1; i++) {
                $('#ctl00_ContentPlaceHolder1_drpStartEsc input[type=checkbox]').each(function () {
                    var lblValue = $(this).next('label').html();
                    splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                    if (lblValue.trim() == splitedNames[i].trim()) {
                        $(this).attr('checked', true);
    ...
    if (filterName == "Finish Esc") {

        $('#ctl00_ContentPlaceHolder1_drpFinishEsc input[type="checkbox"]').attr('checked', false);
        if (filterValue != '') {
            var splitedNames = filterValue.split("|");
            for (i = 0; i <= splitedNames.length - 1; i++) {
                $('#ctl00_ContentPlaceHolder1_drpFinishEsc input[type=checkbox]').each(function () {
                    var lblValue = $(this).next('label').html();
                    splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                    if (lblValue.trim() == splitedNames[i].trim()) {
                        $(this).attr('checked', true);
    ...
    if (filterName == "Expiration Date") {
        ...
        if (filterValue != '') {
            var splitedNames = filterValue.split("|");
            for (i = 0; i <= splitedNames.length - 1; i++) {
                $('#ctl00_ContentPlaceHolder1_drpExpirationDate input[type=checkbox]').each(function () {
                    var lblValue = $(this).next('label').html();
                    splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                    if (lblValue.trim() == splitedNames[i].trim()) {
                        $(this).attr('checked', true);
    ...
    if (filterName == "Next Due") {

        $('#ctl00_ContentPlaceHolder1_drpNextDue input[type="checkbox"]').attr('checked', false);
        if (filterValue != '') {
            var splitedNames = filterValue.split("|");
            for (i = 0; i <= splitedNames.length - 1; i++) {
                $('#ctl00_ContentPlaceHolder1_drpNextDue input[type=checkbox]').each(function () {
                    var lblValue = $(this).next('label').html();
                    splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                    if (lblValue.trim() == splitedNames[i].trim()) {
                        $(this).attr('checked', true);
    ...
    if (filterName == "New Amount") {

        $('#ctl00_ContentPlaceHolder1_drpNewAmount input[type="checkbox"]').attr('checked', false);
        if (filterValue != '') {
            var splitedNames = filterValue.split("|");
            for (i = 0; i <= splitedNames.length - 1; i++) {
                $('#ctl00_ContentPlaceHolder1_drpNewAmount input[type=checkbox]').each(function () {
                    var lblValue = $(this).next('label').html();
                    splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                    if (lblValue.trim() == splitedNames[i].trim()) {
                        $(this).attr('checked', true);
    ...
    if (filterName == "Contract") {
        ...
        if (filterValue != '') {
            var splitedNames = filterValue.split("|");
            for (i = 0; i <= splitedNames.length - 1; i++) {
                $('#ctl00_ContentPlaceHolder1_drpContract input[type=checkbox]').each(function () {
                    var lblValue = $(this).next('label').html();
                    splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                    if (lblValue.trim() == splitedNames[i].trim()) {
                        $(this).attr('checked', true);
    ...
    if (filterName == "Renewal Notes") {

        $('#ctl00_ContentPlaceHolder1_drpRenewalNotes input[type="checkbox"]').attr('checked', false);
        if (filterValue != '') {
            var splitedNames = filterValue.split("|");
            for (i = 0; i <= splitedNames.length - 1; i++) {
                $('#ctl00_ContentPlaceHolder1_drpRenewalNotes input[type=checkbox]').each(function () {
                    var lblValue = $(this).next('label').html();
                    splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                    if (lblValue.trim() == splitedNames[i].trim()) {
                        $(this).attr('checked', true);
    ...
    if (filterName == "Action" || filterName == "Description" || filterName == Length) {
...
jQuery(document).ready(function () {
    ...
    $("#btnPreview").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "EscalationListingReport.aspx/GetEscalationPreviewDetails",
    ...
    $('#ctl00_ContentPlaceHolder1_drpLocationId input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpLocationId", "Location Id");
    });

    //Rahil
    $('#ctl00_ContentPlaceHolder1_drpLocationName input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpLocationName", "Location Name");
    });
    ...
    $('#ctl00_ContentPlaceHolder1_drpServiceType input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpServiceType", "Service Type");
    });

    $('#ctl00_ContentPlaceHolder1_drpBillingFreqency input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpBillingFreqency", "Billing Freqency");
    });

    $('#ctl00_ContentPlaceHolder1_drpEscType input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpEscType", "Esc Type");
    });

    $('#ctl00_ContentPlaceHolder1_drpAction input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpAction", "Action");
    });

    $('#ctl00_ContentPlaceHolder1_drpEscCycle input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpEscCycle", "Esc Cycle");
    });

    $('#ctl00_ContentPlaceHolder1_drpEscFactor input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpEscFactor", "Esc Factor");
    });

    $('#ctl00_ContentPlaceHolder1_drpLastEsc input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpLastEsc", "Last Esc");
    });

    $('#ctl00_ContentPlaceHolder1_drpStartEsc input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpStartEsc", "Start Esc");
    });

    $('#ctl00_ContentPlaceHolder1_drpExpirationDate input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpExpirationDate", "Expiration Date");
    });

    $('#ctl00_ContentPlaceHolder1_drpFinishEsc input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpFinishEsc", "Finish Esc");
    });

    $('#ctl00_ContentPlaceHolder1_drpNextDue input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpNextDue", "Next Due");
    });

    $('#ctl00_ContentPlaceHolder1_drpNewAmount input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpNewAmount", "New Amount");
    });

    $('#ctl00_ContentPlaceHolder1_drpLength input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpLength", "Length");
    });

    $('#ctl00_ContentPlaceHolder1_drpContract input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpContract", "Contract");
    });

    $('#ctl00_ContentPlaceHolder1_drpRenewalNotes input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpRenewalNotes", "RenewalNotes");
    });
