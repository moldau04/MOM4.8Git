...
function EmptyFilters() {
    ...
    $("#ctl00_ContentPlaceHolder1_txtAmtEqual").val('');
    $("#ctl00_ContentPlaceHolder1_txtAmtLessAndEqual").val('');
    $("#ctl00_ContentPlaceHolder1_txtAmtGreaterAndEqual").val('');

    //$("#tblStatus").css("display", "none");
    //$("#ctl00_ContentPlaceHolder1_drpStatus").val('All');

    $("#tblOpportunity").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpOpportunity input[type="checkbox"]').attr('checked', false);

    $("#tblEstimate").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpEstimate input[type="checkbox"]').attr('checked', false);

    $("#tblProject").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpProject input[type="checkbox"]').attr('checked', false);

    $("#tblProbability").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpProbability input[type="checkbox"]').attr('checked', false);

    $("#tblName").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpName input[type="checkbox"]').attr('checked', false);

    $("#tblCloseDate").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpCloseDate input[type="checkbox"]').attr('checked', false);

    $("#tblClosed").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpClosed input[type="checkbox"]').attr('checked', false);
    ...
    $('#tblAmount input[name="ctl00$ContentPlaceHolder1$Amount"][value="rdbAny"]').prop('checked', true);
    $("#ctl00_ContentPlaceHolder1_txtAmtEqual").attr("disabled", "disabled");
    $("#ctl00_ContentPlaceHolder1_txtAmtLessAndEqual").attr("disabled", "disabled");
    $("#ctl00_ContentPlaceHolder1_txtAmtGreaterAndEqual").attr("disabled", "disabled");
...
function setFilters(filterName) {
    ...
    if (filterName == "Opportunity#") {
        filterName = "Opportunity";
    }

    if (filterName == "Estimate#") {
        filterName = "Estimate";
    }
    ...
    if (filterName == "Amount") {
        $("#tblAmount").fadeIn(200).css("display", "block");
        if ($("#ctl00_ContentPlaceHolder1_txtAmtEqual").val() == '' && $("#ctl00_ContentPlaceHolder1_txtAmtLessAndEqual").val() == '' && $("#ctl00_ContentPlaceHolder1_txtAmtGreaterAndEqual").val() == '') {
            $('#tblAmount input[name="ctl00$ContentPlaceHolder1$Amount"][value="rdbAmtAny"]').prop('checked', true);
            $("#ctl00_ContentPlaceHolder1_txtAmtEqual").attr("disabled", "disabled");
            $("#ctl00_ContentPlaceHolder1_txtAmtLessAndEqual").attr("disabled", "disabled");
            $("#ctl00_ContentPlaceHolder1_txtAmtGreaterAndEqual").attr("disabled", "disabled");
        }
...
function setFiltersValue(filterName, filterValue) {
    ...
    if (filterName == "Amount") {
        if (filterValue == "") {
            $('#tblAmount input[name="ctl00$ContentPlaceHolder1$Amount"][value="rdbAmtAny"]').prop('checked', true);
            $("#ctl00_ContentPlaceHolder1_txtAmtEqual").val('');
            $("#ctl00_ContentPlaceHolder1_txtAmtEqual").attr("disabled", true);
            $("#ctl00_ContentPlaceHolder1_txtAmtGreaterAndEqual").val('');
            $("#ctl00_ContentPlaceHolder1_txtAmtGreaterAndEqual").attr("disabled", true);
            $("#ctl00_ContentPlaceHolder1_txtAmtLessAndEqual").val('');
            $("#ctl00_ContentPlaceHolder1_txtAmtLessAndEqual").attr("disabled", true);
        }
        else if ((filterValue.indexOf(">=") != -1 || filterValue.indexOf("&gt;") != -1) && filterValue.indexOf('and') == -1) {
            $("#ctl00_ContentPlaceHolder1_txtAmtGreaterAndEqual").attr("disabled", false);
            $('#tblAmount input[name="ctl00$ContentPlaceHolder1$Amount"][value="rdbAmtGreaterAndEqual"]').prop('checked', true);
            filterValue = filterValue.replace("&gt;=", '').replace(">=", '').replace("&lt;=", '').replace("<=", '').replace("=", '');
            $("#ctl00_ContentPlaceHolder1_txtAmtGreaterAndEqual").val(filterValue.trim());
            $("#ctl00_ContentPlaceHolder1_txtAmtEqual").val('');
            $("#ctl00_ContentPlaceHolder1_txtAmtEqual").attr("disabled", 'disabled');
            $("#ctl00_ContentPlaceHolder1_txtAmtLessAndEqual").val('');
            $("#ctl00_ContentPlaceHolder1_txtAmtLessAndEqual").attr("disabled", 'disabled');
            ...
            $("#ctl00_ContentPlaceHolder1_txtAmtLessAndEqual").attr("disabled", false);
            $('#tblAmount input[name="ctl00$ContentPlaceHolder1$Amount"][value="rdbAmtLessAndEqual"]').prop('checked', true);
            filterValue = filterValue.replace("&gt;=", '').replace(">=", '').replace("&lt;=", '').replace("<=", '').replace("=", '');
            $("#ctl00_ContentPlaceHolder1_txtAmtLessAndEqual").val(filterValue.trim());
            $("#ctl00_ContentPlaceHolder1_txtAmtEqual").val('');
            $("#ctl00_ContentPlaceHolder1_txtAmtEqual").attr("disabled", true);
            $("#ctl00_ContentPlaceHolder1_txtAmtGreaterAndEqual").val('');
            $("#ctl00_ContentPlaceHolder1_txtAmtGreaterAndEqual").attr("disabled", true);
            ...
            greaterValue = splitedBalance[0].replace("&gt;=", '').replace(">=", '').replace("&lt;=", '').replace("<=", '').replace("=", '');
            lessValue = splitedBalance[1].replace("&gt;=", '').replace(">=", '').replace("&lt;=", '').replace("<=", '').replace("=", '');
            $("#ctl00_ContentPlaceHolder1_txtAmtGreaterAndEqual").val(greaterValue.trim());
            $("#ctl00_ContentPlaceHolder1_txtAmtLessAndEqual").val(lessValue.trim());
            $("#ctl00_ContentPlaceHolder1_txtAmtEqual").val('');
            $("#ctl00_ContentPlaceHolder1_txtAmtEqual").attr("disabled", true);
            $("#ctl00_ContentPlaceHolder1_txtAmtGreaterAndEqual").attr("disabled", false);
            $("#ctl00_ContentPlaceHolder1_txtAmtLessAndEqual").attr("disabled", false);
            ...
            $('#tblAmount input[name="ctl00$ContentPlaceHolder1$Amount"][value="rdbAmtEqual"]').prop('checked', true);
            filterValue = filterValue.replace("&gt;=", '').replace(">=", '').replace("&lt;=", '').replace("<=", '').replace("=", '');
            $("#ctl00_ContentPlaceHolder1_txtAmtEqual").val(filterValue.trim());
            $("#ctl00_ContentPlaceHolder1_txtAmtGreaterAndEqual").val('');
            $("#ctl00_ContentPlaceHolder1_txtAmtGreaterAndEqual").attr("disabled", true);
            $("#ctl00_ContentPlaceHolder1_txtAmtLessAndEqual").val('');
            $("#ctl00_ContentPlaceHolder1_txtAmtLessAndEqual").attr("disabled", true);
    ...
    if (filterName == "Close Date") {
        ...
        if (filterValue != '') {
            var splitedNames = filterValue.split("|");
            for (i = 0; i <= splitedNames.length - 1; i++) {
                $('#ctl00_ContentPlaceHolder1_drpCloseDate input[type=checkbox]').each(function () {
                    var lblValue = $(this).next('label').html();
                    splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                    if (lblValue.trim() == splitedNames[i].trim()) {
                        $(this).attr('checked', true);
    ...
    if (filterName == "Sales Person") {

        $('#ctl00_ContentPlaceHolder1_drpSalesPerson input[type="checkbox"]').attr('checked', false);
        if (filterValue != '') {
            var splitedNames = filterValue.split("|");
            for (i = 0; i <= splitedNames.length - 1; i++) {
                $('#ctl00_ContentPlaceHolder1_drpSalesPerson input[type=checkbox]').each(function () {
                    var lblValue = $(this).next('label').html();
                    splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                    if (lblValue.trim() == splitedNames[i].trim()) {
                        $(this).attr('checked', true);
    ...
    if (filterName == "Opportunity" || filterName == "Project" || filterName == "Estimate" || filterName == "Closed" || filterName == "Contact" || filterName == "Probability" || filterName == "Status") {
...
jQuery(document).ready(function () {
    ...
    $("#btnPreview").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "OpportunityListingReport.aspx/GetOpportunityPreviewDetails",
    ...
    $('#tblAmount input[name="ctl00$ContentPlaceHolder1$Amount"] + label').click(function () {
        if ($(this).text() != "Any") {
            if ($(this).text() == "=") {
                if ($("#ctl00_ContentPlaceHolder1_txtAmtBalEqual").val() == '') {
                    $("#trAmount").remove();
                }
                $("#ctl00_ContentPlaceHolder1_txtAmtEqual").attr("disabled", false);
                $("#ctl00_ContentPlaceHolder1_txtAmtGreaterAndEqual").val('');
                $("#ctl00_ContentPlaceHolder1_txtAmtGreaterAndEqual").attr("disabled", true);
                $("#ctl00_ContentPlaceHolder1_txtAmtLessAndEqual").val('');
                $("#ctl00_ContentPlaceHolder1_txtAmtLessAndEqual").attr("disabled", true);
                ...
                $("#ctl00_ContentPlaceHolder1_txtAmtEqual").val('');
                $("#ctl00_ContentPlaceHolder1_txtAmtEqual").attr("disabled", true);
                if ($("#ctl00_ContentPlaceHolder1_txtAmtLessAndEqual").val() == '') {
                    $("#ctl00_ContentPlaceHolder1_txtAmtLessAndEqual").attr("disabled", true);
                }
                else {
                    $("#ctl00_ContentPlaceHolder1_txtAmtLessAndEqual").attr("disabled", false);
                ...
                $("#ctl00_ContentPlaceHolder1_txtAmtEqual").val('');
                $("#ctl00_ContentPlaceHolder1_txtAmtEqual").attr("disabled", true);
                if ($("#ctl00_ContentPlaceHolder1_txtAmtGreaterAndEqual").val() == '') {
                    $("#ctl00_ContentPlaceHolder1_txtAmtGreaterAndEqual").attr("disabled", true);
                }
                else {
                    $("#ctl00_ContentPlaceHolder1_txtAmtGreaterAndEqual").attr("disabled", false);
    ...
    $('#ctl00_ContentPlaceHolder1_drpOpportunity input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpOpportunity", "Opportunity");
    });
    ...
    //Rahil
    $('#ctl00_ContentPlaceHolder1_drpProbability input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpProbability", "Probability");
    });


    $('#ctl00_ContentPlaceHolder1_drpCloseDate input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpCloseDate", "CloseDate");
    });


    $('#ctl00_ContentPlaceHolder1_drpClosed input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpClosed", "Closed");
    });
    ...
    $('#ctl00_ContentPlaceHolder1_drpEstimate input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpEstimate", "Estimate");
    });
    ...
    $("#ctl00_ContentPlaceHolder1_txtAmtEqual").blur(function () {
        var filterValue = $("#ctl00_ContentPlaceHolder1_txtAmtEqual").val();
        if (filterValue != '') {
            var getOperator = $("#tblAmount input[name='ctl00$ContentPlaceHolder1$Amount']:checked + label").text();
            if ($('#tblFilterChoices tr td').hasClass("amount")) {
                $(".amount").html(((getOperator == "Any") ? "" : getOperator) + ' ' + filterValue);
            }
            else {
                $('#tblFilterChoices tbody').append('<tr id="trAmount"><td width="100px" style="height:25px;">Amount</td><td  class="amount" width="220px"  style="height:25px;">' + ((getOperator == "Any") ? "" : getOperator) + ' ' + filterValue + '</td></tr>');
            }
        }
        //                else {
        //                    $("#trBalance").remove();
    ...
    $("#ctl00_ContentPlaceHolder1_txtAmtGreaterAndEqual").blur(function () {
        var filterValue = $("#ctl00_ContentPlaceHolder1_txtAmtGreaterAndEqual").val();
        if (filterValue != '') {
            var getOperator = $("#tblAmount input[name='ctl00$ContentPlaceHolder1$Amount']:checked + label").text();
            if ($('#tblFilterChoices tr td').hasClass("balance") && $("#ctl00_ContentPlaceHolder1_txtAmtLessAndEqual").val() != '') {
                getLessValue = "<=" + $("#ctl00_ContentPlaceHolder1_txtAmtLessAndEqual").val();
                $(".amount").html('');
                //$(".balance").html((((getOperator == "Any") ? "" : getOperator) + ' ' + filterValue) + " and " + getLessValue);
                $(".amount").html(">=" + filterValue + " and " + getLessValue);
            }
            else if ($('#tblFilterChoices tr td').hasClass("amount") && $("#ctl00_ContentPlaceHolder1_txtAmtLessAndEqual").val() == '') {
                //$(".balance").html(((getOperator == "Any") ? "" : getOperator) + ' ' + filterValue);
                $(".balance").html(">=" + filterValue);
            }
            else {
            ...
            if ($("#ctl00_ContentPlaceHolder1_txtAmtLessAndEqual").val() == '') {
                ...
                $(".amount").html("<=" + $("#ctl00_ContentPlaceHolder1_txtAmtLessAndEqual").val());
            }
        }
    });


    $("#ctl00_ContentPlaceHolder1_txtAmtLessAndEqual").blur(function () {
        var filterValue = $("#ctl00_ContentPlaceHolder1_txtAmtLessAndEqual").val();
        if (filterValue != '') {
            var getOperator = $("#tblAmount input[name='ctl00$ContentPlaceHolder1$Amount']:checked + label").text();
            if ($('#tblFilterChoices tr td').hasClass("amount") && $("#ctl00_ContentPlaceHolder1_txtAmtGreaterAndEqual").val() != '') {
                getGreaterValue = ">=" + $("#ctl00_ContentPlaceHolder1_txtAmtGreaterAndEqual").val()
                $(".amount").html('');
                //$(".balance").html((((getOperator == "Any") ? "" : getOperator) + ' ' + filterValue) + " and " + getGreaterValue);
                $(".amount").html(getGreaterValue + " and " + "<=" + filterValue);
            }
            else if ($('#tblFilterChoices tr td').hasClass("amount") && $("#ctl00_ContentPlaceHolder1_txtAmtGreaterAndEqual").val() == '') {
                //$(".balance").html(((getOperator == "Any") ? "" : getOperator) + ' ' + filterValue);
                $(".amount").html("<=" + filterValue);
            }
            else {
                $('#tblFilterChoices tbody').append('<tr id="trAmount"><td width="100px" style="height:25px;">Amount</td><td  class="amount" width="220px"  style="height:25px;">' + ((getOperator == "Any") ? "" : getOperator) + ' ' + filterValue + '</td></tr>');
            }
            ...
            if ($("#ctl00_ContentPlaceHolder1_txtAmtGreaterAndEqual").val() == '') {
                ...
                $(".amount").html(">=" + $("#ctl00_ContentPlaceHolder1_txtAmtGreaterAndEqual").val());
            }
        }
    });
