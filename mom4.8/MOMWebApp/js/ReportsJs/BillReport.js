...
function EmptyFilters() {
    ...
    //Rahil
    $("#tblRef").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpRef input[type="checkbox"]').attr('checked', false);

    $("#tblInvoiceDate").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpInvoiceDate input[type="checkbox"]').attr('checked', false);

    $("#tblPostingDate").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpPostingDate input[type="checkbox"]').attr('checked', false);

    $("#tblDescription").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpDescription input[type="checkbox"]').attr('checked', false);

    $("#tblUseTax").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpUseTax input[type="checkbox"]').attr('checked', false);

    $("#tblAmount").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpAmount input[type="checkbox"]').attr('checked', false);

    $("#tblVendorName").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpVendorName input[type="checkbox"]').attr('checked', false);
...
function setFiltersValue(filterName, filterValue) {
    ...
    if (filterName == "Invoice Date") {
        ...
        if (filterValue != '') {
            var splitedNames = filterValue.split("|");
            for (i = 0; i <= splitedNames.length - 1; i++) {
                $('#ctl00_ContentPlaceHolder1_drpInvoiceDate input[type=checkbox]').each(function () {
                    var lblValue = $(this).next('label').html();
                    splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                    if (lblValue.trim() == splitedNames[i].trim()) {
                        $(this).attr('checked', true);
    ...
    if (filterName == "Vendor Name") {
        ...
        if (filterValue != '') {
            var splitedNames = filterValue.split("|");
            for (i = 0; i <= splitedNames.length - 1; i++) {
                $('#ctl00_ContentPlaceHolder1_drpVendorName input[type=checkbox]').each(function () {
                    var lblValue = $(this).next('label').html();
                    splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                    if (lblValue.trim() == splitedNames[i].trim()) {
                        $(this).attr('checked', true);
    ...
    if (filterName == "Use Tax") {
        ...
        if (filterValue != '') {
            var splitedNames = filterValue.split("|");
            for (i = 0; i <= splitedNames.length - 1; i++) {
                $('#ctl00_ContentPlaceHolder1_drpUseTax input[type=checkbox]').each(function () {
                    var lblValue = $(this).next('label').html();
                    splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                    if (lblValue.trim() == splitedNames[i].trim()) {
                        $(this).attr('checked', true);
    ...
    if (filterName == "Posting Date") {
        ...
        if (filterValue != '') {
            var splitedNames = filterValue.split("|");
            for (i = 0; i <= splitedNames.length - 1; i++) {
                $('#ctl00_ContentPlaceHolder1_drpPostingDate input[type=checkbox]').each(function () {
                    var lblValue = $(this).next('label').html();
                    splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                    if (lblValue.trim() == splitedNames[i].trim()) {
                        $(this).attr('checked', true);
    ...
    if (filterName == "Customer" || filterName == "VendorName" || filterName == "UseTax" || filterName == "Amount" || filterName == "Description" || filterName == "Ref" || filterName == "Posting Date") {
...
jQuery(document).ready(function() {
    ...
    $("#btnPreview").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "BillListingReport.aspx/GetBillPreviewDetails",
    ...
    //Rahil
    $('#ctl00_ContentPlaceHolder1_drpRef input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpRef", "Ref");
    });

    $('#ctl00_ContentPlaceHolder1_drpInvoiceDate input[type="checkbox"]').click(function () {        
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpInvoiceDate", "Invoice Date");
    });

    $('#ctl00_ContentPlaceHolder1_drpPostingDate input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpPostingDate", "Posting Date");
    });
    ...
    $('#ctl00_ContentPlaceHolder2_drpAmount input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpAmount", "Amount");
    });

    $('#ctl00_ContentPlaceHolder3_drpUseTax input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpUseTax", "Use Tax");
    });

    $('#ctl00_ContentPlaceHolder1_drpVendorName input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpVendorName", "Vendor Name");
    });

    $('#ctl00_ContentPlaceHolder1_drpCustom5 input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpCustom5", "Custom5");
    });

    $('#ctl00_ContentPlaceHolder1_drpCustom6 input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpCustom6", "Custom6");
    });

    $('#ctl00_ContentPlaceHolder1_drpCustom7 input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpCustom7", "Custom7");
    });

    $('#ctl00_ContentPlaceHolder1_drpCustom8 input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpCustom8", "Custom8");
    });

    $('#ctl00_ContentPlaceHolder1_drpCustom9 input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpCustom9", "Custom9");
    });
