...
function EmptyFilters() {
    ...
    $("#tblassignname").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpAssignName input[type="checkbox"]').attr('checked', false);

    $("#tblcharge").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpCharge input[type="checkbox"]').attr('checked', false);

    $("#tblTimeComp").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpTimeComp input[type="checkbox"]').attr('checked', false);

    $("#tblTT").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpTT input[type="checkbox"]').attr('checked', false);

    $("#tblTottime").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpTottime input[type="checkbox"]').attr('checked', false);

    $("#tblTimeSite").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpTimeSite input[type="checkbox"]').attr('checked', false);

    $("#tblTimeRoute").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpTimeRoute input[type="checkbox"]').attr('checked', false);

    $("#tblReg").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpReg input[type="checkbox"]').attr('checked', false);

    $("#tblphone").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpphone input[type="checkbox"]').attr('checked', false);

    $("#tblOT").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpOT input[type="checkbox"]').attr('checked', false);

    $("#tblNT").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpNT input[type="checkbox"]').attr('checked', false);

    $("#tblmileage").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpmileage input[type="checkbox"]').attr('checked', false);

    $("#tblmanualinvoice").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpmanualinvoice input[type="checkbox"]').attr('checked', false);

    $("#tbllocname").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drplocname input[type="checkbox"]').attr('checked', false);

    $("#tblfulladdress").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpfulladdress input[type="checkbox"]').attr('checked', false);

    $("#tblfdesc").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpfdesc input[type="checkbox"]').attr('checked', false);

    $("#tblexpenses").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpexpenses input[type="checkbox"]').attr('checked', false);

    $("#tbledate").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpedate input[type="checkbox"]').attr('checked', false);

    $("#tblDT").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpDT input[type="checkbox"]').attr('checked', false);

    $("#tbldescres").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpDescres input[type="checkbox"]').attr('checked', false);
...
function setFiltersValue(filterName, filterValue) {
    ...
    if (filterName == "assignname" || filterName == "charge" || filterName == "customername" || filterName == "descres" || filterName == "DT" || filterName == "edate" || filterName == "expenses" || filterName == "fDesc" || filterName == "fulladdress" || filterName == "locname" || filterName == "manualinvoice" || filterName == "mileage" || filterName == "NT" || filterName == "OT" || filterName == "phone" || filterName == "Reg" || filterName == "TimeComp" || filterName == "TimeSite" || filterName == "Tottime" || filterName == "TT" ) {
...
jQuery(document).ready(function () {
    ...
    $("#btnPreview").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "TicketListReport.aspx/GetTicketPreviewDetails",
    ...
    $('#ctl00_ContentPlaceHolder1_drpAssignName input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpAssignName", "assignname");
    });

    $('#ctl00_ContentPlaceHolder1_drpCharge input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpCharge", "charge");
    });

    $('#ctl00_ContentPlaceHolder1_drpTimeComp input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpTimeComp", "TimeComp");
    });

    $('#ctl00_ContentPlaceHolder1_drpTT input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpTT", "TT");
    });

    $('#ctl00_ContentPlaceHolder1_drpTottime input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpTottime", "Tottime");
    });

    $('#ctl00_ContentPlaceHolder1_drpTimeSite input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpTimeSite", "TimeSite");
    });

    $('#ctl00_ContentPlaceHolder1_drpTimeRoute input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpTimeRoute", "TimeRoute");
    });

    $('#ctl00_ContentPlaceHolder1_drpReg input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpReg", "Reg");
    });

    $('#ctl00_ContentPlaceHolder1_drpphone input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpphone", "phone");
    });

    $('#ctl00_ContentPlaceHolder1_drpOT input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpOT", "OT");
    });

    $('#ctl00_ContentPlaceHolder1_drpNT input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpNT", "NT");
    });

    $('#ctl00_ContentPlaceHolder1_drpmileage input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpmileage", "mileage");
    });

    $('#ctl00_ContentPlaceHolder1_drpmanualinvoice input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpmanualinvoice", "manualinvoice");
    });

    $('#ctl00_ContentPlaceHolder1_drplocname input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drplocname", "locname");
    });

    $('#ctl00_ContentPlaceHolder1_drpfulladdress input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpfulladdress", "fulladdress");
    });

    $('#ctl00_ContentPlaceHolder1_drpfdesc input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpfdesc", "fdesc");
    });


    $('#ctl00_ContentPlaceHolder1_drpexpenses input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpexpenses", "expenses");
    });

    $('#ctl00_ContentPlaceHolder1_drpedate input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpedate", "edate");
    });

    $('#ctl00_ContentPlaceHolder1_drpDT input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpDT", "DT");
    });

    $('#ctl00_ContentPlaceHolder1_drpDescres input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpDescres", "descres");
    });

    $('#ctl00_ContentPlaceHolder1_drpCustomername input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpCustomername", "customername");
    });
    ...
    //Rahil
    $('#ctl00_ContentPlaceHolder1_drpAcct input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpAcct", "Acct");
    });

    $('#ctl00_ContentPlaceHolder1_drp1099 input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drp1099", "1099");
    });

    $('#ctl00_ContentPlaceHolder1_drpShipVia input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpShipVia", "ShipVia");
    });

    $('#ctl00_ContentPlaceHolder1_drpQBVendorID input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpQBVendorID", "QBVendorID");
    });
    ...
    $('#ctl00_ContentPlaceHolder1_drpCLimit input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpCLimit", "CLimit");
    });
