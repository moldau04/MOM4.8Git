...
function EmptyFilters() {
    ...
    $('#ctl00_ContentPlaceHolder1_drpName input[type="checkbox"]').prop('checked', false);
    $("#tblCity").css("display", "none");
    //            $("#ctl00_ContentPlaceHolder1_txtCity").val('');
    $('#ctl00_ContentPlaceHolder1_drpCity input[type="checkbox"]').prop('checked', false);
    $("#tblState").css("display", "none");

    //Changed by Yashasvi Jadav
    $("#tblRoute").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpRoute input[type="checkbox"]').prop('checked', false);
    $("#tblLocationSTax").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpLocationSTax input[type="checkbox"]').prop('checked', false);
    $("#tblDefaultSalesPerson").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpDefaultSalesPerson input[type="checkbox"]').prop('checked', false);
    $("#tblInstalledOn").css("display", "none");
    $("#ctl00_ContentPlaceHolder1_txtInstalledOn").val('');
    $("#drpBuldingType").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpBuldingType input[type="checkbox"]').prop('checked', false);
    $("#drpEquipmentState").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpEquipmentState input[type="checkbox"]').prop('checked', false);
    //$("#ctl00_ContentPlaceHolder1_ddlState").val('All');
    $('#ctl00_ContentPlaceHolder1_ddlState input[type="checkbox"]').prop('checked', false);
    $("#tblZip").css("display", "none");
    $("#ctl00_ContentPlaceHolder1_txtZip").val('');
    $("#tblDoorFrameInstalled").css("display", "none");
    $("#ctl00_ContentPlaceHolder1_txtDoorFrameInstalled").val('');
    $("#tblDoorFrameDelivered").css("display", "none");
    $("#ctl00_ContentPlaceHolder1_txtDoorFrameDelivered").val('');
    $("#ctl00_ContentPlaceHolder1_txtInstalledOn").val('');
    ...
    $('#ctl00_ContentPlaceHolder1_drpAddress input[type="checkbox"]').prop('checked', false);
    ...
    $('#ctl00_ContentPlaceHolder1_drpType input[type="checkbox"]').prop('checked', false);
    ...
    $('#ctl00_ContentPlaceHolder1_drpCustomer input[type="checkbox"]').prop('checked', false);

    $("#tblLocationId").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpLocationId input[type="checkbox"]').prop('checked', false);

    //Rahil
    $("#tblAcct").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpAcct input[type="checkbox"]').prop('checked', false);

    $("#tblRemit").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpRemit input[type="checkbox"]').prop('checked', false);
    //Rahil

    $("#tblLocation").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpLocation input[type="checkbox"]').prop('checked', false);

    $("#tblLocationAddress").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpLocationAddress input[type="checkbox"]').prop('checked', false);

    $("#tblLocationCity").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpLocationCity input[type="checkbox"]').prop('checked', false);

    $("#tblLocationState").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpLocationState input[type="checkbox"]').prop('checked', false);

    $("#tblLocationZip").css("display", "none");
    $("#ctl00_ContentPlaceHolder1_txtLocationZip").val('');

    $("#tblLocationType").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpLocationType input[type="checkbox"]').prop('checked', false);

    $("#tblEquipmentName").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpEquipmentName input[type="checkbox"]').prop('checked', false);

    $("#tblManuf").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpManuf input[type="checkbox"]').prop('checked', false);

    $("#tblEquipmentType").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpEquipmentType input[type="checkbox"]').prop('checked', false);

    $("#tblServiceType").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpServiceType input[type="checkbox"]').prop('checked', false);
...
function setFilters(filterName) {
    debugger;
    filterName = filterName.replace('[', '').replace(']', '').replace(/ /g, '');
...
function setFiltersValue(filterName, filterValue) {
    ...
    if (filterName == "SalesPerson") {
        $('#ctl00_ContentPlaceHolder1_drpDefaultSalesPerson input[type="checkbox"]').prop('checked', false);
        if (filterValue != '') {
            var splitedSales = filterValue.split("|");
            for (i = 0; i <= splitedSales.length - 1; i++) {
                $('#ctl00_ContentPlaceHolder1_drpDefaultSalesPerson input[type=checkbox]').each(function () {
                    var lblValue = $(this).next('label').html();
                    splitedSales[i] = splitedSales[i].replace("'", "").replace("'", "");
                    if (lblValue.trim() == splitedSales[i].trim()) {
                        $(this).prop('checked', true);
                    }
                });
            }
    ...
    if (filterName == "DoorFrameInstalled") {
        $("#ctl00_ContentPlaceHolder1_txtDoorFrameInstalled").val(filterValue);
    }

    if (filterName == "DoorFrameDelivered") {
        $("#ctl00_ContentPlaceHolder1_txtDoorFrameDelivered").val(filterValue);
    }
    ...
    if (filterName == "LocationId" || filterName == "Location" || filterName == "LocationAddress" || filterName == "LocationCity" || filterName == "LocationZip" || filterName == "LocationType" || filterName == "EquipmentName" || filterName == "Manuf" || filterName == "EquipmentType" || filterName == "ServiceType" || filterName == "Customer" || filterName == "Acct" || filterName == "Remit") {

        $('#ctl00_ContentPlaceHolder1_drp' + filterName + ' input[type="checkbox"]').prop('checked', false);
        if (filterValue != '') {
...
jQuery(document).ready(function () {
    ...
    jQuery('.custom-tabs .tab-links a').on('click', function (e) {
        ...
        // Show/Hide Tabs
        jQuery('.custom-tabs ' + currentAttrValue).show().siblings().hide();
    ...
    $("#ctl00_ContentPlaceHolder1_btnPrint").click(function () {
        $("#ctl00_ContentPlaceHolder1_RadGrid_Project").print();
        return (false);
    });
    ...
    $("#btnPreview").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "DCALocalApprovalNoPermit.aspx/GetApprovalPreviewDetails",
    ...
    $("#btnNewReport").click(function () {
        ...
        $('#spnModelTitle').html('New Report: Open Job Report');
    ...
    $('#ctl00_ContentPlaceHolder1_drpDefaultSalesPerson input[type="checkbox"]').click(function () {
        ...
        if (filterValue != '') {
            if ($('#tblFilterChoices tr td').hasClass("defaultsalesperson")) {
                ...
                $('#tblFilterChoices tbody').append('<tr id="trDefaultSalesPerson"><td width="100px" style="height:25px;">SalesPerson</td><td  class="defaultsalesperson" width="220px"  style="height:25px;">' + filterValue + '</td></tr>');
            }
        }
        else {
    ...
    $('#ctl00_ContentPlaceHolder1_drpRemit input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpRemit", "Acct");
    });
    ...
    $("#ctl00_ContentPlaceHolder1_btnCustomizeReport").click(function () {
        ...
        var reportTitle = $("#ctl00_ContentPlaceHolder1_hdnCustomizeReportTitle").val();
        var reportSubject = $("#ctl00_ContentPlaceHolder1_hdnCustomizeReportSubject").val();
        $('#spnModelTitle').html('Modify Report : ' + reportName);
        $("#ctl00_ContentPlaceHolder1_txtReportName").val(reportName);
        $("#ctl00_ContentPlaceHolder1_txtReportTitle").val(reportTitle);
        $("#ctl00_ContentPlaceHolder1_txtSubtitle").val(reportSubject);
        var columnList = $("#ctl00_ContentPlaceHolder1_hdnColumnList").val();
        var splitedColList = columnList.split(",");
        ...
        if (filters.length == 0) {
            ...
            $(filters).each(function (index, filter) {
                if (filter.FilterValues != '') {
                    var classFilterColumns = filter.FilterColumns.replace('[', '').replace(']', '').replace(/ /g, '');

                    if (filter.FilterColumns != "State" && filter.FilterColumns != "LocationState") {
                        $('#tblFilterChoices tbody').append('<tr  id="tr' + classFilterColumns + '"><td width="100px" style="height:25px;">' + filter.FilterColumns + '</td><td  class="' + classFilterColumns.toLowerCase() + '" width="220px"  style="height:25px;">' + filter.FilterValues + '</td></tr>');
                    }
                    else {
    ...
    $('#ctl00_ContentPlaceHolder1_chkColumnList input[type=checkbox]').change(function () {
        if ($(this).is(":checked")) {
            ...
            var optionColId = "#ctl00_ContentPlaceHolder1_lstColumnSort option[value='" + $(this).parent().find('label').html() + "']";
            $(optionColId).each(function () {
                $(this).remove();
            });

            var optionSortId = "#ctl00_ContentPlaceHolder1_drpSortBy option[value='" + $(this).parent().find('label').html() + "']";
            $(optionSortId).each(function () {
                $(this).remove();
            });
        }
    });
    ...
    $('#tblFilterChoices').on('click', 'tr', function (event) {
        ...
        var filterName = $(this).find("td:first").html().replace('[', '').replace(']', '').replace(/ /g, '');
    ...
    $("#ctl00_ContentPlaceHolder1_txtDoorFrameInstalled").blur(function () {
        var filterValue = $("#ctl00_ContentPlaceHolder1_txtDoorFrameInstalled").val();
        if (filterValue != '') {
            if ($('#tblFilterChoices tr td').hasClass("doorframeinstalled")) {
                $(".doorframeinstalled").html(filterValue);
            }
            else {
                $('#tblFilterChoices tbody').append('<tr id="trDoorFrameInstalled"><td width="100px" style="height:25px;">[Door Frame Installed]</td><td  class="doorframeinstalled" width="220px"  style="height:25px;">' + filterValue + '</td></tr>');
            }
        }
        else {
            $("#trDoorFrameInstalled").remove();
        }
    });

    $("#ctl00_ContentPlaceHolder1_txtDoorFrameDelivered").blur(function () {
        var filterValue = $("#ctl00_ContentPlaceHolder1_txtDoorFrameDelivered").val();
        if (filterValue != '') {
            if ($('#tblFilterChoices tr td').hasClass("doorframedelivered")) {
                $(".doorframedelivered").html(filterValue);
            }
            else {
                $('#tblFilterChoices tbody').append('<tr id="trDoorFrameDelivered"><td width="100px" style="height:25px;">[Door Frame Delivered]</td><td  class="doorframedelivered" width="220px"  style="height:25px;">' + filterValue + '</td></tr>');
            }
        }
        else {
            $("#trDoorFrameDelivered").remove();
        }
    });
