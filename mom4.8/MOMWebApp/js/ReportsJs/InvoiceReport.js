...
function EmptyFilters() {
    ...
    $("#tblInvoice").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpInvoice input[type="checkbox"]').attr('checked', false);
    ...
    $("#tblJobRemarks").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpJobRemarks input[type="checkbox"]').attr('checked', false);
...
function setFiltersValue(filterName, filterValue) {
    ...
    if (filterName == "Job Remarks") {

        $('#ctl00_ContentPlaceHolder1_drpJobRemarks input[type="checkbox"]').attr('checked', false);
        if (filterValue != '') {
            var splitedNames = filterValue.split("|");
            for (i = 0; i <= splitedNames.length - 1; i++) {
                $('#ctl00_ContentPlaceHolder1_drpJobRemarks input[type=checkbox]').each(function () {
                    var lblValue = $(this).next('label').html();
                    splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                    if (lblValue.trim() == splitedNames[i].trim()) {
                        $(this).attr('checked', true);
    ...
    if (filterName == "Location Remarks") {

        $('#ctl00_ContentPlaceHolder1_drpLocationRemarks input[type="checkbox"]').attr('checked', false);
        if (filterValue != '') {
            var splitedNames = filterValue.split("|");
            for (i = 0; i <= splitedNames.length - 1; i++) {
                $('#ctl00_ContentPlaceHolder1_drpLocationRemarks input[type=checkbox]').each(function () {
                    var lblValue = $(this).next('label').html();
                    splitedNames[i] = splitedNames[i].replace("'", "").replace("'", "");
                    if (lblValue.trim() == splitedNames[i].trim()) {
                        $(this).attr('checked', true);
    ...
    if (filterName == "Customer" || filterName == "Location" || filterName == "Description" || filterName == "Total" || filterName == "PO" || filterName == "Invoice") {
...
jQuery(document).ready(function() {
    ...
    $("#btnPreview").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "InvoiceListingReport.aspx/GetInvoicePreviewDetails",
    ...
    $('#ctl00_ContentPlaceHolder1_drpInvoice input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpInvoice", "Invoice");
    });
    ...
    $('#ctl00_ContentPlaceHolder2_drpLocationRemarks input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpLocationRemarks", "Location Remarks");
    });
    ...
    $('#ctl00_ContentPlaceHolder1_drpType input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpType", "Department Type");
    });
    ...
    $('#ctl00_ContentPlaceHolder1_drpJobRemarks input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpJobRemarks", "Job Remarks");
    });
