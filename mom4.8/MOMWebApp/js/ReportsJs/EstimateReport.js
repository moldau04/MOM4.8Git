...
function setFiltersValue(filterName, filterValue) {
   ...
   /* if (filterName == "Status") {
    ...
    if (filterName == "ID" || filterName == "Description" || filterName == "Remarks" || filterName == "Job" || filterName == "Contact" || filterName == "Type" || filterName == "Status") {
...
jQuery(document).ready(function() {
    ...
    $("#btnPreview").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "EstimateListingReport.aspx/GetEstimatePreviewDetails",
