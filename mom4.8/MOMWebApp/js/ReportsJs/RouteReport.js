...
function EmptyFilters() {
    ...
    $("#tblMechName").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpMechName input[type="checkbox"]').attr('checked', false);
    ...
    $("#tblHour").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpHour input[type="checkbox"]').attr('checked', false);
...
function setFiltersValue(filterName, filterValue) {
    ...
    if (filterName == "Customer" || filterName == "Amount" || filterName == "Hour" || filterName == "Remarks"  || filterName == "MechName") {
...
jQuery(document).ready(function () {
    ...
    $("#btnPreview").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "RouteListingReport.aspx/GetRoutePreviewDetails",
    ...
    $('#ctl00_ContentPlaceHolder1_drpAmount input[type="checkbox"]').click(function () {
    ...
    $('#ctl00_ContentPlaceHolder1_drpMechName input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpMechName", "MechName");
    });
    ...
    $('#ctl00_ContentPlaceHolder1_drpHour input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpHour", "Hour");
    });
