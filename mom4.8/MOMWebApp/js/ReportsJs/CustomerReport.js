...
function setFiltersValue(filterName, filterValue) {
    ...
    if (filterName == "LocationId" || filterName == "LocationName" || filterName == "LocationAddress" || filterName == "LocationCity" || filterName == "LocationZip" || filterName == "LocationType" || filterName == "EquipmentName" || filterName == "Manuf" || filterName == "EquipmentType" || filterName == "ServiceType" || filterName == "Customer" || filterName == "Acct" || filterName == "Remit") {
...
jQuery(document).ready(function() {
    ...
    $("#btnPreview").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "CustomersReport.aspx/GetCustomerPreviewDetails",            
