...
function EmptyFilters() {
    ...
    $("#tblOwnerID").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpOwnerID input[type="checkbox"]').attr('checked', false);

    $("#tblOwnerName").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpOwnerName input[type="checkbox"]').attr('checked', false);

    $("#tblequipment").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpequipment input[type="checkbox"]').attr('checked', false);

    $("#tblUnique").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpUnique input[type="checkbox"]').attr('checked', false);

    $("#tblfive_year_Insp_Date").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpfive_year_Insp_Date input[type="checkbox"]').attr('checked', false);

    $("#tblannual_Insp_Date").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpannual_Insp_Date input[type="checkbox"]').attr('checked', false);

    $("#tblcustomer").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpcustomer input[type="checkbox"]').attr('checked', false);

    $("#tblInspector_Name").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpInspector_Name input[type="checkbox"]').attr('checked', false);

    $("#tblBuldingType").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpBuldingType input[type="checkbox"]').attr('checked', false);

    $("#tblEquipmentState").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpEquipmentState input[type="checkbox"]').attr('checked', false);
    ...
    $("#tblShutdown").css("display", "none");
    $("#ctl00_ContentPlaceHolder1_drpShutdown").val('All');
}
...
function setFiltersValue(filterName, filterValue) {
    ...
    if (filterName == "Shutdown") {
        filterValue == "" ? ($("#ctl00_ContentPlaceHolder1_drpShutdown").val('All')) : ($("#ctl00_ContentPlaceHolder1_drpShutdown  option:contains('" + filterValue + "')").prop('selected', true));
    }
    ...
    if (filterName == "Inspector_Name" || filterName == "BuildingType" || filterName == "EquipmentState" || filterName == "customer" || filterName == "annual_Insp_Date" || filterName == "five_year_Insp_Date" || filterName == "Unique" || filterName == "equipment" || filterName == "EquipmentName" || filterName == "Manuf" || filterName == "EquipmentType" || filterName == "ServiceType" || filterName == "OwnerName" || filterName == "OwnerID" || filterName == "Location") {
...
jQuery(document).ready(function() {
    ...
    $("#btnPreview").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "EquipmentReport.aspx/GetEquipmentPreviewDetails",
    ...
    $('#ctl00_ContentPlaceHolder1_drpBuildingType input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpBuildingType", "BuildingType");
    });

    $('#ctl00_ContentPlaceHolder1_drpEquipmentState input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpEquipmentState", "EquipmentState");
    });

    $('#ctl00_ContentPlaceHolder1_drpInspector_Name input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpInspector_Name", "Inspector_Name");
    });
    ...
    $('#ctl00_ContentPlaceHolder1_drpfive_year_Insp_Date input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpfive_year_Insp_Date", "five_year_Insp_Date");
    });

    $('#ctl00_ContentPlaceHolder1_drpUnique input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpUnique", "Unique");
    });

    $('#ctl00_ContentPlaceHolder1_drpequipment input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpequipment", "equipment");
    });

    $('#ctl00_ContentPlaceHolder1_drpOwnerName input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpOwnerName", "OwnerName");
    });

    $('#ctl00_ContentPlaceHolder1_drpOwnerID input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpOwnerID", "OwnerID");
    });
    ...
    $("#ctl00_ContentPlaceHolder1_drpShutdown").change(function () {
        var filterValue = $("#ctl00_ContentPlaceHolder1_drpShutdown option:selected").text();
        ...
        if (filterValue != 'All') {
            ...
            //    selectValue = 0;
            //}
            if ($('#tblFilterChoices tr td').hasClass("shutdown")) {
                //$(".shutdown").html(selectValue);
                $(".shutdown").html(filterValue);
            }
            else {
                //$('#tblFilterChoices tbody').append('<tr id="trshutdown"><td width="100px" style="height:25px;">Shutdown</td><td  class="shutdown" width="220px"  style="height:25px;">' + selectValue + '</td></tr>');
                $('#tblFilterChoices tbody').append('<tr id="trshutdown"><td width="100px" style="height:25px;">Shutdown</td><td  class="shutdown" width="220px"  style="height:25px;">' + filterValue + '</td></tr>');
            }
        }
        else {
            $("#trshutdown").remove();
