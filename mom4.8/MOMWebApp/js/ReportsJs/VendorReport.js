...
function EmptyFilters() {
    ...
    $("#tblCustom1").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpCustom1 input[type="checkbox"]').attr('checked', false);
...
function setFiltersValue(filterName, filterValue) {
    ...
    if (filterName == "Customer" || filterName == "Acct" || filterName == "Remit" || filterName == "DA" || filterName == "CLimit" || filterName == "Acc" || filterName == "FID" || filterName == "Terms" || filterName == "Disc" || filterName == "Days" || filterName == "InUse" || filterName == "OnePer" || filterName == "DBank" || filterName == "Custom1" || filterName == "Custom2" || filterName == "Custom3" || filterName == "Custom4" || filterName == "Custom5" || filterName == "Custom6" || filterName == "Custom7" || filterName == "Custom8" || filterName == "Custom9" || filterName == "Custom10" || filterName == "ShipVia" || filterName == "QBVendorID" || filterName == "1099") {
...
jQuery(document).ready(function() {
    ...
    $("#btnPreview").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "VendorListReport.aspx/GetVendorPreviewDetails",
    ...
    $('#ctl00_ContentPlaceHolder1_drpCustom1 input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpCustom1", "Custom1");
    });

    $('#ctl00_ContentPlaceHolder2_drpCustom1 input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpCustom2", "Custom2");
    });

    $('#ctl00_ContentPlaceHolder3_drpCustom1 input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpCustom3", "Custom3");
    });

    $('#ctl00_ContentPlaceHolder1_drpCustom4 input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpCustom4", "Custom4");
    });
