...
function EmptyFilters() {
    ...
    $("#tblProspect").css("display", "none");
    //            $("#ctl00_ContentPlaceHolder1_txtAddress").val('');
    $('#ctl00_ContentPlaceHolder1_drpProspect input[type="checkbox"]').attr('checked', false);
    ...
    $("#tblTaxRate").css("display", "none");
    $("#ctl00_ContentPlaceHolder1_txtTaxRateEqual").val('');
    $("#ctl00_ContentPlaceHolder1_txtTaxRateLessAndEqual").val('');
    $("#ctl00_ContentPlaceHolder1_txtTaxRateGreaterAndEqual").val('');
    ...
    $("#tblTaxDesc").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpTaxDesc input[type="checkbox"]').attr('checked', false);

    $("#tblTaxName").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpTaxName input[type="checkbox"]').attr('checked', false);

    $("#tblTaxRate").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpTaxRate input[type="checkbox"]').attr('checked', false);

    $("#tblSalesPerson").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpSalesPerson input[type="checkbox"]').attr('checked', false);

    $("#tblDefaultWorker").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpDefaultWorker input[type="checkbox"]').attr('checked', false);

    $("#tblBillingAddress").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpBillingAddress input[type="checkbox"]').attr('checked', false);

    $("#tblProspect").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpBillingProspect input[type="checkbox"]').attr('checked', false);

    $("#tblAcct").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpAcct input[type="checkbox"]').attr('checked', false);

    $("#tblPreferredWorker").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpPreferredWorker input[type="checkbox"]').attr('checked', false);

    $("#tbl1099").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drp1099 input[type="checkbox"]').attr('checked', false);

    $("#tblState").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpState input[type="checkbox"]').attr('checked', false);

    $("#tblCustom2").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpCustom2 input[type="checkbox"]').attr('checked', false);

    $("#tblCustom3").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpCustom3 input[type="checkbox"]').attr('checked', false);

    $("#tblCustom4").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpCustom4 input[type="checkbox"]').attr('checked', false);

    $("#tblCustom5").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpCustom5 input[type="checkbox"]').attr('checked', false);

    $("#tblCustom6").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpCustom6 input[type="checkbox"]').attr('checked', false);

    $("#tblCustom7").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpCustom7 input[type="checkbox"]').attr('checked', false);

    $("#tblCustom8").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpCustom8 input[type="checkbox"]').attr('checked', false);

    $("#tblCustom9").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpCustom9 input[type="checkbox"]').attr('checked', false);

    $("#tblCustom10").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpCustom10 input[type="checkbox"]').attr('checked', false);
    ...
    $("#tblDisc").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpDisc input[type="checkbox"]').attr('checked', false);
    ...
    $("#tblCLimit").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpCLimit input[type="checkbox"]').attr('checked', false);

    $("#tblDA").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpDA input[type="checkbox"]').attr('checked', false);

    $("#tblFID").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpFID input[type="checkbox"]').attr('checked', false);
    ...
    $("#tblZip").css("display", "none");
    $('#ctl00_ContentPlaceHolder1_drpZip input[type="checkbox"]').attr('checked', false);
    ...
    $('#tblTaxRate input[name="ctl00$ContentPlaceHolder1$TaxRate"][value="rdbTaxRateAny"]').prop('checked', true);
    $("#ctl00_ContentPlaceHolder1_txtTaxRateEqual").attr("disabled", "disabled");
    $("#ctl00_ContentPlaceHolder1_txtTaxRateLessAndEqual").attr("disabled", "disabled");
    $("#ctl00_ContentPlaceHolder1_txtTaxRateGreaterAndEqual").attr("disabled", "disabled");
...
function setFilters(filterName) {
    ...
    if (filterName == "TaxRate") {
        $("#tblTaxRate").fadeIn(200).css("display", "block");
        if ($("#ctl00_ContentPlaceHolder1_txtTaxRateEqual").val() == '' && $("#ctl00_ContentPlaceHolder1_txtTaxRateLessAndEqual").val() == '' && $("#ctl00_ContentPlaceHolder1_txtTaxRateGreaterAndEqual").val() == '') {
            $('#tblTaxRate input[name="ctl00$ContentPlaceHolder1$TaxRate"][value="rdbTaxRateAny"]').prop('checked', true);
            $("#ctl00_ContentPlaceHolder1_txtTaxRateEqual").attr("disabled", "disabled");
            $("#ctl00_ContentPlaceHolder1_txtTaxRateLessAndEqual").attr("disabled", "disabled");
            $("#ctl00_ContentPlaceHolder1_txtTaxRateGreaterAndEqual").attr("disabled", "disabled");
...
function setFiltersValue(filterName, filterValue) {
    ...
    if (filterName == "TaxRate") {
        if (filterValue == "") {
            $('#tblTaxRate input[name="ctl00$ContentPlaceHolder1$TaxRate"][value="rdbTaxRateAny"]').prop('checked', true);
            $("#ctl00_ContentPlaceHolder1_txtTaxRateEqual").val('');
            $("#ctl00_ContentPlaceHolder1_txtTaxRateEqual").attr("disabled", true);
            $("#ctl00_ContentPlaceHolder1_txtTaxRateGreaterAndEqual").val('');
            $("#ctl00_ContentPlaceHolder1_txtTaxRateGreaterAndEqual").attr("disabled", true);
            $("#ctl00_ContentPlaceHolder1_txtTaxRateLessAndEqual").val('');
            $("#ctl00_ContentPlaceHolder1_txtTaxRateLessAndEqual").attr("disabled", true);
        }
        else if ((filterValue.indexOf(">=") != -1 || filterValue.indexOf("&gt;") != -1) && filterValue.indexOf('and') == -1) {
            $("#ctl00_ContentPlaceHolder1_txtTaxRateGreaterAndEqual").attr("disabled", false);
            $('#tblTaxRate input[name="ctl00$ContentPlaceHolder1$TaxRate"][value="rdbTaxRateGreaterAndEqual"]').prop('checked', true);
            filterValue = filterValue.replace("&gt;=", '').replace(">=", '').replace("&lt;=", '').replace("<=", '').replace("=", '');
            $("#ctl00_ContentPlaceHolder1_txtTaxRateGreaterAndEqual").val(filterValue.trim());
            $("#ctl00_ContentPlaceHolder1_txtTaxRateEqual").val('');
            $("#ctl00_ContentPlaceHolder1_txtTaxRateEqual").attr("disabled", 'disabled');
            $("#ctl00_ContentPlaceHolder1_txtTaxRateLessAndEqual").val('');
            $("#ctl00_ContentPlaceHolder1_txtTaxRateLessAndEqual").attr("disabled", 'disabled');
            ...
            $("#ctl00_ContentPlaceHolder1_txtTaxRateLessAndEqual").attr("disabled", false);
            $('#tblTaxRate input[name="ctl00$ContentPlaceHolder1$TaxRate"][value="rdbTaxRateLessAndEqual"]').prop('checked', true);
            filterValue = filterValue.replace("&gt;=", '').replace(">=", '').replace("&lt;=", '').replace("<=", '').replace("=", '');
            $("#ctl00_ContentPlaceHolder1_txtTaxRateLessAndEqual").val(filterValue.trim());
            $("#ctl00_ContentPlaceHolder1_txtTaxRateEqual").val('');
            $("#ctl00_ContentPlaceHolder1_txtTaxRateEqual").attr("disabled", true);
            $("#ctl00_ContentPlaceHolder1_txtTaxRateGreaterAndEqual").val('');
            $("#ctl00_ContentPlaceHolder1_txtTaxRateGreaterAndEqual").attr("disabled", true);
            ...
            $("#ctl00_ContentPlaceHolder1_txtTaxRateGreaterAndEqual").val(greaterValue.trim());
            $("#ctl00_ContentPlaceHolder1_txtTaxRateLessAndEqual").val(lessValue.trim());
            $("#ctl00_ContentPlaceHolder1_txtTaxRateEqual").val('');
            $("#ctl00_ContentPlaceHolder1_txtTaxRateEqual").attr("disabled", true);
            $("#ctl00_ContentPlaceHolder1_txtTaxRateGreaterAndEqual").attr("disabled", false);
            $("#ctl00_ContentPlaceHolder1_txtTaxRateLessAndEqual").attr("disabled", false);
            ...
            $('#tblTaxRate input[name="ctl00$ContentPlaceHolder1$TaxRate"][value="rdbTaxRateEqual"]').prop('checked', true);
            filterValue = filterValue.replace("&gt;=", '').replace(">=", '').replace("&lt;=", '').replace("<=", '').replace("=", '');
            $("#ctl00_ContentPlaceHolder1_txtTaxRateEqual").val(filterValue.trim());
            $("#ctl00_ContentPlaceHolder1_txtTaxRateGreaterAndEqual").val('');
            $("#ctl00_ContentPlaceHolder1_txtTaxRateGreaterAndEqual").attr("disabled", true);
            $("#ctl00_ContentPlaceHolder1_txtTaxRateLessAndEqual").val('');
            $("#ctl00_ContentPlaceHolder1_txtTaxRateLessAndEqual").attr("disabled", true);
    ...
    if (filterName == "Customer" || filterName == "Location" || filterName == "PreferredWorker" || filterName == "Acc" || filterName == "BillingAddress" || filterName == "Prospect" || filterName == "SalesPerson" || filterName == "DefaultWorker" || filterName == "City" || filterName == "State" || filterName == "Zip" || filterName == "Location" || filterName == "TaxDesc" || filterName == "TaxName" || filterName == "TaxRate" || filterName == "FID" || filterName == "Terms" || filterName == "Disc" || filterName == "Days" || filterName == "InUse" || filterName == "OnePer" || filterName == "DBank" || filterName == "Custom1" || filterName == "Custom2" || filterName == "Custom3" || filterName == "Custom4" || filterName == "Custom5" || filterName == "Custom6" || filterName == "Custom7" || filterName == "Custom8" || filterName == "Custom9" || filterName == "Custom10" || filterName == "ShipVia" || filterName == "QBVendorID" || filterName == "1099") {
...
jQuery(document).ready(function() {
    ...
    $("#btnPreview").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "LocationReport.aspx/GetPESLocationPreviewDetails",
    ...
    $('#tblTaxRate input[name="ctl00$ContentPlaceHolder1$TaxRate"] + label').click(function () {
        if ($(this).text() != "Any") {
            if ($(this).text() == "=") {
                if ($("#ctl00_ContentPlaceHolder1_txtTaxRateEqual").val() == '') {
                    $("#trTaxRate").remove();
                }
                $("#ctl00_ContentPlaceHolder1_txtTaxRateEqual").attr("disabled", false);
                $("#ctl00_ContentPlaceHolder1_txtTaxRateGreaterAndEqual").val('');
                $("#ctl00_ContentPlaceHolder1_txtTaxRateGreaterAndEqual").attr("disabled", true);
                $("#ctl00_ContentPlaceHolder1_txtTaxRateLessAndEqual").val('');
                $("#ctl00_ContentPlaceHolder1_txtTaxRateLessAndEqual").attr("disabled", true);
                ...
                $("#ctl00_ContentPlaceHolder1_txtTaxRateEqual").val('');
                $("#ctl00_ContentPlaceHolder1_txtTaxRateEqual").attr("disabled", true);
                if ($("#ctl00_ContentPlaceHolder1_txtTaxRateLessAndEqual").val() == '') {
                    $("#ctl00_ContentPlaceHolder1_txtTaxRateLessAndEqual").attr("disabled", true);
                }
                else {
                    $("#ctl00_ContentPlaceHolder1_txtTaxRateLessAndEqual").attr("disabled", false);
                ...
                $("#ctl00_ContentPlaceHolder1_txtTaxRateEqual").val('');
                $("#ctl00_ContentPlaceHolder1_txtTaxRateEqual").attr("disabled", true);
                if ($("#ctl00_ContentPlaceHolder1_txtTaxRateGreaterAndEqual").val() == '') {
                    $("#ctl00_ContentPlaceHolder1_txtTaxRateGreaterAndEqual").attr("disabled", true);
                }
                else {
                    $("#ctl00_ContentPlaceHolder1_txtTaxRateGreaterAndEqual").attr("disabled", false);
    ...
    $('#ctl00_ContentPlaceHolder1_drpSalesPerson input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpSalesPerson", "SalesPerson");
    });

    $('#ctl00_ContentPlaceHolder1_drpDefaultWorker input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpDefaultWorker", "DefaultWorker");
    });

    $('#ctl00_ContentPlaceHolder1_drpState input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpState", "State");
    });
    $('#ctl00_ContentPlaceHolder1_drpZip input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpZip", "Zip");
    });
    //Rahil   

    $('#ctl00_ContentPlaceHolder1_drpPreferredWorker input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpPreferredWorker", "PreferredWorker");
    });

    $('#ctl00_ContentPlaceHolder1_drpInUse input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpInUse", "InUse");
    });
    $('#ctl00_ContentPlaceHolder1_drpDBank input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpDBank", "DBank");
    });

    $('#ctl00_ContentPlaceHolder1_drpOnePer input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpOnePer", "OnePer");
    });

    $('#ctl00_ContentPlaceHolder1_drpTerms input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpTerms", "Terms");
    });
    $('#ctl00_ContentPlaceHolder1_drpDisc input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpDisc", "Disc");
    });
    $('#ctl00_ContentPlaceHolder1_drpDays input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpDays", "Days");
    });

    $('#ctl00_ContentPlaceHolder1_drpAcc input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpAcc", "Acc");
    });

    $('#ctl00_ContentPlaceHolder1_drpBillingAddress input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpBillingAddress", "BillingAddress");
    });

    $('#ctl00_ContentPlaceHolder1_drpTaxRate input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpTaxRate", "TaxRate");
    });

    $('#ctl00_ContentPlaceHolder1_drpTaxName input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpTaxName", "TaxName");
    });

    $('#ctl00_ContentPlaceHolder1_drpTaxDesc input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpTaxDesc", "TaxDesc");
    });

    $('#ctl00_ContentPlaceHolder1_drpCLimit input[type="checkbox"]').click(function () {
        SetFiltersChoicesFLocatromDropDown("#ctl00_ContentPlaceHolder1_drpCLimit", "CLimit");
    });

    $('#ctl00_ContentPlaceHolder1_drpDA input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpDA", "DA");
    });

    $('#ctl00_ContentPlaceHolder1_drpFID input[type="checkbox"]').click(function () {
        SetFiltersChoicesFromDropDown("#ctl00_ContentPlaceHolder1_drpFID", "FID");
    });
    ...
    $("#ctl00_ContentPlaceHolder1_txtTaxRateEqual").blur(function () {
        var filterValue = $("#ctl00_ContentPlaceHolder1_txtTaxRateEqual").val();
        if (filterValue != '') {
            var getOperator = $("#tblTaxRate input[name='ctl00$ContentPlaceHolder1$TaxRate']:checked + label").text();
            if ($('#tblFilterChoices tr td').hasClass("taxrate")) {
                $(".taxrate").html(((getOperator == "Any") ? "" : getOperator) + ' ' + filterValue);
            }
            else {
                $('#tblFilterChoices tbody').append('<tr id="trTaxRate"><td width="100px" style="height:25px;">TaxRate</td><td  class="taxrate" width="220px"  style="height:25px;">' + ((getOperator == "Any") ? "" : getOperator) + ' ' + filterValue + '</td></tr>');
            }
        }
        //                else {
        //                    $("#trBalance").remove();
    ...
    $("#ctl00_ContentPlaceHolder1_txtTaxRateLessAndEqual").blur(function () {
        var filterValue = $("#ctl00_ContentPlaceHolder1_txtTaxRateLessAndEqual").val();
        if (filterValue != '') {
            var getOperator = $("#tblTaxRate input[name='ctl00$ContentPlaceHolder1$TaxRate']:checked + label").text();
            if ($('#tblFilterChoices tr td').hasClass("taxrate") && $("#ctl00_ContentPlaceHolder1_txtTaxRateGreaterAndEqual").val() != '') {
                getGreaterValue = ">=" + $("#ctl00_ContentPlaceHolder1_txtTaxRateGreaterAndEqual").val()
                $(".taxrate").html('');
                //$(".balance").html((((getOperator == "Any") ? "" : getOperator) + ' ' + filterValue) + " and " + getGreaterValue);
                $(".taxrate").html(getGreaterValue + " and " + "<=" + filterValue);
            }
            else if ($('#tblFilterChoices tr td').hasClass("taxrate") && $("#ctl00_ContentPlaceHolder1_txtTaxRateGreaterAndEqual").val() == '') {
                //$(".balance").html(((getOperator == "Any") ? "" : getOperator) + ' ' + filterValue);
                $(".taxrate").html("<=" + filterValue);
            }
            else {
                $('#tblFilterChoices tbody').append('<tr id="trTaxRate"><td width="100px" style="height:25px;">TaxRate</td><td  class="taxrate" width="220px"  style="height:25px;">' + ((getOperator == "Any") ? "" : getOperator) + ' ' + filterValue + '</td></tr>');
            }
            ...
            if ($("#ctl00_ContentPlaceHolder1_txtTaxRateGreaterAndEqual").val() == '') {
                ...
                $(".taxrate").html(">=" + $("#ctl00_ContentPlaceHolder1_txtTaxRateGreaterAndEqual").val());
            }
        }
    });

    $("#ctl00_ContentPlaceHolder1_txtTaxRateGreaterAndEqual").blur(function () {
        var filterValue = $("#ctl00_ContentPlaceHolder1_txtTaxRateGreaterAndEqual").val();
        if (filterValue != '') {
            var getOperator = $("#tblTaxRate input[name='ctl00$ContentPlaceHolder1$TaxRate']:checked + label").text();
            if ($('#tblFilterChoices tr td').hasClass("taxrate") && $("#ctl00_ContentPlaceHolder1_txtTaxRateLessAndEqual").val() != '') {
                getLessValue = "<=" + $("#ctl00_ContentPlaceHolder1_txtTaxRateLessAndEqual").val();
                $(".taxrate").html('');
                //$(".balance").html((((getOperator == "Any") ? "" : getOperator) + ' ' + filterValue) + " and " + getLessValue);
                $(".taxrate").html(">=" + filterValue + " and " + getLessValue);
            }
            else if ($('#tblFilterChoices tr td').hasClass("taxrate") && $("#ctl00_ContentPlaceHolder1_txtTaxRateLessAndEqual").val() == '') {
                //$(".balance").html(((getOperator == "Any") ? "" : getOperator) + ' ' + filterValue);
                $(".taxrate").html(">=" + filterValue);
            }
            else {
            ...
            if ($("#ctl00_ContentPlaceHolder1_txtTaxRateLessAndEqual").val() == '') {
                ...
                $(".taxrate").html("<=" + $("#ctl00_ContentPlaceHolder1_txtTaxRateLessAndEqual").val());
            }
        }
    });
