<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Mom.master" EnableEventValidation="false" CodeBehind="BillableServiceReport.aspx.cs" Inherits="BillableServiceReport" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Billable Service Report</div>
            ...
            <div class="row">
                ...
                <div class="grid_container">
                    <div class="form-section-row m-b-0">
                        <cc1:StiWebViewer ID="StiWebViewerBillableServiceReport" Height="800px" RequestTimeout="20000" runat="server" CacheMode="None" ViewMode="Continuous" ScrollbarsMode="true"
                            OnGetReport="StiWebViewerBillableServiceReport_GetReport" OnGetReportData="StiWebViewerBillableServiceReport_GetReportData"/>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Billable Service Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
