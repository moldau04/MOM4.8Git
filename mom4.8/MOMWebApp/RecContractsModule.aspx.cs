...
public partial class RecContractsModule : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (pubReportId != 0)
            {
                ...
                if (dsGetRptDetails.Tables.Count > 0)
                {
                    ...
                    if (sortBy == "Location Id" || sortBy == "Loc Type" || sortBy == "Service Type" || sortBy == "Preferred Worker" || sortBy == "Ticket Start" || sortBy == "Ticket Time" || sortBy == "Ticket Freq" || sortBy == "Bill Start" || sortBy == "Bill Amount" || sortBy == "Bill Freqency" || sortBy == "Expiration Date" || sortBy == "Phone Monitoring" || sortBy == "Contract Type" || sortBy == "Occupancy Discount" || sortBy == "Term Of Contract" || sortBy == "Price Adjustment Cap" || sortBy == "Fire Service Testing Included" || sortBy == "Special Rates" || sortBy == "Contract Expiration" || sortBy == "Prorated Items" || sortBy == "Annual Test Included" || sortBy == "Five Year State Test Included" || sortBy == "Expiration Date" || sortBy == "Fire Service Tested Included" || sortBy == "Cancellation Notification Days" || sortBy == "Price Adjustment Notification Days" || sortBy == "After Hours Calls Included" || sortBy == "OG Service Calls Included" || sortBy == "Contract Hours" || sortBy == "Contract Format")
                    {
                        sortBy = "[" + sortBy + "]";
                    }
    ...
    private void GetCustReportFiltersValue()
    {
        ...
        objProp_User.ConnConfig = Session["config"].ToString();
        dsGetCustReportFiltersValue = objBL_ReportsData.GetRecReportFiltersValue(objProp_User);
        ...
        {
            drpLocationId.DataSource = dsGetCustReportFiltersValue.Tables[1];
            drpLocationId.DataTextField = "Location Id";
            drpLocationId.DataValueField = "Location Id";
            drpLocationId.DataBind();
        }
        
        if (dsGetCustReportFiltersValue.Tables[2].Rows.Count > 0)
        {
            drpLocationName.DataSource = dsGetCustReportFiltersValue.Tables[2];
            drpLocationName.DataTextField = "Location";
            drpLocationName.DataValueField = "Location";
            drpLocationName.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[3].Rows.Count > 0)
        {
            drpLocationType.DataSource = dsGetCustReportFiltersValue.Tables[3];
            drpLocationType.DataTextField = "Loc Type";
            drpLocationType.DataValueField = "Loc Type";
            drpLocationType.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[4].Rows.Count > 0)
        {
            drpServiceType.DataSource = dsGetCustReportFiltersValue.Tables[4];
            drpServiceType.DataTextField = "Service Type";
            drpServiceType.DataValueField = "Service Type";
            drpServiceType.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[5].Rows.Count > 0)
        {
            drpDescription.DataSource = dsGetCustReportFiltersValue.Tables[5];
        ...
        {
            drpPreferredWorker.DataSource = dsGetCustReportFiltersValue.Tables[6];
            drpPreferredWorker.DataTextField = "Preferred Worker";
            drpPreferredWorker.DataValueField = "Preferred Worker";
            drpPreferredWorker.DataBind();
        }            

        if (dsGetCustReportFiltersValue.Tables[7].Rows.Count > 0)
        {
            drpTicketStart.DataSource = dsGetCustReportFiltersValue.Tables[7];
            drpTicketStart.DataTextField = "Ticket Start";
            drpTicketStart.DataValueField = "Ticket Start";
            drpTicketStart.DataBind();
        }

       
        if (dsGetCustReportFiltersValue.Tables[8].Rows.Count > 0)
        {
            drpTicketTime.DataSource = dsGetCustReportFiltersValue.Tables[8];
            drpTicketTime.DataTextField = "Ticket Time";
            drpTicketTime.DataValueField = "Ticket Time";
            drpTicketTime.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[9].Rows.Count > 0)
        {
            drpHours.DataSource = dsGetCustReportFiltersValue.Tables[9];
        ...
        {
            drpTicketFreq.DataSource = dsGetCustReportFiltersValue.Tables[10];
            drpTicketFreq.DataTextField = "Ticket Freq";
            drpTicketFreq.DataValueField = "Ticket Freq";
            drpTicketFreq.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[11].Rows.Count > 0)
        {
            drpBillStart.DataSource = dsGetCustReportFiltersValue.Tables[11];
            drpBillStart.DataTextField = "Bill Start";
            drpBillStart.DataValueField = "Bill Start";
            drpBillStart.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[12].Rows.Count > 0)
        {
            drpBillAmount.DataSource = dsGetCustReportFiltersValue.Tables[12];
            drpBillAmount.DataTextField = "Bill Amount";
            drpBillAmount.DataValueField = "Bill Amount";
            drpBillAmount.DataBind();
        }
        if (dsGetCustReportFiltersValue.Tables[13].Rows.Count > 0)
        {
            drpBillFreqency.DataSource = dsGetCustReportFiltersValue.Tables[13];
            drpBillFreqency.DataTextField = "Bill Freqency";
            drpBillFreqency.DataValueField = "Bill Freqency";
            drpBillFreqency.DataBind();
        }
        if (dsGetCustReportFiltersValue.Tables[14].Rows.Count > 0)
        {
            drpStatus.DataSource = dsGetCustReportFiltersValue.Tables[14];
        ...
        {
            drpEquipment.DataSource = dsGetCustReportFiltersValue.Tables[15];
        ...
        {
            drpExpiration.DataSource = dsGetCustReportFiltersValue.Tables[16];
            drpExpiration.DataTextField = "Expiration";
            drpExpiration.DataValueField = "Expiration";
            drpExpiration.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[17].Rows.Count > 0)
        {
            drpExpirationDate.DataSource = dsGetCustReportFiltersValue.Tables[17];
            drpExpirationDate.DataTextField = "Expiration Date";
            drpExpirationDate.DataValueField = "Expiration Date";
            drpExpirationDate.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[18].Rows.Count > 0)
        {
            drpPhoneMonitoring.DataSource = dsGetCustReportFiltersValue.Tables[18];
            drpPhoneMonitoring.DataTextField = "Phone Monitoring";
            drpPhoneMonitoring.DataValueField = "Phone Monitoring";
            drpPhoneMonitoring.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[19].Rows.Count > 0)
        {
            drpContractType.DataSource = dsGetCustReportFiltersValue.Tables[19];
            drpContractType.DataTextField = "Contract Type";
            drpContractType.DataValueField = "Contract Type";
            drpContractType.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[20].Rows.Count > 0)
        {
            drpOccupancyDiscount.DataSource = dsGetCustReportFiltersValue.Tables[20];
            drpOccupancyDiscount.DataTextField = "Occupancy Discount";
            drpOccupancyDiscount.DataValueField = "Occupancy Discount";
            drpOccupancyDiscount.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[21].Rows.Count > 0)
        {
            drpExclusions.DataSource = dsGetCustReportFiltersValue.Tables[21];
            drpExclusions.DataTextField = "Exclusions";
            drpExclusions.DataValueField = "Exclusions";
            drpExclusions.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[22].Rows.Count > 0)
        {
            drpTermOfContract.DataSource = dsGetCustReportFiltersValue.Tables[22];
            drpTermOfContract.DataTextField = "Term Of Contract";
            drpTermOfContract.DataValueField = "Term Of Contract";
            drpTermOfContract.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[23].Rows.Count > 0)
        {
            drpPriceAdjustmentCap.DataSource = dsGetCustReportFiltersValue.Tables[23];
            drpPriceAdjustmentCap.DataTextField = "Price Adjustment Cap";
            drpPriceAdjustmentCap.DataValueField = "Price Adjustment Cap";
            drpPriceAdjustmentCap.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[24].Rows.Count > 0)
        {
            drpFireServiceTestingIncluded.DataSource = dsGetCustReportFiltersValue.Tables[24];
            drpFireServiceTestingIncluded.DataTextField = "Fire Service Testing Included";
            drpFireServiceTestingIncluded.DataValueField = "Fire Service Testing Included";
            drpFireServiceTestingIncluded.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[25].Rows.Count > 0)
        {
            drpSpecialRates.DataSource = dsGetCustReportFiltersValue.Tables[25];
            drpSpecialRates.DataTextField = "Special Rates";
            drpSpecialRates.DataValueField = "Special Rates";
            drpSpecialRates.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[26].Rows.Count > 0)
        {
            drpContractExpiration.DataSource = dsGetCustReportFiltersValue.Tables[26];
            drpContractExpiration.DataTextField = "Contract Expiration";
            drpContractExpiration.DataValueField = "Contract Expiration";
            drpContractExpiration.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[27].Rows.Count > 0)
        {
            drpProratedItems.DataSource = dsGetCustReportFiltersValue.Tables[27];
            drpProratedItems.DataTextField = "Prorated Items";
            drpProratedItems.DataValueField = "Prorated Items";
            drpProratedItems.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[28].Rows.Count > 0)
        {
            drpAnnualTestIncluded.DataSource = dsGetCustReportFiltersValue.Tables[28];
            drpAnnualTestIncluded.DataTextField = "Annual Test Included";
            drpAnnualTestIncluded.DataValueField = "Annual Test Included";
            drpAnnualTestIncluded.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[29].Rows.Count > 0)
        {
            drpFiveYearStateTestIncluded.DataSource = dsGetCustReportFiltersValue.Tables[29];
            drpFiveYearStateTestIncluded.DataTextField = "Five Year State Test Included";
            drpFiveYearStateTestIncluded.DataValueField = "Five Year State Test Included";
            drpFiveYearStateTestIncluded.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[30].Rows.Count > 0)
        {
            drpFireServiceTestedIncluded.DataSource = dsGetCustReportFiltersValue.Tables[30];
            drpFireServiceTestedIncluded.DataTextField = "Fire Service Tested Included";
            drpFireServiceTestedIncluded.DataValueField = "Fire Service Tested Included";
            drpFireServiceTestedIncluded.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[31].Rows.Count > 0)
        {
            drpCancellationNotificationDays.DataSource = dsGetCustReportFiltersValue.Tables[31];
            drpCancellationNotificationDays.DataTextField = "Cancellation Notification Days";
            drpCancellationNotificationDays.DataValueField = "Cancellation Notification Days";
            drpCancellationNotificationDays.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[32].Rows.Count > 0)
        {
            drpPriceAdjustmentNotificationDays.DataSource = dsGetCustReportFiltersValue.Tables[32];
            drpPriceAdjustmentNotificationDays.DataTextField = "Price Adjustment Notification Days";
            drpPriceAdjustmentNotificationDays.DataValueField = "Price Adjustment Notification Days";
            drpPriceAdjustmentNotificationDays.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[33].Rows.Count > 0)
        {
            drpAfterHoursCallsIncluded.DataSource = dsGetCustReportFiltersValue.Tables[33];
            drpAfterHoursCallsIncluded.DataTextField = "After Hours Calls Included";
            drpAfterHoursCallsIncluded.DataValueField = "After Hours Calls Included";
            drpAfterHoursCallsIncluded.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[34].Rows.Count > 0)
        {
            drpOGServiceCallsIncluded.DataSource = dsGetCustReportFiltersValue.Tables[34];
            drpOGServiceCallsIncluded.DataTextField = "OG Service Calls Included";
            drpOGServiceCallsIncluded.DataValueField = "OG Service Calls Included";
            drpOGServiceCallsIncluded.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[35].Rows.Count > 0)
        {
            drpContractHours.DataSource = dsGetCustReportFiltersValue.Tables[35];
            drpContractHours.DataTextField = "Contract Hours";
            drpContractHours.DataValueField = "Contract Hours";
            drpContractHours.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[36].Rows.Count > 0)
        {
            drpContractFormat.DataSource = dsGetCustReportFiltersValue.Tables[36];
            drpContractFormat.DataTextField = "Contract Format";
            drpContractFormat.DataValueField = "Contract Format";
            drpContractFormat.DataBind();
        }
    ...
    private void GetCustomerDetails()
    {
        try
        {
            ...
            dsGetCustDetails = objBL_ReportsData.GetRecurringDetails(objProp_User);
            ...
            if (dsGetCustDetails.Tables.Count > 0)
            {
                ...
                dsGetCustDetails.Tables[0].TableName = "Recurring";
    ...
    protected void btnSaveReport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            objCustReport.Module = "Recurring";
    ...
    protected void btnClose_Click(object sender, EventArgs e)
    {
        try
        {
            Response.Redirect("RecContracts.aspx", false);
        }
        catch
        {
            //
    ...
    private void BindGridReport(string[] checkedColumns, string[] selectedFiltersColumns, string[] selectedFiltersValues, string sortBy)
    {
        ...
        {
            query += " FROM vw_RecurReportDetails order by " + sortBy;
        }
        else
        {
            ...
            if (selectedFiltersColumns != null)
            {
                ...
                {                   
                    ...
                    if (selectedFiltersColumns[i] == "LocationId")
                    {
                        selectedFiltersColumns[i] = "Location Id";
                    }

                    if (selectedFiltersColumns[i] == "LocType")
                    {
                        selectedFiltersColumns[i] = "Loc Type";
                    }

                    if (selectedFiltersColumns[i] == "ServiceType")
                    {
                        selectedFiltersColumns[i] = "Service Type";
                    }

                    if (selectedFiltersColumns[i] == "PreferredWorker")
                    {
                        selectedFiltersColumns[i] = "Preferred Worker";
                    }

                    if (selectedFiltersColumns[i] == "TicketStart")
                    {
                        selectedFiltersColumns[i] = "Ticket Start";
                    }

                    if (selectedFiltersColumns[i] == "TicketTime")
                    {
                        selectedFiltersColumns[i] = "Ticket Time";
                    }

                    if (selectedFiltersColumns[i] == "TicketFreq")
                    {
                        selectedFiltersColumns[i] = "Ticket Freq";
                    }

                    if (selectedFiltersColumns[i] == "BillStart")
                    {
                        selectedFiltersColumns[i] = "Bill Start";
                    }

                    if (selectedFiltersColumns[i] == "BillAmount")
                    {
                        selectedFiltersColumns[i] = "Bill Amount";
                    }

                    if (selectedFiltersColumns[i] == "BillFreqency")
                    {
                        selectedFiltersColumns[i] = "Bill Freqency";
                    }
                    if (selectedFiltersColumns[i] == "PhoneMonitoring")
                    {
                        selectedFiltersColumns[i] = "Phone Monitoring";
                    }
                    if (selectedFiltersColumns[i] == "OccupancyDiscount")
                    {
                        selectedFiltersColumns[i] = "Occupancy Discount";
                    }
                    if (selectedFiltersColumns[i] == "TermOfContract")
                    {
                        selectedFiltersColumns[i] = "Term Of Contract";
                    }
                    if (selectedFiltersColumns[i] == "ContractType")
                    {
                        selectedFiltersColumns[i] = "Contract Type";
                    }
                    if (selectedFiltersColumns[i] == "Price Adjustment Cap")
                    {
                        selectedFiltersColumns[i] = "Price Adjustment Cap";
                    }
                    if (selectedFiltersColumns[i] == "Fire Service Testing Included")
                    {
                        selectedFiltersColumns[i] = "Fire Service Testing Included";
                    }
                    if (selectedFiltersColumns[i] == "SpecialRates")
                    {
                        selectedFiltersColumns[i] = "Special Rates";
                    }
                    if (selectedFiltersColumns[i] == "ContractExpiration")
                    {
                        selectedFiltersColumns[i] = "Contract Expiration";
                    }
                    if (selectedFiltersColumns[i] == "ProratedItems")
                    {
                        selectedFiltersColumns[i] = "ProratedItems";
                    }
                    if (selectedFiltersColumns[i] == "AnnualTestIncluded")
                    {
                        selectedFiltersColumns[i] = "Annual Test Included";
                    }
                    if (selectedFiltersColumns[i] == "FiveYearStateTestIncluded")
                    {
                        selectedFiltersColumns[i] = "Five Year State Test Included";
                    }
                    if (selectedFiltersColumns[i] == "CancellationNotificationDays")
                    {
                        selectedFiltersColumns[i] = "Cancellation Notification Days";
                    }
                    if (selectedFiltersColumns[i] == "PriceAdjustmentNotificationDays")
                    {
                        selectedFiltersColumns[i] = "Price Adjustment Notification Days";
                    }
                    if (selectedFiltersColumns[i] == "AfterHoursCallsIncluded")
                    {
                        selectedFiltersColumns[i] = "After Hours Calls Included";
                    }
                    if (selectedFiltersColumns[i] == "OGServiceCallsIncluded")
                    {
                        selectedFiltersColumns[i] = "OG Service Calls Included";
                    }
                    if (selectedFiltersColumns[i] == "ContractHours")
                    {
                        selectedFiltersColumns[i] = "Contract Hours";
                    }
                    if (selectedFiltersColumns[i] == "ContractFormat")
                    {
                        selectedFiltersColumns[i] = "Contract Format";
                    }
            ...
            query += " FROM vw_RecurReportDetails where " + filters + " order by " + sortBy;
        }
        ...
        try
        {
            ...
            foreach (DataRow row in dsGetCustDetails.Tables[0].Rows)
            {
                ...
                foreach (DataColumn column in dsGetCustDetails.Tables[0].Columns)
                {
                    ...
                    if (column.ColumnName == "Hours")
                    {
                        ...
                        string hrs = Hours.ToString("#,##0.00");
                        html.Append(hrs);
                    }

                    else if (column.ColumnName == "Bill Amount")
                    {
                        decimal BillAmount = Convert.ToDecimal(row[column.ColumnName]);
                        string amt = BillAmount.ToString("#,##0.00");
                        html.Append(amt);
                    }

                    else if (column.ColumnName == "Contract Hours")
                    {
                        if (!(row[column.ColumnName] is DBNull))
                        {
                            decimal ContractHours = Convert.ToDecimal(row[column.ColumnName]);
                            string ContHrs = ContractHours.ToString("#,##0.00");
                            html.Append(ContHrs);
                        }
                    }
            ...
            for (int i = 0; i <= dsGetCustDetails.Tables[0].Columns.Count - 1; i++)
            {
               /* if (dsGetCustDetails.Tables[0].Columns[i].ToString() == "Balance")
                ...
                if (dsGetCustDetails.Tables[0].Columns[i].ToString() == "Bill Amount")
                {
                    decimal BillAmt = Convert.ToDecimal(dsGetCustDetails.Tables[0].Compute("SUM([Bill Amount])", string.Empty));
                    string BAmt = BillAmt.ToString("#,##0.00");
                    footer += "<td style='border:0;padding:20px 20px 3px 10px;color:black;font-weight:bold;'>" + "$" + BAmt + "</td>";
                }

                else if (dsGetCustDetails.Tables[0].Columns[i].ToString() == "Hours")
                {
                    decimal Hours = Convert.ToDecimal(dsGetCustDetails.Tables[0].Compute("SUM([Hours])", string.Empty));
                    string hrs = Hours.ToString("#,##0.00");
                    footer += "<td style='border:0;padding:20px 20px 3px 10px;color:black;font-weight:bold;'>" + "" + hrs + "</td>";
                }               

                /*else if (dsGetCustDetails.Tables[0].Columns[i].ToString() == "Contract Hours")
                {
                    if (!(dsGetCustDetails.Tables[0].Rows[i]["Contract Hours"] is DBNull))
                    {
                        decimal ContractHours = Convert.ToDecimal(dsGetCustDetails.Tables[0].Compute("SUM([Contract Hours])", string.Empty));
                        string ContHours = ContractHours.ToString("#,##0.00");
                        footer += "<td style='border:0;padding:20px 20px 3px 10px;color:black;font-weight:bold;'>" + "" + ContHours + "</td>";
                    }
                }*/
                else
                {
    ...
    public static string GetRecurringPreviewDetails(int reportId, string FilterColumn, string FilterValues, string ColumnWidth, string SortColumn, string DataSortBy)
    {
        try
        {
            RecContractsModule _a = new RecContractsModule();
            BL_ReportsData objBL_ReportsData = new BL_ReportsData();
            BusinessEntity.User objProp_User = new BusinessEntity.User();
            CustomerReport objCustReport = new CustomerReport();
            DataSet dsCompDetail = new DataSet();
            ...
            if (DataSortBy == "Location Id" || DataSortBy == "Loc Type" || DataSortBy == "Service Type" || DataSortBy == "Preferred Worker" || DataSortBy == "Ticket Start" || DataSortBy == "Ticket Time" || DataSortBy == "Ticket Freq" || DataSortBy == "Bill Start" || DataSortBy == "Bill Amount" || DataSortBy == "Bill Freqency" || DataSortBy == "Expiration Date" || DataSortBy == "Phone Monitoring" || DataSortBy == "Contract Type" || DataSortBy == "Occupancy Discount" || DataSortBy == "Term Of Contract" || DataSortBy == "Price Adjustment Cap" || DataSortBy == "Fire Service Testing Included" || DataSortBy == "Special Rates" || DataSortBy == "Contract Expiration" || DataSortBy == "Prorated Items" || DataSortBy == "Annual Test Included" || DataSortBy == "Five Year State Test Included" || DataSortBy == "Expiration Date" || DataSortBy == "Fire Service Tested Included" || DataSortBy == "Cancellation Notification Days" || DataSortBy == "Price Adjustment Notification Days" || DataSortBy == "After Hours Calls Included" || DataSortBy == "OG Service Calls Included" || DataSortBy == "Contract Hours" || DataSortBy == "Contract Format")
            {
            ...
            if (selectedFiltersColumns == null)
            {
                query += " FROM vw_RecurReportDetails order by " + DataSortBy;
            }
            else
            {
                string filters = string.Empty;
                ...
                filters = filters.Substring(0, filters.Length - 4);
                query += " FROM vw_RecurReportDetails where " + filters + " order by " + DataSortBy;
            }
            #endregion
