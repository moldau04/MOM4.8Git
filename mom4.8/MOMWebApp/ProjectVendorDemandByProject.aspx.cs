...
public partial class ProjectVendorDemandByProject : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                GetSMTPUser();
                SetAddress();
                string FileName = "ProjectVendorDemandByProject.pdf";
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        url += "&depts=" + depts + "&inclClosedPO=" + chkIncludeClose.Checked;
    ...
    private StiReport LoadReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/Project/ProjectVendorDemandByProject.mrt");
            ...
            var ds = objBL_Report.GetProjectVendorDemand(objPropCustomer, filters, string.Empty, depts, includeClosedProject, includeClosedPO);
            if (ds != null)
            {
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "Project Vendor Demand by Project Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Project Vendor Demand by Project Report attached.";
                }
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "ProjectVendorDemandByProject.pdf")
                        {
                ...
                mail.FileName = "ProjectVendorDemandByProject.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "ProjectVendorDemandByProject.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=ProjectVendorDemandByProject.pdf");
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached Project Vendor Demand by Project Report.";
