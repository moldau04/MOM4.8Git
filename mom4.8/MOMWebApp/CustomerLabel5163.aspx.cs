...
public partial class CustomerLabel5163 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    ddlCustomerSearch.SelectedValue = Request.QueryString["stype"];
                }

                if (!string.IsNullOrEmpty(Request.QueryString["stext"]))
                {
                    txtCustomerSearch.Text = Request.QueryString["stext"];
                }
                ...
                GetSMTPUser();
                SetAddress();
                string FileName = "CustomerLabel5163.pdf";
    ...
    protected void StiWebViewerCustomerLabel_GetReport(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
    {
        e.Report = LoadCustomerLabelReport();
    }

    protected void StiWebViewerCustomerLabel_GetReportData(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
    {
    ...
    {
        Response.Redirect("CustomerLabel5163.aspx?stype=" + ddlCustomerSearch.SelectedValue + "&stext=" + txtCustomerSearch.Text);
    }

    private StiReport LoadCustomerLabelReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/CustomerLabel5163.mrt");
            ...
            {
                ds = objBL_Report.GetCustomerLabel(objCust, new GeneralFunctions().GetSalesAsigned());
            }
    ...
    private void GetSMTPUser()
    {
        ...
        if (IsAPIIntegrationEnable == "YES")
        {
            string APINAME = "CustomersAPI/AddCustomer_ServiceHistoryReport_GetSMTPByUserID";

            APIResponse _APIResponse = new MOMWebUtility().CallMOMWebAPI(APINAME, _GetSMTPByUserID, true);

            _lstSMTPEmail = (new JavaScriptSerializer()).Deserialize<List<SMTPEmailViewModel>>(_APIResponse.ResponseData);
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "Customer Label 5163 Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Customer Label 5163 Report attached.";
                }
                ...
                service.ExportTo(LoadCustomerLabelReport(), stream, settings);
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "CustomerLabel5163.pdf")
                        {
                ...
                mail.FileName = "CustomerLabel5163.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "CustomerLabel5163.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=CustomerLabel5163.pdf");
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached Customer Label 5163 Report.";
