...
public partial class CallWarningReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            GetSMTPUser();
            SetAddress();
            string FileName = "CallWarningByRouteReport.pdf";
    ...
    {
        string reportPathStimul = Server.MapPath("StimulsoftReports/CallWarningReport.mrt");
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "Call Warning by Route Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Call Warning by Route Report attached.";
                }
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "CallWarningByRouteReport.pdf")
                        {
                ...
                mail.FileName = "CallWarningByRouteReport.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "CallWarningByRouteReport.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=CallWarningByRouteReport.pdf");
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached Call Warning by Route Report.";
