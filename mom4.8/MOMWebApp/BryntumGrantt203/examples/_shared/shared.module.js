import { WidgetHelper, AjaxHelper, DomHelper, IdHelper, Tooltip, Toast, BrowserHelper, StringHelper, LocaleManager, Localizable, DataGenerator, Fullscreen, Events, GlobalEvents, VersionHelper, EventHelper, Popup, ResizeHelper, Rectangle, Widget } from '../../build/gantt.module.js?439331';
...
const
    ...
    isModule         = pathName.endsWith('module.html') || (moduleTag && moduleTag.src.includes('app.module.js?439331')) || (pathName.endsWith('index.html') && isOnline),
    isUmd            = pathName.endsWith('umd.html');

let isSiesta = null;

try {
    isSiesta = window.parent.Siesta;
}
catch (e) {
...
class CodeEditor extends Popup {
            ...
            tbar : [
                {
                    ...
                    ref      : 'filesCombo',
                    editable : false,
                    value    : isModule ? 'app.module.js?439331' : isUmd ? 'app.umd.js?439331' : 'app.js?439331',
                    items    : [
                        isModule ? 'app.module.js?439331' : isUmd ? 'app.umd.js?439331' : 'app.js?439331'
                    ],
    ...
    async loadCode(filename = isModule ? 'app.module.js?439331' : isUmd ? 'app.umd.js?439331' : 'app.js?439331') {
        const me = this;
        ...
        if (filename.endsWith('.js?439331')) {
            me.mode = 'js';
            code = me.processJS(code);
        }
        else if (filename.endsWith('.css?439331')) {
            me.mode = 'css';
    ...
    updateDownloadLink() {
        ...
        downloadLink.href = `data:text/${this.filename.endsWith('.css?439331') ? 'css' : 'javascript'};charset=utf-8,${escape(this.codeElement.innerText)}`;
    }
    ...
    static async addToPage(button) {
        ...
        if (document.head.querySelector('[href$="app.css?439331"]')) {
            filesStore.add({ text : 'resources/app.css?439331', value : 'resources/app.css?439331' });
        }
