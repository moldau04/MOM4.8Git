<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CustomerReportMaster.master" Inherits="EscalationListingReport" EnableEventValidation="false"  Codebehind="EscalationListingReport.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script src="js/ReportsJs/EscalationReport.js" type="text/javascript"></script>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="pc-title">
                    <ul class="lnklist-header">
                        <li>
                            <asp:Label CssClass="title_text" ID="lblHeader" runat="server">Escalation Report Preview</asp:Label></li>
                                        ...
                                        <div style="float: left;">
                                            <fieldset style="border-color: #CDCDCD; width: 460px;">
                                                ...
                                                <div id="Div2" style="float: right; margin: 20px; width: 220px;">
                                                    ...
                                                    <table id="tblLocationId" style="display: none">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <asp:DropDownCheckBoxes ID="drpLocationId" runat="server" AddJQueryReference="false" UseButtons="false"
                                                                    Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                    ...
                                                    <table id="tblEscCycle" style="display: none">
                                                        <tr>
                                                            <td>Esc Cycle
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <asp:DropDownCheckBoxes ID="drpEscCycle" CssClass="form-control" runat="server" AddJQueryReference="false" UseButtons="false"
                                                    ...
                                                    <table id="tblFinishEsc" style="display: none">
                                                        <tr>
                                                            <td>Finish Esc
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <asp:DropDownCheckBoxes ID="drpFinishEsc" runat="server" AddJQueryReference="false" UseButtons="false"
                                                    ...
                                                    <table id="tblLocationName" style="display: none">
                                                     ...
                                                     <table id="tblBillingFreqency" style="display: none">
                                                        <tr>
                                                            <td>Billing Freqency
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpBillingFreqency" runat="server" AddJQueryReference="false"
                                                    ...
                                                    <table id="tblNewAmount" style="display: none">
                                                        <tr>
                                                            <td>New Amount
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpNewAmount" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" CssClass="form-control" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblEscType" style="display: none">
                                                        <tr>
                                                            <td>Esc Type
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpEscType" runat="server" AddJQueryReference="false"
                                                    ...
                                                    <table id="tblAction" style="display: none">
                                                        <tr>
                                                            <td>Action
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpAction" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblNextDue" style="display: none">
                                                        <tr>
                                                            <td>Next Due
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <asp:DropDownCheckBoxes ID="drpNextDue" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblLength" style="display: none">
                                                        <tr>
                                                            <td>Length
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpLength" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblEscFactor" style="display: none">
                                                        <tr>
                                                            <td>Esc Factor
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpEscFactor" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblLastEsc" style="display: none">
                                                        <tr>
                                                            <td>Last Esc
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpLastEsc" runat="server" AddJQueryReference="false" UseButtons="false"
                                                                    Width="150px" UseSelectAllNode="false" CssClass="form-control">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblContract" style="display: none">
                                                        <tr>
                                                            <td>Contract#
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpContract" runat="server" AddJQueryReference="false" UseButtons="false"
                                                                    Width="150px" UseSelectAllNode="false" CssClass="form-control">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                      ...
                                                      <table id="tblRenewalNotes" style="display: none">
                                                        <tr>
                                                            <td>Renewal Notes
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpRenewalNotes" runat="server" AddJQueryReference="false" UseButtons="false"
                                                                    Width="150px" UseSelectAllNode="false" CssClass="form-control">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblStartEsc" style="display: none">
                                                        <tr>
                                                            <td>Start Esc
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpStartEsc" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false" CssClass="form-control">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
