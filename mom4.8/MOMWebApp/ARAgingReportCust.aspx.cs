...
public partial class ARAgingReportCust : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                GetSMTPUser();
                SetAddress();
                string FileName = "ARAgingByCustomReport.pdf";
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        var url = "ARAgingReportCust.aspx?stype=" + ddlType.SelectedValue + "&sdate=" + txtSearchDate.Text + "&type=" + type + "&pHide=" + chkHidePartial.Checked + "&inclNotes=" + chkIncludeNotes.Checked + "&creditFlag=" + chkCreditFlag.Checked;
    ...
    private StiReport LoadReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/ARAgingByCustomReport.mrt");
            if (!string.IsNullOrEmpty(Request["type"]) && Request["type"] == "summary")
            {
                reportPathStimul = Server.MapPath("StimulsoftReports/ARAgingByCustomSummaryReport.mrt");
            }
        ...
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "ARAgingByCustomReport.pdf")
                        {
                ...
                mail.FileName = "ARAgingByCustomReport.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "ARAgingByCustomReport.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=ARAgingByCustomReport.pdf");
