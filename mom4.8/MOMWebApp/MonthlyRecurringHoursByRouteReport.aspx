<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="MonthlyRecurringHoursByRouteReport.aspx.cs" Inherits="MonthlyRecurringHoursByRouteReport" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Monthly Recurring Hours By Route/Area Report</div>
        ...
        <div class="container">
            <div class="row">
                <div class="srchpane">
                    ...
                    <div class="srchinputwrap">
                        <telerik:RadComboBox RenderMode="Auto" Skin="Metro" ID="rcRoute" runat="server" EmptyMessage="--Select Route--" Filter="StartsWith" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" Width="300" CssClass="inGrid">
                        </telerik:RadComboBox>       
                    </div>
                ...
                <div class="grid_container">
                    <div class="form-section-row" style="margin-bottom: 0 !important;">
                        <cc1:StiWebViewer ID="StiWebViewerMonthlyRecurring" Height="800px" RequestTimeout="20000" runat="server" ViewMode="Continuous" ScrollbarsMode="true" Visible="false" />
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Monthly Recurring Hours By Route/Area Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
