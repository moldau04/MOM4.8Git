...
{ 
    ...
    public partial class RTJquery : System.Web.UI.Page
    {
        ...
        protected void Page_PreRender(Object o, EventArgs e)
        {
            ...
            //ClientScript.RegisterStartupScript(Page.GetType(), "key1", "SelectedRowStyle('" + gvOpenCalls.ClientID + "');", true);
        ...
        protected void gvOpenCalls_ItemDataBound(object sender, GridItemEventArgs e)
        {
            ...
            //    {
            //        var totalHour = getTotalItem.TotalHours;
            //        GridFooterItem footerItem = (GridFooterItem)e.Item;
            //        Label lblTotalHours = (Label)footerItem.FindControl("lblTHours");
