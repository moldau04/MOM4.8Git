...
public partial class PastDueMCPReport : System.Web.UI.Page
{
    ...
    GetPastDueMCPDataParam _GetPastDueMCPData = new GetPastDueMCPDataParam();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            GetSMTPUser();
            SetAddress();
            string FileName = "PastDueMCPReport.pdf";
    ...
    protected void StiWebViewerPastDueMCP_GetReport(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
    {
        string reportPathStimul = Server.MapPath("StimulsoftReports/PastDueMCPReport.mrt");          
    ...
    protected void StiWebViewerPastDueMCP_GetReportData(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
    {
        var report = e.Report;
        try
        {
            ...
            _GetPastDueMCPData.ConnConfig = connString;
            ...
            if (IsAPIIntegrationEnable == "YES")
            {
                string APINAME = "EquipmentAPI/EquipmentReport_GetPastDueMCPData";

                APIResponse _APIResponse = new MOMWebUtility().CallMOMWebAPI(APINAME, _GetPastDueMCPData, true);

                JavaScriptSerializer serializer = new JavaScriptSerializer();

                serializer.MaxJsonLength = Int32.MaxValue;

                _lstGetPastDueMCPData = serializer.Deserialize<List<GetPastDueMCPDataViewModel>>(_APIResponse.ResponseData);
                ds = CommonMethods.ToDataSet<GetPastDueMCPDataViewModel>(_lstGetPastDueMCPData);
            }
            else
            {
                ds = bL_Report.GetPastDueMCPData(objChart);
            }
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "Past Due MCP Template Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Past Due MCP Template Report attached.";
                }
                ...
                service.ExportTo(LoadPastDueMCPReport(), stream, settings);
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "PastDueMCPReport.pdf")
                        {
                ...
                mail.FileName = "PastDueMCPReport.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "PastDueMCPReport.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=PastDueMCPReport.pdf");
    ...
    private StiReport LoadPastDueMCPReport()
    {
        string reportPathStimul = Server.MapPath("StimulsoftReports/PastDueMCPReport.mrt");
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached Past Due MCP Template Report.";
