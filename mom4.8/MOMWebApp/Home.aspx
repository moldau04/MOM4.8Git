<%@ Page Title="Home || MOM" Language="C#" MasterPageFile="~/MOM.master" AutoEventWireup="true" Inherits="Home" CodeBehind="Home.aspx.cs" %>

<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <asp:UpdatePanel ID="NewKPIDashboard" runat="server">
            <ContentTemplate>
        ...
        <asp:UpdatePanel ID="DefaultDashboard" runat="server" Visible="false">
            <ContentTemplate>
                <!--start container-->
                <div class="container">
                    <div class="container" style="text-align: center; margin-top: 220px;">
                        <h1>Welcome to Mobile Office Manager v5.0 </h1>
                    </div>
                </div>
                <!--end container-->
            </ContentTemplate>
