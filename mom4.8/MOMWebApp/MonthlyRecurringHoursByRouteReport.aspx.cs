...
public partial class MonthlyRecurringHoursByRouteReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            txtfromDate.Text = startDay.Date.ToShortDateString();
            txtToDate.Text = endDay.Date.ToShortDateString();

            GetSMTPUser();
            SetAddress();
            string FileName = "MonthlyRecurringHoursByRouteReport.pdf";
        ...
        else
        {
            ...
            StiWebViewerMonthlyRecurring.Report = LoadMonthlyRecurringHoursReport();
        }
    }
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "Monthly Recurring Hours By Route/Area Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Monthly Recurring Hours By Route/Area Report attached.";
                }
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "MonthlyRecurringHoursByRouteReport.pdf")
                        {
                ...
                mail.FileName = "MonthlyRecurringHoursByRouteReport.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "MonthlyRecurringHoursByRouteReport.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=MonthlyRecurringHoursByRouteReport.pdf");
    ...
    private StiReport LoadMonthlyRecurringHoursReport()
    {
        ...
        {
            reportPathStimul = Server.MapPath("StimulsoftReports/MonthlyRecurringHoursByRouteReport-TEI.mrt");
        }
        else
        {
            reportPathStimul = Server.MapPath("StimulsoftReports/MonthlyRecurringHoursByRouteReport.mrt");
        }
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached Monthly Recurring Hours By Route/Area Report.";
    ...
    private void FillRoute()
    {
        ...
        if (ds.Tables.Count > 0)
        {
            for(int i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                ...
                rcRoute.Items.Insert(i + 1, new RadComboBoxItem(row["Name"].ToString(), row["ID"].ToString()));
            }
        }
    }
