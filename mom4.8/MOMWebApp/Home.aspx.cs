...
public partial class Home : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        if (ConfigurationManager.AppSettings["KPIDisable"] != null && !Convert.ToBoolean(ConfigurationManager.AppSettings["KPIDisable"]))
        {
            NewKPIDashboard.Visible = true;
            ...
            if (!Page.IsPostBack)
            {
                ...
                else
                {
                    ...
                    {
                        Response.Redirect(string.Format("Home.aspx?id={0}", dsDefault.Tables[0].Rows[0]["ID"]));
                    }
    ...
    private string GetDockTitle(string tag)
    {
        ...
        switch (tag)
        {
            ...
            case "~/NewKPI/Components/TicketRecurringChart.ascx":
                title = string.Format("Monthly Recurring {0}Hours Open vs Completed", _defaultCategory);
                break;
            ...
            case "~/NewKPI/Components/TroubleCallsByEquipment.ascx":
                ...
                break;
            case "~/NewKPI/Components/TicketCountByCategoryAndDateRange.ascx":
                title = "Ticket Count By Category And Date Range";
                break;
        }
