...
public partial class GeneralLedger : System.Web.UI.Page
{
    ...
    BL_Chart bL_Chart = new BL_Chart();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    ddlAccount.SelectedValue = Request["account"];
                }
                ...
                GetSMTPUser();
                SetAddress();
                string FileName = "GeneralLedgerReport.pdf";
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            account = Convert.ToInt32(ddlAccount.SelectedValue);
        }

        var type = rdExpandAll.Checked ? "detail" : "summary";
        var url = "GeneralLedger.aspx?sd=" + txtfromDate.Text + "&ed=" + txtToDate.Text + "&account=" + account + "&type=" + type;
    ...
    {
        e.Report = LoadGeneralLedgerReport();
    }
    ...
    private StiReport LoadGeneralLedgerReport()
    {
        string reportPathStimul = Server.MapPath("StimulsoftReports/GeneralLedgerReport.mrt");
        if (!string.IsNullOrEmpty(Request["type"]) && Request["type"] == "summary")
        {
            reportPathStimul = Server.MapPath("StimulsoftReports/GeneralLedgerSummaryReport.mrt");
        }
        ...
        if (!string.IsNullOrEmpty(Request["account"]))
        {
            AcctID = Convert.ToInt32(Request["account"]);
        }

        objChart.ConnConfig = connString;
        objChart.ID = AcctID;
        objChart.StartDate = startDate;
        objChart.EndDate = endDate;

        DataSet ds = bL_Chart.GetGeneralLedgerByDate(objChart);
        if (ds != null)
        {
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "General Ledger Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the General Ledger Report attached.";
                }
                ...
                service.ExportTo(LoadGeneralLedgerReport(), stream, settings);
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "GeneralLedgerReport.pdf")
                        {
                ...
                mail.FileName = "GeneralLedgerReport.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "GeneralLedgerReport.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=GeneralLedgerReport.pdf");
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached General Ledger Report.";
    ...
    private void FillAccount()
    {
        try
        {
            ...
            DataSet dsAccount = bL_Chart.GetAllAccountDetails(objChart);
            ...
            if (dsAccount.Tables[0].Rows.Count > 0)
            {
                ...
                ddlAccount.DataSource = dsAccount;
