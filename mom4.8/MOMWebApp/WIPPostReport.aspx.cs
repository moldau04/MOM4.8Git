...
public partial class WIPPostReport : System.Web.UI.Page
{
    #region Variables
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    txtSearchDate.Text = HttpUtility.UrlDecode(Request.QueryString["edate"]);
                    StiWebViewerWIP.Visible = true;
                }
                ...
                GetSMTPUser();
                SetAddress();
                string FileName = "WIPPostReport.pdf";
    ...
    protected void StiWebViewerWIP_GetReport(object sender, StiReportDataEventArgs e)
    {
        e.Report = LoadReport();
    }

    protected void StiWebViewerWIP_GetReportData(object sender, StiReportDataEventArgs e)
    {
    ...
    {
        var url = "WIPPostReport.aspx?edate=" + txtSearchDate.Text;
    ...
    private StiReport LoadReport(bool isExport = false)
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/ProjectWIPPostReport.mrt");
            ...
            var includeClose = 1;
            DataSet ds = objBL_Customer.GetJobProjectWIPSummary(objPropCustomer, includeClose);
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the WIP Post Report attached.";
                }
                ...
                mail.FileName = "WIPPostReport.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "WIPPostReport.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=WIPPostReport.pdf");
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached WIP Post Report.";
