                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <asp:DropDownList ID="ddlUsers" CssClass="form-control" runat="server">
                                            ...
                                            <asp:ListItem Value="1">Aman</asp:ListItem>
                                            <asp:ListItem Value="1">Ravi</asp:ListItem>
                                            <asp:ListItem Value="2">Shyam</asp:ListItem>
                                            <asp:ListItem Value="4">User5</asp:ListItem>
                                            <asp:ListItem Value="5">Harish</asp:ListItem>
                                            <asp:ListItem Value="6">Tarun</asp:ListItem>
                                        </asp:DropDownList>
