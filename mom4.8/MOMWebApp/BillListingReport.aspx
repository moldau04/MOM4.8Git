<%@ Page Language="C#" MasterPageFile="~/CustomerReportMaster.master"
    AutoEventWireup="true" Inherits="BillListingReport" Title="" EnableEventValidation="false" Codebehind="BillListingReport.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script src="js/ReportsJs/BillReport.js" type="text/javascript"></script>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="pc-title">
                    <ul class="lnklist-header">
                        <li>
                            <asp:Label CssClass="title_text" ID="lblHeader" runat="server">Bill Report Preview</asp:Label></li>
                    ...
                    <div class="title_bar" style="height: 32px">
                        <div style="float: left">
                            <table>
                                <tr>
                                    ...
                                    <td class="p-l-20" style="padding-left: 20px;">
                        ...
                        <select style="width: 200px" class="tech" name="tech" id="tech" onchange="showValue(this)">
                            ...
                            Report</a>
                                    ...
                                    <td class="p-l-2" style="padding-left: 2px;">
                                    ...
                                    <td>
                                        ...
                                        <div id="dvBtnEmail">
                                            <ul class="w-66" style="width: 66px">
                                    ...
                                    <td class="pl-37" style="padding-left: 37px;">
                                       <%-- <asp:Button ID="btnClose" runat="server" Text="Close" class="myButton" OnClick="btnClose_Click" />--%>
                                        <button runat="server" id="btnClose" title="Close" onserverclick="btnClose_Click" style="font-weight:bold;">
                        ...
                        <div class="btnCuscss" style="float: right; padding-right: 50px">
                            <table>
                                <tr>
                                    <%--<td>
                                        <a id="btnCustomizeReport" class="myButton js-open-modal" href="#" data-modal-id="popup">Customize Report</a>
                                                ...
                                                <div id="Div2" style="float: right; margin: 20px; width: 220px;">
                                                    ...
                                                    <table id="tblCity" style="display: none">
                                                     ...
                                                     <table id="tblDescription" style="display: none">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpDescription" runat="server" AddJQueryReference="false" UseButtons="false"
                                                                    Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblAmount" style="display: none">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpAmount" runat="server" AddJQueryReference="false" UseButtons="false"
                                                                    Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblUseTax" style="display: none">
                                                        <tr>
                                                            <td>UseTax
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpUseTax" runat="server" AddJQueryReference="false" UseButtons="false"
                                                                    Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                      ...
                                                      <table id="tblVendorName" style="display: none">
                                                        <tr>
                                                            <td>Vendor Name
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpVendorName" runat="server" AddJQueryReference="false" UseButtons="false"
                                                                    Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblInvoiceDate" style="display: none">
                                                        <tr>
                                                            <td>Invoice Date
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpInvoiceDate" runat="server" AddJQueryReference="false" UseButtons="false"
                                                                    Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblPostingDate" style="display: none">
                                                        <tr>
                                                            <td>Posting Date
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpPostingDate" runat="server" AddJQueryReference="false" UseButtons="false"
                                                                    Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblAcct" style="display: none">
                                                        <tr>
                                                            <td>Acct
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpAcct" runat="server" AddJQueryReference="false"
                                                    ...
                                                    <table id="tblDA" style="display: none">
                                                        <tr>
                                                            <td>DA
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpDA" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
