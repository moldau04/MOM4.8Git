...
public partial class LocationWithHomeownerReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                GetSMTPUser();
                SetAddress();
                string FileName = "LocationWithHomeOwnerReport.pdf";
    ...
    protected void StiWebViewerLocationOwner_GetReport(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
    {
        e.Report = LoadLocationOwnerReport();
    }

    protected void StiWebViewerLocationOwner_GetReportData(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
    {
    ...
    protected void lnkExcel_Click(object sender, EventArgs e)
    {
        ...
        report = LoadLocationOwnerReport();
        ...
        Response.AddHeader("Content-Disposition", $"attachment;filename=LocationWithHomeOwnerReport.xls");
    ...
    private StiReport LoadLocationOwnerReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/LocationWithHomeOwnerReport.mrt");
            ...
            DataSet ds = objBL_Report.GetLocationWithHomeOwnerReport(objPropMapData, filters, inclInactive);
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = $"Location with Home Owner Report";
                ...
                {
                    mail.Text = $"This is report email sent from Mobile Office Manager. Please find the Location with Home Owner Report attached.";
                }
                ...
                System.IO.MemoryStream stream = new System.IO.MemoryStream();
                service.ExportTo(LoadLocationOwnerReport(), stream, settings);
                buffer1 = stream.ToArray();
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "LocationWithHomeOwnerReport.pdf")
                        {
                ...
                mail.FileName = "LocationWithHomeOwnerReport.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "LocationWithHomeOwnerReport.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", $"attachment;filename=LocationWithHomeOwnerReport.pdf");
    ...
    private void SetAddress()
    {
        ...
        string mailBody = $"Please review the attached Location with Home Owner Report.";
