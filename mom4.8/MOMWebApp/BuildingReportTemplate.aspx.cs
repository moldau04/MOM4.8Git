...
public partial class BuildingReportTemplate : System.Web.UI.Page
{
    ...
    GetCompletedTicketParam _GetCompletedTicket = new GetCompletedTicketParam();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            GetSMTPUser();
            SetAddress();
            string FileName = "CompletedTicketReport.pdf";
    ...
    protected void StiWebViewerBuildingTemplate_GetReport(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
    {
        e.Report = LoadReport();
    }

    protected void StiWebViewerBuildingTemplate_GetReportData(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
    {
    ...
    private StiReport LoadReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/BuildingReportTemplate-WestCoast.mrt");
            ...
            {
                objPropMapData.Department = Convert.ToInt32(HttpUtility.UrlDecode(Request.QueryString["department"]));
            }
            ...
            DataSet ds = bL_Report.GetTicketListForReport(objPropMapData, filters);
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "Building Report Template";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Building Report Template attached.";
                }
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "CompletedTicketReport.pdf")
                        {
                ...
                mail.FileName = "CompletedTicketReport.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "CompletedTicketReport.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=CompletedTicketReport.pdf");
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached Building Report Template.";
