<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="PrintBillRegisterGL" CodeBehind="PrintBillRegisterGL.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Bill Register GL Cross Reference Report</div>
            ...
            <div class="row">
                <div class="srchpane">
                   <div class="srchinputwrap">
                        <asp:DropDownList ID="ddlFilterDate" runat="server" CssClass="browser-default selectst selectsml">
                ...
                <div class="grid_container">
                    <div class="form-section-row m-b-0" >
                        <cc1:StiWebViewer ID="StiWebViewerBill" Height="800px" RequestTimeout="20000" runat="server" CacheMode="None" ViewMode="Continuous" ScrollbarsMode="true"
                            OnGetReport="StiWebViewerBill_GetReport" OnGetReportData="StiWebViewerBill_GetReportData" />
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Bill Register GL Cross Reference Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
