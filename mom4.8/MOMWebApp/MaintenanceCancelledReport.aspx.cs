...
public partial class MaintenanceCancelledReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    StiWebViewerMaintenanceCancelled.Visible = true;
                }
                //else
                //{
                ...
                GetSMTPUser();
                SetAddress();
                string FileName = "MaintenanceCancelledReport.pdf";
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached Invoices Weekly Report.";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "MaintenanceCancelledReport.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=MaintenanceCancelledReport.pdf");
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "Maintenance Cancelled Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Maintenance Cancelled Report attached.";
                }
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "MaintenanceCancelledReport.pdf")
                        {
                ...
                mail.FileName = "MaintenanceCancelledReport.pdf";
    ...
    private StiReport LoadReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/MaintenanceCancelled.mrt");
            ...
            {
                DateTime now = DateTime.Now;
                objPropContracts.StartDate = new DateTime(now.Year, now.Month, 1);
            }
            ...
            {
                objPropContracts.EndDate = DateTime.Now.Date;
            }


            objPropContracts.SearchAmtPaidUnpaid = "(0,3)";
            DataSet ds = objBL_Contracts.GetManitenanceCancelled(objPropContracts, null, null, null);
            if (ds != null && ds.Tables.Count > 0)
            {

                //DataTable rs = new DataTable();

                //using (var odConnection = new OleDbConnection(@"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\Users\Turgajo\Desktop\PTest.xlsx;Extended Properties='Excel 12.0;HDR=YES;IMEX=1;';"))
                //{
                //    odConnection.Open();
                ...
                dl.RowFilter = "CancelledDate IS NOT NULL";
    ...
    {
        var url = "MaintenanceCancelledReport.aspx?sd=" + txtfromDate.Text + "&ed=" + txtToDate.Text;
    ...
    {
        Response.Redirect("RecContracts");
    }

    //Report Get Data Event
    protected void StiWebViewerMaintenanceCancelled_GetReport(object sender, StiReportDataEventArgs e)
    {
        e.Report = LoadReport();
    }

    //Report Data Set Event
    protected void StiWebViewerMaintenanceCancelled_GetReportData(object sender, StiReportDataEventArgs e)
    {
