<%@ Page Title="" Language="C#" MasterPageFile="~/MOM.master" AutoEventWireup="true" Inherits="PrintCustomPOReport" CodeBehind="PrintCustomPOReport.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('#ctl00_ContentPlaceHolder1_rvPO_ctl05').find('input').attr('style', 'height:15px');
            $('#ctl00_ContentPlaceHolder1_rvPO_ctl05').find('td').attr('height', '0');
            $('#ctl00_ContentPlaceHolder1_rvPO_ctl05').find('td').attr('style', 'height:0px !important;padding:2px 0px 0px 0px !important;');
            $('#ctl00_ContentPlaceHolder1_rvPO_fixedTable').attr('style', 'margin-top:-20px');
            $('#ctl00_ContentPlaceHolder1_rvPO_ctl09').attr('style', 'background-color:#fff;margin-top:-18px;');
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:HiddenField ID="hdnRol" runat="server" Value="" />
    <asp:HiddenField ID="hdnShowEmail" runat="server" Value="0" />
    ...
    <div class="divbutton-container" id="printHeader">
        <div id="divButtons">
                                        ...
                                        <div class="row">
                                            <div class="page-title">
                                                <i class="mdi-editor-insert-drive-file"></i>&nbsp;
                                                 <asp:Label CssClass="title_text" ID="lblHeader" runat="server">Print Custom Purchase Order</asp:Label>
                                            </div>
                                            <div class="buttonContainer">
                                                <div class="btnlinks">
                                                    <a href="javascript:void(0);" id="aOpenEmail" onclick="ShowEmailDiv()">Email</a>
                                                </div>
                                            </div>
                                            <div class="buttonContainer">
                                                <div class="btnlinks">
                                                    <asp:LinkButton runat="server" ID="btnPrintReport" OnClick="btnPrintReport_Click" ToolTip="Print Report">
                                                    Print Report
                                                    </asp:LinkButton>
        ...
        <div style="margin-left: 5px;" id="rsweb">
            <cc1:StiWebViewer ID="StiWebViewerCustomPO" Height="800px" runat="server" ScrollbarsMode="true" CacheMode="None" RequestTimeout="900000" Zoom="100" BackgroundColor="White"
                OnGetReport="StiWebViewerCustomPO_GetReport" OnGetReportData="StiWebViewerCustomPO_GetReportData" ViewMode="Continuous" />

        </div>
    </div>

    <div class="divbutton-container" id="composeHeader" style="display: none;">
        <header>
            <div class="container row-color-grey">
                <div class="row">
                    <div class="col s12 m12 l12">
                        <div class="row">
                            <div class="col s12 m12 l12">
                                <div class="row">
                                    <div class="page-title">
                                        <i class="mdi-editor-insert-drive-file"></i>&nbsp;
                                                 <asp:Label CssClass="title_text" ID="Label1" runat="server">Email Report</asp:Label>
                                    </div>
                                    <div class="buttonContainer">
                                        <div class="btnlinks">
                                    ...
                                    <div class="buttonContainer">
                                        <div class="btnlinks">
                                            <a href="javascript:void(0);" onclick="return HideEmailDiv();">Cancel</a>
                                        </div>
                                    </div>
                                    <div class="btnclosewrap">
                                        <a href="javascript:void(0);" onclick="return HideEmailDiv();"><i class="mdi-content-clear"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="container mailtitcketcontainer" id="pnlCompose" style="display: none;">
        <div class="row">
            <div class="srchpane-advanced" style="margin: 0 !important;">
                <div class="srchpaneinner">
                    <div class="form-col">
                        ...
                        <div class="fc-input">
                            <asp:TextBox ID="txtFrom" CssClass="form-control" runat="server" Enabled="false" Placeholder="From"></asp:TextBox>
                    ...
                    <div class="form-col">
                        ...
                        <div class="fc-input">
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server"
                                ...
                                ValidationExpression="^(\s?[^\s,]+@[^\s,]+\.[^\s,]+\s?,)*(\s?[^\s,]+@[^\s,]+\.[^\s,]+)$"
                                ValidationGroup="mail"></asp:RegularExpressionValidator>
                            ...
                            <asp:AutoCompleteExtender runat="server" Enabled="True" TargetControlID="txtTo" ServicePath="CustomerAuto.asmx"
                                ...
                                ID="AutoCompleteExtender1" DelimiterCharacters="" CompletionInterval="250" OnClientItemSelected="SetSelectedValue">
                    ...
                    <div class="form-col">
                        ...
                        <div class="fc-input">
                            <asp:TextBox ID="txtCC" CssClass="form-control" runat="server" Placeholder="Cc"
                            ...
                            <asp:HiddenField ID="hdnEmailCc" runat="server" Value="" />
                            ...
                            <asp:AutoCompleteExtender runat="server" Enabled="True" TargetControlID="txtCC" ServicePath="CustomerAuto.asmx"
                                ...
                                CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem"
                                CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"
                                ID="AutoCompleteExtender2" DelimiterCharacters="" CompletionInterval="250" OnClientItemSelected="SetSelectedValueCc">
                            </asp:AutoCompleteExtender>
                        </div>
                    </div>
                    <div class="form-col">
                        ...
                        <div class="fc-input">
                            <asp:TextBox ID="txtEmailBCC" runat="server" CssClass="form-control"
                                TabIndex="9" ToolTip="Bcc"
                                onfocus="ValueBackupBCC(); redisplayAutocompleteExtenderBCC();  "
                                onclick="ValueBackupBCC(); redisplayAutocompleteExtenderBCC(); "
                                onkeydown="ValueBackupBCC(); redisplayAutocompleteExtenderBCC(); " Placeholder="Bcc"></asp:TextBox>
                            <asp:HiddenField ID="hdnEmailBCC" runat="server" Value="" />
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator8" runat="server" ControlToValidate="txtEmailBCC"
                                Display="None" ErrorMessage="Invalid E-Mail Address" ValidationExpression="^(\s?[^\s,]+@[^\s,]+\.[^\s,]+\s?,)*(\s?[^\s,]+@[^\s,]+\.[^\s,]+)$"
                            ...
                            <asp:AutoCompleteExtender runat="server" Enabled="True" TargetControlID="txtEmailBCC" ServicePath="CustomerAuto.asmx"
                                ...
                                CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem"
                                CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"
                                ID="AutoCompleteExtender3" DelimiterCharacters="" CompletionInterval="250" OnClientItemSelected="SetSelectedValueBcc">
                            </asp:AutoCompleteExtender>
                        </div>
                    </div>
                    <div class="form-col">
                        ...
                        <div class="fc-input">
                            <ul class="brws-list">
                                <asp:DataList ID="dlAttachmentsDelete" runat="server" CellPadding="0" CellSpacing="5"
                                    RepeatColumns="5" RepeatDirection="Horizontal" Style="width: auto;">
                                    <ItemTemplate>
...
<asp:Content ID="Content5" ContentPlaceHolderID="javascriptHolder" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function ShowEmailDiv() {
            $('#pnlCompose').attr('style', 'display:block');
            $('#composeHeader').attr('style', 'display:block');
            $('#printHeader').attr('style', 'display:none');
        }

        function HideEmailDiv() {
            $('#pnlCompose').attr('style', 'display:none');
            $('#composeHeader').attr('style', 'display:none');
            $('#printHeader').attr('style', 'display:block');
        }
        ...
        function CheckUncheckAllCheckBoxAsNeeded_BCC() {
            CheckUncheckAllCheckBoxAsNeeded('<%=txtEmailBCC.ClientID%>');
        }
