<%@ Page Title="Receive Payment || MOM" Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="ReceivePayment" Codebehind="ReceivePayment.aspx.cs" %>
                    ...
                    <div class="container row-color-grey">
                        <div class="row">
                            <div class="col s12 m12 l12">
                                <div class="row">
                                    <div class="page-title"><i class="mdi-action-payment"></i>&nbsp;Receive Payment</div>
                                    <div class="buttonContainer">
                                        <asp:Panel runat="server" ID="pnlGridButtons">
                                            <div class="btnlinks">
                                             ...
                                             <div class="btnlinks">
                                                <asp:LinkButton ID="lnkAddMulti" runat="server" OnClick="lnkAddMulti_Click"> Batch Receipt</asp:LinkButton>
                                            </div>
                                            <div class="btnlinks">
                                            ...
                                            <ul id="drpMenu" class="nomgn hideMenu menuList">
                                                ...
                                                <li>
                                                    ...
                                                    <ul id="dropdown1" class="dropdown-content">
                                                        <li>
                                                            <asp:LinkButton ID="lnkReceivePayment" runat="server" OnClick="lnkReceivePayment_Click">Receive Payment Report</asp:LinkButton>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li>
        ...
        <div class="row">
            ...
            <div class="grid_container">
                <div class="form-section-row" >
                    ...
                    <telerik:RadAjaxManager ID="RadAjaxManager_ReceivePayment" runat="server">
                        <AjaxSettings>
                            <telerik:AjaxSetting AjaxControlID="lnkDelete">
                                <UpdatedControls>
                                    <telerik:AjaxUpdatedControl ControlID="RadGrid_ReceivePayment" LoadingPanelID="RadAjaxLoadingPanel_ReceivePayment" />
                            ...
                            <telerik:AjaxSetting AjaxControlID="RadGrid_ReceivePayment">
                                <UpdatedControls>
                                    <telerik:AjaxUpdatedControl ControlID="RadGrid_ReceivePayment" LoadingPanelID="RadAjaxLoadingPanel_ReceivePayment" />
 <telerik:AjaxUpdatedControl ControlID="lblRecordCount"  />
                    ...
                    <telerik:RadAjaxLoadingPanel ID="RadAjaxLoadingPanel_ReceivePayment" runat="server">
                    ...
                    <div class="RadGrid RadGrid_Material">
                        <telerik:RadCodeBlock ID="codeBlock1" runat="server">
                            <script type="text/javascript">
                                function pageLoad() {
                                    var grid = $find("<%= RadGrid_ReceivePayment.ClientID %>");
                        ...
                        <telerik:RadAjaxPanel ID="RadAjaxPanel_ReceivePayment" runat="server" LoadingPanelID="RadAjaxLoadingPanel_ReceivePayment" ClientEvents-OnRequestStart="requestStart" ClientEvents-OnResponseEnd="responseEnd">
                            <telerik:RadGrid RenderMode="Auto" ID="RadGrid_ReceivePayment" AllowFilteringByColumn="true" ShowFooter="True" PageSize="50"
                                ...
                                OnNeedDataSource="RadGrid_ReceivePayment_NeedDataSource" 
                                OnPreRender="RadGrid_ReceivePayment_PreRender" 
                                OnItemCreated="RadGrid_ReceivePayment_ItemCreated" 
                                OnExcelMLExportRowCreated="RadGrid_ReceivePayment_ExcelMLExportRowCreated"
                                OnPageIndexChanged="RadGrid_ReceivePayment_PageIndexChanged"
                                OnPageSizeChanged="RadGrid_ReceivePayment_PageSizeChanged"
                               >
                                <CommandItemStyle />
                                ...
                                <MasterTableView AutoGenerateColumns="false" AllowFilteringByColumn="True" ShowFooter="True">
                                    <Columns>
                                        ...
                                        <telerik:GridClientSelectColumn UniqueName="chkSelect" HeaderStyle-Width="2%">

                                        </telerik:GridClientSelectColumn>
                                      <telerik:GridTemplateColumn DataField="ID" UniqueName="ID" HeaderText="ID" SortExpression="ID" DataType="System.String"
                                        ...
                                        <telerik:GridTemplateColumn SortExpression="PaymentReceivedDate" HeaderStyle-Width="13%" UniqueName="PaymentReceivedDate" AutoPostBackOnFilter="true" DataField="PaymentReceivedDate" DataType="System.String"
                                            CurrentFilterFunction="Contains" HeaderText="Payment Received Date" ShowFilterIcon="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblfDate" runat="server" Text='<%# Eval("PaymentReceivedDate", "{0:M/d/yyyy}") %>'></asp:Label>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridTemplateColumn DataField="CheckNumber" UniqueName="CheckNumber" HeaderText="Ref/Check" SortExpression="CheckNumber"
                                            AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" HeaderStyle-Width="8%"
                                        ...
                                        <telerik:GridTemplateColumn DataField="customerName" UniqueName="customerName" HeaderStyle-Width="18%" SortExpression="customerName" AutoPostBackOnFilter="true"
                                            CurrentFilterFunction="Contains" HeaderText="Customer Name" ShowFilterIcon="false">
                                            <ItemTemplate>
                                                <asp:HyperLink ID="lnkName" runat="server" Text='<%# Bind("customerName") %>'></asp:HyperLink>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                                        <telerik:GridBoundColumn DataField="Tag" HeaderText="Location" HeaderStyle-Width="18%" SortExpression="Tag" UniqueName="Tag"
                                            AutoPostBackOnFilter="true" CurrentFilterFunction="Contains"
                                            ShowFilterIcon="false">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="PaymentMethod" HeaderText="Payment Method" SortExpression="PaymentMethod" UniqueName="PaymentMethod"
                                            AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" HeaderStyle-Width="10%"
                                            ShowFilterIcon="false">
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="StatusName" HeaderText="Status" HeaderStyle-Width="7%" SortExpression="StatusName" UniqueName="StatusName"
                                            AutoPostBackOnFilter="true" CurrentFilterFunction="Contains"
                                            ShowFilterIcon="false">
                                        </telerik:GridBoundColumn>
                                        ...
                                        <telerik:GridTemplateColumn DataField="DepID" UniqueName="DepID" SortExpression="DepID" HeaderStyle-Width="7%" AutoPostBackOnFilter="true" CurrentFilterFunction="EqualTo" HeaderText="Deposit #" ShowFilterIcon="false">
                                            <ItemTemplate>
                                        ...
                                        <telerik:GridTemplateColumn DataField="BatchReceipt" UniqueName="BatchReceipt" HeaderStyle-Width="8%" SortExpression="BatchReceipt" AutoPostBackOnFilter="true" CurrentFilterFunction="EqualTo" HeaderText="Batch Receipt" ShowFilterIcon="false">
                                            <ItemTemplate>
                                                    <asp:HyperLink ID="lnkBatchID" Visible='<%# Eval("BatchReceipt").ToString()=="0"?false:true %>' runat="server" Text='<%# Eval("BatchReceipt") %>' Target="_blank" NavigateUrl='<%# "EditMultiReceivepayment?uid=" +Eval("BatchReceipt")  %>'></asp:HyperLink>
...
<asp:Content ID="Content3" ContentPlaceHolderID="javascriptHolder" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function closedMesg() {
            noty({
                //text: 'This receive payment has applied and cannot be deleted.',
                text:'This receive payment has been deposited and cannot be deleted.',
                type: 'warning',
                layout: 'topCenter',
