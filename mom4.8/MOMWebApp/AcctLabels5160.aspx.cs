...
public partial class AcctLabels5160 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                GetSMTPUser();
                SetAddress();
                string FileName = "LocationLabel5160.pdf";
    ...
    {
        Response.Redirect("AcctLabels5160.aspx?stype=" + ddlLocationSearch.SelectedValue + "&stext=" + txtLocationSearch.Text);
    }
    ...
    private StiReport LoadLocationLabelReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/AccountLabel5160.mrt");
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "Location Label 5160 Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Location Label 5160 Report attached.";
                }
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "LocationLabel5160.pdf")
                        {
                ...
                mail.FileName = "LocationLabel5160.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "LocationLabel5160.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=LocationLabel5160.pdf");
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached Location Label 5160 Report.";
