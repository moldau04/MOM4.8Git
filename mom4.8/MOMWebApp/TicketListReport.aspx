<%@ Page Language="C#" MasterPageFile="~/CustomerReportMaster.master" AutoEventWireup="true" Inherits="TicketListReport" Title="" EnableEventValidation="false" Codebehind="TicketListReport.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script src="js/ReportsJs/TicketReport.js" type="text/javascript"></script>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="pc-title">
                    <ul class="lnklist-header">
                        <li>
                            <asp:Label CssClass="title_text" ID="lblHeader" runat="server">TicketList Report (Signature) Preview</asp:Label></li>
                                        ...
                                        <div style="float: left;">
                                            <fieldset style="border-color: #CDCDCD; width: 460px;">
                                                ...
                                                <div id="Div2" style="float: right; margin: 20px; width: 220px;">
                                                    ...
                                                    <table id="tblassignname" style="display: none">
                                                        <tr>
                                                            <td>Assign Name
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <asp:DropDownCheckBoxes ID="drpAssignName" runat="server" AddJQueryReference="false" UseButtons="false"
                                                                    Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                    ...
                                                    <table id="tblcharge" style="display: none">
                                                        <tr>
                                                            <td>Charge
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <asp:DropDownCheckBoxes ID="drpCharge" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                      ...
                                                      <table id="tbldescres" style="display: none">
                                                        <tr>
                                                            <td>Descres
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <%-- <asp:TextBox ID="txtAddress" runat="server" CssClass="register_input_bg" Width="150px"></asp:TextBox>--%>
                                                                <asp:DropDownCheckBoxes ID="drpDescres" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblDT" style="display: none">
                                                        <tr>
                                                            <td>DT
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>                                                                
                                                                <asp:DropDownCheckBoxes ID="drpDT" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tbledate" style="display: none">
                                                        <tr>
                                                            <td>EDate
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>                                                                
                                                                <asp:DropDownCheckBoxes ID="drpedate" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblexpenses" style="display: none">
                                                        ...
                                                        <tr>
                                                            <td>                                                                
                                                                <asp:DropDownCheckBoxes ID="drpexpenses" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblfDesc" style="display: none">
                                                        <tr>
                                                            <td>fDesc
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <%-- <asp:TextBox ID="txtAddress" runat="server" CssClass="register_input_bg" Width="150px"></asp:TextBox>--%>
                                                                <asp:DropDownCheckBoxes ID="drpfDesc" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblfulladdress" style="display: none">
                                                        <tr>
                                                            <td>Full Address
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <%-- <asp:TextBox ID="txtAddress" runat="server" CssClass="register_input_bg" Width="150px"></asp:TextBox>--%>
                                                                <asp:DropDownCheckBoxes ID="drpfulladdress" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tbllocname" style="display: none">
                                                        <tr>
                                                            <td>Loc Name
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <%-- <asp:TextBox ID="txtAddress" runat="server" CssClass="register_input_bg" Width="150px"></asp:TextBox>--%>
                                                                <asp:DropDownCheckBoxes ID="drplocname" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblmanualinvoice" style="display: none">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <%-- <asp:TextBox ID="txtAddress" runat="server" CssClass="register_input_bg" Width="150px"></asp:TextBox>--%>
                                                                <asp:DropDownCheckBoxes ID="drpmanualinvoice" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblmileage" style="display: none">
                                                        <tr>
                                                            <td>Mileage
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <%-- <asp:TextBox ID="txtAddress" runat="server" CssClass="register_input_bg" Width="150px"></asp:TextBox>--%>
                                                                <asp:DropDownCheckBoxes ID="drpmileage" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblNT" style="display: none">
                                                        <tr>
                                                            <td>NT
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <%-- <asp:TextBox ID="txtAddress" runat="server" CssClass="register_input_bg" Width="150px"></asp:TextBox>--%>
                                                                <asp:DropDownCheckBoxes ID="drpNT" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblOT" style="display: none">
                                                        <tr>
                                                            <td>OT
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <%-- <asp:TextBox ID="txtAddress" runat="server" CssClass="register_input_bg" Width="150px"></asp:TextBox>--%>
                                                                <asp:DropDownCheckBoxes ID="drpOT" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblphone" style="display: none">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <%-- <asp:TextBox ID="txtAddress" runat="server" CssClass="register_input_bg" Width="150px"></asp:TextBox>--%>
                                                                <asp:DropDownCheckBoxes ID="drpphone" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblReg" style="display: none">
                                                        <tr>
                                                            <td>Reg
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <%-- <asp:TextBox ID="txtAddress" runat="server" CssClass="register_input_bg" Width="150px"></asp:TextBox>--%>
                                                                <asp:DropDownCheckBoxes ID="drpReg" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblTimeComp" style="display: none">
                                                        <tr>
                                                            <td>Time Comp
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <%-- <asp:TextBox ID="txtAddress" runat="server" CssClass="register_input_bg" Width="150px"></asp:TextBox>--%>
                                                                <asp:DropDownCheckBoxes ID="drpTimeComp" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblTimeRoute" style="display: none">
                                                        <tr>
                                                            <td>Time Route
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <%-- <asp:TextBox ID="txtAddress" runat="server" CssClass="register_input_bg" Width="150px"></asp:TextBox>--%>
                                                                <asp:DropDownCheckBoxes ID="drpTimeRoute" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                      ...
                                                      <table id="tblTimeSite" style="display: none">
                                                        <tr>
                                                            <td>Time Site
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <%-- <asp:TextBox ID="txtAddress" runat="server" CssClass="register_input_bg" Width="150px"></asp:TextBox>--%>
                                                                <asp:DropDownCheckBoxes ID="drpTimeSite" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblTottime" style="display: none">
                                                        <tr>
                                                            <td>Tot Time
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <%-- <asp:TextBox ID="txtAddress" runat="server" CssClass="register_input_bg" Width="150px"></asp:TextBox>--%>
                                                                <asp:DropDownCheckBoxes ID="drpTottime" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                     ...
                                                     <table id="tblTT" style="display: none">
                                                        <tr>
                                                            <td>TT
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <%-- <asp:TextBox ID="txtAddress" runat="server" CssClass="register_input_bg" Width="150px"></asp:TextBox>--%>
                                                                <asp:DropDownCheckBoxes ID="drpTT" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
