...
public partial class PrintProjectSummaryListing : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            GetSMTPUser();
            SetAddress();
            string FileName = "ProjectSummaryListingReport.pdf";
    ...
    protected void StiWebViewerProjectSummary_GetReport(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
    {
        e.Report = LoadProjectSummaryReport();
    }

    protected void StiWebViewerProjectSummary_GetReportData(object sender, Stimulsoft.Report.Web.StiReportDataEventArgs e)
    {
    ...
    {
        string reportPathStimul = Server.MapPath("StimulsoftReports/Project/ProjectSummaryListingReport.mrt");
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "Project Summary Listing Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Project Summary Listing Report attached.";
                }
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "ProjectSummaryListingReport.pdf")
                        {
                ...
                mail.FileName = "ProjectSummaryListingReport.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "ProjectSummaryListingReport.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=ProjectSummaryListingReport.pdf");
    ...
    private void SetAddress()
    {
        ...
        string mailBody = "Please review the attached Project Summary Listing Report.";
