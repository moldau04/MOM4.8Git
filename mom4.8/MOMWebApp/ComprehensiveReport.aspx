<%@ Page Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" CodeBehind="ComprehensiveReport.aspx.cs" Inherits="ComprehensiveReport" %>
    ...
    <div id="mainWindow">
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Comprehensive Report</div>
        ...
        <div class="container">
            <div class="row">
                <div class="srchpane">
                    <div class="srchpane">
                        <div class="srchtitle srchtitlecustomwidth" style="padding-left: 34px;">
                            Start Date
                        </div>
                        ...
                        <div class="srchtitle" style="margin-left: 30px !important">
                            Title
                        </div>
                        <div class="srchinputwrap" style="width:20%">
                    ...
                    <div class="grid_container">
                        <div class="form-section-row" style="margin-bottom: 0 !important;">
                            <cc1:StiWebViewer ID="StiWebViewerComprehensiveReport" Height="800px" RequestTimeout="20000" runat="server" CacheMode="None" Visible="false" ViewMode="Continuous" ScrollbarsMode="true"
                                OnGetReport="StiWebViewerComprehensiveReport_GetReport" OnGetReportData="StiWebViewerComprehensiveReport_GetReportData" />
                        </div>
                    </div>
                </div>
            </div>
