<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="ServiceSalesCheckUpReport.aspx.cs" Inherits="ServiceSalesCheckUpReport" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Service Sales Check Up Report</div>
            ...
            <div class="row">
                <div class="grid_container">
                    <div class="form-section-row" style="margin-bottom: 0 !important;">
                        <cc1:StiWebViewer ID="StiWebViewerReport" Height="800px" RequestTimeout="20000" runat="server" OnGetReport="StiWebViewerReport_GetReport" OnGetReportData="StiWebViewerReport_GetReportData" ViewMode="Continuous" ScrollbarsMode="true"/>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Service Sales Check Up Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
