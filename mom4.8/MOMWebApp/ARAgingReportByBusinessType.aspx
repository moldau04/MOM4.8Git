<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Mom.master" Inherits="ARAgingReportByBusinessType" CodeBehind="ARAgingReportByBusinessType.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; <span runat="server" id="pageTitle">AR Aging by Business Type Report</span></div>
                ...
                <div class="srchpane">
                    <div class="srchpaneinnernegate">
                        <div class="srchpaneinner">
                            ...
                            <div class="srchinputwrap rdleftmgn">
                                <div class="rdpairing" style="display:none">
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp;<span runat="server" id="pageEmailTitle"> AR Aging by Business Type Report</span>
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
