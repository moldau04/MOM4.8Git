<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="ProjectSummaryReport" CodeBehind="ProjectSummaryReport.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Project Summary Report</div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
                                                <a id="mailReport" href="javascript:void(0);" onclick="showMailReport();return false;">Email</a>
                                            </div>
                                            <div class="btnlinks">
                                                <asp:LinkButton ID="lnkProjectSummaryReport" runat="server" OnClick="lnkProjectSummaryReport_Click">Export to Excel</asp:LinkButton>
                                            </div>
                                        </div>
