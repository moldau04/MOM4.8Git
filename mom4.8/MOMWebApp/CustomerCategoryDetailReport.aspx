<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Mom.master" Inherits="CustomerCategoryDetailReport" CodeBehind="CustomerCategoryDetailReport.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Customer Ticket Category by Last Service Date</div>
            ...
            <div class="grid_container">
                <div class="form-section-row" style="margin-bottom: 0 !important;">
                    <cc1:StiWebViewer ID="StiWebViewerCustomerCategoryDetailReport" Height="800px" RequestTimeout="20000" CacheMode="None" runat="server" ViewMode="Continuous" ScrollbarsMode="true"
                        OnGetReport="StiWebViewerCustomerCategoryDetailReport_GetReport" OnGetReportData="StiWebViewerCustomerCategoryDetailReport_GetReportData" Visible="false" />
                </div>
            </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Customer Ticket Category by Last Service Date
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
