<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Mom.master" EnableEventValidation="false" CodeBehind="InvoicebyBillingCodes.aspx.cs" Inherits="InvoicebyBillingCodes" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Invoice By Billing Codes Report</div>
            ...
            <div class="row">
                ...
                <div class="srchpane">
                    ...
                    <div class="col s12">
                        ...
                        <div class="srchinputwrap srchinputwrap-w ">
                            <telerik:RadComboBox EmptyMessage="Select Billing Code" RenderMode="Auto" ID="ddlBLCategory" runat="server" CssClass="browser-default selectst dllCategory" CheckBoxes="true" EnableCheckAllItemsCheckBox="true" OnDataBinding="ddlBLCategory_DataBinding">
                            </telerik:RadComboBox>
                        </div>
                ...
                <div class="grid_container">
                    <div class="form-section-row m-b-0" >
                        <cc1:StiWebViewer ID="StiWebViewerInvoices" Height="800px" RequestTimeout="20000" runat="server" CacheMode="None" ViewMode="Continuous" ScrollbarsMode="true"
                            OnGetReport="StiWebViewerInvoices_GetReport" OnGetReportData="StiWebViewerInvoices_GetReportData" Visible="false" />
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Invoice By Billing Codes Report
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
                ...
                <div class="srchpane-advanced margin">
                    <div class="srchpaneinner">
                        ...
                        <div class="form-col">
                            ...
                            <div class="fc-input">
                                <asp:TextBox ID="txtCC" runat="server" CssClass="form-control" Placeholder="Cc"
                                    ...
                                    onkeydown="ValueBackupCC(); redisplayAutocompleteExtenderCC();">
                                </asp:TextBox>
                        ...
                        <div class="form-col">
                            <div class="fc-label">
                                <label>
                                    <asp:HyperLink ID="lnkBCC" runat="server" class="hyr-css" 
                                        OnClick="return OpenEmailsSelectionWindow_BCC();" Text="Bcc"></asp:HyperLink>
                                </label>
                            </div>
                            <div class="fc-input">
                                <asp:TextBox ID="txtEmailBCC" runat="server" CssClass="form-control"
                                    ...
                                    onkeydown="ValueBackupBCC(); redisplayAutocompleteExtenderBCC();">
                                </asp:TextBox>
                        ...
                        <div class="form-col">
                            ...
                            <div class="fc-input">
                                <asp:TextBox ID="txtSubject" runat="server"
                                    ...
                                    TabIndex="9" ToolTip="Subject" Placeholder="Subject">
                                </asp:TextBox>
                            </div>
                        </div>
