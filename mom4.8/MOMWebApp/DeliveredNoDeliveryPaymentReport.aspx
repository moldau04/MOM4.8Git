<%@ Page Language="C#" MasterPageFile="~/CustomerReportMaster.master" AutoEventWireup="true" Inherits="DeliveredNoDeliveryPaymentReport" Title="" EnableEventValidation="false" Codebehind="DeliveredNoDeliveryPaymentReport.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script src="js/ReportsJs/DeliveryReport.js" type="text/javascript"></script>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="pc-title">
                    <ul class="lnklist-header">
                        <li>
                            <asp:Label CssClass="title_text" ID="lblHeader" runat="server">Delivered No Delivery Payment Report Preview</asp:Label></li>
                ...
                <div class="com-cont">
                    ...
                    <div style="margin-left: 5px; padding-top: 20px;" align="center">
                        ...
                        <div id="dvGridReport" runat="server" style="display: none;">
                            ...
                            <div style="width: 100%; overflow: auto; padding-top: 20px;" align="left">
