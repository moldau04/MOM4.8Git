...
public partial class PrintJobActualBudget_New : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!IsPostBack)
            {
                GetSMTPUser();
                SetAddress();
                string FileName = "ProjectActualVsBudgetReport.pdf";
    ...
    private StiReport LoadCustomerTicketCategorybyLastServiceReport()
    {
        try
        {
            string reportPathStimul = Server.MapPath("StimulsoftReports/Project/ProjectActualVsBudgetReport.mrt");
    ...
    protected void hideModalPopupViaServerConfirm_Click(object sender, EventArgs e)
    {
        if (txtTo.Text.Trim() != string.Empty)
        {
            try
            {
                ...
                mail.Title = "Project Actual Vs Budget Report";
                ...
                {
                    mail.Text = "This is report email sent from Mobile Office Manager. Please find the Project Actual Vs Budget Report attached.";
                }
                ...
                if (ViewState["pathmailatt"] != null)
                {
                    ...
                    {
                        if (strpath != "ProjectActualVsBudgetReport.pdf")
                        {
                ...
                mail.FileName = "ProjectActualVsBudgetReport.pdf";
    ...
    private void DownloadDocument(string filePath, string DownloadFileName)
    {
        ...
        {
            if (DownloadFileName == "ProjectActualVsBudgetReport.pdf")
            {
                byte[] buffer1 = null;
                ...
                Response.AddHeader("content-disposition", "attachment;filename=ProjectActualVsBudgetReport.pdf");
    ...
    private void SetAddress()
    {
        ...
        if (dsC.Tables[0].Rows.Count > 0)
        {
            ...
            string mailBody = "Please review the attached Project Actual Vs Budget Report.";
