<%@ Page Title="" Language="C#" MasterPageFile="~/MOM.master" AutoEventWireup="true" Inherits="MaintenanceControlPlan" CodeBehind="MaintenanceControlPlan.aspx.cs" %>
                        ...
                        <div class="container row-color-grey">
                            <div class="row">
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title"><i class="mdi-action-swap-vert-circle"></i>&nbsp; Maintenance Control Plan</div>
            ...
            <div class="row">
                <div class="grid_container">
                    <div class="form-section-row" style="margin-bottom: 0 !important;">
                        <cc1:StiWebViewer ID="StiWebViewerMCP" Height="800px" runat="server" ScrollbarsMode="true" ViewMode="Continuous" BackgroundColor="White" CacheMode="None"
                            OnGetReport="StiWebViewerMCP_GetReport" OnGetReportData="StiWebViewerMCP_GetReportData" Visible="true" RequestTimeout="9000000" />
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col s12 m12 l12">
                                    <div class="row">
                                        <div class="page-title">
                                            <i class="mdi-action-swap-vert-circle"></i>&nbsp; Maintenance Control Plan
                                        </div>
                                        <div class="buttonContainer">
                                            <div class="btnlinks">
