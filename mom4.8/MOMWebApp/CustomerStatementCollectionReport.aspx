<%@ Page Title="" Language="C#" MasterPageFile="~/Mom.master" AutoEventWireup="true" Inherits="CustomerStatementCollectionReport" CodeBehind="CustomerStatementCollectionReport.aspx.cs" %>
                    ...
                    <div class="srchpaneinnernegate">
                        <div class="srchpaneinner">                  
                            <div class="srchinputwrap">
                                <div class="rdpairing" style="margin-top: 5px">
                ...
                <div class="grid_container">
                    <div class="form-section-row">
                        <cc1:StiWebViewer ID="StiWebViewerStatement" Height="800px" runat="server" ScrollbarsMode="true" ViewMode="Continuous" CacheMode="None" BackgroundColor="White"
                            OnGetReport="StiWebViewerStatement_GetReport" OnGetReportData="StiWebViewerStatement_GetReportData" RequestTimeout="9000000" />
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <ContentTemplate>
                                <asp:Panel runat="Server" ID="programmaticPopupDragHandle" Style="cursor: move; background-color: #DDDDDD;">
                                    <div class="model-popup-body">
                                        ...
                                        <asp:LinkButton runat="server" ID="hideModalPopupViaServerConfirm" Text="Send"
