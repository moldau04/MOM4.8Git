<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CustomerReportMaster.master" Inherits="OpportunityListingReport" Title="" EnableEventValidation="false" CodeBehind="OpportunityListingReport.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script src="js/ReportsJs/OpportunityReport.js" type="text/javascript"></script>
    ...
    <style type="text/css">
        ...
        #tblResize .resize-header {
            ...
            #ctl00_ContentPlaceHolder1_dvGridReport{
            ...
            <div class="col-lg-12 col-md-12">
                <div class="pc-title">
                    <ul class="lnklist-header">
                        <li>
                            <asp:Label CssClass="title_text" ID="lblHeader" runat="server">Opportunity Report Preview</asp:Label></li>
                        ...
                        <div style="float: left">
                            <table>
                                <tr>
                                    ...
                                    <td style="padding-left: 20px;">
                                        <a id="btnNewReport" class="myButton js-open-modal" href="#" data-modal-id="popup">New Report</a>
                                    </td>
                                        ...
                                        <div style="float: left;">
                                            <fieldset style="border-color: #CDCDCD; width: 460px;">
                                                ...
                                                <div>
                                                    ...
                                                    <asp:TextBox ID="txtStartDate" runat="server" MaxLength="50" Width="130px" autocomplete="off"></asp:TextBox>
                                                    <asp:CalendarExtender ID="txtStartDate_CalendarExtender" runat="server" Enabled="True"
                                                        TargetControlID="txtStartDate">
                                                    </asp:CalendarExtender>
                                                    <asp:RequiredFieldValidator ID="rfvStartDt" Enabled="true"
                                                    ...
                                                    <label for="" style="margin-left: 35px; margin-bottom: 19px;">End Date</label>
                                                    <asp:TextBox ID="txtEndDate" runat="server" MaxLength="50" Width="130px" autocomplete="off"></asp:TextBox>
                                                    <asp:CalendarExtender ID="txtEndDate_CalendarExtender" runat="server" Enabled="True"
                                                        TargetControlID="txtEndDate">
                                                    </asp:CalendarExtender>
                                                    <asp:RequiredFieldValidator ID="rfvEndDt" Enabled="true"
                                                ...
                                                <div id="Div2" style="float: right; margin: 20px; width: 220px;">
                                                    ...
                                                    <table id="tblOpportunity" style="display: none">
                                                        <tr>
                                                            <td>Opportunity#
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpOpportunity" runat="server" AddJQueryReference="false" UseButtons="false"
                                                                    Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblSalesPerson" style="display: none">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpSalesPerson" runat="server" AddJQueryReference="false" UseButtons="false"
                                                                    Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblEstimate" style="display: none">
                                                        <tr>
                                                            <td>Estimate#
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpEstimate" runat="server" AddJQueryReference="false" UseButtons="false"
                                                                    Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="170"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblClosed" style="display: none">
                                                        <tr>
                                                            <td>Closed
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <asp:DropDownCheckBoxes ID="drpClosed" runat="server" CssClass="form-control" AddJQueryReference="false"
                                                    ...
                                                    <table id="tblAmount" style="display: none">
                                                        <tr>
                                                            <td colspan="4">Amount
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td colspan="4">
                                                                <asp:RadioButton ID="rdbAmtAny" runat="server" GroupName="Amount" Text="Any" CssClass="ListControl" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbAmtEqual" runat="server" Width="40px" GroupName="Amount" Text="="
                                                                    CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtAmtEqual" runat="server" CssClass="form-control" Width="80px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbAmtLessAndEqual" runat="server" Width="40px" GroupName="Amount"
                                                                    Text="&lt;=" CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtAmtLessAndEqual" runat="server" CssClass="form-control"
                                                                    Width="80px"></asp:TextBox>
                                                                <span style="padding-left: 10px;">and</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:RadioButton ID="rdbAmtGreaterAndEqual" runat="server" Width="40px" GroupName="Amount"
                                                                    Text="&gt;=" CssClass="ListControl" />
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txtAmtGreaterAndEqual" runat="server" CssClass="form-control"
                                                                    Width="80px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    <table id="tblRemarks" style="display: none">
                                                        <tr>
                                                            <td>Remarks
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpRemarks" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" UseSelectAllNode="false" CssClass="form-control">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblContact" style="display: none">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpContact" runat="server" AddJQueryReference="false"
                                                    ...
                                                    <table id="tblProbability" style="display: none">
                                                        <tr>
                                                            <td>Probability
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpProbability" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblCloseDate" style="display: none">
                                                        <tr>
                                                            <td>CloseDate
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpCloseDate" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
                                                    ...
                                                    <table id="tblInUse" style="display: none">
                                                        <tr>
                                                            <td>InUse
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:DropDownCheckBoxes ID="drpInUse" runat="server" AddJQueryReference="false"
                                                                    UseButtons="false" Width="150px" CssClass="form-control" UseSelectAllNode="false">
                                                                    <Style2 SelectBoxWidth="200" DropDownBoxBoxWidth="200" DropDownBoxBoxHeight="130"
                                                                        SelectBoxCssClass="ListControl" />
                                                                    <Texts SelectBoxCaption="Select" />
