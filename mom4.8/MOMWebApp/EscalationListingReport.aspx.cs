...
public partial class EscalationListingReport : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (pubReportId != 0)
            {
                ...
                if (dsGetRptDetails.Tables.Count > 0)
                {
                    ...
                    if (sortBy == "Location Id" || sortBy == "Location Name" || sortBy == "Service Type" || sortBy == "Billing Freqency" || sortBy == "Esc Type" || sortBy == "Esc Cycle" || sortBy == "Esc Factor" || sortBy == "Last Esc" || sortBy == "Start Esc" || sortBy == "Finish Esc" || sortBy == "Expiration Date" || sortBy == "Phone Monitoring" || sortBy == "Next Due" || sortBy == "New Amount" || sortBy == "Contract #" || sortBy == "Renewal Notes")
                    {
                        sortBy = "[" + sortBy + "]";
                    }
    ...
    private void GetCustReportFiltersValue()
    {
        ...
        objProp_User.ConnConfig = Session["config"].ToString();
        dsGetCustReportFiltersValue = objBL_ReportsData.GetEscalationReportFiltersValue(objProp_User);

        if (dsGetCustReportFiltersValue.Tables[0].Rows.Count > 0)
        {
            drpLocationId.DataSource = dsGetCustReportFiltersValue.Tables[0];
        ...
        {
            drpLocationName.DataSource = dsGetCustReportFiltersValue.Tables[1];
        ...
        {
            drpServiceType.DataSource = dsGetCustReportFiltersValue.Tables[2];
        ...
        {
            drpDescription.DataSource = dsGetCustReportFiltersValue.Tables[3];
        ...
        {
            drpBillingFreqency.DataSource = dsGetCustReportFiltersValue.Tables[4];
            drpBillingFreqency.DataTextField = "Billing Freqency";
            drpBillingFreqency.DataValueField = "Billing Freqency";
            drpBillingFreqency.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[5].Rows.Count > 0)
        {
            drpEscType.DataSource = dsGetCustReportFiltersValue.Tables[5];
            drpEscType.DataTextField = "Esc Type";
            drpEscType.DataValueField = "Esc Type";
            drpEscType.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[6].Rows.Count > 0)
        {
            drpAction.DataSource = dsGetCustReportFiltersValue.Tables[6];
            drpAction.DataTextField = "Action";
            drpAction.DataValueField = "Action";
            drpAction.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[7].Rows.Count > 0)
        {
            drpEscCycle.DataSource = dsGetCustReportFiltersValue.Tables[7];
            drpEscCycle.DataTextField = "Esc Cycle";
            drpEscCycle.DataValueField = "Esc Cycle";
            drpEscCycle.DataBind();
        }
        
        if (dsGetCustReportFiltersValue.Tables[8].Rows.Count > 0)
        {
            drpEscFactor.DataSource = dsGetCustReportFiltersValue.Tables[8];
            drpEscFactor.DataTextField = "Esc Factor";
            drpEscFactor.DataValueField = "Esc Factor";
            drpEscFactor.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[9].Rows.Count > 0)
        {
            drpLastEsc.DataSource = dsGetCustReportFiltersValue.Tables[9];
            drpLastEsc.DataTextField = "Last Esc";
            drpLastEsc.DataValueField = "Last Esc";
            drpLastEsc.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[10].Rows.Count > 0)
        {
            drpStartEsc.DataSource = dsGetCustReportFiltersValue.Tables[10];
            drpStartEsc.DataTextField = "Start Esc";
            drpStartEsc.DataValueField = "Start Esc";
            drpStartEsc.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[11].Rows.Count > 0)
        {
            drpFinishEsc.DataSource = dsGetCustReportFiltersValue.Tables[11];
            drpFinishEsc.DataTextField = "Finish Esc";
            drpFinishEsc.DataValueField = "Finish Esc";
            drpFinishEsc.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[12].Rows.Count > 0)
        {
            drpNextDue.DataSource = dsGetCustReportFiltersValue.Tables[12];
            drpNextDue.DataTextField = "Next Due";
            drpNextDue.DataValueField = "Next Due";
            drpNextDue.DataBind();
        }
        if (dsGetCustReportFiltersValue.Tables[14].Rows.Count > 0)
        {
            drpNewAmount.DataSource = dsGetCustReportFiltersValue.Tables[14];
            drpNewAmount.DataTextField = "New Amount";
            drpNewAmount.DataValueField = "New Amount";
            drpNewAmount.DataBind();
        }
        if (dsGetCustReportFiltersValue.Tables[15].Rows.Count > 0)
        {
            drpLength.DataSource = dsGetCustReportFiltersValue.Tables[15];
            drpLength.DataTextField = "Length";
            drpLength.DataValueField = "Length";
            drpLength.DataBind();
        }

        if (dsGetCustReportFiltersValue.Tables[16].Rows.Count > 0)
        {
            drpContract.DataSource = dsGetCustReportFiltersValue.Tables[16];
            drpContract.DataTextField = "Contract";
            drpContract.DataValueField = "Contract";
        ...
        {
            drpExpirationDate.DataSource = dsGetCustReportFiltersValue.Tables[18];
            drpExpirationDate.DataTextField = "Renewal Notes";
            drpExpirationDate.DataValueField = "Renewal Notes";
            drpExpirationDate.DataBind();
        }
    ...
    private void GetCustomerDetails()
    {
        try
        {
            ...
            dsGetCustDetails = objBL_ReportsData.GetEscalationDetails(objProp_User);
            ...
            if (dsGetCustDetails.Tables.Count > 0)
            {
                ...
                dsGetCustDetails.Tables[0].TableName = "Escalation";
    ...
    protected void btnSaveReport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            objCustReport.Module = "Escalation";
    ...
    private void BindGridReport(string[] checkedColumns, string[] selectedFiltersColumns, string[] selectedFiltersValues, string sortBy)
    {
        ...
        {
            query += " FROM vw_EscalationContracts order by " + sortBy;
        }
        else
        {
            ...
            if (selectedFiltersColumns != null)
            {
                for (int i = 0; i <= selectedFiltersColumns.Count() - 1; i++)
                {
                    ...
                    if (selectedFiltersColumns[i] == "BillingFreqency")
                    {
                        selectedFiltersColumns[i] = "BillingFreqency";
                    }
                    ...
                    if (selectedFiltersColumns[i] == "Esc Type")
                    {
                        selectedFiltersColumns[i] = "EscType";
                    }

                    if (selectedFiltersColumns[i] == "Esc Cycle")
                    {
                        selectedFiltersColumns[i] = "EscCycle";
                    }

                    if (selectedFiltersColumns[i] == "EscFactor")
                    {
                        selectedFiltersColumns[i] = "Esc Factor";
                    }

                    if (selectedFiltersColumns[i] == "StartEsc")
                    {
                        selectedFiltersColumns[i] = "Start Esc";
                    }

                    if (selectedFiltersColumns[i] == "LastEsc")
                    {
                        selectedFiltersColumns[i] = "Last Esc";
                    }

                    if (selectedFiltersColumns[i] == "NextDue")
                    {
                        selectedFiltersColumns[i] = "Next Due";
                    }

                    if (selectedFiltersColumns[i] == "FinishEsc")
                    {
                        selectedFiltersColumns[i] = "Finish Esc";
                    }
                    if (selectedFiltersColumns[i] == "New Amount")
                    {
                        selectedFiltersColumns[i] = "New Amount";
                    }
                    if (selectedFiltersColumns[i] == "Contract#")
                    {
                        selectedFiltersColumns[i] = "Contract #";
                    }
                    if (selectedFiltersColumns[i] == "Renewal Notes")
                    {
                        selectedFiltersColumns[i] = "Renewal Notes";
                    }
                    if (selectedFiltersColumns[i] == "ExpirationDate")
                    {
                        selectedFiltersColumns[i] = "Expiration Date";
                    }
            ...
            query += " FROM vw_EscalationContracts where " + filters + " order by " + sortBy;
        }
        ...
        try
        {
            ...
            foreach (DataRow row in dsGetCustDetails.Tables[0].Rows)
            {
                ...
                foreach (DataColumn column in dsGetCustDetails.Tables[0].Columns)
                {
                    ...
                    else if (column.ColumnName == "New Amount")
                    {
                        decimal NewAmount = Convert.ToDecimal(row[column.ColumnName]);
                        string NewAmt = NewAmount.ToString("#,##0.00");
                        html.Append(NewAmt);
                    }
            ...
            for (int i = 0; i <= dsGetCustDetails.Tables[0].Columns.Count - 1; i++)
            {
               /* if (dsGetCustDetails.Tables[0].Columns[i].ToString() == "Balance")
                ...
                if (dsGetCustDetails.Tables[0].Columns[i].ToString() == "Amount")
                {
                ...
                else if (dsGetCustDetails.Tables[0].Columns[i].ToString() == "New Amount")
                {
                    decimal NewAmount = Convert.ToDecimal(dsGetCustDetails.Tables[0].Compute("SUM([New Amount])", string.Empty));
                    string NewAmt = NewAmount.ToString("#,##0.00");
                    footer += "<td style='border:0;padding:20px 20px 3px 10px;color:black;font-weight:bold;'>" + "" + NewAmt + "</td>";
                }               
    ...
    public static string GetEscalationPreviewDetails(int reportId, string FilterColumn, string FilterValues, string ColumnWidth, string SortColumn, string DataSortBy)
    {
        try
        {
            EscalationListingReport _a = new EscalationListingReport();
            BL_ReportsData objBL_ReportsData = new BL_ReportsData();
            BusinessEntity.User objProp_User = new BusinessEntity.User();
            CustomerReport objCustReport = new CustomerReport();
            DataSet dsCompDetail = new DataSet();
            ...
            if (DataSortBy == "Location Id" || DataSortBy == "Location Name" || DataSortBy == "Service Type" || DataSortBy == "Billing Freqency" || DataSortBy == "Esc Type" || DataSortBy == "Esc Cycle" || DataSortBy == "Esc Factor" || DataSortBy == "Last Esc" || DataSortBy == "Start Esc" || DataSortBy == "Finish Esc" || DataSortBy == "Expiration Date" || DataSortBy == "Phone Monitoring" || DataSortBy == "Next Due" || DataSortBy == "New Amount" || DataSortBy == "Contract #" || DataSortBy == "Renewal Notes")
            {
            ...
            if (selectedFiltersColumns == null)
            {
                query += " FROM vw_EscalationContracts order by " + DataSortBy;
            }
            else
            {
                string filters = string.Empty;
                ...
                filters = filters.Substring(0, filters.Length - 4);
                query += " FROM vw_EscalationContracts where " + filters + " order by " + DataSortBy;
            }
            #endregion
