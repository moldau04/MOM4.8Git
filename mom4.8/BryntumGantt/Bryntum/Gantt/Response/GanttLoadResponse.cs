...
namespace Bryntum.Gantt.Response
{
    ...
    public class GanttLoadResponse : LoadResponse {
        ...
        public void setCalendars(IEnumerable<Calendar> rows, int projectCalendar) {
            IDictionary<String, Object> metaData = new Dictionary<String, Object>();
            metaData.Add("projectCalendar", projectCalendar);

            calendars = new LoadStoreResponse<Calendar>(rows, false, metaData);
        }
