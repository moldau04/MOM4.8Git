    ...
    public class DL_AccountType
    {
        ...
        public DataSet AddCentral(Central _objCentral)
        {
            try
            {
                ...
                {
                    ParameterName = "@CentralName",
                    SqlDbType = SqlDbType.VarChar,
                    Value = _objCentral.CentralName
                };
                para[1] = new SqlParameter
                {
                    ParameterName = "@SortOrder",
                    SqlDbType = SqlDbType.SmallInt,
                    Value = _objCentral.SortOrder
                };
                return SqlHelper.ExecuteDataset(_objCentral.ConnConfig, "spAddCentral", para);
            }
            catch (Exception ex)
            {
                throw ex;
