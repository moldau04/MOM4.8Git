...
{
    [Serializable]
    public class ListGetInventoryItemStatus
    {
        public List<GetInventoryItemStatusTable1> lstTable1 { get; set; }
        public List<GetInventoryItemStatusTable2> lstTable2 { get; set; }
    }

    [Serializable]
    public class GetInventoryItemStatusTable1
    {
        //Table 1
        ...
        public string StrStatus { get { return _StrStatus; } set { _StrStatus = value; } }
    ...
    [Serializable]
    public class GetInventoryItemStatusTable2
    {
        //Table 2
