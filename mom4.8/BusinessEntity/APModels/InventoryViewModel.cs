...
namespace BusinessEntity.APModels
{
    ...
    {
        public List<GetInventoryByIDTable1> lstTable1 { get; set; }
        public List<GetInventoryByIDTable2> lstTable2 { get; set; }
        public List<GetInventoryByIDTable3> lstTable3 { get; set; }
        public List<GetInventoryByIDTable4> lstTable4 { get; set; }
    }

    [Serializable]
    public class GetInventoryByIDTable1
    {

    }

    [Serializable]
    public class GetInventoryByIDTable2
    {

    }

    [Serializable]
    public class GetInventoryByIDTable3
    {

    }

    [Serializable]
    public class GetInventoryByIDTable4
    {
