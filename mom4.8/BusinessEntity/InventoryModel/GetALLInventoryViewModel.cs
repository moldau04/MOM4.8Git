...
{
    [Serializable]
    public class ListGetALLInventory
    {
        public List<GetALLInventoryTable1> lstTable1 { get; set; }
        public List<GetALLInventoryTable2> lstTable2 { get; set; }
    }

    [Serializable]
    public class GetALLInventoryTable1
    {
    ...
    [Serializable]
    public class GetALLInventoryTable2
    {
