...
{
    [Serializable]
    public class ListGetSearchInventory
    {
        public List<GetSearchInventoryTable1> lstTable1 { get; set; }
        public List<GetSearchInventoryTable2> lstTable2 { get; set; }
    }

    [Serializable]
    public class GetSearchInventoryTable1
    {
    ...
    [Serializable]
    public class GetSearchInventoryTable2
    {
