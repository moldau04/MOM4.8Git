...
{
    [Serializable]
    public class ListGetARAging
    {
        public List<GetARAgingTable1> lstTable1 { get; set; }
        public List<GetARAgingTable2> lstTable2 { get; set; }
    }

    [Serializable]
    public class GetARAgingTable1
    {
