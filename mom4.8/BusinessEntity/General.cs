...
namespace BusinessEntity
{
    public class General
    {
        ...
        public int DiagnosticTypeOld { get; set; }


        public string DiagnosticCategoryOld { get; set; }
        ...
        public DataTable dtDiagnostic { get; set; }

        /// <summary>
        /// _DeviceType IOS/Android
        /// </summary>
        ...
        public int ScreenRefID { get; set; }
        public DataTable CustomItems { get; set; }
        public DataTable CustomItemsValue { get; set; }
        public DataTable CustomItemsDelete { get; set; }
    }

    public class getCustomFieldsParam
    {
        private string _CustomName;
        private string _ConnConfig;
        public string CustomName
    ...
    public class getCustomFieldParam
    {
        private string _CustomName;
        private string _ConnConfig;
        public string CustomName
    ...
    public class getCustomFieldsControlParam
    {
        private string _ConnConfig;
        public string ConnConfig
        {
    ...
    public class UpdateQBLastSyncParam
    {
        private string _ConnConfig;
        public string ConnConfig
        {
    ...
    public class GetDiagnosticCategoryParam
    {
        private string _ConnConfig;
        private DataSet _ds;
        public string ConnConfig
