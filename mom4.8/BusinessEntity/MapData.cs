...
namespace BusinessEntity
{
    ...
    public class MapData
    {
        ...
        private double _MileStart;
        private double _MileEnd;
        ...
        public string CustomTick5 { get; set; }
        ...
        public double MileEnd
        {
            get { return _MileEnd; }
            set { _MileEnd = value; }
        }

        public double MileStart
        {
        ...
        public DataTable dtTasks { get; set; }


        public string PartsUsed
        {
            get { return _PartsUsed; }
            set { _PartsUsed=value; }
        }
        ...
        public DataTable dtTicketINV { get; set; }

        public string Route { get; set; }

        public string ElevUnit { get; set; }
        ...
        //public List<RetainFilter> filter { get; set; }
    }

    public class GetChecksReportDataParam
    {
        private string _ConnConfig;
        private DateTime _StartDate;
        private DateTime _EndDate;
    ...
    public class PostInventoryItemsToProjectParam
    {
        private string _ConnConfig;
        private DateTime _CallDate;
        private string _Who;
    ...
    public class GetCallHistoryParam
    {
        private string _ConnConfig;
        private string _Workorder;
        private string _SearchBy;
        ...
        public int IsCallForTicketReport { get; set; }
        public int Status
        {
            get { return _Status; }
            set { _Status = value; }
    ...
    public class GetCompletedTicketParam
    {
        private string _SearchBy;
        private string _SearchValue;
        private string _ConnConfig;
    ...
    public class ImportDataForMassAttachDocumentsParam
    {
        public string strConfig { get; set; }
        public DataTable dataTable { get; set; }
    }

    public class GetLocationDocumentsParam
    {
        private int _TicketID;
        private string _ConnConfig;
        private DataSet _Ds;
    ...
    public class GetLocationEquipmentListParam
    {
        private string _SearchBy;
        private string _SearchValue;
        private string _ConnConfig;
    ...
    public class GetLocationByBusinessTypeParam
    {
        private string _SearchBy;
        private string _SearchValue;
        private string _ConnConfig;
    ...
    public class GetLocationDetailsReportParam
    {
        private string _SearchBy;
        private string _SearchValue;
        private string _ConnConfig;
    ...
    public class GetTicketByIDParam
    {
        private string _ConnConfig;
        private int _TicketID;
        private DataSet _Ds;
    ...
    public class GetElevByTicketParam
    {
        private string _ConnConfig;
        private int _TicketID;
        public string ConnConfig
    ...
    public class GetElevByTicketIDParam
    {
        private string _ConnConfig;
        private int _TicketID;
        public string ConnConfig
    ...
    public class GetElevByTicketIDsParam
    {
        private string _ConnConfig;
        public string ConnConfig
        {
    ...
    public class GetOpenMaintenanceByEquipmentParam
    {
        private string _ConnConfig;
        public string ConnConfig
        {
